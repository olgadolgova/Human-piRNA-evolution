...
Clusters.all <- readVCF("new_chr2.vcf.gz", numcols=10000, tid="2", from=90498900, to=239363666, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/1265288)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 90498900:239363666))) # N polyallelic sites in that region
m <- 1265288-sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(90498900:91730960), c(95419856:95459749), c(95521847:95541715), c(121973698:121982558), c(130792797:130835551), c(237030675:237041380), c(239352995:239363666)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr2.vcf.gz", numcols=10000, tid="2", from=90498900, to=91730960, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/1226918)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 90498900:91730960))) # N polyallelic sites in that region
m <- 1226918-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr2.vcf.gz", numcols=10000, tid="2", from=95419856, to=95459749, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/2519)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 95419856:95459749))) # N polyallelic sites in that region
m <- 2519-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr2.vcf.gz", numcols=10000, tid="2", from=95521847, to=95541715, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/8893)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 95521847:95541715))) # N polyallelic sites in that region
m <- 8893-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr2.vcf.gz", numcols=10000, tid="2", from=121973698, to=121982558, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/465)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 121973698:121982558))) # N polyallelic sites in that region
m <- 465-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr2.vcf.gz", numcols=10000, tid="2", from=130792797, to=130835551, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/22899)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 130792797:130835551))) # N polyallelic sites in that region
m <- 22899-sum(misshuman,na.rm=T)-polysites
...
#Cluster_6
Clusters_6 <- readVCF("new_chr2.vcf.gz", numcols=10000, tid="2", from=237030675, to=237041380, include.unknown = TRUE)
...
Mu <- (Clusters_6@theta_Watterson/936)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 237030675:237041380))) # N polyallelic sites in that region
...
#Cluster_7
Clusters_7 <- readVCF("new_chr2.vcf.gz", numcols=10000, tid="2", from=239352995, to=239363666, include.unknown = TRUE)
...
Mu <- (Clusters_7@theta_Watterson/2658)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 239352995:239363666))) # N polyallelic sites in that region
m <- 2658-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr2_1.vcf.gz", numcols=10000, tid="2", from=90498900, to=239363666, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(90498900:91730960), c(95419856:95459749), c(95521847:95541715), c(121973698:121982558), c(130792797:130835551), c(237030675:237041380), c(239352995:239363666)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr2_1.vcf.gz", numcols=10000, tid="2", from=90498900, to=91730960, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/1226918
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/1226918)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr2_1.vcf.gz", numcols=10000, tid="2", from=95419856, to=95459749, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/2519
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/2519)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr2_1.vcf.gz", numcols=10000, tid="2", from=95521847, to=95541715, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/8893
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/8893)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr2_1.vcf.gz", numcols=10000, tid="2", from=121973698, to=121982558, include.unknown = TRUE)
...
Mu <- (Clusters4_AFR@theta_Watterson/465)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr2_1.vcf.gz", numcols=10000, tid="2", from=130792797, to=130835551, include.unknown = TRUE)
...
divsites5_AFR
D <- divsites5_AFR/22899
D

#Mutation rate
Clusters5_AFR <- neutrality.stats(Clusters5_AFR, FAST = TRUE)
Mu <- (Clusters5_AFR@theta_Watterson/22899)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AFR<- readVCF("new_chr2_1.vcf.gz", numcols=10000, tid="2", from=237030675, to=237041380, include.unknown = TRUE)
...
Mu <- (Clusters6_AFR@theta_Watterson/936)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AFR <- readVCF("new_chr2_1.vcf.gz", numcols=10000, tid="2", from=239352995, to=239363666, include.unknown = TRUE)
...
divsites7_AFR
D <- divsites7_AFR/2658
D

#Mutation rate
Clusters7_AFR <- neutrality.stats(Clusters7_AFR, FAST = TRUE)
Mu <- (Clusters7_AFR@theta_Watterson/2658)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr2_2.vcf.gz", numcols=10000, tid="2", from=90498900, to=239363666, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(90498900:91730960), c(95419856:95459749), c(95521847:95541715), c(121973698:121982558), c(130792797:130835551), c(237030675:237041380), c(239352995:239363666)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr2_2.vcf.gz", numcols=10000, tid="2", from=90498900, to=91730960, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/1226918
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/1226918)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr2_2.vcf.gz", numcols=10000, tid="2", from=95419856, to=95459749, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/2519
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/2519)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr2_2.vcf.gz", numcols=10000, tid="2", from=95521847, to=95541715, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/8893
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/8893)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr2_2.vcf.gz", numcols=10000, tid="2", from=121973698, to=121982558, include.unknown = TRUE)
...
Mu <- (Clusters4_AMR@theta_Watterson/465)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr2_2.vcf.gz", numcols=10000, tid="2", from=130792797, to=130835551, include.unknown = TRUE)
...
divsites5_AMR
D <- divsites5_AMR/22899
D

#Mutation rate
Clusters5_AMR <- neutrality.stats(Clusters5_AMR, FAST = TRUE)
Mu <- (Clusters5_AMR@theta_Watterson/22899)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AMR<- readVCF("new_chr2_2.vcf.gz", numcols=10000, tid="2", from=237030675, to=237041380, include.unknown = TRUE)
...
Mu <- (Clusters6_AMR@theta_Watterson/936)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AMR <- readVCF("new_chr2_2.vcf.gz", numcols=10000, tid="2", from=239352995, to=239363666, include.unknown = TRUE)
...
divsites7_AMR
D <- divsites7_AMR/2658
D

#Mutation rate
Clusters7_AMR <- neutrality.stats(Clusters7_AMR, FAST = TRUE)
Mu <- (Clusters7_AMR@theta_Watterson/2658)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr2_3.vcf.gz", numcols=10000, tid="2", from=90498900, to=239363666, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(90498900:91730960), c(95419856:95459749), c(95521847:95541715), c(121973698:121982558), c(130792797:130835551), c(237030675:237041380), c(239352995:239363666)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr2_3.vcf.gz", numcols=10000, tid="2", from=90498900, to=91730960, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/1226918
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/1226918)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr2_3.vcf.gz", numcols=10000, tid="2", from=95419856, to=95459749, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/2519
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/2519)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr2_3.vcf.gz", numcols=10000, tid="2", from=95521847, to=95541715, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/8893
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/8893)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr2_3.vcf.gz", numcols=10000, tid="2", from=121973698, to=121982558, include.unknown = TRUE)
...
Mu <- (Clusters4_EAS@theta_Watterson/465)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS <- readVCF("new_chr2_3.vcf.gz", numcols=10000, tid="2", from=130792797, to=130835551, include.unknown = TRUE)
...
divsites5_EAS
D <- divsites5_EAS/22899
D

#Mutation rate
Clusters5_EAS <- neutrality.stats(Clusters5_EAS, FAST = TRUE)
Mu <- (Clusters5_EAS@theta_Watterson/22899)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EAS <- readVCF("new_chr2_3.vcf.gz", numcols=10000, tid="2", from=237030675, to=237041380, include.unknown = TRUE)
...
Mu <- (Clusters6_EAS@theta_Watterson/936)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EAS <- readVCF("new_chr2_3.vcf.gz", numcols=10000, tid="2", from=239352995, to=239363666, include.unknown = TRUE)
...
divsites7_EAS
D <- divsites7_EAS/2658
D

#Mutation rate
Clusters7_EAS <- neutrality.stats(Clusters7_EAS, FAST = TRUE)
Mu <- (Clusters7_EAS@theta_Watterson/2658)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr2_4.vcf.gz", numcols=10000, tid="2", from=90498900, to=239363666, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(90498900:91730960), c(95419856:95459749), c(95521847:95541715), c(121973698:121982558), c(130792797:130835551), c(237030675:237041380), c(239352995:239363666)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr2_4.vcf.gz", numcols=10000, tid="2", from=90498900, to=91730960, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/1226918
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/1226918)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr2_4.vcf.gz", numcols=10000, tid="2", from=95419856, to=95459749, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/2519
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/2519)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr2_4.vcf.gz", numcols=10000, tid="2", from=95521847, to=95541715, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/8893
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/8893)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr2_4.vcf.gz", numcols=10000, tid="2", from=121973698, to=121982558, include.unknown = TRUE)
...
Mu <- (Clusters4_EUR@theta_Watterson/465)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR <- readVCF("new_chr2_4.vcf.gz", numcols=10000, tid="2", from=130792797, to=130835551, include.unknown = TRUE)
...
divsites5_EUR
D <- divsites5_EUR/22899
D

#Mutation rate
Clusters5_EUR <- neutrality.stats(Clusters5_EUR, FAST = TRUE)
Mu <- (Clusters5_EUR@theta_Watterson/22899)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EUR <- readVCF("new_chr2_4.vcf.gz", numcols=10000, tid="2", from=237030675, to=237041380, include.unknown = TRUE)
...
Mu <- (Clusters6_EUR@theta_Watterson/936)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EUR <- readVCF("new_chr2_4.vcf.gz", numcols=10000, tid="2", from=239352995, to=239363666, include.unknown = TRUE)
...
divsites7_EUR
D <- divsites7_EUR/2658
D

#Mutation rate
Clusters7_EUR <- neutrality.stats(Clusters7_EUR, FAST = TRUE)
Mu <- (Clusters7_EUR@theta_Watterson/2658)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr2_5.vcf.gz", numcols=10000, tid="2", from=90498900, to=239363666, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(90498900:91730960), c(95419856:95459749), c(95521847:95541715), c(121973698:121982558), c(130792797:130835551), c(237030675:237041380), c(239352995:239363666)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr2_5.vcf.gz", numcols=10000, tid="2", from=90498900, to=91730960, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/1226918
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/1226918)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr2_5.vcf.gz", numcols=10000, tid="2", from=95419856, to=95459749, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/2519
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/2519)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr2_5.vcf.gz", numcols=10000, tid="2", from=95521847, to=95541715, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/8893
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/8893)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr2_3.vcf.gz", numcols=10000, tid="2", from=121973698, to=121982558, include.unknown = TRUE)
...
Mu <- (Clusters4_SAS@theta_Watterson/465)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS <- readVCF("new_chr2_5.vcf.gz", numcols=10000, tid="2", from=130792797, to=130835551, include.unknown = TRUE)
...
divsites5_SAS
D <- divsites5_SAS/22899
D

#Mutation rate
Clusters5_SAS <- neutrality.stats(Clusters5_SAS, FAST = TRUE)
Mu <- (Clusters5_SAS@theta_Watterson/22899)/(4*10000)
Mu
...
#Cluster_6
Clusters6_SAS <- readVCF("new_chr2_5.vcf.gz", numcols=10000, tid="2", from=237030675, to=237041380, include.unknown = TRUE)
...
Mu <- (Clusters6_SAS@theta_Watterson/936)/(4*10000)
Mu
...
#Cluster_7
Clusters7_SAS <- readVCF("new_chr2_5.vcf.gz", numcols=10000, tid="2", from=239352995, to=239363666, include.unknown = TRUE)
...
divsites7_SAS
D <- divsites7_SAS/2658
D

#Mutation rate
Clusters7_SAS <- neutrality.stats(Clusters7_SAS, FAST = TRUE)
Mu <- (Clusters7_SAS@theta_Watterson/2658)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr2_intergenic.vcf.gz", numcols=10000, tid="2", from=91730937, to=239419331, include.unknown = TRUE)
...
Mu <- (Intergenic.all@theta_Watterson/117983)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 91730937:239419331))) # N polyallelic sites in that region
m <- 117983-sum(misshuman,na.rm=T)-polysites
...
#Region 1-3
Intergenic1_3 <- readVCF("new_chr2_intergenic.vcf.gz", numcols=10000, tid="2", from=91730937, to=91734174, include.unknown = TRUE)
Intergenic1_3 <- set.outgroup(Intergenic1_3, c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic1_3) 

#Divergence
bial <- get.biallelic.matrix(Intergenic1_3,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter1 <- sum (div & !polym,na.rm=T)
divsites_inter1
D <- divsites_inter1/3237
D

#Region 4
Intergenic4 <- readVCF("new_chr2_intergenic.vcf.gz", numcols=10000, tid="2", from=121940156, to=121973697, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/33541
D

#Region 5
Intergenic5 <- readVCF("new_chr2_intergenic.vcf.gz", numcols=10000, tid="2", from=130740311, to=130748029, include.unknown = TRUE)
...
divsites_inter5
D <- divsites_inter5/7718
D

#Region 6
Intergenic6 <- readVCF("new_chr2_intergenic.vcf.gz", numcols=10000, tid="2", from=237041381, to=237061715, include.unknown = TRUE)
...
divsites_inter6
D <- divsites_inter6/20328
D

#Region 7
Intergenic7 <- readVCF("new_chr2_intergenic.vcf.gz", numcols=10000, tid="2", from=239366161, to=239419331, include.unknown = TRUE)
...
divsites_inter7
D <- divsites_inter7/53159
D

###################POPULATIONS####################################################

#AFR
Intergenic.all_AFR <- readVCF("new_chr2_1_intergenic.vcf.gz", numcols=10000, tid="2", from=91730937, to=239419331, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AFR@theta_Watterson/117983)/(4*10000)
Mu
...
#Region 1-3
Intergenic1_3_AFR <- readVCF("new_chr2_1_intergenic.vcf.gz", numcols=10000, tid="2", from=91730937, to=91734174, include.unknown = TRUE)
Intergenic1_3_AFR <- set.outgroup(Intergenic1_3_AFR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic1_3_AFR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic1_3_AFR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter1_3_AFR <- sum (div & !polym,na.rm=T)
divsites_inter1_3_AFR
D <- divsites_inter1_3_AFR/1444
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr2_1_intergenic.vcf.gz", numcols=10000, tid="2", from=121940156, to=121973697, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/33541
D

#Region 5
Intergenic5_AFR <- readVCF("new_chr2_1_intergenic.vcf.gz", numcols=10000, tid="2", from=130740311, to=130748029, include.unknown = TRUE)
...
divsites_inter5_AFR
D <- divsites_inter5_AFR/7718
D

#Region 6
Intergenic6_AFR <- readVCF("new_chr2_1_intergenic.vcf.gz", numcols=10000, tid="2", from=237041381, to=237061715, include.unknown = TRUE)
...
divsites_inter6_AFR
D <- divsites_inter6_AFR/20328
D

#Region 7
Intergenic7_AFR <- readVCF("new_chr2_1_intergenic.vcf.gz", numcols=10000, tid="2", from=239366161, to=239419331, include.unknown = TRUE)
...
divsites_inter7_AFR
D <- divsites_inter7_AFR/53159
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr2_2_intergenic.vcf.gz", numcols=10000, tid="2", from=91730937, to=239419331, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AMR@theta_Watterson/117983)/(4*10000)
Mu
...
#Region 1-3
Intergenic1_3_AMR <- readVCF("new_chr2_2_intergenic.vcf.gz", numcols=10000, tid="2", from=91730937, to=91734174, include.unknown = TRUE)
Intergenic1_3_AMR <- set.outgroup(Intergenic1_3_AMR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic1_3_AMR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic1_3_AMR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter1_3_AMR <- sum (div & !polym,na.rm=T)
divsites_inter1_3_AMR
D <- divsites_inter1_3_AMR/1444
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr2_2_intergenic.vcf.gz", numcols=10000, tid="2", from=121940156, to=121973697, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/33541
D

#Region 5
Intergenic5_AMR <- readVCF("new_chr2_2_intergenic.vcf.gz", numcols=10000, tid="2", from=130740311, to=130748029, include.unknown = TRUE)
...
divsites_inter5_AMR
D <- divsites_inter5_AMR/7718
D

#Region 6
Intergenic6_AMR <- readVCF("new_chr2_2_intergenic.vcf.gz", numcols=10000, tid="2", from=237041381, to=237061715, include.unknown = TRUE)
...
divsites_inter6_AMR
D <- divsites_inter6_AMR/20328
D

#Region 7
Intergenic7_AMR <- readVCF("new_chr2_2_intergenic.vcf.gz", numcols=10000, tid="2", from=239366161, to=239419331, include.unknown = TRUE)
...
divsites_inter7_AMR
D <- divsites_inter7_AMR/53159
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr2_3_intergenic.vcf.gz", numcols=10000, tid="2", from=91730937, to=239419331, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EAS@theta_Watterson/117983)/(4*10000)
Mu
...
#Region 1-3
Intergenic1_3_EAS <- readVCF("new_chr2_3_intergenic.vcf.gz", numcols=10000, tid="2", from=91730937, to=91734174, include.unknown = TRUE)
Intergenic1_3_EAS <- set.outgroup(Intergenic1_3_EAS,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic1_3_EAS) 

#Divergence
bial <- get.biallelic.matrix(Intergenic1_3_EAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter1_3_EAS <- sum (div & !polym,na.rm=T)
divsites_inter1_3_EAS
D <- divsites_inter1_3_EAS/1444
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr2_3_intergenic.vcf.gz", numcols=10000, tid="2", from=121940156, to=121973697, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/33541
D

#Region 5
Intergenic5_EAS <- readVCF("new_chr2_3_intergenic.vcf.gz", numcols=10000, tid="2", from=130740311, to=130748029, include.unknown = TRUE)
...
divsites_inter5_EAS
D <- divsites_inter5_EAS/7718
D

#Region 6
Intergenic6_EAS <- readVCF("new_chr2_3_intergenic.vcf.gz", numcols=10000, tid="2", from=237041381, to=237061715, include.unknown = TRUE)
...
divsites_inter6_EAS
D <- divsites_inter6_EAS/20328
D

#Region 7
Intergenic7_EAS <- readVCF("new_chr2_3_intergenic.vcf.gz", numcols=10000, tid="2", from=239366161, to=239419331, include.unknown = TRUE)
...
divsites_inter7_EAS
D <- divsites_inter7_EAS/53159
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr2_4_intergenic.vcf.gz", numcols=10000, tid="2", from=91730937, to=239419331, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EUR@theta_Watterson/117983)/(4*10000)
Mu
...
#Region 1-3
Intergenic1_3_EUR <- readVCF("new_chr2_4_intergenic.vcf.gz", numcols=10000, tid="2", from=91730937, to=91734174, include.unknown = TRUE)
Intergenic1_3_EUR <- set.outgroup(Intergenic1_3_EUR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic1_3_EUR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic1_3_EUR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter1_3_EUR <- sum (div & !polym,na.rm=T)
divsites_inter1_3_EUR
D <- divsites_inter1_3_EUR/1444
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr2_4_intergenic.vcf.gz", numcols=10000, tid="2", from=121940156, to=121973697, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/33541
D

#Region 5
Intergenic5_EUR <- readVCF("new_chr2_4_intergenic.vcf.gz", numcols=10000, tid="2", from=130740311, to=130748029, include.unknown = TRUE)
...
divsites_inter5_EUR
D <- divsites_inter5_EUR/7718
D

#Region 6
Intergenic6_EUR <- readVCF("new_chr2_4_intergenic.vcf.gz", numcols=10000, tid="2", from=237041381, to=237061715, include.unknown = TRUE)
...
divsites_inter6_EUR
D <- divsites_inter6_EUR/20328
D

#Region 7
Intergenic7_EUR <- readVCF("new_chr2_4_intergenic.vcf.gz", numcols=10000, tid="2", from=239366161, to=239419331, include.unknown = TRUE)
...
divsites_inter7_EUR
D <- divsites_inter7_EUR/53159
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr2_5_intergenic.vcf.gz", numcols=10000, tid="2", from=91730937, to=239419331, include.unknown = TRUE)
...
Mu <- (Intergenic.all_SAS@theta_Watterson/117983)/(4*10000)
Mu
...
#Region 1-3
Intergenic1_3_SAS <- readVCF("new_chr2_5_intergenic.vcf.gz", numcols=10000, tid="2", from=91730937, to=91734174, include.unknown = TRUE)
Intergenic1_3_SAS <- set.outgroup(Intergenic1_3_SAS,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic1_3_SAS) 

#Divergence
bial <- get.biallelic.matrix(Intergenic1_3_SAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter1_3_SAS <- sum (div & !polym,na.rm=T)
divsites_inter1_3_SAS
D <- divsites_inter1_3_SAS/1444
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr2_5_intergenic.vcf.gz", numcols=10000, tid="2", from=121940156, to=121973697, include.unknown = TRUE)
...
divsites_inter4_SAS
D <- divsites_inter4_SAS/33541
D

#Region 5
Intergenic5_SAS <- readVCF("new_chr2_5_intergenic.vcf.gz", numcols=10000, tid="2", from=130740311, to=130748029, include.unknown = TRUE)
...
divsites_inter5_SAS
D <- divsites_inter5_SAS/7718
D

#Region 6
Intergenic6_SAS <- readVCF("new_chr2_5_intergenic.vcf.gz", numcols=10000, tid="2", from=237041381, to=237061715, include.unknown = TRUE)
...
divsites_inter6_SAS
D <- divsites_inter6_SAS/20328
D

#Region 7
Intergenic7_SAS <- readVCF("new_chr2_5_intergenic.vcf.gz", numcols=10000, tid="2", from=239366161, to=239419331, include.unknown = TRUE)
...
MKT_1=rbind(c(Intergenic1_3@n.biallelic.sites, divsites_inter1), c(Clusters_1@n.biallelic.sites, divsites1))
MKT_1
chisq.test(MKT_1, simulate.p.value=TRUE)

MKT_2=rbind(c(Intergenic1_3@n.biallelic.sites, divsites_inter1), c(Clusters_2@n.biallelic.sites, divsites2))
MKT_2
chisq.test(MKT_2, simulate.p.value=TRUE)

MKT_3=rbind(c(Intergenic1_3@n.biallelic.sites, divsites_inter1), c(Clusters_3@n.biallelic.sites, divsites3))
MKT_3
...
MKT_AFR_1=rbind(c(Intergenic1_3_AFR@n.biallelic.sites, divsites_inter1_3_AFR), c(Clusters1_AFR@n.biallelic.sites, divsites1_AFR))
MKT_AFR_1
chisq.test(MKT_AFR_1, simulate.p.value=TRUE)

MKT_AFR_2=rbind(c(Intergenic1_3_AFR@n.biallelic.sites, divsites_inter1_3_AFR), c(Clusters2_AFR@n.biallelic.sites, divsites2_AFR))
MKT_AFR_2
chisq.test(MKT_AFR_2, simulate.p.value=TRUE)

MKT_AFR_3=rbind(c(Intergenic1_3_AFR@n.biallelic.sites, divsites_inter1_3_AFR), c(Clusters3_AFR@n.biallelic.sites, divsites3_AFR))
MKT_AFR_3
...
MKT_AMR_1=rbind(c(Intergenic1_3_AMR@n.biallelic.sites, divsites_inter1_3_AMR), c(Clusters1_AMR@n.biallelic.sites, divsites1_AMR))
MKT_AMR_1
chisq.test(MKT_AMR_1, simulate.p.value=TRUE)

MKT_AMR_2=rbind(c(Intergenic1_3_AMR@n.biallelic.sites, divsites_inter1_3_AMR), c(Clusters2_AMR@n.biallelic.sites, divsites2_AMR))
MKT_AMR_2
chisq.test(MKT_AMR_2, simulate.p.value=TRUE)

MKT_AMR_3=rbind(c(Intergenic1_3_AMR@n.biallelic.sites, divsites_inter1_3_AMR), c(Clusters3_AMR@n.biallelic.sites, divsites3_AMR))
MKT_AMR_3
...
MKT_EAS_1=rbind(c(Intergenic1_3_EAS@n.biallelic.sites, divsites_inter1_3_EAS), c(Clusters1_EAS@n.biallelic.sites, divsites1_EAS))
MKT_EAS_1
chisq.test(MKT_EAS_1, simulate.p.value=TRUE)

MKT_EAS_2=rbind(c(Intergenic1_3_EAS@n.biallelic.sites, divsites_inter1_3_EAS), c(Clusters2_EAS@n.biallelic.sites, divsites2_EAS))
MKT_EAS_2
chisq.test(MKT_EAS_2, simulate.p.value=TRUE)

MKT_EAS_3=rbind(c(Intergenic1_3_EAS@n.biallelic.sites, divsites_inter1_3_EAS), c(Clusters3_EAS@n.biallelic.sites, divsites3_EAS))
MKT_EAS_3
...
MKT_EUR_1=rbind(c(Intergenic1_3_EUR@n.biallelic.sites, divsites_inter1_3_EUR), c(Clusters1_EUR@n.biallelic.sites, divsites1_EUR))
MKT_EUR_1
chisq.test(MKT_EUR_1, simulate.p.value=TRUE)

MKT_EUR_2=rbind(c(Intergenic1_3_EUR@n.biallelic.sites, divsites_inter1_3_EUR), c(Clusters2_EUR@n.biallelic.sites, divsites2_EUR))
MKT_EUR_2
chisq.test(MKT_EUR_2, simulate.p.value=TRUE)

MKT_EUR_3=rbind(c(Intergenic1_3_EUR@n.biallelic.sites, divsites_inter1_3_EUR), c(Clusters3_EUR@n.biallelic.sites, divsites3_EUR))
MKT_EUR_3
...
MKT_SAS_1=rbind(c(Intergenic1_3_SAS@n.biallelic.sites, divsites_inter1_3_SAS), c(Clusters1_SAS@n.biallelic.sites, divsites1_SAS))
MKT_SAS_1
chisq.test(MKT_SAS_1, simulate.p.value=TRUE)

MKT_SAS_2=rbind(c(Intergenic1_3_SAS@n.biallelic.sites, divsites_inter1_3_SAS), c(Clusters2_SAS@n.biallelic.sites, divsites2_SAS))
MKT_SAS_2
chisq.test(MKT_SAS_2, simulate.p.value=TRUE)

MKT_SAS_3=rbind(c(Intergenic1_3_SAS@n.biallelic.sites, divsites_inter1_3_SAS), c(Clusters3_SAS@n.biallelic.sites, divsites3_SAS))
MKT_SAS_3
