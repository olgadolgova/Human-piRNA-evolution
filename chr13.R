...
Clusters.all <- readVCF("new_chr13.vcf.gz", numcols=10000, tid="13", from=31905163, to=114934504, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/57878)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 31905163:114934504))) # N polyallelic sites in that region
m <- 57878-sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(31905163:31955148), c(114924574:114934504)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr13.vcf.gz", numcols=10000, tid="13", from=31905163, to=31955148, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/47948)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 31905163:31955148))) # N polyallelic sites in that region
m <- 47948-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr13.vcf.gz", numcols=10000, tid="13", from=114924574, to=114934504, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/9930)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 114924574:114934504))) # N polyallelic sites in that region
m <- 9930-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr13_1.vcf.gz", numcols=10000, tid="13", from=31905163, to=114934504, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(31905163:31955148), c(114924574:114934504)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr13_1.vcf.gz", numcols=10000, tid="13", from=31905163, to=31955148, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/47948
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/47948)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr13_1.vcf.gz", numcols=10000, tid="13", from=114924574, to=114934504, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/9930
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/9930)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr13_2.vcf.gz", numcols=10000, tid="13", from=31905163, to=114934504, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(31905163:31955148), c(114924574:114934504)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr13_2.vcf.gz", numcols=10000, tid="13", from=31905163, to=31955148, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/47948
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/47948)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr13_2.vcf.gz", numcols=10000, tid="13", from=114924574, to=114934504, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/9930
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/9930)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr13_3.vcf.gz", numcols=10000, tid="13", from=31905163, to=114934504, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(31905163:31955148), c(114924574:114934504)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr13_3.vcf.gz", numcols=10000, tid="13", from=31905163, to=31955148, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/47948
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/47948)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr13_3.vcf.gz", numcols=10000, tid="13", from=114924574, to=114934504, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/9930
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/9930)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr13_4.vcf.gz", numcols=10000, tid="13", from=31905163, to=114934504, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(31905163:31955148), c(114924574:114934504)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr13_4.vcf.gz", numcols=10000, tid="13", from=31905163, to=31955148, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/47948
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/47948)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr13_4.vcf.gz", numcols=10000, tid="13", from=114924574, to=114934504, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/9930
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/9930)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr13_5.vcf.gz", numcols=10000, tid="13", from=31905163, to=114934504, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(31905163:31955148), c(114924574:114934504)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr13_5.vcf.gz", numcols=10000, tid="13", from=31905163, to=31955148, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/47948
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/47948)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr13_5.vcf.gz", numcols=10000, tid="13", from=114924574, to=114934504, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/9930
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/9930)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr13_intergenic.vcf.gz", numcols=10000, tid="13", from=31955149, to=114924573, include.unknown = TRUE)
...
Mu <- (Intergenic.all@theta_Watterson/62249)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 31955149:114924573))) # N polyallelic sites in that region
m <- 62249-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr13_intergenic.vcf.gz", numcols=10000, tid="13", from=31955149, to=31994126, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/38977
D

#Region 2
Intergenic2 <- readVCF("new_chr13_intergenic.vcf.gz", numcols=10000, tid="13", from=114898086, to=114924573, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/23272
D

###################POPULATIONS####################################################

#AFR
Intergenic.all_AFR <- readVCF("new_chr13_1_intergenic.vcf.gz", numcols=10000, tid="13", from=31955149, to=114924573, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AFR@theta_Watterson/62249)/(4*10000)
Mu
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr13_1_intergenic.vcf.gz", numcols=10000, tid="13", from=31955149, to=31994126, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/38977
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr13_1_intergenic.vcf.gz", numcols=10000, tid="13", from=114898086, to=114924573, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/23272
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr13_2_intergenic.vcf.gz", numcols=10000, tid="13", from=31955149, to=114924573, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AMR@theta_Watterson/62249)/(4*10000)
Mu
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr13_2_intergenic.vcf.gz", numcols=10000, tid="13", from=31955149, to=31994126, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/38977
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr13_2_intergenic.vcf.gz", numcols=10000, tid="13", from=114898086, to=114924573, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/23272
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr13_3_intergenic.vcf.gz", numcols=10000, tid="13", from=31955149, to=114924573, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EAS@theta_Watterson/62249)/(4*10000)
Mu
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr13_3_intergenic.vcf.gz", numcols=10000, tid="13", from=31955149, to=31994126, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/38977
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr13_3_intergenic.vcf.gz", numcols=10000, tid="13", from=114898086, to=114924573, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/23272
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr13_4_intergenic.vcf.gz", numcols=10000, tid="13", from=31955149, to=114924573, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EUR@theta_Watterson/62249)/(4*10000)
Mu
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr13_4_intergenic.vcf.gz", numcols=10000, tid="13", from=31955149, to=31994126, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/38977
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr13_4_intergenic.vcf.gz", numcols=10000, tid="13", from=114898086, to=114924573, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/23272
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr13_5_intergenic.vcf.gz", numcols=10000, tid="13", from=31955149, to=114924573, include.unknown = TRUE)
...
Mu <- (Intergenic.all_SAS@theta_Watterson/62249)/(4*10000)
Mu
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr13_5_intergenic.vcf.gz", numcols=10000, tid="13", from=31955149, to=31994126, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/38977
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr13_5_intergenic.vcf.gz", numcols=10000, tid="13", from=114898086, to=114924573, include.unknown = TRUE)
