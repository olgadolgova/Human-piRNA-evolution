...
Clusters.all <- readVCF("new_chr16.vcf.gz", numcols=10000, tid="16", from=23677355, to=68543883, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/23507)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 23677355:68543883))) # N polyallelic sites in that region
m <- 23507-sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(23677355:23690204), c(28381362:28391348), c(31083339:31095335), c(66647926:66658617), c(68530944:68543883)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr16.vcf.gz", numcols=10000, tid="16", from=23677355, to=23690204, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/201)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 23677355:23690204))) # N polyallelic sites in that region
m <- 201-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr16.vcf.gz", numcols=10000, tid="16", from=28381362, to=28391348, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/9538)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 28381362:28391348))) # N polyallelic sites in that region
m <- 9538-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr16.vcf.gz", numcols=10000, tid="16", from=31083339, to=31095335, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/102)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 31083339:31095335))) # N polyallelic sites in that region
m <- 102-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr16.vcf.gz", numcols=10000, tid="16", from=66647926, to=66658617, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/727)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 66647926:66658617))) # N polyallelic sites in that region
m <- 727-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr16.vcf.gz", numcols=10000, tid="16", from=68530944, to=68543883, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/12939)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 68530944:68543883))) # N polyallelic sites in that region
m <- 12939-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr16_1.vcf.gz", numcols=10000, tid="16", from=23677355, to=68543883, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(23677355:23690204), c(28381362:28391348), c(31083339:31095335), c(66647926:66658617), c(68530944:68543883)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr16_1.vcf.gz", numcols=10000, tid="16", from=23677355, to=23690204, include.unknown = TRUE)
...
Mu <- (Clusters1_AFR@theta_Watterson/201)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr16_1.vcf.gz", numcols=10000, tid="16", from=28381362, to=28391348, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/9538
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/9538)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr16_1.vcf.gz", numcols=10000, tid="16", from=31083339, to=31095335, include.unknown = TRUE)
...
Mu <- (Clusters3_AFR@theta_Watterson/102)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr16_1.vcf.gz", numcols=10000, tid="16", from=66647926, to=66658617, include.unknown = TRUE)
...
Mu <- (Clusters4_AFR@theta_Watterson/727)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr16_1.vcf.gz", numcols=10000, tid="16", from=68530944, to=68543883, include.unknown = TRUE)
...
divsites5_AFR
D <- divsites5_AFR/12939
D

#Mutation rate
Clusters5_AFR <- neutrality.stats(Clusters5_AFR, FAST = TRUE)
Mu <- (Clusters5_AFR@theta_Watterson/12939)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr16_2.vcf.gz", numcols=10000, tid="16", from=23677355, to=68543883, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(23677355:23690204), c(28381362:28391348), c(31083339:31095335), c(66647926:66658617), c(68530944:68543883)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr16_2.vcf.gz", numcols=10000, tid="16", from=23677355, to=23690204, include.unknown = TRUE)
...
Mu <- (Clusters1_AMR@theta_Watterson/201)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr16_2.vcf.gz", numcols=10000, tid="16", from=28381362, to=28391348, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/9538
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/9538)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr16_2.vcf.gz", numcols=10000, tid="16", from=31083339, to=31095335, include.unknown = TRUE)
...
Mu <- (Clusters3_AMR@theta_Watterson/102)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr16_2.vcf.gz", numcols=10000, tid="16", from=66647926, to=66658617, include.unknown = TRUE)
...
Mu <- (Clusters4_AMR@theta_Watterson/727)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr16_2.vcf.gz", numcols=10000, tid="16", from=68530944, to=68543883, include.unknown = TRUE)
...
divsites5_AMR
D <- divsites5_AMR/12939
D

#Mutation rate
Clusters5_AMR <- neutrality.stats(Clusters5_AMR, FAST = TRUE)
Mu <- (Clusters5_AMR@theta_Watterson/12939)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr16_3.vcf.gz", numcols=10000, tid="16", from=23677355, to=68543883, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(23677355:23690204), c(28381362:28391348), c(31083339:31095335), c(66647926:66658617), c(68530944:68543883)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr16_3.vcf.gz", numcols=10000, tid="16", from=23677355, to=23690204, include.unknown = TRUE)
...
Mu <- (Clusters1_EAS@theta_Watterson/201)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr16_3.vcf.gz", numcols=10000, tid="16", from=28381362, to=28391348, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/9538
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/9538)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr16_3.vcf.gz", numcols=10000, tid="16", from=31083339, to=31095335, include.unknown = TRUE)
...
Mu <- (Clusters3_EAS@theta_Watterson/102)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr16_3.vcf.gz", numcols=10000, tid="16", from=66647926, to=66658617, include.unknown = TRUE)
...
Mu <- (Clusters4_EAS@theta_Watterson/727)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS<- readVCF("new_chr16_3.vcf.gz", numcols=10000, tid="16", from=68530944, to=68543883, include.unknown = TRUE)
...
divsites5_EAS
D <- divsites5_EAS/12939
D

#Mutation rate
Clusters5_EAS <- neutrality.stats(Clusters5_EAS, FAST = TRUE)
Mu <- (Clusters5_EAS@theta_Watterson/12939)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr16_4.vcf.gz", numcols=10000, tid="16", from=23677355, to=68543883, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(23677355:23690204), c(28381362:28391348), c(31083339:31095335), c(66647926:66658617), c(68530944:68543883)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr16_4.vcf.gz", numcols=10000, tid="16", from=23677355, to=23690204, include.unknown = TRUE)
...
Mu <- (Clusters1_EUR@theta_Watterson/201)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr16_4.vcf.gz", numcols=10000, tid="16", from=28381362, to=28391348, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/9538
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/9538)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr16_4.vcf.gz", numcols=10000, tid="16", from=31083339, to=31095335, include.unknown = TRUE)
...
Mu <- (Clusters3_EUR@theta_Watterson/102)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr16_4.vcf.gz", numcols=10000, tid="16", from=66647926, to=66658617, include.unknown = TRUE)
...
Mu <- (Clusters4_EUR@theta_Watterson/727)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR<- readVCF("new_chr16_4.vcf.gz", numcols=10000, tid="16", from=68530944, to=68543883, include.unknown = TRUE)
...
divsites5_EUR
D <- divsites5_EUR/12939
D

#Mutation rate
Clusters5_EUR <- neutrality.stats(Clusters5_EUR, FAST = TRUE)
Mu <- (Clusters5_EUR@theta_Watterson/12939)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr16_5.vcf.gz", numcols=10000, tid="16", from=23677355, to=68543883, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(23677355:23690204), c(28381362:28391348), c(31083339:31095335), c(66647926:66658617), c(68530944:68543883)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr16_5.vcf.gz", numcols=10000, tid="16", from=23677355, to=23690204, include.unknown = TRUE)
...
Mu <- (Clusters1_SAS@theta_Watterson/201)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr16_5.vcf.gz", numcols=10000, tid="16", from=28381362, to=28391348, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/9538
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/9538)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr16_5.vcf.gz", numcols=10000, tid="16", from=31083339, to=31095335, include.unknown = TRUE)
...
Mu <- (Clusters3_SAS@theta_Watterson/102)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr16_5.vcf.gz", numcols=10000, tid="16", from=66647926, to=66658617, include.unknown = TRUE)
...
Mu <- (Clusters4_SAS@theta_Watterson/727)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS<- readVCF("new_chr16_5.vcf.gz", numcols=10000, tid="16", from=68530944, to=68543883, include.unknown = TRUE)
...
divsites5_SAS
D <- divsites5_SAS/12939
D

#Mutation rate
Clusters5_SAS <- neutrality.stats(Clusters5_SAS, FAST = TRUE)
Mu <- (Clusters5_SAS@theta_Watterson/12939)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr16_intergenic.vcf.gz", numcols=10000, tid="16", from=23724821, to=68530943, include.unknown = TRUE)
...
Mu <- (Intergenic.all@theta_Watterson/90067)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 23724821:68530943))) # N polyallelic sites in that region
m <- 90067-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr16_intergenic.vcf.gz", numcols=10000, tid="16", from=23724821, to=23765010, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/40178
D


#Region 2
Intergenic2 <- readVCF("new_chr16_intergenic.vcf.gz", numcols=10000, tid="16", from=28376654, to=28381361, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/4700
D

#Region 3
Intergenic3 <- readVCF("new_chr16_intergenic.vcf.gz", numcols=10000, tid="16", from=31107301, to=31117428, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/10120
D

#Region 4
Intergenic4 <- readVCF("new_chr16_intergenic.vcf.gz", numcols=10000, tid="16", from=66622178, to=66637777, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/15599
D

#Region 5
Intergenic5 <- readVCF("new_chr16_intergenic.vcf.gz", numcols=10000, tid="16", from=68511473, to=68530943, include.unknown = TRUE)
...
divsites_inter5
D <- divsites_inter5/19470
D

###################POPULATIONS####################################################

#AFR
Intergenic.all_AFR <- readVCF("new_chr16_1_intergenic.vcf.gz", numcols=10000, tid="16", from=23724821, to=68530943, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AFR@theta_Watterson/90067)/(4*10000)
Mu
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr16_1_intergenic.vcf.gz", numcols=10000, tid="16", from=23724821, to=23765010, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/40178
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr16_1_intergenic.vcf.gz", numcols=10000, tid="16", from=28376654, to=28381361, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/4700
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr16_1_intergenic.vcf.gz", numcols=10000, tid="16", from=31107301, to=31117428, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/10120
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr16_1_intergenic.vcf.gz", numcols=10000, tid="16", from=66622178, to=66637777, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/15599
D

#Region 5
Intergenic5_AFR <- readVCF("new_chr16_1_intergenic.vcf.gz", numcols=10000, tid="16", from=68511473, to=68530943, include.unknown = TRUE)
...
divsites_inter5_AFR
D <- divsites_inter5_AFR/19470
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr16_2_intergenic.vcf.gz", numcols=10000, tid="16", from=23724821, to=68530943, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AMR@theta_Watterson/90067)/(4*10000)
Mu
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr16_2_intergenic.vcf.gz", numcols=10000, tid="16", from=23724821, to=23765010, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/40178
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr16_2_intergenic.vcf.gz", numcols=10000, tid="16", from=28376654, to=28381361, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/4700
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr16_2_intergenic.vcf.gz", numcols=10000, tid="16", from=31107301, to=31117428, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/10120
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr16_2_intergenic.vcf.gz", numcols=10000, tid="16", from=66622178, to=66637777, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/15599
D

#Region 5
Intergenic5_AMR <- readVCF("new_chr16_2_intergenic.vcf.gz", numcols=10000, tid="16", from=68511473, to=68530943, include.unknown = TRUE)
...
divsites_inter5_AMR
D <- divsites_inter5_AMR/19470
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr16_3_intergenic.vcf.gz", numcols=10000, tid="16", from=23724821, to=68530943, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EAS@theta_Watterson/90067)/(4*10000)
Mu
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr16_3_intergenic.vcf.gz", numcols=10000, tid="16", from=23724821, to=23765010, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/40178
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr16_3_intergenic.vcf.gz", numcols=10000, tid="16", from=28376654, to=28381361, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/4700
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr16_3_intergenic.vcf.gz", numcols=10000, tid="16", from=31107301, to=31117428, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/10120
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr16_3_intergenic.vcf.gz", numcols=10000, tid="16", from=66622178, to=66637777, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/15599
D

#Region 5
Intergenic5_EAS <- readVCF("new_chr16_3_intergenic.vcf.gz", numcols=10000, tid="16", from=68511473, to=68530943, include.unknown = TRUE)
...
divsites_inter5_EAS
D <- divsites_inter5_EAS/19470
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr16_4_intergenic.vcf.gz", numcols=10000, tid="16", from=23724821, to=68530943, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EUR@theta_Watterson/90067)/(4*10000)
Mu
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr16_4_intergenic.vcf.gz", numcols=10000, tid="16", from=23724821, to=23765010, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/40178
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr16_4_intergenic.vcf.gz", numcols=10000, tid="16", from=28376654, to=28381361, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/4700
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr16_4_intergenic.vcf.gz", numcols=10000, tid="16", from=31107301, to=31117428, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/10120
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr16_4_intergenic.vcf.gz", numcols=10000, tid="16", from=66622178, to=66637777, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/15599
D

#Region 5
Intergenic5_EUR <- readVCF("new_chr16_4_intergenic.vcf.gz", numcols=10000, tid="16", from=68511473, to=68530943, include.unknown = TRUE)
...
divsites_inter5_EUR
D <- divsites_inter5_EUR/19470
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr16_5_intergenic.vcf.gz", numcols=10000, tid="16", from=23724821, to=68530943, include.unknown = TRUE)
...
Mu <- (Intergenic.all_SAS@theta_Watterson/90067)/(4*10000)
Mu
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr16_5_intergenic.vcf.gz", numcols=10000, tid="16", from=23724821, to=23765010, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/40178
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr16_5_intergenic.vcf.gz", numcols=10000, tid="16", from=28376654, to=28381361, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/4700
D

#Region 3
Intergenic3_SAS <- readVCF("new_chr16_5_intergenic.vcf.gz", numcols=10000, tid="16", from=31107301, to=31117428, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/10120
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr16_5_intergenic.vcf.gz", numcols=10000, tid="16", from=66622178, to=66637777, include.unknown = TRUE)
...
divsites_inter4_SAS
D <- divsites_inter4_SAS/15599
D

#Region 5
Intergenic5_SAS <- readVCF("new_chr16_5_intergenic.vcf.gz", numcols=10000, tid="16", from=68511473, to=68530943, include.unknown = TRUE)
