...
Clusters.all <- readVCF("new_chr15.vcf.gz", numcols=10000, tid="15", from=24223168, to=91849238, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/61270)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 24223168:91849238))) # N polyallelic sites in that region
m <- 61270-sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(24223168:24254145), c(24269210:24279095), c(43029219:43039793), c(62496215:62573211), c(79022376:79033249), c(89736386:89749195), c(91825325:91849238)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr15.vcf.gz", numcols=10000, tid="15", from=24223168, to=24254145, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/5563)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 24223168:24254145))) # N polyallelic sites in that region
m <- 5563-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr15.vcf.gz", numcols=10000, tid="15", from=24269210, to=24279095, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/9885)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 24269210:24279095))) # N polyallelic sites in that region
m <- 9885-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr15.vcf.gz", numcols=10000, tid="15", from=43029219, to=43039793, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/1608)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 43029219:43039793))) # N polyallelic sites in that region
m <- 1608-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr15.vcf.gz", numcols=10000, tid="15", from=62496215, to=62573211, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/30505)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 62496215:62573211))) # N polyallelic sites in that region
m <- 30505-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr15.vcf.gz", numcols=10000, tid="15", from=79022376, to=79033249, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/5412)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 79022376:79033249))) # N polyallelic sites in that region
m <- 8189-sum(misshuman,na.rm=T)-polysites
...
#Cluster_6
Clusters_6 <- readVCF("new_chr15.vcf.gz", numcols=10000, tid="15", from=89736386, to=89749195, include.unknown = TRUE)
...
Mu <- (Clusters_6@theta_Watterson/3598)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 89736386:89749195))) # N polyallelic sites in that region
m <- 3598-sum(misshuman,na.rm=T)-polysites
...
#Cluster_7
Clusters_7 <- readVCF("new_chr15.vcf.gz", numcols=10000, tid="15", from=91825325, to=91849238, include.unknown = TRUE)
...
Mu <- (Clusters_7@theta_Watterson/4699)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 91825325:91849238))) # N polyallelic sites in that region
m <- 4699-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr15_1.vcf.gz", numcols=10000, tid="15", from=24223168, to=91849238, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(24223168:24254145), c(24269210:24279095), c(43029219:43039793), c(62496215:62573211), c(79022376:79033249), c(89736386:89749195), c(91825325:91849238)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr15_1.vcf.gz", numcols=10000, tid="15", from=24223168, to=24254145, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/5563
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/5563)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr15_1.vcf.gz", numcols=10000, tid="15", from=24269210, to=24279095, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/9885
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/9885)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr15_1.vcf.gz", numcols=10000, tid="15", from=43029219, to=43039793, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/1608
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/1608)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr15_1.vcf.gz", numcols=10000, tid="15", from=62496215, to=62573211, include.unknown = TRUE)
...
divsites4_AFR
D <- divsites4_AFR/30505
D

#Mutation rate
Clusters4_AFR <- neutrality.stats(Clusters4_AFR, FAST = TRUE)
Mu <- (Clusters4_AFR@theta_Watterson/30505)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr15_1.vcf.gz", numcols=10000, tid="15", from=79022376, to=79033249, include.unknown = TRUE)
...
divsites5_AFR
D <- divsites5_AFR/5412
D

#Mutation rate
Clusters5_AFR <- neutrality.stats(Clusters5_AFR, FAST = TRUE)
Mu <- (Clusters5_AFR@theta_Watterson/5412)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 79022376:79033249))) # N polyallelic sites in that region
m <- 5412-sum(misshuman,na.rm=T)-polysites
...
#Cluster_6
Clusters6_AFR<- readVCF("new_chr15_1.vcf.gz", numcols=10000, tid="15", from=89736386, to=89749195, include.unknown = TRUE)
...
divsites6_AFR
D <- divsites6_AFR/3598
D

#Mutation rate
Clusters6_AFR <- neutrality.stats(Clusters6_AFR, FAST = TRUE)
Mu <- (Clusters6_AFR@theta_Watterson/3598)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AFR <- readVCF("new_chr15_1.vcf.gz", numcols=10000, tid="15", from=91825325, to=91849238, include.unknown = TRUE)
...
divsites7_AFR
D <- divsites7_AFR/4699
D

#Mutation rate
Clusters7_AFR <- neutrality.stats(Clusters7_AFR, FAST = TRUE)
Mu <- (Clusters7_AFR@theta_Watterson/4699)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr15_2.vcf.gz", numcols=10000, tid="15", from=24223168, to=91849238, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(24223168:24254145), c(24269210:24279095), c(43029219:43039793), c(62496215:62573211), c(79022376:79033249), c(89736386:89749195), c(91825325:91849238)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr15_2.vcf.gz", numcols=10000, tid="15", from=24223168, to=24254145, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/5563
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/5563)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr15_2.vcf.gz", numcols=10000, tid="15", from=24269210, to=24279095, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/9885
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/9885)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr15_2.vcf.gz", numcols=10000, tid="15", from=43029219, to=43039793, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/1608
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/1608)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr15_2.vcf.gz", numcols=10000, tid="15", from=62496215, to=62573211, include.unknown = TRUE)
...
divsites4_AMR
D <- divsites4_AMR/30505
D

#Mutation rate
Clusters4_AMR <- neutrality.stats(Clusters4_AMR, FAST = TRUE)
Mu <- (Clusters4_AMR@theta_Watterson/30505)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr15_2.vcf.gz", numcols=10000, tid="15", from=79022376, to=79033249, include.unknown = TRUE)
...
divsites5_AMR
D <- divsites5_AMR/5412
D

#Mutation rate
Clusters5_AMR <- neutrality.stats(Clusters5_AMR, FAST = TRUE)
Mu <- (Clusters5_AMR@theta_Watterson/5412)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AMR<- readVCF("new_chr15_2.vcf.gz", numcols=10000, tid="15", from=89736386, to=89749195, include.unknown = TRUE)
...
divsites6_AMR
D <- divsites6_AMR/3598
D

#Mutation rate
Clusters6_AMR <- neutrality.stats(Clusters6_AMR, FAST = TRUE)
Mu <- (Clusters6_AMR@theta_Watterson/3598)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AMR <- readVCF("new_chr15_2.vcf.gz", numcols=10000, tid="15", from=91825325, to=91849238, include.unknown = TRUE)
...
divsites7_AMR
D <- divsites7_AMR/4699
D

#Mutation rate
Clusters7_AMR <- neutrality.stats(Clusters7_AMR, FAST = TRUE)
Mu <- (Clusters7_AMR@theta_Watterson/4699)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr15_3.vcf.gz", numcols=10000, tid="15", from=24223168, to=91849238, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(24223168:24254145), c(24269210:24279095), c(43029219:43039793), c(62496215:62573211), c(79022376:79033249), c(89736386:89749195), c(91825325:91849238)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr15_3.vcf.gz", numcols=10000, tid="15", from=24223168, to=24254145, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/5563
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/5563)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr15_3.vcf.gz", numcols=10000, tid="15", from=24269210, to=24279095, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/9885
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/9885)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr15_3.vcf.gz", numcols=10000, tid="15", from=43029219, to=43039793, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/1608
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/1608)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr15_3.vcf.gz", numcols=10000, tid="15", from=62496215, to=62573211, include.unknown = TRUE)
...
divsites4_EAS
D <- divsites4_EAS/30505
D

#Mutation rate
Clusters4_EAS <- neutrality.stats(Clusters4_EAS, FAST = TRUE)
Mu <- (Clusters4_EAS@theta_Watterson/30505)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS<- readVCF("new_chr15_3.vcf.gz", numcols=10000, tid="15", from=79022376, to=79033249, include.unknown = TRUE)
...
divsites5_EAS
D <- divsites5_EAS/5412
D

#Mutation rate
Clusters5_EAS <- neutrality.stats(Clusters5_EAS, FAST = TRUE)
Mu <- (Clusters5_EAS@theta_Watterson/5412)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EAS<- readVCF("new_chr15_3.vcf.gz", numcols=10000, tid="15", from=89736386, to=89749195, include.unknown = TRUE)
...
divsites6_EAS
D <- divsites6_EAS/3598
D

#Mutation rate
Clusters6_EAS <- neutrality.stats(Clusters6_EAS, FAST = TRUE)
Mu <- (Clusters6_EAS@theta_Watterson/3598)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EAS <- readVCF("new_chr15_3.vcf.gz", numcols=10000, tid="15", from=91825325, to=91849238, include.unknown = TRUE)
...
divsites7_EAS
D <- divsites7_EAS/4699
D

#Mutation rate
Clusters7_EAS <- neutrality.stats(Clusters7_EAS, FAST = TRUE)
Mu <- (Clusters7_EAS@theta_Watterson/4699)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr15_4.vcf.gz", numcols=10000, tid="15", from=24223168, to=91849238, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(24223168:24254145), c(24269210:24279095), c(43029219:43039793), c(62496215:62573211), c(79022376:79033249), c(89736386:89749195), c(91825325:91849238)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr15_4.vcf.gz", numcols=10000, tid="15", from=24223168, to=24254145, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/5563
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/5563)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr15_4.vcf.gz", numcols=10000, tid="15", from=24269210, to=24279095, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/9885
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/9885)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr15_4.vcf.gz", numcols=10000, tid="15", from=43029219, to=43039793, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/1608
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/1608)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr15_4.vcf.gz", numcols=10000, tid="15", from=62496215, to=62573211, include.unknown = TRUE)
...
divsites4_EUR
D <- divsites4_EUR/30505
D

#Mutation rate
Clusters4_EUR <- neutrality.stats(Clusters4_EUR, FAST = TRUE)
Mu <- (Clusters4_EUR@theta_Watterson/30505)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR<- readVCF("new_chr15_4.vcf.gz", numcols=10000, tid="15", from=79022376, to=79033249, include.unknown = TRUE)
...
divsites5_EUR
D <- divsites5_EUR/5412
D

#Mutation rate
Clusters5_EUR <- neutrality.stats(Clusters5_EUR, FAST = TRUE)
Mu <- (Clusters5_EUR@theta_Watterson/5412)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EUR<- readVCF("new_chr15_4.vcf.gz", numcols=10000, tid="15", from=89736386, to=89749195, include.unknown = TRUE)
...
divsites6_EUR
D <- divsites6_EUR/3598
D

#Mutation rate
Clusters6_EUR <- neutrality.stats(Clusters6_EUR, FAST = TRUE)
Mu <- (Clusters6_EUR@theta_Watterson/3598)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EUR <- readVCF("new_chr15_4.vcf.gz", numcols=10000, tid="15", from=91825325, to=91849238, include.unknown = TRUE)
...
divsites7_EUR
D <- divsites7_EUR/4699
D

#Mutation rate
Clusters7_EUR <- neutrality.stats(Clusters7_EUR, FAST = TRUE)
Mu <- (Clusters7_EUR@theta_Watterson/4699)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr15_5.vcf.gz", numcols=10000, tid="15", from=24223168, to=91849238, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(24223168:24254145), c(24269210:24279095), c(43029219:43039793), c(62496215:62573211), c(79022376:79033249), c(89736386:89749195), c(91825325:91849238)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr15_5.vcf.gz", numcols=10000, tid="15", from=24223168, to=24254145, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/5563
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/5563)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr15_5.vcf.gz", numcols=10000, tid="15", from=24269210, to=24279095, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/9885
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/9885)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr15_5.vcf.gz", numcols=10000, tid="15", from=43029219, to=43039793, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/1608
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/1608)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr15_5.vcf.gz", numcols=10000, tid="15", from=62496215, to=62573211, include.unknown = TRUE)
...
divsites4_SAS
D <- divsites4_SAS/30505
D

#Mutation rate
Clusters4_SAS <- neutrality.stats(Clusters4_SAS, FAST = TRUE)
Mu <- (Clusters4_SAS@theta_Watterson/30505)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS<- readVCF("new_chr15_5.vcf.gz", numcols=10000, tid="15", from=79022376, to=79033249, include.unknown = TRUE)
...
divsites5_SAS
D <- divsites5_SAS/5412
D

#Mutation rate
Clusters5_SAS <- neutrality.stats(Clusters5_SAS, FAST = TRUE)
Mu <- (Clusters5_SAS@theta_Watterson/5412)/(4*10000)
Mu
...
#Cluster_6
Clusters6_SAS<- readVCF("new_chr15_5.vcf.gz", numcols=10000, tid="15", from=89736386, to=89749195, include.unknown = TRUE)
...
divsites6_SAS
D <- divsites6_SAS/3598
D

#Mutation rate
Clusters6_SAS <- neutrality.stats(Clusters6_SAS, FAST = TRUE)
Mu <- (Clusters6_SAS@theta_Watterson/3598)/(4*10000)
Mu
...
#Cluster_7
Clusters7_SAS <- readVCF("new_chr15_5.vcf.gz", numcols=10000, tid="15", from=91825325, to=91849238, include.unknown = TRUE)
...
divsites7_SAS
D <- divsites7_SAS/4699
D

#Mutation rate
Clusters7_SAS <- neutrality.stats(Clusters7_SAS, FAST = TRUE)
Mu <- (Clusters7_SAS@theta_Watterson/4699)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr15_intergenic.vcf.gz", numcols=10000, tid="15", from=24254146, to=91951938, include.unknown = TRUE)
...
Mu <- (Intergenic.all@theta_Watterson/212834)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 24254146:91951938))) # N polyallelic sites in that region
m <- 212834-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr15_intergenic.vcf.gz", numcols=10000, tid="15", from=24254146, to=24269209, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/15063
D

#Region 2
Intergenic2 <- readVCF("new_chr15_intergenic.vcf.gz", numcols=10000, tid="15", from=24279096, to=24407901, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/71840
D

#Region 3
Intergenic3 <- readVCF("new_chr15_intergenic.vcf.gz", numcols=10000, tid="15", from=43013179, to=43015757, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/2578
D

#Region 4
Intergenic4 <- readVCF("new_chr15_intergenic.vcf.gz", numcols=10000, tid="15", from=62573212, to=62576389, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/3177
D

#Region 5
Intergenic5 <- readVCF("new_chr15_intergenic.vcf.gz", numcols=10000, tid="15", from=79027837, to=79042175, include.unknown = TRUE)
...
divsites_inter5
D <- divsites_inter5/14338
D

#Region 6
Intergenic6 <- readVCF("new_chr15_intergenic.vcf.gz", numcols=10000, tid="15", from=89749196, to=89753100, include.unknown = TRUE)
...
divsites_inter6
D <- divsites_inter6/3139
D

#Region 7
Intergenic7 <- readVCF("new_chr15_intergenic.vcf.gz", numcols=10000, tid="15", from=91849239, to=91951938, include.unknown = TRUE)
...
divsites_inter7
D <- divsites_inter7/102699
D

###################POPULATIONS####################################################

#AFR
Intergenic.all_AFR <- readVCF("new_chr15_1_intergenic.vcf.gz", numcols=10000, tid="15", from=24254146, to=91951938, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AFR@theta_Watterson/212834)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 9428413:121132911))) # N polyallelic sites in that region
m <- 130462-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr15_1_intergenic.vcf.gz", numcols=10000, tid="15", from=24254146, to=24269209, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/15063
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr15_1_intergenic.vcf.gz", numcols=10000, tid="15", from=24279096, to=24407901, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/71840
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr15_1_intergenic.vcf.gz", numcols=10000, tid="15", from=43013179, to=43015757, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/2578
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr15_1_intergenic.vcf.gz", numcols=10000, tid="15", from=62573212, to=62576389, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/3177
D

#Region 5
Intergenic5_AFR <- readVCF("new_chr15_1_intergenic.vcf.gz", numcols=10000, tid="15", from=79027837, to=79042175, include.unknown = TRUE)
...
divsites_inter5_AFR
D <- divsites_inter5_AFR/14338
D

#Region 6
Intergenic6_AFR <- readVCF("new_chr15_1_intergenic.vcf.gz", numcols=10000, tid="15", from=89749196, to=89753100, include.unknown = TRUE)
...
divsites_inter6_AFR
D <- divsites_inter6_AFR/3139
D

#Region 7
Intergenic7_AFR <- readVCF("new_chr15_1_intergenic.vcf.gz", numcols=10000, tid="15", from=91849239, to=91951938, include.unknown = TRUE)
...
divsites_inter7_AFR
D <- divsites_inter7_AFR/102699
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr15_2_intergenic.vcf.gz", numcols=10000, tid="15", from=24254146, to=91951938, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AMR@theta_Watterson/212834)/(4*10000)
Mu
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr15_2_intergenic.vcf.gz", numcols=10000, tid="15", from=24254146, to=24269209, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/15063
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr15_2_intergenic.vcf.gz", numcols=10000, tid="15", from=24279096, to=24407901, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/71840
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr15_2_intergenic.vcf.gz", numcols=10000, tid="15", from=43013179, to=43015757, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/2578
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr15_2_intergenic.vcf.gz", numcols=10000, tid="15", from=62573212, to=62576389, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/3177
D

#Region 5
Intergenic5_AMR <- readVCF("new_chr15_2_intergenic.vcf.gz", numcols=10000, tid="15", from=79027837, to=79042175, include.unknown = TRUE)
...
divsites_inter5_AMR
D <- divsites_inter5_AMR/14338
D

#Region 6
Intergenic6_AMR <- readVCF("new_chr15_2_intergenic.vcf.gz", numcols=10000, tid="15", from=89749196, to=89753100, include.unknown = TRUE)
...
divsites_inter6_AMR
D <- divsites_inter6_AMR/3139
D

#Region 7
Intergenic7_AMR <- readVCF("new_chr15_2_intergenic.vcf.gz", numcols=10000, tid="15", from=91849239, to=91951938, include.unknown = TRUE)
...
divsites_inter7_AMR
D <- divsites_inter7_AMR/102699
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr15_3_intergenic.vcf.gz", numcols=10000, tid="15", from=24254146, to=91951938, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EAS@theta_Watterson/212834)/(4*10000)
Mu
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr15_3_intergenic.vcf.gz", numcols=10000, tid="15", from=24254146, to=24269209, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/15063
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr15_3_intergenic.vcf.gz", numcols=10000, tid="15", from=24279096, to=24407901, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/71840
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr15_3_intergenic.vcf.gz", numcols=10000, tid="15", from=43013179, to=43015757, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/2578
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr15_3_intergenic.vcf.gz", numcols=10000, tid="15", from=62573212, to=62576389, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/3177
D

#Region 5
Intergenic5_EAS <- readVCF("new_chr15_3_intergenic.vcf.gz", numcols=10000, tid="15", from=79027837, to=79042175, include.unknown = TRUE)
...
divsites_inter5_EAS
D <- divsites_inter5_EAS/14338
D

#Region 6
Intergenic6_EAS <- readVCF("new_chr15_3_intergenic.vcf.gz", numcols=10000, tid="15", from=89749196, to=89753100, include.unknown = TRUE)
...
divsites_inter6_EAS
D <- divsites_inter6_EAS/3139
D

#Region 7
Intergenic7_EAS <- readVCF("new_chr15_3_intergenic.vcf.gz", numcols=10000, tid="15", from=91849239, to=91951938, include.unknown = TRUE)
...
divsites_inter7_EAS
D <- divsites_inter7_EAS/102699
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr15_4_intergenic.vcf.gz", numcols=10000, tid="15", from=24254146, to=91951938, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EUR@theta_Watterson/212834)/(4*10000)
Mu
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr15_4_intergenic.vcf.gz", numcols=10000, tid="15", from=24254146, to=24269209, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/15063
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr15_4_intergenic.vcf.gz", numcols=10000, tid="15", from=24279096, to=24407901, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/71840
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr15_4_intergenic.vcf.gz", numcols=10000, tid="15", from=43013179, to=43015757, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/2578
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr15_4_intergenic.vcf.gz", numcols=10000, tid="15", from=62573212, to=62576389, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/3177
D

#Region 5
Intergenic5_EUR <- readVCF("new_chr15_4_intergenic.vcf.gz", numcols=10000, tid="15", from=79027837, to=79042175, include.unknown = TRUE)
...
divsites_inter5_EUR
D <- divsites_inter5_EUR/14338
D

#Region 6
Intergenic6_EUR <- readVCF("new_chr15_4_intergenic.vcf.gz", numcols=10000, tid="15", from=89749196, to=89753100, include.unknown = TRUE)
...
divsites_inter6_EUR
D <- divsites_inter6_EUR/3139
D

#Region 7
Intergenic7_EUR <- readVCF("new_chr15_4_intergenic.vcf.gz", numcols=10000, tid="15", from=91849239, to=91951938, include.unknown = TRUE)
...
divsites_inter7_EUR
D <- divsites_inter7_EUR/102699
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr15_5_intergenic.vcf.gz", numcols=10000, tid="15", from=24254146, to=91951938, include.unknown = TRUE)
...
Mu <- (Intergenic.all_SAS@theta_Watterson/212834)/(4*10000)
Mu
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr15_5_intergenic.vcf.gz", numcols=10000, tid="15", from=24254146, to=24269209, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/15063
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr15_5_intergenic.vcf.gz", numcols=10000, tid="15", from=24279096, to=24407901, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/71840
D

#Region 3
Intergenic3_SAS <- readVCF("new_chr15_5_intergenic.vcf.gz", numcols=10000, tid="15", from=43013179, to=43015757, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/2578
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr15_5_intergenic.vcf.gz", numcols=10000, tid="15", from=62573212, to=62576389, include.unknown = TRUE)
...
divsites_inter4_SAS
D <- divsites_inter4_SAS/3177
D

#Region 5
Intergenic5_SAS <- readVCF("new_chr15_5_intergenic.vcf.gz", numcols=10000, tid="15", from=79027837, to=79042175, include.unknown = TRUE)
...
divsites_inter5_SAS
D <- divsites_inter5_SAS/14338
D

#Region 6
Intergenic6_SAS <- readVCF("new_chr15_5_intergenic.vcf.gz", numcols=10000, tid="15", from=89749196, to=89753100, include.unknown = TRUE)
...
divsites_inter6_SAS
D <- divsites_inter6_SAS/3139
D

#Region 7
Intergenic7_SAS <- readVCF("new_chr15_5_intergenic.vcf.gz", numcols=10000, tid="15", from=91849239, to=91951938, include.unknown = TRUE)
