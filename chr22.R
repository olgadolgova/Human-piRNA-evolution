...
Clusters.all <- readVCF("new_chr22.vcf.gz", numcols=10000, tid="22", from=18208834, to=50290618, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/16387)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 18208834:50290618))) # N polyallelic sites in that region
m <- 16387-sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(18208834:18217791), c(18832651:18840619), c(21040679:21049277), c(31671114:31689434), c(39078331:39087131), c(50272669:50290618)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr22.vcf.gz", numcols=10000, tid="22", from=18208834, to=18217791, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/3283)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 18208834:18217791))) # N polyallelic sites in that region
m <- 3283-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr22.vcf.gz", numcols=10000, tid="22", from=18832651, to=18840619, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/1045)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 18832651:18840619))) # N polyallelic sites in that region
m <- 1045-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr22.vcf.gz", numcols=10000, tid="22", from=21040679, to=21049277, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/3538)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 21040679:21049277))) # N polyallelic sites in that region
m <- 3538-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr22.vcf.gz", numcols=10000, tid="22", from=31671114, to=31689434, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/1507)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 31671114:31689434))) # N polyallelic sites in that region
m <- 1507-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr22.vcf.gz", numcols=10000, tid="22", from=39078331, to=39087131, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/122)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 39078331:39087131))) # N polyallelic sites in that region
m <- 122-sum(misshuman,na.rm=T)-polysites
...
#Cluster_6
Clusters_6 <- readVCF("new_chr22.vcf.gz", numcols=10000, tid="22", from=50272669, to=50290618, include.unknown = TRUE)
...
Mu <- (Clusters_6@theta_Watterson/6892)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 50272669:50290618))) # N polyallelic sites in that region
m <- 6892-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr22_1.vcf.gz", numcols=10000, tid="22", from=18208834, to=50290618, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(18208834:18217791), c(18832651:18840619), c(21040679:21049277), c(31671114:31689434), c(39078331:39087131), c(50272669:50290618)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr22_1.vcf.gz", numcols=10000, tid="22", from=18208834, to=18217791, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/3283
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/3283)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr22_1.vcf.gz", numcols=10000, tid="22", from=18832651, to=18840619, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/1045
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/1045)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr22_1.vcf.gz", numcols=10000, tid="22", from=21040679, to=21049277, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/3538
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/3538)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr22_1.vcf.gz", numcols=10000, tid="22", from=31671114, to=31689434, include.unknown = TRUE)
...
divsites4_AFR
D <- divsites4_AFR/1507
D

#Mutation rate
Clusters4_AFR <- neutrality.stats(Clusters4_AFR, FAST = TRUE)
Mu <- (Clusters4_AFR@theta_Watterson/1507)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr22_1.vcf.gz", numcols=10000, tid="22", from=39078331, to=39087131, include.unknown = TRUE)
...
Mu <- (Clusters5_AFR@theta_Watterson/122)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AFR<- readVCF("new_chr22_1.vcf.gz", numcols=10000, tid="22", from=50272669, to=50290618, include.unknown = TRUE)
...
divsites6_AFR
D <- divsites6_AFR/6892
D

#Mutation rate
Clusters6_AFR <- neutrality.stats(Clusters6_AFR, FAST = TRUE)
Mu <- (Clusters6_AFR@theta_Watterson/6892)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr22_2.vcf.gz", numcols=10000, tid="22", from=18208834, to=50290618, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(18208834:18217791), c(18832651:18840619), c(21040679:21049277), c(31671114:31689434), c(39078331:39087131), c(50272669:50290618)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr22_2.vcf.gz", numcols=10000, tid="22", from=18208834, to=18217791, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/3283
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/3283)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr22_2.vcf.gz", numcols=10000, tid="22", from=18832651, to=18840619, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/1045
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/1045)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr22_2.vcf.gz", numcols=10000, tid="22", from=21040679, to=21049277, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/3538
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/3538)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr22_2.vcf.gz", numcols=10000, tid="22", from=31671114, to=31689434, include.unknown = TRUE)
...
divsites4_AMR
D <- divsites4_AMR/1507
D

#Mutation rate
Clusters4_AMR <- neutrality.stats(Clusters4_AMR, FAST = TRUE)
Mu <- (Clusters4_AMR@theta_Watterson/1507)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr22_2.vcf.gz", numcols=10000, tid="22", from=39078331, to=39087131, include.unknown = TRUE)
...
Mu <- (Clusters5_AMR@theta_Watterson/122)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AMR<- readVCF("new_chr22_2.vcf.gz", numcols=10000, tid="22", from=50272669, to=50290618, include.unknown = TRUE)
...
divsites6_AMR
D <- divsites6_AMR/6892
D

#Mutation rate
Clusters6_AMR <- neutrality.stats(Clusters6_AMR, FAST = TRUE)
Mu <- (Clusters6_AMR@theta_Watterson/6892)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr22_3.vcf.gz", numcols=10000, tid="22", from=18208834, to=50290618, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(18208834:18217791), c(18832651:18840619), c(21040679:21049277), c(31671114:31689434), c(39078331:39087131), c(50272669:50290618)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr22_3.vcf.gz", numcols=10000, tid="22", from=18208834, to=18217791, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/3283
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/3283)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr22_3.vcf.gz", numcols=10000, tid="22", from=18832651, to=18840619, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/1045
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/1045)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr22_3.vcf.gz", numcols=10000, tid="22", from=21040679, to=21049277, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/3538
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/3538)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr22_3.vcf.gz", numcols=10000, tid="22", from=31671114, to=31689434, include.unknown = TRUE)
...
divsites4_EAS
D <- divsites4_EAS/1507
D

#Mutation rate
Clusters4_EAS <- neutrality.stats(Clusters4_EAS, FAST = TRUE)
Mu <- (Clusters4_EAS@theta_Watterson/1507)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS<- readVCF("new_chr22_3.vcf.gz", numcols=10000, tid="22", from=39078331, to=39087131, include.unknown = TRUE)
...
Mu <- (Clusters5_EAS@theta_Watterson/122)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EAS<- readVCF("new_chr22_3.vcf.gz", numcols=10000, tid="22", from=50272669, to=50290618, include.unknown = TRUE)
...
divsites6_EAS
D <- divsites6_EAS/6892
D

#Mutation rate
Clusters6_EAS <- neutrality.stats(Clusters6_EAS, FAST = TRUE)
Mu <- (Clusters6_EAS@theta_Watterson/6892)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr22_4.vcf.gz", numcols=10000, tid="22", from=18208834, to=50290618, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(18208834:18217791), c(18832651:18840619), c(21040679:21049277), c(31671114:31689434), c(39078331:39087131), c(50272669:50290618)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr22_4.vcf.gz", numcols=10000, tid="22", from=18208834, to=18217791, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/3283
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/3283)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr22_4.vcf.gz", numcols=10000, tid="22", from=18832651, to=18840619, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/1045
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/1045)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr22_4.vcf.gz", numcols=10000, tid="22", from=21040679, to=21049277, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/3538
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/3538)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr22_4.vcf.gz", numcols=10000, tid="22", from=31671114, to=31689434, include.unknown = TRUE)
...
divsites4_EUR
D <- divsites4_EUR/1507
D

#Mutation rate
Clusters4_EUR <- neutrality.stats(Clusters4_EUR, FAST = TRUE)
Mu <- (Clusters4_EUR@theta_Watterson/1507)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR<- readVCF("new_chr22_4.vcf.gz", numcols=10000, tid="22", from=39078331, to=39087131, include.unknown = TRUE)
...
Mu <- (Clusters5_EUR@theta_Watterson/122)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EUR<- readVCF("new_chr22_4.vcf.gz", numcols=10000, tid="22", from=50272669, to=50290618, include.unknown = TRUE)
...
divsites6_EUR
D <- divsites6_EUR/6892
D

#Mutation rate
Clusters6_EUR <- neutrality.stats(Clusters6_EUR, FAST = TRUE)
Mu <- (Clusters6_EUR@theta_Watterson/6892)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr22_5.vcf.gz", numcols=10000, tid="22", from=18208834, to=50290618, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(18208834:18217791), c(18832651:18840619), c(21040679:21049277), c(31671114:31689434), c(39078331:39087131), c(50272669:50290618)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr22_5.vcf.gz", numcols=10000, tid="22", from=18208834, to=18217791, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/3283
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/3283)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr22_5.vcf.gz", numcols=10000, tid="22", from=18832651, to=18840619, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/1045
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/1045)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr22_5.vcf.gz", numcols=10000, tid="22", from=21040679, to=21049277, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/3538
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/3538)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr22_5.vcf.gz", numcols=10000, tid="22", from=31671114, to=31689434, include.unknown = TRUE)
...
divsites4_SAS
D <- divsites4_SAS/1507
D

#Mutation rate
Clusters4_SAS <- neutrality.stats(Clusters4_SAS, FAST = TRUE)
Mu <- (Clusters4_SAS@theta_Watterson/1507)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS<- readVCF("new_chr22_5.vcf.gz", numcols=10000, tid="22", from=39078331, to=39087131, include.unknown = TRUE)
...
Mu <- (Clusters5_SAS@theta_Watterson/122)/(4*10000)
Mu
...
#Cluster_6
Clusters6_SAS<- readVCF("new_chr22_5.vcf.gz", numcols=10000, tid="22", from=50272669, to=50290618, include.unknown = TRUE)
...
divsites6_SAS
D <- divsites6_SAS/6892
D

#Mutation rate
Clusters6_SAS <- neutrality.stats(Clusters6_SAS, FAST = TRUE)
Mu <- (Clusters6_SAS@theta_Watterson/6892)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr22_intergenic.vcf.gz", numcols=10000, tid="22", from=18257536, to=50293877, include.unknown = TRUE)
...
Mu <- (Intergenic.all@theta_Watterson/60191)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 18257536:50293877))) # N polyallelic sites in that region
m <- 60191-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr22_intergenic.vcf.gz", numcols=10000, tid="22", from=18257536, to=18260088, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/2552
D

#Region 2
Intergenic2 <- readVCF("new_chr22_intergenic.vcf.gz", numcols=10000, tid="22", from=18830912, to=18832650, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/1738
D

#Region 3
Intergenic3 <- readVCF("new_chr22_intergenic.vcf.gz", numcols=10000, tid="22", from=37711386, to=37735624, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/24238
D

#Region 4
Intergenic4 <- readVCF("new_chr22_intergenic.vcf.gz", numcols=10000, tid="22", from=37711386, to=37735624, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/24238
D

#Region 5
Intergenic5 <- readVCF("new_chr22_intergenic.vcf.gz", numcols=10000, tid="22", from=39097561, to=39101728, include.unknown = TRUE)
...
divsites_inter5
D <- divsites_inter5/4167
D

#Region 6
Intergenic6 <- readVCF("new_chr22_intergenic.vcf.gz", numcols=10000, tid="22", from=50290619, to=50293877, include.unknown = TRUE)
...
divsites_inter6
D <- divsites_inter6/3258
D

###################POPULATIONS####################################################

#AFR
Intergenic.all_AFR <- readVCF("new_chr22_1_intergenic.vcf.gz", numcols=10000, tid="22", from=18257536, to=50293877, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AFR@theta_Watterson/56933)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 18257536:50293877))) # N polyallelic sites in that region
m <- 56933-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr22_1_intergenic.vcf.gz", numcols=10000, tid="22", from=18257536, to=18260088, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/2552
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr22_1_intergenic.vcf.gz", numcols=10000, tid="22", from=18830912, to=18832650, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/1738
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr22_1_intergenic.vcf.gz", numcols=10000, tid="22", from=37711386, to=37735624, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/24238
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr22_1_intergenic.vcf.gz", numcols=10000, tid="22", from=37711386, to=37735624, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/24238
D

#Region 5
Intergenic5_AFR <- readVCF("new_chr22_1_intergenic.vcf.gz", numcols=10000, tid="22", from=39097561, to=39101728, include.unknown = TRUE)
...
divsites_inter5_AFR
D <- divsites_inter5_AFR/4167
D

#Region 6
Intergenic6_AFR <- readVCF("new_chr22_1_intergenic.vcf.gz", numcols=10000, tid="22", from=50290619, to=50293877, include.unknown = TRUE)
...
divsites_inter6_AFR
D <- divsites_inter6_AFR/3258
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr22_2_intergenic.vcf.gz", numcols=10000, tid="22", from=18257536, to=50293877, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AMR@theta_Watterson/56933)/(4*10000)
Mu
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr22_2_intergenic.vcf.gz", numcols=10000, tid="22", from=18257536, to=18260088, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/2552
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr22_2_intergenic.vcf.gz", numcols=10000, tid="22", from=18830912, to=18832650, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/1738
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr22_2_intergenic.vcf.gz", numcols=10000, tid="22", from=37711386, to=37735624, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/24238
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr22_2_intergenic.vcf.gz", numcols=10000, tid="22", from=37711386, to=37735624, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/24238
D

#Region 5
Intergenic5_AMR <- readVCF("new_chr22_2_intergenic.vcf.gz", numcols=10000, tid="22", from=39097561, to=39101728, include.unknown = TRUE)
...
divsites_inter5_AMR
D <- divsites_inter5_AMR/4167
D

#Region 6
Intergenic6_AMR <- readVCF("new_chr22_2_intergenic.vcf.gz", numcols=10000, tid="22", from=50290619, to=50293877, include.unknown = TRUE)
...
divsites_inter6_AMR
D <- divsites_inter6_AMR/3258
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr22_3_intergenic.vcf.gz", numcols=10000, tid="22", from=18257536, to=50293877, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EAS@theta_Watterson/56933)/(4*10000)
Mu
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr22_3_intergenic.vcf.gz", numcols=10000, tid="22", from=18257536, to=18260088, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/2552
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr22_3_intergenic.vcf.gz", numcols=10000, tid="22", from=18830912, to=18832650, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/1738
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr22_3_intergenic.vcf.gz", numcols=10000, tid="22", from=37711386, to=37735624, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/24238
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr22_3_intergenic.vcf.gz", numcols=10000, tid="22", from=37711386, to=37735624, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/24238
D

#Region 5
Intergenic5_EAS <- readVCF("new_chr22_3_intergenic.vcf.gz", numcols=10000, tid="22", from=39097561, to=39101728, include.unknown = TRUE)
...
divsites_inter5_EAS
D <- divsites_inter5_EAS/4167
D

#Region 6
Intergenic6_EAS <- readVCF("new_chr22_3_intergenic.vcf.gz", numcols=10000, tid="22", from=50290619, to=50293877, include.unknown = TRUE)
...
divsites_inter6_EAS
D <- divsites_inter6_EAS/3258
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr22_4_intergenic.vcf.gz", numcols=10000, tid="22", from=18257536, to=50293877, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EUR@theta_Watterson/56933)/(4*10000)
Mu
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr22_4_intergenic.vcf.gz", numcols=10000, tid="22", from=18257536, to=18260088, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/2552
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr22_4_intergenic.vcf.gz", numcols=10000, tid="22", from=18830912, to=18832650, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/1738
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr22_4_intergenic.vcf.gz", numcols=10000, tid="22", from=37711386, to=37735624, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/24238
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr22_4_intergenic.vcf.gz", numcols=10000, tid="22", from=37711386, to=37735624, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/24238
D

#Region 5
Intergenic5_EUR <- readVCF("new_chr22_4_intergenic.vcf.gz", numcols=10000, tid="22", from=39097561, to=39101728, include.unknown = TRUE)
...
divsites_inter5_EUR
D <- divsites_inter5_EUR/4167
D

#Region 6
Intergenic6_EUR <- readVCF("new_chr22_4_intergenic.vcf.gz", numcols=10000, tid="22", from=50290619, to=50293877, include.unknown = TRUE)
...
divsites_inter6_EUR
D <- divsites_inter6_EUR/3258
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr22_5_intergenic.vcf.gz", numcols=10000, tid="22", from=18257536, to=50293877, include.unknown = TRUE)
...
Mu <- (Intergenic.all_SAS@theta_Watterson/56933)/(4*10000)
Mu
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr22_5_intergenic.vcf.gz", numcols=10000, tid="22", from=18257536, to=18260088, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/2552
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr22_5_intergenic.vcf.gz", numcols=10000, tid="22", from=18830912, to=18832650, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/1738
D

#Region 3
Intergenic3_SAS <- readVCF("new_chr22_5_intergenic.vcf.gz", numcols=10000, tid="22", from=37711386, to=37735624, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/24238
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr22_5_intergenic.vcf.gz", numcols=10000, tid="22", from=37711386, to=37735624, include.unknown = TRUE)
...
divsites_inter4_SAS
D <- divsites_inter4_SAS/24238
D

#Region 5
Intergenic5_SAS <- readVCF("new_chr22_5_intergenic.vcf.gz", numcols=10000, tid="22", from=39097561, to=39101728, include.unknown = TRUE)
...
divsites_inter5_SAS
D <- divsites_inter5_SAS/4167
D

#Region 6
Intergenic6_SAS <- readVCF("new_chr22_5_intergenic.vcf.gz", numcols=10000, tid="22", from=50290619, to=50293877, include.unknown = TRUE)
