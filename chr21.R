...
Clusters.all <- readVCF("new_chr21.vcf.gz", numcols=10000, tid="21", from=45886885, to=45920909, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/20102)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 45886885:45920909))) # N polyallelic sites in that region
m <- 20102-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr21_1.vcf.gz", numcols=10000, tid="21", from=45886885, to=45920909, include.unknown = TRUE)
...
#AMR
Clusters.all_AMR <- readVCF("new_chr21_2.vcf.gz", numcols=10000, tid="21", from=45886885, to=45920909, include.unknown = TRUE)
...
#EAS
Clusters.all_EAS <- readVCF("new_chr21_3.vcf.gz", numcols=10000, tid="21", from=45886885, to=45920909, include.unknown = TRUE)
...
#EUR
Clusters.all_EUR <- readVCF("new_chr21_4.vcf.gz", numcols=10000, tid="21", from=45886885, to=45920909, include.unknown = TRUE)
...
#SAS
Clusters.all_SAS <- readVCF("new_chr21_5.vcf.gz", numcols=10000, tid="21", from=45886885, to=45920909, include.unknown = TRUE)
...
Intergenic.all <- readVCF("new_chr21_intergenic.vcf.gz", numcols=10000, tid="21", from=45882079, to=45886884, include.unknown = TRUE)
...
polysites <- sum(!is.na(match(polyal, 45882079:45886884))) # N polyallelic sites in that region
m <- 4805-sum(misshuman,na.rm=T)-polysites
...
#AFR
Intergenic.all_AFR <- readVCF("new_chr21_1_intergenic.vcf.gz", numcols=10000, tid="21", from=45882079, to=45886884, include.unknown = TRUE)
...
#AMR
Intergenic.all_AMR <- readVCF("new_chr21_2_intergenic.vcf.gz", numcols=10000, tid="21", from=45882079, to=45886884, include.unknown = TRUE)
...
#EAS
Intergenic.all_EAS <- readVCF("new_chr21_3_intergenic.vcf.gz", numcols=10000, tid="21", from=45882079, to=45886884, include.unknown = TRUE)
...
#EUR
Intergenic.all_EUR <- readVCF("new_chr21_4_intergenic.vcf.gz", numcols=10000, tid="21", from=45882079, to=45886884, include.unknown = TRUE)
...
#SAS
Intergenic.all_SAS <- readVCF("new_chr21_5_intergenic.vcf.gz", numcols=10000, tid="21", from=45882079, to=45886884, include.unknown = TRUE)
