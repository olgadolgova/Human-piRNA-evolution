...
Clusters.all <- readVCF("new_chr19.vcf.gz", numcols=10000, tid="19", from=16120965, to=35403584, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/48207)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 16120965:35403584))) # N polyallelic sites in that region
m <- 48207-sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(16120965:16155513), c(19848827:19869819), c(22928738:22935512), c(35374879:35387799), c(35391755:35403584)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr19.vcf.gz", numcols=10000, tid="19", from=16120965, to=16155513, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/11564)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 16120965:16155513))) # N polyallelic sites in that region
m <- 11564-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr19.vcf.gz", numcols=10000, tid="19", from=19848827, to=19869819, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/16805)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 19848827:19869819))) # N polyallelic sites in that region
m <- 16805-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr19.vcf.gz", numcols=10000, tid="19", from=22928738, to=22935512, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/6247)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 22928738:22935512))) # N polyallelic sites in that region
m <- 6247-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr19.vcf.gz", numcols=10000, tid="19", from=35374879, to=35387799, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/7293)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 35374879:35387799))) # N polyallelic sites in that region
m <- 7293-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr19.vcf.gz", numcols=10000, tid="19", from=35391755, to=35403584, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/6298)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 35391755:35403584))) # N polyallelic sites in that region
m <- 6298-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr19_1.vcf.gz", numcols=10000, tid="19", from=16120965, to=35403584, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(16120965:16155513), c(19848827:19869819), c(22928738:22935512), c(35374879:35387799), c(35391755:35403584)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr19_1.vcf.gz", numcols=10000, tid="19", from=16120965, to=16155513, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/11564
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/11564)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr19_1.vcf.gz", numcols=10000, tid="19", from=19848827, to=19869819, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/16805
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/16805)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr19_1.vcf.gz", numcols=10000, tid="19", from=22928738, to=22935512, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/6247
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/6247)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr19_1.vcf.gz", numcols=10000, tid="19", from=35374879, to=35387799, include.unknown = TRUE)
...
divsites4_AFR
D <- divsites4_AFR/7293
D

#Mutation rate
Clusters4_AFR <- neutrality.stats(Clusters4_AFR, FAST = TRUE)
Mu <- (Clusters4_AFR@theta_Watterson/7293)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr19_1.vcf.gz", numcols=10000, tid="19", from=35391755, to=35403584, include.unknown = TRUE)
...
divsites5_AFR
D <- divsites5_AFR/6298
D

#Mutation rate
Clusters5_AFR <- neutrality.stats(Clusters5_AFR, FAST = TRUE)
Mu <- (Clusters5_AFR@theta_Watterson/6298)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr19_2.vcf.gz", numcols=10000, tid="19", from=16120965, to=35403584, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(16120965:16155513), c(19848827:19869819), c(22928738:22935512), c(35374879:35387799), c(35391755:35403584)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr19_2.vcf.gz", numcols=10000, tid="19", from=16120965, to=16155513, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/11564
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/11564)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr19_2.vcf.gz", numcols=10000, tid="19", from=19848827, to=19869819, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/16805
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/16805)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr19_2.vcf.gz", numcols=10000, tid="19", from=22928738, to=22935512, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/6247
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/6247)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr19_2.vcf.gz", numcols=10000, tid="19", from=35374879, to=35387799, include.unknown = TRUE)
...
divsites4_AMR
D <- divsites4_AMR/7293
D

#Mutation rate
Clusters4_AMR <- neutrality.stats(Clusters4_AMR, FAST = TRUE)
Mu <- (Clusters4_AMR@theta_Watterson/7293)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr19_2.vcf.gz", numcols=10000, tid="19", from=35391755, to=35403584, include.unknown = TRUE)
...
divsites5_AMR
D <- divsites5_AMR/6298
D

#Mutation rate
Clusters5_AMR <- neutrality.stats(Clusters5_AMR, FAST = TRUE)
Mu <- (Clusters5_AMR@theta_Watterson/6298)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr19_3.vcf.gz", numcols=10000, tid="19", from=16120965, to=35403584, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(16120965:16155513), c(19848827:19869819), c(22928738:22935512), c(35374879:35387799), c(35391755:35403584)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr19_3.vcf.gz", numcols=10000, tid="19", from=16120965, to=16155513, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/11564
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/11564)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr19_3.vcf.gz", numcols=10000, tid="19", from=19848827, to=19869819, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/16805
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/16805)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr19_3.vcf.gz", numcols=10000, tid="19", from=22928738, to=22935512, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/6247
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/6247)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr19_3.vcf.gz", numcols=10000, tid="19", from=35374879, to=35387799, include.unknown = TRUE)
...
divsites4_EAS
D <- divsites4_EAS/7293
D

#Mutation rate
Clusters4_EAS <- neutrality.stats(Clusters4_EAS, FAST = TRUE)
Mu <- (Clusters4_EAS@theta_Watterson/7293)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS<- readVCF("new_chr19_3.vcf.gz", numcols=10000, tid="19", from=35391755, to=35403584, include.unknown = TRUE)
...
divsites5_EAS
D <- divsites5_EAS/6298
D

#Mutation rate
Clusters5_EAS <- neutrality.stats(Clusters5_EAS, FAST = TRUE)
Mu <- (Clusters5_EAS@theta_Watterson/6298)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr19_4.vcf.gz", numcols=10000, tid="19", from=16120965, to=35403584, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(16120965:16155513), c(19848827:19869819), c(22928738:22935512), c(35374879:35387799), c(35391755:35403584)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr19_4.vcf.gz", numcols=10000, tid="19", from=16120965, to=16155513, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/11564
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/11564)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr19_4.vcf.gz", numcols=10000, tid="19", from=19848827, to=19869819, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/16805
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/16805)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr19_4.vcf.gz", numcols=10000, tid="19", from=22928738, to=22935512, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/6247
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/6247)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr19_4.vcf.gz", numcols=10000, tid="19", from=35374879, to=35387799, include.unknown = TRUE)
...
divsites4_EUR
D <- divsites4_EUR/7293
D

#Mutation rate
Clusters4_EUR <- neutrality.stats(Clusters4_EUR, FAST = TRUE)
Mu <- (Clusters4_EUR@theta_Watterson/7293)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR<- readVCF("new_chr19_4.vcf.gz", numcols=10000, tid="19", from=35391755, to=35403584, include.unknown = TRUE)
...
divsites5_EUR
D <- divsites5_EUR/6298
D

#Mutation rate
Clusters5_EUR <- neutrality.stats(Clusters5_EUR, FAST = TRUE)
Mu <- (Clusters5_EUR@theta_Watterson/6298)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr19_5.vcf.gz", numcols=10000, tid="19", from=16120965, to=35403584, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(16120965:16155513), c(19848827:19869819), c(22928738:22935512), c(35374879:35387799), c(35391755:35403584)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr19_5.vcf.gz", numcols=10000, tid="19", from=16120965, to=16155513, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/11564
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/11564)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr19_5.vcf.gz", numcols=10000, tid="19", from=19848827, to=19869819, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/16805
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/16805)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr19_5.vcf.gz", numcols=10000, tid="19", from=22928738, to=22935512, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/6247
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/6247)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr19_5.vcf.gz", numcols=10000, tid="19", from=35374879, to=35387799, include.unknown = TRUE)
...
divsites4_SAS
D <- divsites4_SAS/7293
D

#Mutation rate
Clusters4_SAS <- neutrality.stats(Clusters4_SAS, FAST = TRUE)
Mu <- (Clusters4_SAS@theta_Watterson/7293)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS<- readVCF("new_chr19_5.vcf.gz", numcols=10000, tid="19", from=35391755, to=35403584, include.unknown = TRUE)
...
divsites5_SAS
D <- divsites5_SAS/6298
D

#Mutation rate
Clusters5_SAS <- neutrality.stats(Clusters5_SAS, FAST = TRUE)
Mu <- (Clusters5_SAS@theta_Watterson/6298)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr19_intergenic.vcf.gz", numcols=10000, tid="19", from=16109830, to=35414203, include.unknown = TRUE)
...
Mu <- (Intergenic.all@theta_Watterson/46240)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 16109830:35414203))) # N polyallelic sites in that region
m <- 46240-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr19_intergenic.vcf.gz", numcols=10000, tid="19", from=16109830, to=16120964, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/11134
D


#Region 2
Intergenic2 <- readVCF("new_chr19_intergenic.vcf.gz", numcols=10000, tid="19", from=19843906, to=19848826, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/4920
D

#Region 3
Intergenic3 <- readVCF("new_chr19_intergenic.vcf.gz", numcols=10000, tid="19", from=22926212, to=22928737, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/2525
D

#Region 4
Intergenic4 <- readVCF("new_chr19_intergenic.vcf.gz", numcols=10000, tid="19", from=35357823, to=35374878, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/17043
D

#Region 5
Intergenic5 <- readVCF("new_chr19_intergenic.vcf.gz", numcols=10000, tid="19", from=35403585, to=35414203, include.unknown = TRUE)
...
divsites_inter5
D <- divsites_inter5/10618
D

###################POPULATIONS####################################################

#AFR
Intergenic.all_AFR <- readVCF("new_chr19_1_intergenic.vcf.gz", numcols=10000, tid="19", from=16109830, to=35414203, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AFR@theta_Watterson/46240)/(4*10000)
Mu
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr19_1_intergenic.vcf.gz", numcols=10000, tid="19", from=16109830, to=16120964, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/11134
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr19_1_intergenic.vcf.gz", numcols=10000, tid="19", from=19843906, to=19848826, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/4920
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr19_1_intergenic.vcf.gz", numcols=10000, tid="19", from=22926212, to=22928737, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/2525
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr19_1_intergenic.vcf.gz", numcols=10000, tid="19", from=35357823, to=35374878, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/17043
D

#Region 5
Intergenic5_AFR <- readVCF("new_chr19_1_intergenic.vcf.gz", numcols=10000, tid="19", from=35403585, to=35414203, include.unknown = TRUE)
...
divsites_inter5_AFR
D <- divsites_inter5_AFR/10618
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr19_2_intergenic.vcf.gz", numcols=10000, tid="19", from=16109830, to=35414203, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AMR@theta_Watterson/46240)/(4*10000)
Mu
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr19_2_intergenic.vcf.gz", numcols=10000, tid="19", from=16109830, to=16120964, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/11134
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr19_2_intergenic.vcf.gz", numcols=10000, tid="19", from=19843906, to=19848826, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/4920
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr19_2_intergenic.vcf.gz", numcols=10000, tid="19", from=22926212, to=22928737, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/2525
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr19_2_intergenic.vcf.gz", numcols=10000, tid="19", from=35357823, to=35374878, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/17043
D

#Region 5
Intergenic5_AMR <- readVCF("new_chr19_2_intergenic.vcf.gz", numcols=10000, tid="19", from=35403585, to=35414203, include.unknown = TRUE)
...
divsites_inter5_AMR
D <- divsites_inter5_AMR/10618
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr19_3_intergenic.vcf.gz", numcols=10000, tid="19", from=16109830, to=35414203, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EAS@theta_Watterson/46240)/(4*10000)
Mu
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr19_3_intergenic.vcf.gz", numcols=10000, tid="19", from=16109830, to=16120964, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/11134
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr19_3_intergenic.vcf.gz", numcols=10000, tid="19", from=19843906, to=19848826, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/4920
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr19_3_intergenic.vcf.gz", numcols=10000, tid="19", from=22926212, to=22928737, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/2525
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr19_3_intergenic.vcf.gz", numcols=10000, tid="19", from=35357823, to=35374878, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/17043
D

#Region 5
Intergenic5_EAS <- readVCF("new_chr19_3_intergenic.vcf.gz", numcols=10000, tid="19", from=35403585, to=35414203, include.unknown = TRUE)
...
divsites_inter5_EAS
D <- divsites_inter5_EAS/10618
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr19_4_intergenic.vcf.gz", numcols=10000, tid="19", from=16109830, to=35414203, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EUR@theta_Watterson/46240)/(4*10000)
Mu
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr19_4_intergenic.vcf.gz", numcols=10000, tid="19", from=16109830, to=16120964, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/11134
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr19_4_intergenic.vcf.gz", numcols=10000, tid="19", from=19843906, to=19848826, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/4920
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr19_4_intergenic.vcf.gz", numcols=10000, tid="19", from=22926212, to=22928737, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/2525
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr19_4_intergenic.vcf.gz", numcols=10000, tid="19", from=35357823, to=35374878, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/17043
D

#Region 5
Intergenic5_EUR <- readVCF("new_chr19_4_intergenic.vcf.gz", numcols=10000, tid="19", from=35403585, to=35414203, include.unknown = TRUE)
...
divsites_inter5_EUR
D <- divsites_inter5_EUR/10618
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr19_5_intergenic.vcf.gz", numcols=10000, tid="19", from=16109830, to=35414203, include.unknown = TRUE)
...
Mu <- (Intergenic.all_SAS@theta_Watterson/46240)/(4*10000)
Mu
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr19_5_intergenic.vcf.gz", numcols=10000, tid="19", from=16109830, to=16120964, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/11134
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr19_5_intergenic.vcf.gz", numcols=10000, tid="19", from=19843906, to=19848826, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/4920
D

#Region 3
Intergenic3_SAS <- readVCF("new_chr19_5_intergenic.vcf.gz", numcols=10000, tid="19", from=22926212, to=22928737, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/2525
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr19_5_intergenic.vcf.gz", numcols=10000, tid="19", from=35357823, to=35374878, include.unknown = TRUE)
...
divsites_inter4_SAS
D <- divsites_inter4_SAS/17043
D

#Region 5
Intergenic5_SAS <- readVCF("new_chr19_5_intergenic.vcf.gz", numcols=10000, tid="19", from=35403585, to=35414203, include.unknown = TRUE)
