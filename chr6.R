...
Clusters.all <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=4185730, to=159058050, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/108725)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 4185730:159058050))) # N polyallelic sites in that region
m <- 108725 -sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(4185730:4194263), c(25723034:25734245), c(26103393:26113254), c(26153437:26161250), c(26212797:26220651), c(26231685:26239237), c(29493892:29505708), c(34245126:34257679), c(36451822:36460692), c(39068783:39093690), c(39094797:39108646), c(40343104:40351746), c(42689739:42699763), c(42842946:42858545), c(107383411:107395081), c(133133066:133141657), c(159049067:159058050)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=4185730, to=4194263, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/6187)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 4185730:4194263))) # N polyallelic sites in that region
m <- 6187-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=25723034, to=25734245, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/9794)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 25723034:25734245))) # N polyallelic sites in that region
m <- 9794-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=26103393, to=26113254, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/8710)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 26103393:26113254))) # N polyallelic sites in that region
m <- 8710-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=26153437, to=26161250, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/4184)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 26153437:26161250))) # N polyallelic sites in that region
m <- 4184-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=26212797, to=26220651, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/6707)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 26212797:26220651))) # N polyallelic sites in that region
m <- 6707-sum(misshuman,na.rm=T)-polysites
...
#Cluster_6
Clusters_6 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=26231685, to=26239237, include.unknown = TRUE)
...
Mu <- (Clusters_6@theta_Watterson/6754)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 26231685:26239237))) # N polyallelic sites in that region
m <- 6754-sum(misshuman,na.rm=T)-polysites
...
#Cluster_7
Clusters_7 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=29493892, to=29505708, include.unknown = TRUE)
...
Mu <- (Clusters_7@theta_Watterson/7344)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 29493892:29505708))) # N polyallelic sites in that region
m <- 7344-sum(misshuman,na.rm=T)-polysites
...
#Cluster_8
Clusters_8 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=34245126, to=34257679, include.unknown = TRUE)
...
Mu <- (Clusters_8@theta_Watterson/2330)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 34245126:34257679))) # N polyallelic sites in that region
m <- 2330-sum(misshuman,na.rm=T)-polysites
...
#Cluster_9
Clusters_9 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=36451822, to=36460692, include.unknown = TRUE)
...
Mu <- (Clusters_9@theta_Watterson/1772)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 36451822:36460692))) # N polyallelic sites in that region
m <- 1772-sum(misshuman,na.rm=T)-polysites
...
#Cluster_10
Clusters_10 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=39068783, to=39093690, include.unknown = TRUE)
...
Mu <- (Clusters_10@theta_Watterson/13776)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 39068783:39093690))) # N polyallelic sites in that region
m <- 13776-sum(misshuman,na.rm=T)-polysites
...
#Cluster_11
Clusters_11 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=39094797, to=39108646, include.unknown = TRUE)
...
Mu <- (Clusters_11@theta_Watterson/13835)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 39094797:39108646))) # N polyallelic sites in that region
m <- 13835-sum(misshuman,na.rm=T)-polysites
...
#Cluster_12
Clusters_12 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=40343104, to=40351746, include.unknown = TRUE)
...
Mu <- (Clusters_12@theta_Watterson/4120)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 40343104:40351746))) # N polyallelic sites in that region
m <- 4120-sum(misshuman,na.rm=T)-polysites
...
#Cluster_13
Clusters_13 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=42689739, to=42699763, include.unknown = TRUE)
Clusters_13 <- set.outgroup(Clusters_13, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters_13) 

#Divergence
bial <- get.biallelic.matrix(Clusters_13,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites13 <- sum (div & !polym,na.rm=T)
divsites13
D <- divsites13/8973
D

#Mutation rate
Clusters_13 <- neutrality.stats(Clusters_13)
Mu <- (Clusters_13@theta_Watterson/8973)/40000
Mu

#Pi_Cluster13
individuals <- get.individuals(Clusters_13)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 

bial <- get.biallelic.matrix(Clusters_13,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters_13@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 42689739:42699763))) # N polyallelic sites in that region
m <- 8973-sum(misshuman,na.rm=T)-polysites
...
EUR <- c("HG00097", "HG00099", "HG00102", "HG00110", "HG00111", "HG00118", "HG00120", "HG00121", "HG00122", "HG00125", "HG00127", "HG00128", "HG00130", "HG00132", "HG00133", "HG00137", "HG00146", "HG00150", "HG00154", "HG00158", "HG00171", "HG00173", "HG00174", "HG00176", "HG00177", "HG00178", "HG00179", "HG00180", "HG00231", "HG00232", "HG00233", "HG00235", "HG00236", "HG00237", "HG00238", "HG00239", "HG00245", "HG00250", "HG00253", "HG00254", "HG00255", "HG00257", "HG00258", "HG00259", "HG00261", "HG00262", "HG00263", "HG00266", "HG00268", "HG00269", "HG00272", "HG00274", "HG00275", "HG00276", "HG00281", "HG00282", "HG00285", "HG00288", "HG00304", "HG00306", "HG00309", "HG00313", "HG00315", "HG00318", "HG00319", "HG00320", "HG00323", "HG00324", "HG00326", "HG00327", "HG00328", "HG00330", "HG00331", "HG00332", "HG00334", "HG00337", "HG00339", "HG00343", "HG00344", "HG00346", "HG00349", "HG00350", "HG00353", "HG00355", "HG00356", "HG00357", "HG00361", "HG00362", "HG00364", "HG00365", "HG00367", "HG00368", "HG00373", "HG00376", "HG00378", "HG00379", "HG00380", "HG00381", "HG00383", "HG00384", "HG01501", "HG01504", "HG01507", "HG01510", "HG01513", "HG01516", "HG01519", "HG01522", "HG01525", "HG01528", "HG01531", "HG01537", "HG01602", "HG01605", "HG01607", "HG01612", "HG01613", "HG01618", "HG01620", "HG01623", "HG01626", "HG01628", "HG01632", "HG01668", "HG01670", "HG01673", "HG01676", "HG01679", "HG01684", "HG01685", "HG01695", "HG01697", "HG01702", "HG01704", "HG01707", "HG01710", "HG01746", "HG01757", "HG01762", "HG01766", "HG01768", "HG01770", "HG01773", "HG01776", "HG01779", "HG01784", "HG01786", "HG01790", "HG02215", "HG02220", "HG02223", "HG02230", "HG02232", "HG02235", "HG02239", "NA06985", "NA06989", "NA07000", "NA07037", "NA07056", "NA10847", "NA11830", "NA11832", "NA11840", "NA11892", "NA11894", "NA11918", "NA11920", "NA11933", "NA11995", "NA12004", "NA12006", "NA12044", "NA12046", "NA12058", "NA12156", "NA12234", "NA12249", "NA12273", "NA12275", "NA12283", "NA12287", "NA12341", "NA12348", "NA12400", "NA12414", "NA12489", "NA12717", "NA12718", "NA12749", "NA12751", "NA12761", "NA12763", "NA12776", "NA12778", "NA12813", "NA12815", "NA12828", "NA12830", "NA12843", "NA12873", "NA12878", "NA12890", "NA20502", "NA20503", "NA20504", "NA20505", "NA20506", "NA20507", "NA20508", "NA20514", "NA20517", "NA20522", "NA20529", "NA20530", "NA20531", "NA20533", "NA20535", "NA20540", "NA20541", "NA20542", "NA20582", "NA20585", "NA20587", "NA20589", "NA20753", "NA20756", "NA20757", "NA20760", "NA20761", "NA20764", "NA20766", "NA20768", "NA20769", "NA20771", "NA20772", "NA20773", "NA20774", "NA20775", "NA20790", "NA20795", "NA20797", "NA20799", "NA20800", "NA20802", "NA20804", "NA20807", "NA20808", "NA20813", "NA20818", "NA20819", "NA20821", "NA20822", "NA20826", "NA20828", "NA20832")
SAS <- c("HG02491", "HG02494", "HG02601", "HG02652", "HG02661", "HG02688", "HG02697", "HG02725", "HG02728", "HG02731", "HG02737", "HG02775", "HG02778", "HG02784", "HG02787", "HG02790", "HG02793", "HG03007", "HG03016", "HG03235", "HG03238", "HG03488", "HG03491", "HG03589", "HG03595", "HG03598", "HG03604", "HG03607", "HG03611", "HG03616", "HG03631", "HG03634", "HG03640", "HG03642", "HG03643", "HG03645", "HG03653", "HG03668", "HG03673", "HG03684", "HG03689", "HG03692", "HG03698", "HG03703", "HG03706", "HG03709", "HG03714", "HG03717", "HG03730", "HG03731", "HG03736", "HG03757", "HG03760", "HG03762", "HG03765", "HG03770", "HG03772", "HG03774", "HG03780", "HG03781", "HG03782", "HG03787", "HG03789", "HG03793", "HG03796", "HG03802", "HG03805", "HG03808", "HG03814", "HG03817", "HG03823", "HG03826", "HG03829", "HG03832", "HG03849", "HG03857", "HG03861", "HG03863", "HG03868", "HG03874", "HG03882", "HG03886", "HG03888", "HG03897", "HG03907", "HG03910", "HG03913", "HG03916", "HG03919", "HG03922", "HG03925", "HG03928", "HG03931", "HG03934", "HG03937", "HG03940", "HG03945", "HG03947", "HG03949", "HG03951", "HG03968", "HG03973", "HG03977", "HG03986", "HG03989", "HG04001", "HG04014", "HG04018", "HG04025", "HG04026", "HG04042", "HG04047", "HG04059", "HG04062", "HG04063", "HG04075", "HG04076", "HG04090", "HG04099", "HG04118", "HG04141", "HG04144", "HG04153", "HG04156", "HG04159", "HG04171", "HG04177", "HG04180", "HG04183", "HG04186", "HG04189", "HG04195", "HG04200", "HG04202", "HG04212", "HG04214", "HG04216", "HG04227", "NA20847", "NA20849", "NA20851", "NA20853", "NA20854", "NA20856", "NA20859", "NA20862", "NA20868", "NA20869", "NA20872", "NA20874", "NA20875", "NA20876", "NA20877", "NA20878", "NA20881", "NA20882", "NA20888", "NA20892", "NA20894", "NA20896", "NA20899", "NA20902", "NA20906", "NA20908", "NA20910", "NA21086", "NA21088", "NA21089", "NA21097", "NA21101", "NA21102", "NA21103", "NA21106", "NA21108", "NA21110", "NA21120", "NA21122", "NA21125", "NA21137", "NA21141", "NA21143", "NA21144")
Clusters_13 <- set.populations(Clusters_13, list(AFR,AMR,EAS,EUR,SAS), diploid = TRUE)
Clusters_13 <- set.outgroup(Clusters_13, c("Chimp"), diploid=TRUE)

#F_ST
Clusters_13 <- F_ST.stats(Clusters_13, mode="nucleotide")
Clusters_13@nuc.F_ST.vs.all [[1]]
Clusters_13@nuc.F_ST.vs.all [[2]]
Clusters_13@nuc.F_ST.vs.all [[3]]
Clusters_13@nuc.F_ST.vs.all [[4]]
Clusters_13@nuc.F_ST.vs.all [[5]]

#Cluster_14
Clusters_14 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=42842946, to=42858545, include.unknown = TRUE)
Clusters_14 <- set.outgroup(Clusters_14, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters_14) 

#Divergence
bial <- get.biallelic.matrix(Clusters_14,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites14 <- sum (div & !polym,na.rm=T)
divsites14
D <- divsites14/4750
D

#Mutation rate
Clusters_14 <- neutrality.stats(Clusters_14)
Mu <- (Clusters_14@theta_Watterson/4750)/40000
Mu

#Pi_Cluster14
individuals <- get.individuals(Clusters_14)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 

bial <- get.biallelic.matrix(Clusters_14,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters_14@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 42842946:42858545))) # N polyallelic sites in that region
m <- 4750-sum(misshuman,na.rm=T)-polysites
...
EUR <- c("HG00097", "HG00099", "HG00102", "HG00110", "HG00111", "HG00118", "HG00120", "HG00121", "HG00122", "HG00125", "HG00127", "HG00128", "HG00130", "HG00132", "HG00133", "HG00137", "HG00146", "HG00150", "HG00154", "HG00158", "HG00171", "HG00173", "HG00174", "HG00176", "HG00177", "HG00178", "HG00179", "HG00180", "HG00231", "HG00232", "HG00233", "HG00235", "HG00236", "HG00237", "HG00238", "HG00239", "HG00245", "HG00250", "HG00253", "HG00254", "HG00255", "HG00257", "HG00258", "HG00259", "HG00261", "HG00262", "HG00263", "HG00266", "HG00268", "HG00269", "HG00272", "HG00274", "HG00275", "HG00276", "HG00281", "HG00282", "HG00285", "HG00288", "HG00304", "HG00306", "HG00309", "HG00313", "HG00315", "HG00318", "HG00319", "HG00320", "HG00323", "HG00324", "HG00326", "HG00327", "HG00328", "HG00330", "HG00331", "HG00332", "HG00334", "HG00337", "HG00339", "HG00343", "HG00344", "HG00346", "HG00349", "HG00350", "HG00353", "HG00355", "HG00356", "HG00357", "HG00361", "HG00362", "HG00364", "HG00365", "HG00367", "HG00368", "HG00373", "HG00376", "HG00378", "HG00379", "HG00380", "HG00381", "HG00383", "HG00384", "HG01501", "HG01504", "HG01507", "HG01510", "HG01513", "HG01516", "HG01519", "HG01522", "HG01525", "HG01528", "HG01531", "HG01537", "HG01602", "HG01605", "HG01607", "HG01612", "HG01613", "HG01618", "HG01620", "HG01623", "HG01626", "HG01628", "HG01632", "HG01668", "HG01670", "HG01673", "HG01676", "HG01679", "HG01684", "HG01685", "HG01695", "HG01697", "HG01702", "HG01704", "HG01707", "HG01710", "HG01746", "HG01757", "HG01762", "HG01766", "HG01768", "HG01770", "HG01773", "HG01776", "HG01779", "HG01784", "HG01786", "HG01790", "HG02215", "HG02220", "HG02223", "HG02230", "HG02232", "HG02235", "HG02239", "NA06985", "NA06989", "NA07000", "NA07037", "NA07056", "NA10847", "NA11830", "NA11832", "NA11840", "NA11892", "NA11894", "NA11918", "NA11920", "NA11933", "NA11995", "NA12004", "NA12006", "NA12044", "NA12046", "NA12058", "NA12156", "NA12234", "NA12249", "NA12273", "NA12275", "NA12283", "NA12287", "NA12341", "NA12348", "NA12400", "NA12414", "NA12489", "NA12717", "NA12718", "NA12749", "NA12751", "NA12761", "NA12763", "NA12776", "NA12778", "NA12813", "NA12815", "NA12828", "NA12830", "NA12843", "NA12873", "NA12878", "NA12890", "NA20502", "NA20503", "NA20504", "NA20505", "NA20506", "NA20507", "NA20508", "NA20514", "NA20517", "NA20522", "NA20529", "NA20530", "NA20531", "NA20533", "NA20535", "NA20540", "NA20541", "NA20542", "NA20582", "NA20585", "NA20587", "NA20589", "NA20753", "NA20756", "NA20757", "NA20760", "NA20761", "NA20764", "NA20766", "NA20768", "NA20769", "NA20771", "NA20772", "NA20773", "NA20774", "NA20775", "NA20790", "NA20795", "NA20797", "NA20799", "NA20800", "NA20802", "NA20804", "NA20807", "NA20808", "NA20813", "NA20818", "NA20819", "NA20821", "NA20822", "NA20826", "NA20828", "NA20832")
SAS <- c("HG02491", "HG02494", "HG02601", "HG02652", "HG02661", "HG02688", "HG02697", "HG02725", "HG02728", "HG02731", "HG02737", "HG02775", "HG02778", "HG02784", "HG02787", "HG02790", "HG02793", "HG03007", "HG03016", "HG03235", "HG03238", "HG03488", "HG03491", "HG03589", "HG03595", "HG03598", "HG03604", "HG03607", "HG03611", "HG03616", "HG03631", "HG03634", "HG03640", "HG03642", "HG03643", "HG03645", "HG03653", "HG03668", "HG03673", "HG03684", "HG03689", "HG03692", "HG03698", "HG03703", "HG03706", "HG03709", "HG03714", "HG03717", "HG03730", "HG03731", "HG03736", "HG03757", "HG03760", "HG03762", "HG03765", "HG03770", "HG03772", "HG03774", "HG03780", "HG03781", "HG03782", "HG03787", "HG03789", "HG03793", "HG03796", "HG03802", "HG03805", "HG03808", "HG03814", "HG03817", "HG03823", "HG03826", "HG03829", "HG03832", "HG03849", "HG03857", "HG03861", "HG03863", "HG03868", "HG03874", "HG03882", "HG03886", "HG03888", "HG03897", "HG03907", "HG03910", "HG03913", "HG03916", "HG03919", "HG03922", "HG03925", "HG03928", "HG03931", "HG03934", "HG03937", "HG03940", "HG03945", "HG03947", "HG03949", "HG03951", "HG03968", "HG03973", "HG03977", "HG03986", "HG03989", "HG04001", "HG04014", "HG04018", "HG04025", "HG04026", "HG04042", "HG04047", "HG04059", "HG04062", "HG04063", "HG04075", "HG04076", "HG04090", "HG04099", "HG04118", "HG04141", "HG04144", "HG04153", "HG04156", "HG04159", "HG04171", "HG04177", "HG04180", "HG04183", "HG04186", "HG04189", "HG04195", "HG04200", "HG04202", "HG04212", "HG04214", "HG04216", "HG04227", "NA20847", "NA20849", "NA20851", "NA20853", "NA20854", "NA20856", "NA20859", "NA20862", "NA20868", "NA20869", "NA20872", "NA20874", "NA20875", "NA20876", "NA20877", "NA20878", "NA20881", "NA20882", "NA20888", "NA20892", "NA20894", "NA20896", "NA20899", "NA20902", "NA20906", "NA20908", "NA20910", "NA21086", "NA21088", "NA21089", "NA21097", "NA21101", "NA21102", "NA21103", "NA21106", "NA21108", "NA21110", "NA21120", "NA21122", "NA21125", "NA21137", "NA21141", "NA21143", "NA21144")
Clusters_14 <- set.populations(Clusters_14, list(AFR,AMR,EAS,EUR,SAS), diploid = TRUE)
Clusters_14 <- set.outgroup(Clusters_14, c("Chimp"), diploid=TRUE)

#F_ST
Clusters_14 <- F_ST.stats(Clusters_14, mode="nucleotide")
Clusters_14@nuc.F_ST.vs.all [[1]]
Clusters_14@nuc.F_ST.vs.all [[2]]
Clusters_14@nuc.F_ST.vs.all [[3]]
Clusters_14@nuc.F_ST.vs.all [[4]]
Clusters_14@nuc.F_ST.vs.all [[5]]

#Cluster_15
Clusters_15 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=107383411, to=107395081, include.unknown = TRUE)
Clusters_15 <- set.outgroup(Clusters_15, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters_15) 

#Divergence
bial <- get.biallelic.matrix(Clusters_15,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites15 <- sum (div & !polym,na.rm=T)
divsites15
D <- divsites15/2975
D

#Mutation rate
Clusters_15 <- neutrality.stats(Clusters_15)
Mu <- (Clusters_15@theta_Watterson/2975)/40000
Mu

#Pi_Cluster15
individuals <- get.individuals(Clusters_15)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 

bial <- get.biallelic.matrix(Clusters_15,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters_15@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 107383411:107395081))) # N polyallelic sites in that region
m <- 2975-sum(misshuman,na.rm=T)-polysites
...
EUR <- c("HG00097", "HG00099", "HG00102", "HG00110", "HG00111", "HG00118", "HG00120", "HG00121", "HG00122", "HG00125", "HG00127", "HG00128", "HG00130", "HG00132", "HG00133", "HG00137", "HG00146", "HG00150", "HG00154", "HG00158", "HG00171", "HG00173", "HG00174", "HG00176", "HG00177", "HG00178", "HG00179", "HG00180", "HG00231", "HG00232", "HG00233", "HG00235", "HG00236", "HG00237", "HG00238", "HG00239", "HG00245", "HG00250", "HG00253", "HG00254", "HG00255", "HG00257", "HG00258", "HG00259", "HG00261", "HG00262", "HG00263", "HG00266", "HG00268", "HG00269", "HG00272", "HG00274", "HG00275", "HG00276", "HG00281", "HG00282", "HG00285", "HG00288", "HG00304", "HG00306", "HG00309", "HG00313", "HG00315", "HG00318", "HG00319", "HG00320", "HG00323", "HG00324", "HG00326", "HG00327", "HG00328", "HG00330", "HG00331", "HG00332", "HG00334", "HG00337", "HG00339", "HG00343", "HG00344", "HG00346", "HG00349", "HG00350", "HG00353", "HG00355", "HG00356", "HG00357", "HG00361", "HG00362", "HG00364", "HG00365", "HG00367", "HG00368", "HG00373", "HG00376", "HG00378", "HG00379", "HG00380", "HG00381", "HG00383", "HG00384", "HG01501", "HG01504", "HG01507", "HG01510", "HG01513", "HG01516", "HG01519", "HG01522", "HG01525", "HG01528", "HG01531", "HG01537", "HG01602", "HG01605", "HG01607", "HG01612", "HG01613", "HG01618", "HG01620", "HG01623", "HG01626", "HG01628", "HG01632", "HG01668", "HG01670", "HG01673", "HG01676", "HG01679", "HG01684", "HG01685", "HG01695", "HG01697", "HG01702", "HG01704", "HG01707", "HG01710", "HG01746", "HG01757", "HG01762", "HG01766", "HG01768", "HG01770", "HG01773", "HG01776", "HG01779", "HG01784", "HG01786", "HG01790", "HG02215", "HG02220", "HG02223", "HG02230", "HG02232", "HG02235", "HG02239", "NA06985", "NA06989", "NA07000", "NA07037", "NA07056", "NA10847", "NA11830", "NA11832", "NA11840", "NA11892", "NA11894", "NA11918", "NA11920", "NA11933", "NA11995", "NA12004", "NA12006", "NA12044", "NA12046", "NA12058", "NA12156", "NA12234", "NA12249", "NA12273", "NA12275", "NA12283", "NA12287", "NA12341", "NA12348", "NA12400", "NA12414", "NA12489", "NA12717", "NA12718", "NA12749", "NA12751", "NA12761", "NA12763", "NA12776", "NA12778", "NA12813", "NA12815", "NA12828", "NA12830", "NA12843", "NA12873", "NA12878", "NA12890", "NA20502", "NA20503", "NA20504", "NA20505", "NA20506", "NA20507", "NA20508", "NA20514", "NA20517", "NA20522", "NA20529", "NA20530", "NA20531", "NA20533", "NA20535", "NA20540", "NA20541", "NA20542", "NA20582", "NA20585", "NA20587", "NA20589", "NA20753", "NA20756", "NA20757", "NA20760", "NA20761", "NA20764", "NA20766", "NA20768", "NA20769", "NA20771", "NA20772", "NA20773", "NA20774", "NA20775", "NA20790", "NA20795", "NA20797", "NA20799", "NA20800", "NA20802", "NA20804", "NA20807", "NA20808", "NA20813", "NA20818", "NA20819", "NA20821", "NA20822", "NA20826", "NA20828", "NA20832")
SAS <- c("HG02491", "HG02494", "HG02601", "HG02652", "HG02661", "HG02688", "HG02697", "HG02725", "HG02728", "HG02731", "HG02737", "HG02775", "HG02778", "HG02784", "HG02787", "HG02790", "HG02793", "HG03007", "HG03016", "HG03235", "HG03238", "HG03488", "HG03491", "HG03589", "HG03595", "HG03598", "HG03604", "HG03607", "HG03611", "HG03616", "HG03631", "HG03634", "HG03640", "HG03642", "HG03643", "HG03645", "HG03653", "HG03668", "HG03673", "HG03684", "HG03689", "HG03692", "HG03698", "HG03703", "HG03706", "HG03709", "HG03714", "HG03717", "HG03730", "HG03731", "HG03736", "HG03757", "HG03760", "HG03762", "HG03765", "HG03770", "HG03772", "HG03774", "HG03780", "HG03781", "HG03782", "HG03787", "HG03789", "HG03793", "HG03796", "HG03802", "HG03805", "HG03808", "HG03814", "HG03817", "HG03823", "HG03826", "HG03829", "HG03832", "HG03849", "HG03857", "HG03861", "HG03863", "HG03868", "HG03874", "HG03882", "HG03886", "HG03888", "HG03897", "HG03907", "HG03910", "HG03913", "HG03916", "HG03919", "HG03922", "HG03925", "HG03928", "HG03931", "HG03934", "HG03937", "HG03940", "HG03945", "HG03947", "HG03949", "HG03951", "HG03968", "HG03973", "HG03977", "HG03986", "HG03989", "HG04001", "HG04014", "HG04018", "HG04025", "HG04026", "HG04042", "HG04047", "HG04059", "HG04062", "HG04063", "HG04075", "HG04076", "HG04090", "HG04099", "HG04118", "HG04141", "HG04144", "HG04153", "HG04156", "HG04159", "HG04171", "HG04177", "HG04180", "HG04183", "HG04186", "HG04189", "HG04195", "HG04200", "HG04202", "HG04212", "HG04214", "HG04216", "HG04227", "NA20847", "NA20849", "NA20851", "NA20853", "NA20854", "NA20856", "NA20859", "NA20862", "NA20868", "NA20869", "NA20872", "NA20874", "NA20875", "NA20876", "NA20877", "NA20878", "NA20881", "NA20882", "NA20888", "NA20892", "NA20894", "NA20896", "NA20899", "NA20902", "NA20906", "NA20908", "NA20910", "NA21086", "NA21088", "NA21089", "NA21097", "NA21101", "NA21102", "NA21103", "NA21106", "NA21108", "NA21110", "NA21120", "NA21122", "NA21125", "NA21137", "NA21141", "NA21143", "NA21144")
Clusters_15 <- set.populations(Clusters_15, list(AFR,AMR,EAS,EUR,SAS), diploid = TRUE)
Clusters_15 <- set.outgroup(Clusters_15, c("Chimp"), diploid=TRUE)

#F_ST
Clusters_15 <- F_ST.stats(Clusters_15, mode="nucleotide")
Clusters_15@nuc.F_ST.vs.all [[1]]
Clusters_15@nuc.F_ST.vs.all [[2]]
Clusters_15@nuc.F_ST.vs.all [[3]]
Clusters_15@nuc.F_ST.vs.all [[4]]
Clusters_15@nuc.F_ST.vs.all [[5]]

#Cluster_16
Clusters_16 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=133133066, to=133141657, include.unknown = TRUE)
Clusters_16 <- set.outgroup(Clusters_16, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters_16) 

#Divergence
bial <- get.biallelic.matrix(Clusters_16,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites16 <- sum (div & !polym,na.rm=T)
divsites16
D <- divsites16/5468
D

#Mutation rate
Clusters_16 <- neutrality.stats(Clusters_16)
Mu <- (Clusters_16@theta_Watterson/5468)/40000
Mu

#Pi_Cluster16
individuals <- get.individuals(Clusters_16)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 

bial <- get.biallelic.matrix(Clusters_16,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters_16@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 133133066:133141657))) # N polyallelic sites in that region
m <- 5468-sum(misshuman,na.rm=T)-polysites
...
EUR <- c("HG00097", "HG00099", "HG00102", "HG00110", "HG00111", "HG00118", "HG00120", "HG00121", "HG00122", "HG00125", "HG00127", "HG00128", "HG00130", "HG00132", "HG00133", "HG00137", "HG00146", "HG00150", "HG00154", "HG00158", "HG00171", "HG00173", "HG00174", "HG00176", "HG00177", "HG00178", "HG00179", "HG00180", "HG00231", "HG00232", "HG00233", "HG00235", "HG00236", "HG00237", "HG00238", "HG00239", "HG00245", "HG00250", "HG00253", "HG00254", "HG00255", "HG00257", "HG00258", "HG00259", "HG00261", "HG00262", "HG00263", "HG00266", "HG00268", "HG00269", "HG00272", "HG00274", "HG00275", "HG00276", "HG00281", "HG00282", "HG00285", "HG00288", "HG00304", "HG00306", "HG00309", "HG00313", "HG00315", "HG00318", "HG00319", "HG00320", "HG00323", "HG00324", "HG00326", "HG00327", "HG00328", "HG00330", "HG00331", "HG00332", "HG00334", "HG00337", "HG00339", "HG00343", "HG00344", "HG00346", "HG00349", "HG00350", "HG00353", "HG00355", "HG00356", "HG00357", "HG00361", "HG00362", "HG00364", "HG00365", "HG00367", "HG00368", "HG00373", "HG00376", "HG00378", "HG00379", "HG00380", "HG00381", "HG00383", "HG00384", "HG01501", "HG01504", "HG01507", "HG01510", "HG01513", "HG01516", "HG01519", "HG01522", "HG01525", "HG01528", "HG01531", "HG01537", "HG01602", "HG01605", "HG01607", "HG01612", "HG01613", "HG01618", "HG01620", "HG01623", "HG01626", "HG01628", "HG01632", "HG01668", "HG01670", "HG01673", "HG01676", "HG01679", "HG01684", "HG01685", "HG01695", "HG01697", "HG01702", "HG01704", "HG01707", "HG01710", "HG01746", "HG01757", "HG01762", "HG01766", "HG01768", "HG01770", "HG01773", "HG01776", "HG01779", "HG01784", "HG01786", "HG01790", "HG02215", "HG02220", "HG02223", "HG02230", "HG02232", "HG02235", "HG02239", "NA06985", "NA06989", "NA07000", "NA07037", "NA07056", "NA10847", "NA11830", "NA11832", "NA11840", "NA11892", "NA11894", "NA11918", "NA11920", "NA11933", "NA11995", "NA12004", "NA12006", "NA12044", "NA12046", "NA12058", "NA12156", "NA12234", "NA12249", "NA12273", "NA12275", "NA12283", "NA12287", "NA12341", "NA12348", "NA12400", "NA12414", "NA12489", "NA12717", "NA12718", "NA12749", "NA12751", "NA12761", "NA12763", "NA12776", "NA12778", "NA12813", "NA12815", "NA12828", "NA12830", "NA12843", "NA12873", "NA12878", "NA12890", "NA20502", "NA20503", "NA20504", "NA20505", "NA20506", "NA20507", "NA20508", "NA20514", "NA20517", "NA20522", "NA20529", "NA20530", "NA20531", "NA20533", "NA20535", "NA20540", "NA20541", "NA20542", "NA20582", "NA20585", "NA20587", "NA20589", "NA20753", "NA20756", "NA20757", "NA20760", "NA20761", "NA20764", "NA20766", "NA20768", "NA20769", "NA20771", "NA20772", "NA20773", "NA20774", "NA20775", "NA20790", "NA20795", "NA20797", "NA20799", "NA20800", "NA20802", "NA20804", "NA20807", "NA20808", "NA20813", "NA20818", "NA20819", "NA20821", "NA20822", "NA20826", "NA20828", "NA20832")
SAS <- c("HG02491", "HG02494", "HG02601", "HG02652", "HG02661", "HG02688", "HG02697", "HG02725", "HG02728", "HG02731", "HG02737", "HG02775", "HG02778", "HG02784", "HG02787", "HG02790", "HG02793", "HG03007", "HG03016", "HG03235", "HG03238", "HG03488", "HG03491", "HG03589", "HG03595", "HG03598", "HG03604", "HG03607", "HG03611", "HG03616", "HG03631", "HG03634", "HG03640", "HG03642", "HG03643", "HG03645", "HG03653", "HG03668", "HG03673", "HG03684", "HG03689", "HG03692", "HG03698", "HG03703", "HG03706", "HG03709", "HG03714", "HG03717", "HG03730", "HG03731", "HG03736", "HG03757", "HG03760", "HG03762", "HG03765", "HG03770", "HG03772", "HG03774", "HG03780", "HG03781", "HG03782", "HG03787", "HG03789", "HG03793", "HG03796", "HG03802", "HG03805", "HG03808", "HG03814", "HG03817", "HG03823", "HG03826", "HG03829", "HG03832", "HG03849", "HG03857", "HG03861", "HG03863", "HG03868", "HG03874", "HG03882", "HG03886", "HG03888", "HG03897", "HG03907", "HG03910", "HG03913", "HG03916", "HG03919", "HG03922", "HG03925", "HG03928", "HG03931", "HG03934", "HG03937", "HG03940", "HG03945", "HG03947", "HG03949", "HG03951", "HG03968", "HG03973", "HG03977", "HG03986", "HG03989", "HG04001", "HG04014", "HG04018", "HG04025", "HG04026", "HG04042", "HG04047", "HG04059", "HG04062", "HG04063", "HG04075", "HG04076", "HG04090", "HG04099", "HG04118", "HG04141", "HG04144", "HG04153", "HG04156", "HG04159", "HG04171", "HG04177", "HG04180", "HG04183", "HG04186", "HG04189", "HG04195", "HG04200", "HG04202", "HG04212", "HG04214", "HG04216", "HG04227", "NA20847", "NA20849", "NA20851", "NA20853", "NA20854", "NA20856", "NA20859", "NA20862", "NA20868", "NA20869", "NA20872", "NA20874", "NA20875", "NA20876", "NA20877", "NA20878", "NA20881", "NA20882", "NA20888", "NA20892", "NA20894", "NA20896", "NA20899", "NA20902", "NA20906", "NA20908", "NA20910", "NA21086", "NA21088", "NA21089", "NA21097", "NA21101", "NA21102", "NA21103", "NA21106", "NA21108", "NA21110", "NA21120", "NA21122", "NA21125", "NA21137", "NA21141", "NA21143", "NA21144")
Clusters_16 <- set.populations(Clusters_16, list(AFR,AMR,EAS,EUR,SAS), diploid = TRUE)
Clusters_16 <- set.outgroup(Clusters_16, c("Chimp"), diploid=TRUE)

#F_ST
Clusters_16 <- F_ST.stats(Clusters_16, mode="nucleotide")
Clusters_16@nuc.F_ST.vs.all [[1]]
Clusters_16@nuc.F_ST.vs.all [[2]]
Clusters_16@nuc.F_ST.vs.all [[3]]
Clusters_16@nuc.F_ST.vs.all [[4]]
Clusters_16@nuc.F_ST.vs.all [[5]]

#Cluster_17
Clusters_17 <- readVCF("new_chr6.vcf.gz", numcols=10000, tid="6", from=159049067, to=159058050, include.unknown = TRUE)
Clusters_17 <- set.outgroup(Clusters_17, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters_17) 

#Divergence
bial <- get.biallelic.matrix(Clusters_17,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites17 <- sum (div & !polym,na.rm=T)
divsites17
D <- divsites17/1046
D

#Mutation rate
Clusters_17 <- neutrality.stats(Clusters_17)
Mu <- (Clusters_17@theta_Watterson/1046)/40000
Mu

#Pi_Cluster17
individuals <- get.individuals(Clusters_17)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 

bial <- get.biallelic.matrix(Clusters_17,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters_17@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 159049067:159058050))) # N polyallelic sites in that region
m <- 1046-sum(misshuman,na.rm=T)-polysites
...
EUR <- c("HG00097", "HG00099", "HG00102", "HG00110", "HG00111", "HG00118", "HG00120", "HG00121", "HG00122", "HG00125", "HG00127", "HG00128", "HG00130", "HG00132", "HG00133", "HG00137", "HG00146", "HG00150", "HG00154", "HG00158", "HG00171", "HG00173", "HG00174", "HG00176", "HG00177", "HG00178", "HG00179", "HG00180", "HG00231", "HG00232", "HG00233", "HG00235", "HG00236", "HG00237", "HG00238", "HG00239", "HG00245", "HG00250", "HG00253", "HG00254", "HG00255", "HG00257", "HG00258", "HG00259", "HG00261", "HG00262", "HG00263", "HG00266", "HG00268", "HG00269", "HG00272", "HG00274", "HG00275", "HG00276", "HG00281", "HG00282", "HG00285", "HG00288", "HG00304", "HG00306", "HG00309", "HG00313", "HG00315", "HG00318", "HG00319", "HG00320", "HG00323", "HG00324", "HG00326", "HG00327", "HG00328", "HG00330", "HG00331", "HG00332", "HG00334", "HG00337", "HG00339", "HG00343", "HG00344", "HG00346", "HG00349", "HG00350", "HG00353", "HG00355", "HG00356", "HG00357", "HG00361", "HG00362", "HG00364", "HG00365", "HG00367", "HG00368", "HG00373", "HG00376", "HG00378", "HG00379", "HG00380", "HG00381", "HG00383", "HG00384", "HG01501", "HG01504", "HG01507", "HG01510", "HG01513", "HG01516", "HG01519", "HG01522", "HG01525", "HG01528", "HG01531", "HG01537", "HG01602", "HG01605", "HG01607", "HG01612", "HG01613", "HG01618", "HG01620", "HG01623", "HG01626", "HG01628", "HG01632", "HG01668", "HG01670", "HG01673", "HG01676", "HG01679", "HG01684", "HG01685", "HG01695", "HG01697", "HG01702", "HG01704", "HG01707", "HG01710", "HG01746", "HG01757", "HG01762", "HG01766", "HG01768", "HG01770", "HG01773", "HG01776", "HG01779", "HG01784", "HG01786", "HG01790", "HG02215", "HG02220", "HG02223", "HG02230", "HG02232", "HG02235", "HG02239", "NA06985", "NA06989", "NA07000", "NA07037", "NA07056", "NA10847", "NA11830", "NA11832", "NA11840", "NA11892", "NA11894", "NA11918", "NA11920", "NA11933", "NA11995", "NA12004", "NA12006", "NA12044", "NA12046", "NA12058", "NA12156", "NA12234", "NA12249", "NA12273", "NA12275", "NA12283", "NA12287", "NA12341", "NA12348", "NA12400", "NA12414", "NA12489", "NA12717", "NA12718", "NA12749", "NA12751", "NA12761", "NA12763", "NA12776", "NA12778", "NA12813", "NA12815", "NA12828", "NA12830", "NA12843", "NA12873", "NA12878", "NA12890", "NA20502", "NA20503", "NA20504", "NA20505", "NA20506", "NA20507", "NA20508", "NA20514", "NA20517", "NA20522", "NA20529", "NA20530", "NA20531", "NA20533", "NA20535", "NA20540", "NA20541", "NA20542", "NA20582", "NA20585", "NA20587", "NA20589", "NA20753", "NA20756", "NA20757", "NA20760", "NA20761", "NA20764", "NA20766", "NA20768", "NA20769", "NA20771", "NA20772", "NA20773", "NA20774", "NA20775", "NA20790", "NA20795", "NA20797", "NA20799", "NA20800", "NA20802", "NA20804", "NA20807", "NA20808", "NA20813", "NA20818", "NA20819", "NA20821", "NA20822", "NA20826", "NA20828", "NA20832")
SAS <- c("HG02491", "HG02494", "HG02601", "HG02652", "HG02661", "HG02688", "HG02697", "HG02725", "HG02728", "HG02731", "HG02737", "HG02775", "HG02778", "HG02784", "HG02787", "HG02790", "HG02793", "HG03007", "HG03016", "HG03235", "HG03238", "HG03488", "HG03491", "HG03589", "HG03595", "HG03598", "HG03604", "HG03607", "HG03611", "HG03616", "HG03631", "HG03634", "HG03640", "HG03642", "HG03643", "HG03645", "HG03653", "HG03668", "HG03673", "HG03684", "HG03689", "HG03692", "HG03698", "HG03703", "HG03706", "HG03709", "HG03714", "HG03717", "HG03730", "HG03731", "HG03736", "HG03757", "HG03760", "HG03762", "HG03765", "HG03770", "HG03772", "HG03774", "HG03780", "HG03781", "HG03782", "HG03787", "HG03789", "HG03793", "HG03796", "HG03802", "HG03805", "HG03808", "HG03814", "HG03817", "HG03823", "HG03826", "HG03829", "HG03832", "HG03849", "HG03857", "HG03861", "HG03863", "HG03868", "HG03874", "HG03882", "HG03886", "HG03888", "HG03897", "HG03907", "HG03910", "HG03913", "HG03916", "HG03919", "HG03922", "HG03925", "HG03928", "HG03931", "HG03934", "HG03937", "HG03940", "HG03945", "HG03947", "HG03949", "HG03951", "HG03968", "HG03973", "HG03977", "HG03986", "HG03989", "HG04001", "HG04014", "HG04018", "HG04025", "HG04026", "HG04042", "HG04047", "HG04059", "HG04062", "HG04063", "HG04075", "HG04076", "HG04090", "HG04099", "HG04118", "HG04141", "HG04144", "HG04153", "HG04156", "HG04159", "HG04171", "HG04177", "HG04180", "HG04183", "HG04186", "HG04189", "HG04195", "HG04200", "HG04202", "HG04212", "HG04214", "HG04216", "HG04227", "NA20847", "NA20849", "NA20851", "NA20853", "NA20854", "NA20856", "NA20859", "NA20862", "NA20868", "NA20869", "NA20872", "NA20874", "NA20875", "NA20876", "NA20877", "NA20878", "NA20881", "NA20882", "NA20888", "NA20892", "NA20894", "NA20896", "NA20899", "NA20902", "NA20906", "NA20908", "NA20910", "NA21086", "NA21088", "NA21089", "NA21097", "NA21101", "NA21102", "NA21103", "NA21106", "NA21108", "NA21110", "NA21120", "NA21122", "NA21125", "NA21137", "NA21141", "NA21143", "NA21144")
Clusters_17 <- set.populations(Clusters_17, list(AFR,AMR,EAS,EUR,SAS), diploid = TRUE)
Clusters_17 <- set.outgroup(Clusters_17, c("Chimp"), diploid=TRUE)

#F_ST
Clusters_17 <- F_ST.stats(Clusters_17, mode="nucleotide")
Clusters_17@nuc.F_ST.vs.all [[1]]
Clusters_17@nuc.F_ST.vs.all [[2]]
Clusters_17@nuc.F_ST.vs.all [[3]]
Clusters_17@nuc.F_ST.vs.all [[4]]
Clusters_17@nuc.F_ST.vs.all [[5]]

#############################STATISTICS per POPULATION########################################################

#AFR
Clusters.all_AFR <- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=418573 , to=159058050, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(4185730:4194263), c(25723034:25734245), c(26103393:26113254), c(26153437:26161250), c(26212797:26220651), c(26231685:26239237), c(29493892:29505708), c(34245126:34257679), c(36451822:36460692), c(39068783:39093690), c(39094797:39108646), c(40343104:40351746), c(42689739:42699763), c(42842946:42858545), c(107383411:107395081), c(133133066:133141657), c(159049067:159058050)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=4185730, to=4194263, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/6187
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/6187)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=25723034, to=25734245, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/9794
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/9794)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=26103393, to=26113254, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/8710
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/8710)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=26153437, to=26161250, include.unknown = TRUE)
...
divsites4_AFR
D <- divsites4_AFR/4184
D

#Mutation rate
Clusters4_AFR <- neutrality.stats(Clusters4_AFR, FAST = TRUE)
Mu <- (Clusters4_AFR@theta_Watterson/4184)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=26212797, to=26220651, include.unknown = TRUE)
...
divsites5_AFR
D <- divsites5_AFR/6707
D

#Mutation rate
Clusters5_AFR <- neutrality.stats(Clusters5_AFR, FAST = TRUE)
Mu <- (Clusters5_AFR@theta_Watterson/6707)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AFR<- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=26231685, to=26239237, include.unknown = TRUE)
...
divsites6_AFR
D <- divsites6_AFR/6754
D

#Mutation rate
Clusters6_AFR <- neutrality.stats(Clusters6_AFR, FAST = TRUE)
Mu <- (Clusters6_AFR@theta_Watterson/6754)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AFR <- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=29493892, to=29505708, include.unknown = TRUE)
...
divsites7_AFR
D <- divsites7_AFR/7344
D

#Mutation rate
Clusters7_AFR <- neutrality.stats(Clusters7_AFR, FAST = TRUE)
Mu <- (Clusters7_AFR@theta_Watterson/7344)/(4*10000)
Mu
...
#Cluster_8
Clusters8_AFR <- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=34245126, to=34257679, include.unknown = TRUE)
...
divsites8_AFR
D <- divsites8_AFR/2330
D

#Mutation rate
Clusters8_AFR <- neutrality.stats(Clusters8_AFR, FAST = TRUE)
Mu <- (Clusters8_AFR@theta_Watterson/2330)/(4*10000)
Mu
...
#Cluster_9
Clusters9_AFR <- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=36451822, to=36460692, include.unknown = TRUE)
...
divsites9_AFR
D <- divsites9_AFR/1772
D

#Mutation rate
Clusters9_AFR <- neutrality.stats(Clusters9_AFR, FAST = TRUE)
Mu <- (Clusters9_AFR@theta_Watterson/1772)/(4*10000)
Mu
...
#Cluster_10
Clusters10_AFR <- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=39068783, to=39093690, include.unknown = TRUE)
...
divsites10_AFR
D <- divsites10_AFR/13776
D

#Mutation rate
Clusters10_AFR <- neutrality.stats(Clusters10_AFR, FAST = TRUE)
Mu <- (Clusters10_AFR@theta_Watterson/13776)/(4*10000)
Mu
...
#Cluster_11
Clusters11_AFR <- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=39094797, to=39108646, include.unknown = TRUE)
...
divsites11_AFR
D <- divsites11_AFR/13835
D

#Mutation rate
Clusters11_AFR <- neutrality.stats(Clusters11_AFR, FAST = TRUE)
Mu <- (Clusters11_AFR@theta_Watterson/13835)/(4*10000)
Mu
...
#Cluster_12
Clusters12_AFR <- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=40343104, to=40351746, include.unknown = TRUE)
...
divsites12_AFR
D <- divsites12_AFR/4120
D

#Mutation rate
Clusters12_AFR <- neutrality.stats(Clusters12_AFR, FAST = TRUE)
Mu <- (Clusters12_AFR@theta_Watterson/4120)/(4*10000)
Mu
...
#Cluster_13
Clusters13_AFR<- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=42689739, to=42699763, include.unknown = TRUE)
Clusters13_AFR <- set.outgroup(Clusters13_AFR,c("Chimp"), diploid=TRUE)
get.sum.data(Clusters13_AFR) 

#Divergence
bial <- get.biallelic.matrix(Clusters13_AFR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites13_AFR <- sum (div & !polym,na.rm=T)
divsites13_AFR
D <- divsites13_AFR/8973
D

#Mutation rate
Clusters13_AFR <- neutrality.stats(Clusters13_AFR, FAST = TRUE)
Mu <- (Clusters13_AFR@theta_Watterson/8973)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters13_AFR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters13_AFR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters13_AFR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 42689739:42699763))) # N polyallelic sites in that region
m <- 8973-sum(misshuman,na.rm=T)-polysites
...
#Cluster_14
Clusters14_AFR<- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=42842946, to=42858545, include.unknown = TRUE)
Clusters14_AFR <- set.outgroup(Clusters14_AFR, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters14_AFR) 

#Divergence
bial <- get.biallelic.matrix(Clusters14_AFR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites14_AFR <- sum (div & !polym,na.rm=T)
divsites14_AFR
D <- divsites14_AFR/4750
D

#Mutation rate
Clusters14_AFR <- neutrality.stats(Clusters14_AFR, FAST = TRUE)
Mu <- (Clusters14_AFR@theta_Watterson/4750)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters14_AFR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters14_AFR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters14_AFR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 42842946:42858545))) # N polyallelic sites in that region
m <- 4750-sum(misshuman,na.rm=T)-polysites
...
#Cluster_15
Clusters15_AFR <- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=107383411, to=107395081, include.unknown = TRUE)
Clusters15_AFR <- set.outgroup(Clusters15_AFR, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters15_AFR) 

#Divergence
bial <- get.biallelic.matrix(Clusters15_AFR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites15_AFR <- sum (div & !polym,na.rm=T)
divsites15_AFR
D <- divsites15_AFR/2975
D

#Mutation rate
Clusters15_AFR <- neutrality.stats(Clusters15_AFR, FAST = TRUE)
Mu <- (Clusters15_AFR@theta_Watterson/2975)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters15_AFR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters15_AFR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters15_AFR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 107383411:107395081))) # N polyallelic sites in that region
m <- 2975-sum(misshuman,na.rm=T)-polysites
...
#Cluster_16
Clusters16_AFR <- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=133133066, to=133141657, include.unknown = TRUE)
Clusters16_AFR <- set.outgroup(Clusters16_AFR,c("Chimp"), diploid=TRUE)
get.sum.data(Clusters16_AFR) 

#Divergence
bial <- get.biallelic.matrix(Clusters16_AFR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites16_AFR <- sum (div & !polym,na.rm=T)
divsites16_AFR
D <- divsites16_AFR/5468
D

#Mutation rate
Clusters16_AFR <- neutrality.stats(Clusters16_AFR, FAST = TRUE)
Mu <- (Clusters16_AFR@theta_Watterson/5468)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters16_AFR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters16_AFR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters16_AFR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 133133066:133141657))) # N polyallelic sites in that region
m <- 5468-sum(misshuman,na.rm=T)-polysites
...
#Cluster_17
Clusters17_AFR <- readVCF("new_chr6_1.vcf.gz", numcols=10000, tid="6", from=159049067, to=159058050, include.unknown = TRUE)
Clusters17_AFR <- set.outgroup(Clusters17_AFR, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters17_AFR) 

#Divergence
bial <- get.biallelic.matrix(Clusters17_AFR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites17_AFR <- sum (div & !polym,na.rm=T)
divsites17_AFR
D <- divsites17_AFR/1046
D

#Mutation rate
Clusters17_AFR <- neutrality.stats(Clusters17_AFR, FAST = TRUE)
Mu <- (Clusters17_AFR@theta_Watterson/1046)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters17_AFR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters17_AFR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters17_AFR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 159049067:159058050))) # N polyallelic sites in that region
m <- 1046-sum(misshuman,na.rm=T)-polysites
...
#AMR
Clusters.all_AMR <- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=4185730, to=159058050, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(4185730:4194263), c(25723034:25734245), c(26103393:26113254), c(26153437:26161250), c(26212797:26220651), c(26231685:26239237), c(29493892:29505708), c(34245126:34257679), c(36451822:36460692), c(39068783:39093690), c(39094797:39108646), c(40343104:40351746), c(42689739:42699763), c(42842946:42858545), c(107383411:107395081), c(133133066:133141657), c(159049067:159058050)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=4185730, to=4194263, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/6187
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/6187)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=25723034, to=25734245, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/9794
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/9794)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=26103393, to=26113254, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/8710
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/8710)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=26153437, to=26161250, include.unknown = TRUE)
...
divsites4_AMR
D <- divsites4_AMR/4184
D

#Mutation rate
Clusters4_AMR <- neutrality.stats(Clusters4_AMR, FAST = TRUE)
Mu <- (Clusters4_AMR@theta_Watterson/4184)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=26212797, to=26220651, include.unknown = TRUE)
...
divsites5_AMR
D <- divsites5_AMR/6707
D

#Mutation rate
Clusters5_AMR <- neutrality.stats(Clusters5_AMR, FAST = TRUE)
Mu <- (Clusters5_AMR@theta_Watterson/6707)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AMR<- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=26231685, to=26239237, include.unknown = TRUE)
...
divsites6_AMR
D <- divsites6_AMR/6754
D

#Mutation rate
Clusters6_AMR <- neutrality.stats(Clusters6_AMR, FAST = TRUE)
Mu <- (Clusters6_AMR@theta_Watterson/6754)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AMR <- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=29493892, to=29505708, include.unknown = TRUE)
...
divsites7_AMR
D <- divsites7_AMR/7344
D

#Mutation rate
Clusters7_AFR <- neutrality.stats(Clusters7_AMR, FAST = TRUE)
Mu <- (Clusters7_AFR@theta_Watterson/7344)/(4*10000)
Mu
...
#Cluster_8
Clusters8_AMR <- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=34245126, to=34257679, include.unknown = TRUE)
...
divsites8_AMR
D <- divsites8_AMR/2330
D

#Mutation rate
Clusters8_AMR <- neutrality.stats(Clusters8_AMR, FAST = TRUE)
Mu <- (Clusters8_AMR@theta_Watterson/2330)/(4*10000)
Mu
...
#Cluster_9
Clusters9_AMR <- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=36451822, to=36460692, include.unknown = TRUE)
...
divsites9_AMR
D <- divsites9_AMR/1772
D

#Mutation rate
Clusters9_AMR <- neutrality.stats(Clusters9_AMR, FAST = TRUE)
Mu <- (Clusters9_AMR@theta_Watterson/1772)/(4*10000)
Mu
...
#Cluster_10
Clusters10_AMR <- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=39068783, to=39093690, include.unknown = TRUE)
...
divsites10_AMR
D <- divsites10_AMR/13776
D

#Mutation rate
Clusters10_AMR <- neutrality.stats(Clusters10_AMR, FAST = TRUE)
Mu <- (Clusters10_AMR@theta_Watterson/13776)/(4*10000)
Mu
...
#Cluster_11
Clusters11_AMR <- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=39094797, to=39108646, include.unknown = TRUE)
...
divsites11_AMR
D <- divsites11_AMR/13835
D

#Mutation rate
Clusters11_AMR <- neutrality.stats(Clusters11_AMR, FAST = TRUE)
Mu <- (Clusters11_AMR@theta_Watterson/13835)/(4*10000)
Mu
...
#Cluster_12
Clusters12_AMR <- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=40343104, to=40351746, include.unknown = TRUE)
...
divsites12_AMR
D <- divsites12_AMR/4120
D

#Mutation rate
Clusters12_AMR <- neutrality.stats(Clusters12_AMR, FAST = TRUE)
Mu <- (Clusters12_AMR@theta_Watterson/4120)/(4*10000)
Mu
...
#Cluster_13
Clusters13_AMR<- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=42689739, to=42699763, include.unknown = TRUE)
Clusters13_AMR <- set.outgroup(Clusters13_AMR,c("Chimp"), diploid=TRUE)
get.sum.data(Clusters13_AMR) 

#Divergence
bial <- get.biallelic.matrix(Clusters13_AMR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites13_AMR <- sum (div & !polym,na.rm=T)
divsites13_AMR
D <- divsites13_AMR/8973
D

#Mutation rate
Clusters13_AMR <- neutrality.stats(Clusters13_AMR, FAST = TRUE)
Mu <- (Clusters13_AMR@theta_Watterson/8973)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters13_AMR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters13_AMR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters13_AMR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 42689739:42699763))) # N polyallelic sites in that region
m <- 8973-sum(misshuman,na.rm=T)-polysites
...
#Cluster_14
Clusters14_AMR<- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=42842946, to=42858545, include.unknown = TRUE)
Clusters14_AMR <- set.outgroup(Clusters14_AMR, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters14_AMR) 

#Divergence
bial <- get.biallelic.matrix(Clusters14_AMR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites14_AMR <- sum (div & !polym,na.rm=T)
divsites14_AMR
D <- divsites14_AMR/4750
D

#Mutation rate
Clusters14_AMR <- neutrality.stats(Clusters14_AMR, FAST = TRUE)
Mu <- (Clusters14_AMR@theta_Watterson/4750)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters14_AMR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters14_AMR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters14_AMR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 42842946:42858545))) # N polyallelic sites in that region
m <- 4750-sum(misshuman,na.rm=T)-polysites
...
#Cluster_15
Clusters15_AMR <- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=107383411, to=107395081, include.unknown = TRUE)
Clusters15_AMR <- set.outgroup(Clusters15_AMR, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters15_AMR) 

#Divergence
bial <- get.biallelic.matrix(Clusters15_AMR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites15_AMR <- sum (div & !polym,na.rm=T)
divsites15_AMR
D <- divsites15_AMR/2975
D

#Mutation rate
Clusters15_AMR <- neutrality.stats(Clusters15_AMR, FAST = TRUE)
Mu <- (Clusters15_AMR@theta_Watterson/2975)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters15_AMR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters15_AMR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters15_AMR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 107383411:107395081))) # N polyallelic sites in that region
m <- 2975-sum(misshuman,na.rm=T)-polysites
...
#Cluster_16
Clusters16_AMR <- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=133133066, to=133141657, include.unknown = TRUE)
Clusters16_AMR <- set.outgroup(Clusters16_AMR,c("Chimp"), diploid=TRUE)
get.sum.data(Clusters16_AMR) 

#Divergence
bial <- get.biallelic.matrix(Clusters16_AMR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites16_AMR <- sum (div & !polym,na.rm=T)
divsites16_AMR
D <- divsites16_AMR/5468
D

#Mutation rate
Clusters16_AMR <- neutrality.stats(Clusters16_AMR, FAST = TRUE)
Mu <- (Clusters16_AMR@theta_Watterson/5468)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters16_AMR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters16_AMR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters16_AMR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 133133066:133141657))) # N polyallelic sites in that region
m <- 5468-sum(misshuman,na.rm=T)-polysites
...
#Cluster_17
Clusters17_AMR <- readVCF("new_chr6_2.vcf.gz", numcols=10000, tid="6", from=159049067, to=159058050, include.unknown = TRUE)
Clusters17_AMR <- set.outgroup(Clusters17_AMR, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters17_AMR) 

#Divergence
bial <- get.biallelic.matrix(Clusters17_AMR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites17_AMR <- sum (div & !polym,na.rm=T)
divsites17_AMR
D <- divsites17_AMR/1046
D

#Mutation rate
Clusters17_AMR <- neutrality.stats(Clusters17_AMR, FAST = TRUE)
Mu <- (Clusters17_AMR@theta_Watterson/1046)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters17_AMR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters17_AMR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters17_AMR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 159049067:159058050))) # N polyallelic sites in that region
m <- 1046-sum(misshuman,na.rm=T)-polysites
...
#EAS
Clusters.all_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=4185730, to=159058050, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(4185730:4194263), c(25723034:25734245), c(26103393:26113254), c(26153437:26161250), c(26212797:26220651), c(26231685:26239237), c(29493892:29505708), c(34245126:34257679), c(36451822:36460692), c(39068783:39093690), c(39094797:39108646), c(40343104:40351746), c(42689739:42699763), c(42842946:42858545), c(107383411:107395081), c(133133066:133141657), c(159049067:159058050)), type=2)
...
#Cluster_1
Clusters1_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=4185730, to=4194263, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/6187
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/6187)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=25723034, to=25734245, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/9794
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/9794)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=26103393, to=26113254, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/8710
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/8710)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=26153437, to=26161250, include.unknown = TRUE)
...
divsites4_EAS
D <- divsites4_EAS/4184
D

#Mutation rate
Clusters4_EAS <- neutrality.stats(Clusters4_EAS, FAST = TRUE)
Mu <- (Clusters4_EAS@theta_Watterson/4184)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS<- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=26212797, to=26220651, include.unknown = TRUE)
...
divsites5_EAS
D <- divsites5_EAS/6707
D

#Mutation rate
Clusters5_EAS <- neutrality.stats(Clusters5_EAS, FAST = TRUE)
Mu <- (Clusters5_EAS@theta_Watterson/6707)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EAS<- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=26231685, to=26239237, include.unknown = TRUE)
...
divsites6_EAS
D <- divsites6_EAS/6754
D

#Mutation rate
Clusters6_EAS <- neutrality.stats(Clusters6_EAS, FAST = TRUE)
Mu <- (Clusters6_EAS@theta_Watterson/6754)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=29493892, to=29505708, include.unknown = TRUE)
...
divsites7_EAS
D <- divsites7_EAS/7344
D

#Mutation rate
Clusters7_EAS <- neutrality.stats(Clusters7_EAS, FAST = TRUE)
Mu <- (Clusters7_EAS@theta_Watterson/7344)/(4*10000)
Mu
...
#Cluster_8
Clusters8_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=34245126, to=34257679, include.unknown = TRUE)
...
divsites8_EAS
D <- divsites8_EAS/2330
D

#Mutation rate
Clusters8_EAS <- neutrality.stats(Clusters8_EAS, FAST = TRUE)
Mu <- (Clusters8_EAS@theta_Watterson/2330)/(4*10000)
Mu
...
#Cluster_9
Clusters9_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=36451822, to=36460692, include.unknown = TRUE)
...
divsites9_EAS
D <- divsites9_EAS/1772
D

#Mutation rate
Clusters9_EAS<- neutrality.stats(Clusters9_EAS, FAST = TRUE)
Mu <- (Clusters9_EAS@theta_Watterson/1772)/(4*10000)
Mu
...
#Cluster_10
Clusters10_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=39068783, to=39093690, include.unknown = TRUE)
...
divsites10_EAS
D <- divsites10_EAS/13776
D

#Mutation rate
Clusters10_EAS <- neutrality.stats(Clusters10_EAS, FAST = TRUE)
Mu <- (Clusters10_EAS@theta_Watterson/13776)/(4*10000)
Mu
...
#Cluster_11
Clusters11_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=39094797, to=39108646, include.unknown = TRUE)
...
divsites11_EAS
D <- divsites11_EAS/13835
D

#Mutation rate
Clusters11_EAS <- neutrality.stats(Clusters11_EAS, FAST = TRUE)
Mu <- (Clusters11_EAS@theta_Watterson/13835)/(4*10000)
Mu
...
#Cluster_12
Clusters12_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=40343104, to=40351746, include.unknown = TRUE)
...
divsites12_EAS
D <- divsites12_EAS/4120
D

#Mutation rate
Clusters12_EAS <- neutrality.stats(Clusters12_EAS, FAST = TRUE)
Mu <- (Clusters12_EAS@theta_Watterson/4120)/(4*10000)
Mu
...
#Cluster_13
Clusters13_EAS<- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=42689739, to=42699763, include.unknown = TRUE)
Clusters13_EAS <- set.outgroup(Clusters13_EAS,c("Chimp"), diploid=TRUE)
get.sum.data(Clusters13_EAS) 

#Divergence
bial <- get.biallelic.matrix(Clusters13_EAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites13_EAS <- sum (div & !polym,na.rm=T)
divsites13_EAS
D <- divsites13_EAS/8973
D

#Mutation rate
Clusters13_EAS <- neutrality.stats(Clusters13_EAS, FAST = TRUE)
Mu <- (Clusters13_EAS@theta_Watterson/8973)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters13_EAS)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters13_EAS,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters13_EAS@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 42689739:42699763))) # N polyallelic sites in that region
m <- 8973-sum(misshuman,na.rm=T)-polysites
...
#Cluster_14
Clusters14_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=42842946, to=42858545, include.unknown = TRUE)
Clusters14_EAS <- set.outgroup(Clusters14_EAS, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters14_EAS) 

#Divergence
bial <- get.biallelic.matrix(Clusters14_EAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites14_EAS <- sum (div & !polym,na.rm=T)
divsites14_EAS
D <- divsites14_EAS/4750
D

#Mutation rate
Clusters14_EAS <- neutrality.stats(Clusters14_EAS, FAST = TRUE)
Mu <- (Clusters14_EAS@theta_Watterson/4750)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters14_EAS)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters14_EAS,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters14_EAS@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 42842946:42858545))) # N polyallelic sites in that region
m <- 4750-sum(misshuman,na.rm=T)-polysites
...
#Cluster_15
Clusters15_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=107383411, to=107395081, include.unknown = TRUE)
Clusters15_EAS <- set.outgroup(Clusters15_EAS, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters15_EAS) 

#Divergence
bial <- get.biallelic.matrix(Clusters15_EAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites15_EAS <- sum (div & !polym,na.rm=T)
divsites15_EAS
D <- divsites15_EAS/2975
D

#Mutation rate
Clusters15_EAS <- neutrality.stats(Clusters15_EAS, FAST = TRUE)
Mu <- (Clusters15_EAS@theta_Watterson/2975)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters15_EAS)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters15_EAS,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters15_EAS@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 107383411:107395081))) # N polyallelic sites in that region
m <- 2975-sum(misshuman,na.rm=T)-polysites
...
#Cluster_16
Clusters16_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=133133066, to=133141657, include.unknown = TRUE)
Clusters16_EAS <- set.outgroup(Clusters16_EAS,c("Chimp"), diploid=TRUE)
get.sum.data(Clusters16_EAS) 

#Divergence
bial <- get.biallelic.matrix(Clusters16_EAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites16_EAS <- sum (div & !polym,na.rm=T)
divsites16_EAS
D <- divsites16_EAS/5468
D

#Mutation rate
Clusters16_EAS <- neutrality.stats(Clusters16_EAS, FAST = TRUE)
Mu <- (Clusters16_EAS@theta_Watterson/5468)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters16_EAS)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters16_EAS,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters16_EAS@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 133133066:133141657))) # N polyallelic sites in that region
m <- 5468-sum(misshuman,na.rm=T)-polysites
...
#Cluster_17
Clusters17_EAS <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=159049067, to=159058050, include.unknown = TRUE)
Clusters17_EAS <- set.outgroup(Clusters17_EAS, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters17_EAS) 

#Divergence
bial <- get.biallelic.matrix(Clusters17_EAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites17_EAS <- sum (div & !polym,na.rm=T)
divsites17_EAS
D <- divsites17_EAS/1046
D

#Mutation rate
Clusters17_EAS <- neutrality.stats(Clusters17_EAS, FAST = TRUE)
Mu <- (Clusters17_EAS@theta_Watterson/1046)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters17_EAS)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters17_EAS,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters17_EAS@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 159049067:159058050))) # N polyallelic sites in that region
m <- 1046-sum(misshuman,na.rm=T)-polysites
...
#EUR
Clusters.all_EUR <- readVCF("new_chr6_3.vcf.gz", numcols=10000, tid="6", from=4185730, to=159058050, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(4185730:4194263), c(25723034:25734245), c(26103393:26113254), c(26153437:26161250), c(26212797:26220651), c(26231685:26239237), c(29493892:29505708), c(34245126:34257679), c(36451822:36460692), c(39068783:39093690), c(39094797:39108646), c(40343104:40351746), c(42689739:42699763), c(42842946:42858545), c(107383411:107395081), c(133133066:133141657), c(159049067:159058050)), type=2)
...
#Cluster_1
Clusters1_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=4185730, to=4194263, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/6187
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/6187)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=25723034, to=25734245, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/9794
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/9794)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=26103393, to=26113254, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/8710
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/8710)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=26153437, to=26161250, include.unknown = TRUE)
...
divsites4_EUR
D <- divsites4_EUR/4184
D

#Mutation rate
Clusters4_EUR <- neutrality.stats(Clusters4_EUR, FAST = TRUE)
Mu <- (Clusters4_EUR@theta_Watterson/4184)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR<- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=26212797, to=26220651, include.unknown = TRUE)
...
divsites5_EUR
D <- divsites5_EUR/6707
D

#Mutation rate
Clusters5_EUR <- neutrality.stats(Clusters5_EUR, FAST = TRUE)
Mu <- (Clusters5_EUR@theta_Watterson/6707)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EUR<- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=26231685, to=26239237, include.unknown = TRUE)
...
divsites6_EUR
D <- divsites6_EUR/6754
D

#Mutation rate
Clusters6_EUR <- neutrality.stats(Clusters6_EUR, FAST = TRUE)
Mu <- (Clusters6_EUR@theta_Watterson/6754)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=29493892, to=29505708, include.unknown = TRUE)
...
divsites7_EUR
D <- divsites7_EUR/7344
D

#Mutation rate
Clusters7_EUR <- neutrality.stats(Clusters7_EUR, FAST = TRUE)
Mu <- (Clusters7_EUR@theta_Watterson/7344)/(4*10000)
Mu
...
#Cluster_8
Clusters8_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=34245126, to=34257679, include.unknown = TRUE)
...
divsites8_EUR
D <- divsites8_EUR/2330
D

#Mutation rate
Clusters8_EUR <- neutrality.stats(Clusters8_EUR, FAST = TRUE)
Mu <- (Clusters8_EUR@theta_Watterson/2330)/(4*10000)
Mu
...
#Cluster_9
Clusters9_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=36451822, to=36460692, include.unknown = TRUE)
...
divsites9_EUR
D <- divsites9_EUR/1772
D

#Mutation rate
Clusters9_EUR<- neutrality.stats(Clusters9_EUR, FAST = TRUE)
Mu <- (Clusters9_EUR@theta_Watterson/1772)/(4*10000)
Mu
...
#Cluster_10
Clusters10_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=39068783, to=39093690, include.unknown = TRUE)
...
divsites10_EUR
D <- divsites10_EUR/13776
D

#Mutation rate
Clusters10_EUR <- neutrality.stats(Clusters10_EUR, FAST = TRUE)
Mu <- (Clusters10_EUR@theta_Watterson/13776)/(4*10000)
Mu
...
#Cluster_11
Clusters11_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=39094797, to=39108646, include.unknown = TRUE)
...
divsites11_EUR
D <- divsites11_EUR/13835
D

#Mutation rate
Clusters11_EUR <- neutrality.stats(Clusters11_EUR, FAST = TRUE)
Mu <- (Clusters11_EUR@theta_Watterson/13835)/(4*10000)
Mu
...
#Cluster_12
Clusters12_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=40343104, to=40351746, include.unknown = TRUE)
...
divsites12_EUR
D <- divsites12_EUR/4120
D

#Mutation rate
Clusters12_EUR <- neutrality.stats(Clusters12_EUR, FAST = TRUE)
Mu <- (Clusters12_EUR@theta_Watterson/4120)/(4*10000)
Mu
...
#Cluster_13
Clusters13_EUR<- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=42689739, to=42699763, include.unknown = TRUE)
Clusters13_EUR <- set.outgroup(Clusters13_EUR,c("Chimp"), diploid=TRUE)
get.sum.data(Clusters13_EUR) 

#Divergence
bial <- get.biallelic.matrix(Clusters13_EUR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites13_EUR <- sum (div & !polym,na.rm=T)
divsites13_EUR
D <- divsites13_EUR/8973
D

#Mutation rate
Clusters13_EUR <- neutrality.stats(Clusters13_EUR, FAST = TRUE)
Mu <- (Clusters13_EUR@theta_Watterson/8973)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters13_EUR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters13_EUR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters13_EUR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 42689739:42699763))) # N polyallelic sites in that region
m <- 8973-sum(misshuman,na.rm=T)-polysites
...
#Cluster_14
Clusters14_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=42842946, to=42858545, include.unknown = TRUE)
Clusters14_EUR <- set.outgroup(Clusters14_EUR, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters14_EUR) 

#Divergence
bial <- get.biallelic.matrix(Clusters14_EUR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites14_EUR <- sum (div & !polym,na.rm=T)
divsites14_EUR
D <- divsites14_EUR/4750
D

#Mutation rate
Clusters14_EUR <- neutrality.stats(Clusters14_EUR, FAST = TRUE)
Mu <- (Clusters14_EUR@theta_Watterson/4750)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters14_EUR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters14_EUR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters14_EUR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 42842946:42858545))) # N polyallelic sites in that region
m <- 4750-sum(misshuman,na.rm=T)-polysites
...
#Cluster_15
Clusters15_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=107383411, to=107395081, include.unknown = TRUE)
Clusters15_EUR <- set.outgroup(Clusters15_EUR, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters15_EUR) 

#Divergence
bial <- get.biallelic.matrix(Clusters15_EUR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites15_EUR <- sum (div & !polym,na.rm=T)
divsites15_EUR
D <- divsites15_EUR/2975
D

#Mutation rate
Clusters15_EUR <- neutrality.stats(Clusters15_EUR, FAST = TRUE)
Mu <- (Clusters15_EUR@theta_Watterson/2975)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters15_EUR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters15_EUR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters15_EUR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 107383411:107395081))) # N polyallelic sites in that region
m <- 2975-sum(misshuman,na.rm=T)-polysites
...
#Cluster_16
Clusters16_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=133133066, to=133141657, include.unknown = TRUE)
Clusters16_EUR <- set.outgroup(Clusters16_EUR,c("Chimp"), diploid=TRUE)
get.sum.data(Clusters16_EUR) 

#Divergence
bial <- get.biallelic.matrix(Clusters16_EUR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites16_EUR <- sum (div & !polym,na.rm=T)
divsites16_EUR
D <- divsites16_EUR/5468
D

#Mutation rate
Clusters16_EUR <- neutrality.stats(Clusters16_EUR, FAST = TRUE)
Mu <- (Clusters16_EUR@theta_Watterson/5468)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters16_EUR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters16_EUR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters16_EUR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 133133066:133141657))) # N polyallelic sites in that region
m <- 5468-sum(misshuman,na.rm=T)-polysites
...
#Cluster_17
Clusters17_EUR <- readVCF("new_chr6_4.vcf.gz", numcols=10000, tid="6", from=159049067, to=159058050, include.unknown = TRUE)
Clusters17_EUR <- set.outgroup(Clusters17_EUR, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters17_EUR) 

#Divergence
bial <- get.biallelic.matrix(Clusters17_EUR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites17_EUR <- sum (div & !polym,na.rm=T)
divsites17_EUR
D <- divsites17_EUR/1046
D

#Mutation rate
Clusters17_EUR <- neutrality.stats(Clusters17_EUR, FAST = TRUE)
Mu <- (Clusters17_EUR@theta_Watterson/1046)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters17_EUR)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters17_EUR,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters17_EUR@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 159049067:159058050))) # N polyallelic sites in that region
m <- 1046-sum(misshuman,na.rm=T)-polysites
...
#SAS
Clusters.all_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=4185730, to=159058050, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(4185730:4194263), c(25723034:25734245), c(26103393:26113254), c(26153437:26161250), c(26212797:26220651), c(26231685:26239237), c(29493892:29505708), c(34245126:34257679), c(36451822:36460692), c(39068783:39093690), c(39094797:39108646), c(40343104:40351746), c(42689739:42699763), c(42842946:42858545), c(107383411:107395081), c(133133066:133141657), c(159049067:159058050)), type=2)
...
#Cluster_1
Clusters1_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=4185730, to=4194263, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/6187
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/6187)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=25723034, to=25734245, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/9794
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/9794)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=26103393, to=26113254, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/8710
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/8710)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=26153437, to=26161250, include.unknown = TRUE)
...
divsites4_SAS
D <- divsites4_SAS/4184
D

#Mutation rate
Clusters4_SAS <- neutrality.stats(Clusters4_SAS, FAST = TRUE)
Mu <- (Clusters4_SAS@theta_Watterson/4184)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=26212797, to=26220651, include.unknown = TRUE)
...
divsites5_SAS
D <- divsites5_SAS/6707
D

#Mutation rate
Clusters5_SAS <- neutrality.stats(Clusters5_SAS, FAST = TRUE)
Mu <- (Clusters5_SAS@theta_Watterson/6707)/(4*10000)
Mu
...
#Cluster_6
Clusters6_SAS<- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=26231685, to=26239237, include.unknown = TRUE)
...
divsites6_SAS
D <- divsites6_SAS/6754
D

#Mutation rate
Clusters6_SAS <- neutrality.stats(Clusters6_SAS, FAST = TRUE)
Mu <- (Clusters6_SAS@theta_Watterson/6754)/(4*10000)
Mu
...
#Cluster_7
Clusters7_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=29493892, to=29505708, include.unknown = TRUE)
...
divsites7_SAS
D <- divsites7_SAS/7344
D

#Mutation rate
Clusters7_SAS <- neutrality.stats(Clusters7_SAS, FAST = TRUE)
Mu <- (Clusters7_SAS@theta_Watterson/7344)/(4*10000)
Mu
...
#Cluster_8
Clusters8_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=34245126, to=34257679, include.unknown = TRUE)
...
divsites8_SAS
D <- divsites8_SAS/2330
D

#Mutation rate
Clusters8_SAS <- neutrality.stats(Clusters8_SAS, FAST = TRUE)
Mu <- (Clusters8_SAS@theta_Watterson/2330)/(4*10000)
Mu
...
#Cluster_9
Clusters9_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=36451822, to=36460692, include.unknown = TRUE)
...
divsites9_SAS
D <- divsites9_SAS/1772
D

#Mutation rate
Clusters9_SAS<- neutrality.stats(Clusters9_SAS, FAST = TRUE)
Mu <- (Clusters9_SAS@theta_Watterson/1772)/(4*10000)
Mu
...
#Cluster_10
Clusters10_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=39068783, to=39093690, include.unknown = TRUE)
...
divsites10_SAS
D <- divsites10_SAS/13776
D

#Mutation rate
Clusters10_SAS <- neutrality.stats(Clusters10_SAS, FAST = TRUE)
Mu <- (Clusters10_SAS@theta_Watterson/13776)/(4*10000)
Mu
...
#Cluster_11
Clusters11_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=39094797, to=39108646, include.unknown = TRUE)
...
divsites11_SAS
D <- divsites11_SAS/13835
D

#Mutation rate
Clusters11_SAS <- neutrality.stats(Clusters11_SAS, FAST = TRUE)
Mu <- (Clusters11_SAS@theta_Watterson/13835)/(4*10000)
Mu
...
#Cluster_12
Clusters12_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=40343104, to=40351746, include.unknown = TRUE)
...
divsites12_SAS
D <- divsites12_SAS/4120
D

#Mutation rate
Clusters12_SAS <- neutrality.stats(Clusters12_SAS, FAST = TRUE)
Mu <- (Clusters12_SAS@theta_Watterson/4120)/(4*10000)
Mu
...
#Cluster_13
Clusters13_SAS<- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=42689739, to=42699763, include.unknown = TRUE)
Clusters13_SAS <- set.outgroup(Clusters13_SAS,c("Chimp"), diploid=TRUE)
get.sum.data(Clusters13_SAS) 

#Divergence
bial <- get.biallelic.matrix(Clusters13_SAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites13_SAS <- sum (div & !polym,na.rm=T)
divsites13_SAS
D <- divsites13_SAS/8973
D

#Mutation rate
Clusters13_SAS <- neutrality.stats(Clusters13_SAS, FAST = TRUE)
Mu <- (Clusters13_SAS@theta_Watterson/8973)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters13_SAS)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters13_SAS,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters13_SAS@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 42689739:42699763))) # N polyallelic sites in that region
m <- 8973-sum(misshuman,na.rm=T)-polysites
...
#Cluster_14
Clusters14_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=42842946, to=42858545, include.unknown = TRUE)
Clusters14_SAS <- set.outgroup(Clusters14_SAS, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters14_SAS) 

#Divergence
bial <- get.biallelic.matrix(Clusters14_SAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites14_SAS <- sum (div & !polym,na.rm=T)
divsites14_SAS
D <- divsites14_SAS/4750
D

#Mutation rate
Clusters14_SAS <- neutrality.stats(Clusters14_SAS, FAST = TRUE)
Mu <- (Clusters14_SAS@theta_Watterson/4750)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters14_SAS)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters14_SAS,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters14_SAS@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 42842946:42858545))) # N polyallelic sites in that region
m <- 4750-sum(misshuman,na.rm=T)-polysites
...
#Cluster_15
Clusters15_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=107383411, to=107395081, include.unknown = TRUE)
Clusters15_SAS <- set.outgroup(Clusters15_SAS, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters15_SAS) 

#Divergence
bial <- get.biallelic.matrix(Clusters15_SAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites15_SAS <- sum (div & !polym,na.rm=T)
divsites15_SAS
D <- divsites15_SAS/2975
D

#Mutation rate
Clusters15_SAS <- neutrality.stats(Clusters15_SAS, FAST = TRUE)
Mu <- (Clusters15_SAS@theta_Watterson/2975)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters15_SAS)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters15_SAS,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters15_SAS@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 107383411:107395081))) # N polyallelic sites in that region
m <- 2975-sum(misshuman,na.rm=T)-polysites
...
#Cluster_16
Clusters16_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=133133066, to=133141657, include.unknown = TRUE)
Clusters16_SAS <- set.outgroup(Clusters16_SAS,c("Chimp"), diploid=TRUE)
get.sum.data(Clusters16_SAS) 

#Divergence
bial <- get.biallelic.matrix(Clusters16_SAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites16_SAS <- sum (div & !polym,na.rm=T)
divsites16_SAS
D <- divsites16_SAS/5468
D

#Mutation rate
Clusters16_SAS <- neutrality.stats(Clusters16_SAS, FAST = TRUE)
Mu <- (Clusters16_SAS@theta_Watterson/5468)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters16_SAS)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters16_SAS,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters16_SAS@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 133133066:133141657))) # N polyallelic sites in that region
m <- 5468-sum(misshuman,na.rm=T)-polysites
...
#Cluster_17
Clusters17_SAS <- readVCF("new_chr6_5.vcf.gz", numcols=10000, tid="6", from=159049067, to=159058050, include.unknown = TRUE)
Clusters17_SAS <- set.outgroup(Clusters17_SAS, c("Chimp"), diploid=TRUE)
get.sum.data(Clusters17_EAS) 

#Divergence
bial <- get.biallelic.matrix(Clusters17_SAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites17_SAS <- sum (div & !polym,na.rm=T)
divsites17_SAS
D <- divsites17_SAS/1046
D

#Mutation rate
Clusters17_SAS <- neutrality.stats(Clusters17_SAS, FAST = TRUE)
Mu <- (Clusters17_SAS@theta_Watterson/1046)/(4*10000)
Mu

#Pi
individuals <- get.individuals(Clusters17_SAS)[[1]]
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Clusters17_SAS,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Clusters17_SAS@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 159049067:159058050))) # N polyallelic sites in that region
m <- 1046-sum(misshuman,na.rm=T)-polysites
...
Intergenic.all <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=4157619, to=159071046, include.unknown = TRUE)
...
polysites <- sum(!is.na(match(polyal, 4157619:159071046))) # N polyallelic sites in that region
m <- 214506-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=4157619, to=4185729, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/28110
D

#Region 2
Intergenic2 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=25723035, to=25726360, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/3325
D

#Region 3
Intergenic3 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=26098571, to=26103392, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/4821
D

#Region 4
Intergenic4 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=26139344, to=26153436, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/14092
D

#Region 5
Intergenic5 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=26206266, to=26212796, include.unknown = TRUE)
...
divsites_inter5
D <- divsites_inter5/6530
D

#Region 6
Intergenic6 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=26227701, to=26231684, include.unknown = TRUE)
...
divsites_inter6
D <- divsites_inter6/3983
D

#Region 7
Intergenic7 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=34231450, to=34245125, include.unknown = TRUE)
...
divsites_inter7
D <- divsites_inter7/13675
D

#Region 8 = region 7

#Region 9
Intergenic9 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=36515247, to=36562130, include.unknown = TRUE)
...
divsites_inter9
D <- divsites_inter9/46883
D

#Region 10
Intergenic10 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=39055519, to=39068782, include.unknown = TRUE)
...
divsites_inter10
D <- divsites_inter10/13263
D

#Region 11
Intergenic11 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=39082965, to=39094796, include.unknown = TRUE)
...
divsites_inter11
D <- divsites_inter11/14092
D

#Region 12
Intergenic12 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=41732198, to=41737914, include.unknown = TRUE)
...
divsites_inter12
D <- divsites_inter12/5710
D

#Region 13
Intergenic13 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=42699764, to=42712219, include.unknown = TRUE)
Intergenic13 <- set.outgroup(Intergenic13,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic13) 

#Divergence
bial <- get.biallelic.matrix(Intergenic13,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter13 <- sum (div & !polym,na.rm=T)
divsites_inter13
D <- divsites_inter13/12455
D

#Region 14
Intergenic14 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=42836298, to=42842945, include.unknown = TRUE)
Intergenic14 <- set.outgroup(Intergenic14,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic14) 

#Divergence
bial <- get.biallelic.matrix(Intergenic14,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter14 <- sum (div & !polym,na.rm=T)
divsites_inter14
D <- divsites_inter14/6647
D

#Region 15
Intergenic15 <- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=107372546, to=107383410, include.unknown = TRUE)
Intergenic15 <- set.outgroup(Intergenic15, c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic15) 

#Divergence
bial <- get.biallelic.matrix(Intergenic15,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter15 <- sum (div & !polym,na.rm=T)
divsites_inter15
D <- divsites_inter15/10864
D

#Region 16
Intergenic16<- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=133119692, to=133133065, include.unknown = TRUE)
Intergenic16 <- set.outgroup(Intergenic16,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic16) 

#Divergence
bial <- get.biallelic.matrix(Intergenic16,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter16 <- sum (div & !polym,na.rm=T)
divsites_inter16
D <- divsites_inter16/13373
D

#Region 17
Intergenic17<- readVCF("new_chr6_intergenic.vcf.gz", numcols=10000, tid="6", from=159065771, to=159071046, include.unknown = TRUE)
Intergenic17 <- set.outgroup(Intergenic17,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic17) 

#Divergence
bial <- get.biallelic.matrix(Intergenic17,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter17 <- sum (div & !polym,na.rm=T)
divsites_inter17
D <- divsites_inter17/5275
D
###################POPULATIONS####################################################
#AFR
Intergenic.all_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=4157619, to=159071046, include.unknown = TRUE)
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=4157619, to=4185729, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/28110
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=25723035, to=25726360, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/3325
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=26098571, to=26103392, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/4821
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=26139344, to=26153436, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/14092
D

#Region 5
Intergenic5_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=26206266, to=26212796, include.unknown = TRUE)
...
divsites_inter5_AFR
D <- divsites_inter5_AFR/6530
D

#Region 6
Intergenic6_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=26227701, to=26231684, include.unknown = TRUE)
...
divsites_inter6_AFR
D <- divsites_inter6_AFR/3983
D

#Region 7
Intergenic7_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=34231450, to=34245125, include.unknown = TRUE)
...
divsites_inter7_AFR
D <- divsites_inter7_AFR/13675
D

#Region 8 = region 7

#Region 9
Intergenic9_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=36515247, to=36562130, include.unknown = TRUE)
...
divsites_inter9_AFR
D <- divsites_inter9_AFR/46883
D

#Region 10
Intergenic10_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=39055519, to=39068782, include.unknown = TRUE)
...
D <- divsites_inter10_AFR/13263
D

#Region 11
Intergenic11_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=39082965, to=39094796, include.unknown = TRUE)
...
D <- divsites_inter11_AFR/14092
D

#Region 12
Intergenic12_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=41732198, to=41737914, include.unknown = TRUE)
...
D <- divsites_inter12_AFR/5710
D

#Region 13
Intergenic13_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=42699764, to=42712219, include.unknown = TRUE)
Intergenic13_AFR <- set.outgroup(Intergenic13_AFR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic13_AFR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic13_AFR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter13_AFR <- sum (div & !polym,na.rm=T)
divsites_inter13_AFR
D <- divsites_inter13_AFR/12455
D

#Region 14
Intergenic14_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=42836298, to=42842945, include.unknown = TRUE)
Intergenic14_AFR <- set.outgroup(Intergenic14_AFR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic14_AFR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic14_AFR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter14_AFR <- sum (div & !polym,na.rm=T)
divsites_inter14_AFR
D <- divsites_inter14_AFR/6647
D

#Region 15
Intergenic15_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=107372546, to=107383410, include.unknown = TRUE)
Intergenic15_AFR <- set.outgroup(Intergenic15_AFR, c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic15_AFR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic15_AFR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter15_AFR <- sum (div & !polym,na.rm=T)
divsites_inter15_AFR
D <- divsites_inter15_AFR/10864
D

#Region 16
Intergenic16_AFR <- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=133119692, to=133133065, include.unknown = TRUE)
Intergenic16_AFR <- set.outgroup(Intergenic16_AFR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic16_AFR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic16_AFR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter16_AFR <- sum (div & !polym,na.rm=T)
divsites_inter16_AFR
D <- divsites_inter16_AFR/13373
D

#Region 17
Intergenic17_AFR<- readVCF("new_chr6_1_intergenic.vcf.gz", numcols=10000, tid="6", from=159065771, to=159071046, include.unknown = TRUE)
Intergenic17_AFR <- set.outgroup(Intergenic17_AFR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic17_AFR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic17_AFR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter17_AFR <- sum (div & !polym,na.rm=T)
divsites_inter17_AFR
D <- divsites_inter17_AFR/5275
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=4157619, to=159071046, include.unknown = TRUE)
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=4157619, to=4185729, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/28110
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=25723035, to=25726360, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/3325
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=26098571, to=26103392, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/4821
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=26139344, to=26153436, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/14092
D

#Region 5
Intergenic5_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=26206266, to=26212796, include.unknown = TRUE)
...
divsites_inter5_AMR
D <- divsites_inter5_AMR/6530
D

#Region 6
Intergenic6_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=26227701, to=26231684, include.unknown = TRUE)
...
divsites_inter6_AMR
D <- divsites_inter6_AMR/3983
D

#Region 7
Intergenic7_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=34231450, to=34245125, include.unknown = TRUE)
...
divsites_inter7_AMR
D <- divsites_inter7_AMR/13675
D

#Region 8 = region 7

#Region 9
Intergenic9_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=36515247, to=36562130, include.unknown = TRUE)
...
divsites_inter9_AMR
D <- divsites_inter9_AMR/46883
D

#Region 10
Intergenic10_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=39055519, to=39068782, include.unknown = TRUE)
...
D <- divsites_inter10_AMR/13263
D

#Region 11
Intergenic11_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=39082965, to=39094796, include.unknown = TRUE)
...
D <- divsites_inter11_AMR/14092
D

#Region 12
Intergenic12_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=41732198, to=41737914, include.unknown = TRUE)
...
D <- divsites_inter12_AMR/5710
D

#Region 13
Intergenic13_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=42699764, to=42712219, include.unknown = TRUE)
Intergenic13_AMR <- set.outgroup(Intergenic13_AMR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic13_AMR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic13_AMR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter13_AMR <- sum (div & !polym,na.rm=T)
divsites_inter13_AMR
D <- divsites_inter13_AMR/12455
D

#Region 14
Intergenic14_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=42836298, to=42842945, include.unknown = TRUE)
Intergenic14_AMR <- set.outgroup(Intergenic14_AMR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic14_AMR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic14_AMR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter14_AMR <- sum (div & !polym,na.rm=T)
divsites_inter14_AMR
D <- divsites_inter14_AMR/6647
D

#Region 15
Intergenic15_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=107372546, to=107383410, include.unknown = TRUE)
Intergenic15_AMR <- set.outgroup(Intergenic15_AMR, c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic15_AMR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic15_AMR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter15_AMR <- sum (div & !polym,na.rm=T)
divsites_inter15_AMR
D <- divsites_inter15_AMR/10864
D

#Region 16
Intergenic16_AMR <- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=133119692, to=133133065, include.unknown = TRUE)
Intergenic16_AMR <- set.outgroup(Intergenic16_AMR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic16_AMR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic16_AMR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter16_AMR <- sum (div & !polym,na.rm=T)
divsites_inter16_AMR
D <- divsites_inter16_AMR/13373
D

#Region 17
Intergenic17_AMR<- readVCF("new_chr6_2_intergenic.vcf.gz", numcols=10000, tid="6", from=159065771, to=159071046, include.unknown = TRUE)
Intergenic17_AMR <- set.outgroup(Intergenic17_AMR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic17_AMR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic17_AMR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter17_AMR <- sum (div & !polym,na.rm=T)
divsites_inter17_AMR
D <- divsites_inter17_AMR/5275
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=4157619, to=159071046, include.unknown = TRUE)
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=4157619, to=4185729, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/28110
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=25723035, to=25726360, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/3325
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=26098571, to=26103392, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/4821
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=26139344, to=26153436, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/14092
D

#Region 5
Intergenic5_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=26206266, to=26212796, include.unknown = TRUE)
...
divsites_inter5_EAS
D <- divsites_inter5_EAS/6530
D

#Region 6
Intergenic6_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=26227701, to=26231684, include.unknown = TRUE)
...
divsites_inter6_EAS
D <- divsites_inter6_EAS/3983
D

#Region 7
Intergenic7_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=34231450, to=34245125, include.unknown = TRUE)
...
divsites_inter7_EAS
D <- divsites_inter7_EAS/13675
D

#Region 8 = region 7

#Region 9
Intergenic9_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=36515247, to=36562130, include.unknown = TRUE)
...
divsites_inter9_EAS
D <- divsites_inter9_EAS/46883
D

#Region 10
Intergenic10_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=39055519, to=39068782, include.unknown = TRUE)
...
D <- divsites_inter10_EAS/13263
D

#Region 11
Intergenic11_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=39082965, to=39094796, include.unknown = TRUE)
...
D <- divsites_inter11_EAS/14092
D

#Region 12
Intergenic12_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=41732198, to=41737914, include.unknown = TRUE)
...
D <- divsites_inter12_EAS/5710
D

#Region 13
Intergenic13_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=42699764, to=42712219, include.unknown = TRUE)
Intergenic13_EAS <- set.outgroup(Intergenic13_EAS,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic13_EAS) 

#Divergence
bial <- get.biallelic.matrix(Intergenic13_EAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter13_EAS <- sum (div & !polym,na.rm=T)
divsites_inter13_EAS
D <- divsites_inter13_EAS/12455
D

#Region 14
Intergenic14_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=42836298, to=42842945, include.unknown = TRUE)
Intergenic14_EAS <- set.outgroup(Intergenic14_EAS,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic14_EAS) 

#Divergence
bial <- get.biallelic.matrix(Intergenic14_EAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter14_EAS <- sum (div & !polym,na.rm=T)
divsites_inter14_EAS
D <- divsites_inter14_EAS/6647
D

#Region 15
Intergenic15_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=107372546, to=107383410, include.unknown = TRUE)
Intergenic15_EAS <- set.outgroup(Intergenic15_EAS, c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic15_EAS) 

#Divergence
bial <- get.biallelic.matrix(Intergenic15_EAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter15_EAS <- sum (div & !polym,na.rm=T)
divsites_inter15_EAS
D <- divsites_inter15_EAS/10864
D

#Region 16
Intergenic16_EAS <- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=133119692, to=133133065, include.unknown = TRUE)
Intergenic16_EAS <- set.outgroup(Intergenic16_EAS,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic16_EAS) 

#Divergence
bial <- get.biallelic.matrix(Intergenic16_EAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter16_EAS <- sum (div & !polym,na.rm=T)
divsites_inter16_EAS
D <- divsites_inter16_EAS/13373
D

#Region 17
Intergenic17_EAS<- readVCF("new_chr6_3_intergenic.vcf.gz", numcols=10000, tid="6", from=159065771, to=159071046, include.unknown = TRUE)
Intergenic17_EAS <- set.outgroup(Intergenic17_EAS,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic17_EAS) 

#Divergence
bial <- get.biallelic.matrix(Intergenic17_EAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter17_EAS <- sum (div & !polym,na.rm=T)
divsites_inter17_EAS
D <- divsites_inter17_EAS/5275
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=4157619, to=159071046, include.unknown = TRUE)
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=4157619, to=4185729, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/28110
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=25723035, to=25726360, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/3325
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=26098571, to=26103392, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/4821
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=26139344, to=26153436, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/14092
D

#Region 5
Intergenic5_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=26206266, to=26212796, include.unknown = TRUE)
...
divsites_inter5_EUR
D <- divsites_inter5_EUR/6530
D

#Region 6
Intergenic6_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=26227701, to=26231684, include.unknown = TRUE)
...
divsites_inter6_EUR
D <- divsites_inter6_EUR/3983
D

#Region 7
Intergenic7_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=34231450, to=34245125, include.unknown = TRUE)
...
divsites_inter7_EUR
D <- divsites_inter7_EUR/13675
D

#Region 8 = region 7

#Region 9
Intergenic9_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=36515247, to=36562130, include.unknown = TRUE)
...
divsites_inter9_EUR
D <- divsites_inter9_EUR/46883
D

#Region 10
Intergenic10_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=39055519, to=39068782, include.unknown = TRUE)
...
D <- divsites_inter10_EUR/13263
D

#Region 11
Intergenic11_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=39082965, to=39094796, include.unknown = TRUE)
...
D <- divsites_inter11_EUR/14092
D

#Region 12
Intergenic12_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=41732198, to=41737914, include.unknown = TRUE)
...
D <- divsites_inter12_EUR/5710
D

#Region 13
Intergenic13_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=42699764, to=42712219, include.unknown = TRUE)
Intergenic13_EUR <- set.outgroup(Intergenic13_EUR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic13_EUR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic13_EUR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter13_EUR <- sum (div & !polym,na.rm=T)
divsites_inter13_EUR
D <- divsites_inter13_EUR/12455
D

#Region 14
Intergenic14_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=42836298, to=42842945, include.unknown = TRUE)
Intergenic14_EUR <- set.outgroup(Intergenic14_EUR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic14_EUR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic14_EUR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter14_EUR <- sum (div & !polym,na.rm=T)
divsites_inter14_EUR
D <- divsites_inter14_EUR/6647
D

#Region 15
Intergenic15_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=107372546, to=107383410, include.unknown = TRUE)
Intergenic15_EUR <- set.outgroup(Intergenic15_EUR, c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic15_EUR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic15_EUR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter15_EUR <- sum (div & !polym,na.rm=T)
divsites_inter15_EUR
D <- divsites_inter15_EUR/10864
D

#Region 16
Intergenic16_EUR <- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=133119692, to=133133065, include.unknown = TRUE)
Intergenic16_EUR <- set.outgroup(Intergenic16_EUR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic16_EUR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic16_EUR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter16_EUR <- sum (div & !polym,na.rm=T)
divsites_inter16_EUR
D <- divsites_inter16_EUR/13373
D

#Region 17
Intergenic17_EUR<- readVCF("new_chr6_4_intergenic.vcf.gz", numcols=10000, tid="6", from=159065771, to=159071046, include.unknown = TRUE)
Intergenic17_EUR <- set.outgroup(Intergenic17_EUR,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic17_EUR) 

#Divergence
bial <- get.biallelic.matrix(Intergenic17_EUR,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter17_EUR <- sum (div & !polym,na.rm=T)
divsites_inter17_EUR
D <- divsites_inter17_EUR/5275
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=4157619, to=159071046, include.unknown = TRUE)
...
Pi(k,m,n)
#Region 1
Intergenic1_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=4157619, to=4185729, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/28110
D
#Region 2
Intergenic2_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=25723035, to=25726360, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/3325
D
#Region 3
Intergenic3_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=26098571, to=26103392, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/4821
D
#Region 4
Intergenic4_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=26139344, to=26153436, include.unknown = TRUE)
...
divsites_inter4_SAS
D <- divsites_inter4_SAS/14092
D
#Region 5
Intergenic5_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=26206266, to=26212796, include.unknown = TRUE)
...
divsites_inter5_SAS
D <- divsites_inter5_SAS/6530
D
#Region 6
Intergenic6_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=26227701, to=26231684, include.unknown = TRUE)
...
divsites_inter6_SAS
D <- divsites_inter6_SAS/3983
D
#Region 7
Intergenic7_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=34231450, to=34245125, include.unknown = TRUE)
...
divsites_inter7_SAS
D <- divsites_inter7_SAS/13675
D
#Region 8 = region 7
#Region 9
Intergenic9_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=36515247, to=36562130, include.unknown = TRUE)
...
divsites_inter9_SAS
D <- divsites_inter9_SAS/46883
D
#Region 10
Intergenic10_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=39055519, to=39068782, include.unknown = TRUE)
...
D <- divsites_inter10_SAS/13263
D
#Region 11
Intergenic11_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=39082965, to=39094796, include.unknown = TRUE)
...
D <- divsites_inter11_SAS/14092
D
#Region 12
Intergenic12_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=41732198, to=41737914, include.unknown = TRUE)
...
D <- divsites_inter12_SAS/5710
D
#Region 13
Intergenic13_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=42699764, to=42712219, include.unknown = TRUE)
Intergenic13_SAS <- set.outgroup(Intergenic13_SAS,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic13_SAS)
#Divergence
bial <- get.biallelic.matrix(Intergenic13_SAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter13_SAS <- sum (div & !polym,na.rm=T)
divsites_inter13_SAS
D <- divsites_inter13_SAS/12455
D
#Region 14
Intergenic14_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=42836298, to=42842945, include.unknown = TRUE)
Intergenic14_SAS <- set.outgroup(Intergenic14_SAS,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic14_SAS)
#Divergence
bial <- get.biallelic.matrix(Intergenic14_SAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter14_SAS <- sum (div & !polym,na.rm=T)
divsites_inter14_SAS
D <- divsites_inter14_SAS/6647
D
#Region 15
Intergenic15_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=107372546, to=107383410, include.unknown = TRUE)
Intergenic15_SAS <- set.outgroup(Intergenic15_SAS, c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic15_SAS)
#Divergence
bial <- get.biallelic.matrix(Intergenic15_SAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter15_SAS <- sum (div & !polym,na.rm=T)
divsites_inter15_SAS
D <- divsites_inter15_SAS/10864
D
#Region 16
Intergenic16_SAS <- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=133119692, to=133133065, include.unknown = TRUE)
Intergenic16_SAS <- set.outgroup(Intergenic16_SAS,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic16_SAS)
#Divergence
bial <- get.biallelic.matrix(Intergenic16_SAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter16_SAS <- sum (div & !polym,na.rm=T)
divsites_inter16_SAS
D <- divsites_inter16_SAS/13373
D
#Region 17
Intergenic17_SAS<- readVCF("new_chr6_5_intergenic.vcf.gz", numcols=10000, tid="6", from=159065771, to=159071046, include.unknown = TRUE)
Intergenic17_SAS <- set.outgroup(Intergenic17_SAS,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic17_SAS)
#Divergence
bial <- get.biallelic.matrix(Intergenic17_SAS,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter17_SAS <- sum (div & !polym,na.rm=T)
divsites_inter17_SAS
D <- divsites_inter17_SAS/5275
D
...
MKT_8=rbind(c(Intergenic7@n.biallelic.sites, divsites_inter7), c(Clusters_8@n.biallelic.sites, divsites8))
MKT_8
...
MKT_13=rbind(c(Intergenic13@n.biallelic.sites, divsites_inter6), c(Clusters_13@n.biallelic.sites, divsites13))
MKT_13
chisq.test(MKT_13, simulate.p.value=TRUE)

MKT_14=rbind(c(Intergenic14@n.biallelic.sites, divsites_inter14), c(Clusters_14@n.biallelic.sites, divsites14))
MKT_14
chisq.test(MKT_14, simulate.p.value=TRUE)

MKT_15=rbind(c(Intergenic15@n.biallelic.sites, divsites_inter15), c(Clusters_15@n.biallelic.sites, divsites15))
MKT_15
chisq.test(MKT_15, simulate.p.value=TRUE)

MKT_16=rbind(c(Intergenic16@n.biallelic.sites, divsites_inter16), c(Clusters_16@n.biallelic.sites, divsites16))
MKT_16
chisq.test(MKT_16, simulate.p.value=TRUE)

MKT_17=rbind(c(Intergenic17@n.biallelic.sites, divsites_inter16), c(Clusters_17@n.biallelic.sites, divsites17))
MKT_17
chisq.test(MKT_17, simulate.p.value=TRUE)
...
MKT_AFR_8=rbind(c(Intergenic7_AFR@n.biallelic.sites, divsites_inter7_AFR), c(Clusters8_AFR@n.biallelic.sites, divsites8_AFR))
MKT_AFR_8
...
MKT_AFR_13=rbind(c(Intergenic13_AFR@n.biallelic.sites, divsites_inter13_AFR), c(Clusters13_AFR@n.biallelic.sites, divsites13_AFR))
MKT_AFR_13
chisq.test(MKT_AFR_13, simulate.p.value=TRUE)

MKT_AFR_14=rbind(c(Intergenic14_AFR@n.biallelic.sites, divsites_inter14_AFR), c(Clusters14_AFR@n.biallelic.sites, divsites14_AFR))
MKT_AFR_14
chisq.test(MKT_AFR_14, simulate.p.value=TRUE)

MKT_AFR_15=rbind(c(Intergenic15_AFR@n.biallelic.sites, divsites_inter15_AFR), c(Clusters15_AFR@n.biallelic.sites, divsites15_AFR))
MKT_AFR_15
chisq.test(MKT_AFR_15, simulate.p.value=TRUE)

MKT_AFR_16=rbind(c(Intergenic16_AFR@n.biallelic.sites, divsites_inter16_AFR), c(Clusters16_AFR@n.biallelic.sites, divsites16_AFR))
MKT_AFR_16
chisq.test(MKT_AFR_16, simulate.p.value=TRUE)

MKT_AFR_17=rbind(c(Intergenic17_AFR@n.biallelic.sites, divsites_inter17_AFR), c(Clusters17_AFR@n.biallelic.sites, divsites17_AFR))
MKT_AFR_17
chisq.test(MKT_AFR_17, simulate.p.value=TRUE)
...
MKT_AMR_8=rbind(c(Intergenic7_AMR@n.biallelic.sites, divsites_inter7_AMR), c(Clusters8_AMR@n.biallelic.sites, divsites8_AMR))
MKT_AMR_8
...
MKT_AMR_13=rbind(c(Intergenic13_AMR@n.biallelic.sites, divsites_inter13_AMR), c(Clusters13_AMR@n.biallelic.sites, divsites13_AMR))
MKT_AMR_13
chisq.test(MKT_AMR_13, simulate.p.value=TRUE)

MKT_AMR_14=rbind(c(Intergenic14_AMR@n.biallelic.sites, divsites_inter14_AMR), c(Clusters14_AMR@n.biallelic.sites, divsites14_AMR))
MKT_AMR_14
chisq.test(MKT_AMR_14, simulate.p.value=TRUE)

MKT_AMR_15=rbind(c(Intergenic15_AMR@n.biallelic.sites, divsites_inter15_AMR), c(Clusters15_AMR@n.biallelic.sites, divsites15_AMR))
MKT_AMR_15
chisq.test(MKT_AMR_15, simulate.p.value=TRUE)

MKT_AMR_16=rbind(c(Intergenic16_AMR@n.biallelic.sites, divsites_inter16_AMR), c(Clusters16_AMR@n.biallelic.sites, divsites16_AMR))
MKT_AMR_16
chisq.test(MKT_AMR_16, simulate.p.value=TRUE)

MKT_AMR_17=rbind(c(Intergenic17_AMR@n.biallelic.sites, divsites_inter17_AMR), c(Clusters17_AMR@n.biallelic.sites, divsites17_AMR))
MKT_AMR_17
chisq.test(MKT_AMR_17, simulate.p.value=TRUE)
...
MKT_EAS_8=rbind(c(Intergenic7_EAS@n.biallelic.sites, divsites_inter7_EAS), c(Clusters8_EAS@n.biallelic.sites, divsites8_EAS))
MKT_EAS_8
...
MKT_EAS_13=rbind(c(Intergenic13_EAS@n.biallelic.sites, divsites_inter13_EAS), c(Clusters13_EAS@n.biallelic.sites, divsites13_EAS))
MKT_EAS_13
chisq.test(MKT_EAS_13, simulate.p.value=TRUE)

MKT_EAS_14=rbind(c(Intergenic14_EAS@n.biallelic.sites, divsites_inter14_EAS), c(Clusters14_EAS@n.biallelic.sites, divsites14_EAS))
MKT_EAS_14
chisq.test(MKT_EAS_14, simulate.p.value=TRUE)

MKT_EAS_15=rbind(c(Intergenic15_EAS@n.biallelic.sites, divsites_inter15_EAS), c(Clusters15_EAS@n.biallelic.sites, divsites15_EAS))
MKT_EAS_15
chisq.test(MKT_EAS_15, simulate.p.value=TRUE)

MKT_EAS_16=rbind(c(Intergenic16_EAS@n.biallelic.sites, divsites_inter16_EAS), c(Clusters16_EAS@n.biallelic.sites, divsites16_EAS))
MKT_EAS_16
chisq.test(MKT_EAS_16, simulate.p.value=TRUE)

MKT_EAS_17=rbind(c(Intergenic17_EAS@n.biallelic.sites, divsites_inter17_EAS), c(Clusters17_EAS@n.biallelic.sites, divsites17_EAS))
MKT_EAS_17
chisq.test(MKT_EAS_17, simulate.p.value=TRUE)
...
MKT_EUR_8=rbind(c(Intergenic7_EUR@n.biallelic.sites, divsites_inter7_EUR), c(Clusters8_EUR@n.biallelic.sites, divsites8_EUR))
MKT_EUR_8
...
MKT_EUR_13=rbind(c(Intergenic13_EUR@n.biallelic.sites, divsites_inter13_EUR), c(Clusters13_EUR@n.biallelic.sites, divsites13_EUR))
MKT_EUR_13
chisq.test(MKT_EUR_13, simulate.p.value=TRUE)

MKT_EUR_14=rbind(c(Intergenic14_EUR@n.biallelic.sites, divsites_inter14_EUR), c(Clusters14_EUR@n.biallelic.sites, divsites14_EUR))
MKT_EUR_14
chisq.test(MKT_EUR_14, simulate.p.value=TRUE)

MKT_EUR_15=rbind(c(Intergenic15_EUR@n.biallelic.sites, divsites_inter15_EUR), c(Clusters15_EUR@n.biallelic.sites, divsites15_EUR))
MKT_EUR_15
chisq.test(MKT_EUR_15, simulate.p.value=TRUE)

MKT_EUR_16=rbind(c(Intergenic16_EUR@n.biallelic.sites, divsites_inter16_EUR), c(Clusters16_EUR@n.biallelic.sites, divsites16_EUR))
MKT_EUR_16
chisq.test(MKT_EUR_16, simulate.p.value=TRUE)

MKT_EUR_17=rbind(c(Intergenic17_EUR@n.biallelic.sites, divsites_inter17_EUR), c(Clusters17_EUR@n.biallelic.sites, divsites17_EUR))
MKT_EUR_17
chisq.test(MKT_EUR_17, simulate.p.value=TRUE)
...
MKT_SAS_8=rbind(c(Intergenic7_SAS@n.biallelic.sites, divsites_inter7_SAS), c(Clusters8_SAS@n.biallelic.sites, divsites8_SAS))
MKT_SAS_8
...
MKT_SAS_13=rbind(c(Intergenic13_SAS@n.biallelic.sites, divsites_inter13_SAS), c(Clusters13_SAS@n.biallelic.sites, divsites13_SAS))
MKT_SAS_13
chisq.test(MKT_SAS_13, simulate.p.value=TRUE)

MKT_SAS_14=rbind(c(Intergenic14_SAS@n.biallelic.sites, divsites_inter14_SAS), c(Clusters14_SAS@n.biallelic.sites, divsites14_SAS))
MKT_SAS_14
chisq.test(MKT_SAS_14, simulate.p.value=TRUE)

MKT_SAS_15=rbind(c(Intergenic15_SAS@n.biallelic.sites, divsites_inter15_SAS), c(Clusters15_SAS@n.biallelic.sites, divsites15_SAS))
MKT_SAS_15
chisq.test(MKT_SAS_15, simulate.p.value=TRUE)

MKT_SAS_16=rbind(c(Intergenic16_SAS@n.biallelic.sites, divsites_inter16_SAS), c(Clusters16_SAS@n.biallelic.sites, divsites16_SAS))
MKT_SAS_16
chisq.test(MKT_SAS_16, simulate.p.value=TRUE)

MKT_SAS_17=rbind(c(Intergenic17_SAS@n.biallelic.sites, divsites_inter17_SAS), c(Clusters17_SAS@n.biallelic.sites, divsites17_SAS))
MKT_SAS_17
chisq.test(MKT_SAS_17, simulate.p.value=TRUE)
