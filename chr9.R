...
Clusters.all <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=26620003, to=136901094, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/156031)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 26620003:136901094))) # N polyallelic sites in that region
m <- 156031 -sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(26620003:26644650), c(33572015:33582959), c(37435083:37445725), c(38539024:38572019), c(44017295:44031054), c(67290040:67306943), c(69446439:69483196), c(82495927:82518848), c(82522045:82532928), c(84523917:84548943), c(84587919:84596471), c(90528916:90548943), c(90732964:90753918), c(93340401:93351022), c(125869371:125883279), c(135562094:135572057), c(136888679:136901094)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=26620003, to=26644650, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/22749)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 26620003:26644650))) # N polyallelic sites in that region
m <- 22749-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=33572015, to=33582959, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/5946)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 33572015:33582959))) # N polyallelic sites in that region
m <- 5946-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=37435083, to=37445725, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/1123)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 37435083:37445725))) # N polyallelic sites in that region
m <- 1123-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=44017295, to=44031054, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/12695)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 44017295:44031054))) # N polyallelic sites in that region
m <- 12695-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=67290040, to=67306943, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/8311)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 67290040:67306943))) # N polyallelic sites in that region
m <- 8311-sum(misshuman,na.rm=T)-polysites
...
#Cluster_6
Clusters_6 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=69446439, to=69483196, include.unknown = TRUE)
...
Mu <- (Clusters_6@theta_Watterson/34511)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 69446439:69483196))) # N polyallelic sites in that region
m <- 34511-sum(misshuman,na.rm=T)-polysites
...
#Cluster_7
Clusters_7 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=82495927, to=82518848, include.unknown = TRUE)
...
Mu <- (Clusters_7@theta_Watterson/14249)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 82495927:82518848))) # N polyallelic sites in that region
m <- 14249-sum(misshuman,na.rm=T)-polysites
...
#Cluster_8
Clusters_8 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=82522045, to=82532928, include.unknown = TRUE)
...
Mu <- (Clusters_8@theta_Watterson/8416)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 82522045:82532928))) # N polyallelic sites in that region
m <- 8416-sum(misshuman,na.rm=T)-polysites
...
#Cluster_9
Clusters_9 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=84523917, to=84548943, include.unknown = TRUE)
...
Mu <- (Clusters_9@theta_Watterson/12530)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 84523917:84548943))) # N polyallelic sites in that region
m <- 12530-sum(misshuman,na.rm=T)-polysites
...
#Cluster_10
Clusters_10 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=84587919, to=84596471, include.unknown = TRUE)
...
Mu <- (Clusters_10@theta_Watterson/525)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 84587919:84596471))) # N polyallelic sites in that region
m <- 525-sum(misshuman,na.rm=T)-polysites
...
#Cluster_11
Clusters_11 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=90528916, to=90548943, include.unknown = TRUE)
...
Mu <- (Clusters_11@theta_Watterson/11015)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 90528916:90548943))) # N polyallelic sites in that region
m <- 11015-sum(misshuman,na.rm=T)-polysites
...
#Cluster_12
Clusters_12 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=90732964, to=90753918, include.unknown = TRUE)
...
Mu <- (Clusters_12@theta_Watterson/11966)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 90732964:90753918))) # N polyallelic sites in that region
m <- 11966-sum(misshuman,na.rm=T)-polysites
...
#Cluster_13
Clusters_13 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=93340401, to=93351022, include.unknown = TRUE)
...
Mu <- (Clusters_13@theta_Watterson/5996)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 93340401:93351022))) # N polyallelic sites in that region
m <- 5996-sum(misshuman,na.rm=T)-polysites
...
#Cluster_14
Clusters_14 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=125869371, to=125883279, include.unknown = TRUE)
...
Mu <- (Clusters_14@theta_Watterson/2402)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 125869371:125883279))) # N polyallelic sites in that region
...
#Cluster_15
Clusters_15 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=135562094, to=135572057, include.unknown = TRUE)
...
Mu <- (Clusters_15@theta_Watterson/1715)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 135562094:135572057))) # N polyallelic sites in that region
m <- 1715-sum(misshuman,na.rm=T)-polysites
...
#Cluster_16
Clusters_16 <- readVCF("new_chr9.vcf.gz", numcols=10000, tid="9", from=136888679, to=136901094, include.unknown = TRUE)
...
Mu <- (Clusters_16@theta_Watterson/1882)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 136888679:1369010947))) # N polyallelic sites in that region
m <- 1882-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=26620003, to=136901094, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(26620003:26644650), c(33572015:33582959), c(37435083:37445725), c(38539024:38572019), c(44017295:44031054), c(67290040:67306943), c(69446439:69483196), c(82495927:82518848), c(82522045:82532928), c(84523917:84548943), c(84587919:84596471), c(90528916:90548943), c(90732964:90753918), c(93340401:93351022), c(125869371:125883279), c(135562094:135572057), c(136888679:136901094)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=26620003, to=26644650, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/22749
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/22749)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=33572015, to=33582959, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/5946
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/5946)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=37435083, to=37445725, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/1123
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/1123)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=44017295, to=44031054, include.unknown = TRUE)
...
divsites4_AFR
D <- divsites4_AFR/12695
D

#Mutation rate
Clusters4_AFR <- neutrality.stats(Clusters4_AFR, FAST = TRUE)
Mu <- (Clusters4_AFR@theta_Watterson/12695)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=67290040, to=67306943, include.unknown = TRUE)
...
divsites5_AFR
D <- divsites5_AFR/8311
D

#Mutation rate
Clusters5_AFR <- neutrality.stats(Clusters5_AFR, FAST = TRUE)
Mu <- (Clusters5_AFR@theta_Watterson/8311)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AFR<- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=69446439, to=69483196, include.unknown = TRUE)
...
divsites6_AFR
D <- divsites6_AFR/34511
D

#Mutation rate
Clusters6_AFR <- neutrality.stats(Clusters6_AFR, FAST = TRUE)
Mu <- (Clusters6_AFR@theta_Watterson/34511)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AFR <- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=82495927, to=82518848, include.unknown = TRUE)
...
divsites7_AFR
D <- divsites7_AFR/14249
D

#Mutation rate
Clusters7_AFR <- neutrality.stats(Clusters7_AFR, FAST = TRUE)
Mu <- (Clusters7_AFR@theta_Watterson/14249)/(4*10000)
Mu
...
#Cluster_8
Clusters8_AFR <- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=82522045, to=82532928, include.unknown = TRUE)
...
#Cluster_9
Clusters9_AFR <- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=84523917, to=84548943, include.unknown = TRUE)
...
#Cluster_10
Clusters10_AFR <- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=84587919, to=84596471, include.unknown = TRUE)
...
divsites10_AFR
D <- divsites10_AFR/525
D

#Mutation rate
Clusters10_AFR <- neutrality.stats(Clusters10_AFR, FAST = TRUE)
Mu <- (Clusters10_AFR@theta_Watterson/525)/(4*10000)
Mu
...
#Cluster_11
Clusters11_AFR <- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=90528916, to=90548943, include.unknown = TRUE)
...
divsites11_AFR
D <- divsites11_AFR/11015
D

#Mutation rate
Clusters11_AFR <- neutrality.stats(Clusters11_AFR, FAST = TRUE)
Mu <- (Clusters11_AFR@theta_Watterson/11015)/(4*10000)
Mu
...
#Cluster_12
Clusters12_AFR <- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=90732964, to=90753918, include.unknown = TRUE)
...
divsites12_AFR
D <- divsites12_AFR/11966
D

#Mutation rate
Clusters12_AFR <- neutrality.stats(Clusters12_AFR, FAST = TRUE)
Mu <- (Clusters12_AFR@theta_Watterson/11966)/(4*10000)
Mu
...
#Cluster_13
Clusters13_AFR<- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=93340401, to=93351022, include.unknown = TRUE)
...
divsites13_AFR
D <- divsites13_AFR/5996
D

#Mutation rate
Clusters13_AFR <- neutrality.stats(Clusters13_AFR, FAST = TRUE)
Mu <- (Clusters13_AFR@theta_Watterson/5996)/(4*10000)
Mu
...
#Cluster_14
Clusters14_AFR<- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=125869371, to=125883279, include.unknown = TRUE)
...
divsites14_AFR
D <- divsites14_AFR/2402
D

#Mutation rate
Clusters14_AFR <- neutrality.stats(Clusters14_AFR, FAST = TRUE)
Mu <- (Clusters14_AFR@theta_Watterson/2402)/(4*10000)
Mu
...
#Cluster_15
Clusters15_AFR <- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=135562094, to=135572057, include.unknown = TRUE)
...
divsites15_AFR
D <- divsites15_AFR/1715
D

#Mutation rate
Clusters15_AFR <- neutrality.stats(Clusters15_AFR, FAST = TRUE)
Mu <- (Clusters15_AFR@theta_Watterson/1715)/(4*10000)
Mu
...
#Cluster_16
Clusters16_AFR <- readVCF("new_chr9_1.vcf.gz", numcols=10000, tid="9", from=136888679, to=136901094, include.unknown = TRUE)
...
divsites16_AFR
D <- divsites16_AFR/1882
D

#Mutation rate
Clusters16_AFR <- neutrality.stats(Clusters16_AFR, FAST = TRUE)
Mu <- (Clusters16_AFR@theta_Watterson/1882)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 136888679:136901094))) # N polyallelic sites in that region
m <- 1882-sum(misshuman,na.rm=T)-polysites
...
#AMR
Clusters.all_AMR <- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=26620003, to=136901094, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(26620003:26644650), c(33572015:33582959), c(37435083:37445725), c(38539024:38572019), c(44017295:44031054), c(67290040:67306943), c(69446439:69483196), c(82495927:82518848), c(82522045:82532928), c(84523917:84548943), c(84587919:84596471), c(90528916:90548943), c(90732964:90753918), c(93340401:93351022), c(125869371:125883279), c(135562094:135572057), c(136888679:136901094)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=26620003, to=26644650, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/22749
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/22749)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=33572015, to=33582959, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/5946
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/5946)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=37435083, to=37445725, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/1123
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/1123)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=44017295, to=44031054, include.unknown = TRUE)
...
divsites4_AMR
D <- divsites4_AMR/12695
D

#Mutation rate
Clusters4_AMR <- neutrality.stats(Clusters4_AMR, FAST = TRUE)
Mu <- (Clusters4_AMR@theta_Watterson/12695)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=67290040, to=67306943, include.unknown = TRUE)
...
divsites5_AMR
D <- divsites5_AMR/8311
D

#Mutation rate
Clusters5_AMR <- neutrality.stats(Clusters5_AMR, FAST = TRUE)
Mu <- (Clusters5_AMR@theta_Watterson/8311)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AMR<- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=69446439, to=69483196, include.unknown = TRUE)
...
divsites6_AMR
D <- divsites6_AMR/34511
D

#Mutation rate
Clusters6_AMR <- neutrality.stats(Clusters6_AMR, FAST = TRUE)
Mu <- (Clusters6_AMR@theta_Watterson/34511)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AMR <- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=82495927, to=82518848, include.unknown = TRUE)
...
divsites7_AMR
D <- divsites7_AMR/14249
D

#Mutation rate
Clusters7_AMR <- neutrality.stats(Clusters7_AMR, FAST = TRUE)
Mu <- (Clusters7_AMR@theta_Watterson/14249)/(4*10000)
Mu
...
#Cluster_8
Clusters8_AMR <- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=82522045, to=82532928, include.unknown = TRUE)
...
#Cluster_9
Clusters9_AMR <- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=84523917, to=84548943, include.unknown = TRUE)
...
#Cluster_10
Clusters10_AMR <- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=84587919, to=84596471, include.unknown = TRUE)
...
divsites10_AMR
D <- divsites10_AMR/525
D

#Mutation rate
Clusters10_AMR <- neutrality.stats(Clusters10_AMR, FAST = TRUE)
Mu <- (Clusters10_AMR@theta_Watterson/525)/(4*10000)
Mu
...
#Cluster_11
Clusters11_AMR <- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=90528916, to=90548943, include.unknown = TRUE)
...
divsites11_AMR
D <- divsites11_AMR/11015
D

#Mutation rate
Clusters11_AMR <- neutrality.stats(Clusters11_AMR, FAST = TRUE)
Mu <- (Clusters11_AMR@theta_Watterson/11015)/(4*10000)
Mu
...
#Cluster_12
Clusters12_AMR <- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=90732964, to=90753918, include.unknown = TRUE)
...
divsites12_AMR
D <- divsites12_AMR/11966
D

#Mutation rate
Clusters12_AMR <- neutrality.stats(Clusters12_AMR, FAST = TRUE)
Mu <- (Clusters12_AMR@theta_Watterson/11966)/(4*10000)
Mu
...
#Cluster_13
Clusters13_AMR<- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=93340401, to=93351022, include.unknown = TRUE)
...
divsites13_AMR
D <- divsites13_AMR/5996
D

#Mutation rate
Clusters13_AMR <- neutrality.stats(Clusters13_AMR, FAST = TRUE)
Mu <- (Clusters13_AMR@theta_Watterson/5996)/(4*10000)
Mu
...
#Cluster_14
Clusters14_AMR<- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=125869371, to=125883279, include.unknown = TRUE)
...
divsites14_AMR
D <- divsites14_AMR/2402
D

#Mutation rate
Clusters14_AMR <- neutrality.stats(Clusters14_AMR, FAST = TRUE)
Mu <- (Clusters14_AMR@theta_Watterson/2402)/(4*10000)
Mu
...
#Cluster_15
Clusters15_AMR <- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=135562094, to=135572057, include.unknown = TRUE)
...
divsites15_AMR
D <- divsites15_AMR/1715
D

#Mutation rate
Clusters15_AMR <- neutrality.stats(Clusters15_AMR, FAST = TRUE)
Mu <- (Clusters15_AMR@theta_Watterson/1715)/(4*10000)
Mu
...
#Cluster_16
Clusters16_AMR <- readVCF("new_chr9_2.vcf.gz", numcols=10000, tid="9", from=136888679, to=136901094, include.unknown = TRUE)
...
divsites16_AMR
D <- divsites16_AMR/1882
D

#Mutation rate
Clusters16_AMR <- neutrality.stats(Clusters16_AMR, FAST = TRUE)
Mu <- (Clusters16_AMR@theta_Watterson/1882)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=26620003, to=136901094, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(26620003:26644650), c(33572015:33582959), c(37435083:37445725), c(38539024:38572019), c(44017295:44031054), c(67290040:67306943), c(69446439:69483196), c(82495927:82518848), c(82522045:82532928), c(84523917:84548943), c(84587919:84596471), c(90528916:90548943), c(90732964:90753918), c(93340401:93351022), c(125869371:125883279), c(135562094:135572057), c(136888679:136901094)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=26620003, to=26644650, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/22749
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/22749)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=33572015, to=33582959, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/5946
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/5946)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=37435083, to=37445725, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/1123
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/1123)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=44017295, to=44031054, include.unknown = TRUE)
...
divsites4_EAS
D <- divsites4_EAS/12695
D

#Mutation rate
Clusters4_EAS <- neutrality.stats(Clusters4_EAS, FAST = TRUE)
Mu <- (Clusters4_EAS@theta_Watterson/12695)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS<- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=67290040, to=67306943, include.unknown = TRUE)
...
divsites5_EAS
D <- divsites5_EAS/8311
D

#Mutation rate
Clusters5_EAS <- neutrality.stats(Clusters5_EAS, FAST = TRUE)
Mu <- (Clusters5_EAS@theta_Watterson/8311)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EAS<- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=69446439, to=69483196, include.unknown = TRUE)
...
divsites6_EAS
D <- divsites6_EAS/34511
D

#Mutation rate
Clusters6_EAS <- neutrality.stats(Clusters6_EAS, FAST = TRUE)
Mu <- (Clusters6_EAS@theta_Watterson/34511)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EAS <- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=82495927, to=82518848, include.unknown = TRUE)
...
divsites7_EAS
D <- divsites7_EAS/14249
D

#Mutation rate
Clusters7_EAS <- neutrality.stats(Clusters7_EAS, FAST = TRUE)
Mu <- (Clusters7_EAS@theta_Watterson/14249)/(4*10000)
Mu
...
#Cluster_8
Clusters8_EAS <- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=82522045, to=82532928, include.unknown = TRUE)
...
#Cluster_9
Clusters9_EAS <- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=84523917, to=84548943, include.unknown = TRUE)
...
#Cluster_10
Clusters10_EAS <- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=84587919, to=84596471, include.unknown = TRUE)
...
divsites10_EAS
D <- divsites10_EAS/525
D

#Mutation rate
Clusters10_EAS <- neutrality.stats(Clusters10_EAS, FAST = TRUE)
Mu <- (Clusters10_EAS@theta_Watterson/525)/(4*10000)
Mu
...
#Cluster_11
Clusters11_EAS <- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=90528916, to=90548943, include.unknown = TRUE)
...
divsites11_EAS
D <- divsites11_EAS/11015
D

#Mutation rate
Clusters11_EAS <- neutrality.stats(Clusters11_EAS, FAST = TRUE)
Mu <- (Clusters11_EAS@theta_Watterson/11015)/(4*10000)
Mu
...
#Cluster_12
Clusters12_EAS <- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=90732964, to=90753918, include.unknown = TRUE)
...
divsites12_EAS
D <- divsites12_EAS/11966
D

#Mutation rate
Clusters12_EAS <- neutrality.stats(Clusters12_EAS, FAST = TRUE)
Mu <- (Clusters12_EAS@theta_Watterson/11966)/(4*10000)
Mu
...
#Cluster_13
Clusters13_EAS<- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=93340401, to=93351022, include.unknown = TRUE)
...
divsites13_EAS
D <- divsites13_EAS/5996
D

#Mutation rate
Clusters13_EAS <- neutrality.stats(Clusters13_EAS, FAST = TRUE)
Mu <- (Clusters13_EAS@theta_Watterson/5996)/(4*10000)
Mu
...
#Cluster_14
Clusters14_EAS<- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=125869371, to=125883279, include.unknown = TRUE)
...
divsites14_EAS
D <- divsites14_EAS/2402
D

#Mutation rate
Clusters14_EAS <- neutrality.stats(Clusters14_EAS, FAST = TRUE)
Mu <- (Clusters14_EAS@theta_Watterson/2402)/(4*10000)
Mu
...
#Cluster_15
Clusters15_EAS <- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=135562094, to=135572057, include.unknown = TRUE)
...
divsites15_EAS
D <- divsites15_EAS/1715
D

#Mutation rate
Clusters15_EAS <- neutrality.stats(Clusters15_EAS, FAST = TRUE)
Mu <- (Clusters15_EAS@theta_Watterson/1715)/(4*10000)
Mu
...
#Cluster_16
Clusters16_EAS <- readVCF("new_chr9_3.vcf.gz", numcols=10000, tid="9", from=136888679, to=136901094, include.unknown = TRUE)
...
divsites16_EAS
D <- divsites16_EAS/1882
D

#Mutation rate
Clusters16_EAS <- neutrality.stats(Clusters16_EAS, FAST = TRUE)
Mu <- (Clusters16_EAS@theta_Watterson/1882)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=26620003, to=136901094, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(26620003:26644650), c(33572015:33582959), c(37435083:37445725), c(38539024:38572019), c(44017295:44031054), c(67290040:67306943), c(69446439:69483196), c(82495927:82518848), c(82522045:82532928), c(84523917:84548943), c(84587919:84596471), c(90528916:90548943), c(90732964:90753918), c(93340401:93351022), c(125869371:125883279), c(135562094:135572057), c(136888679:136901094)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=26620003, to=26644650, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/22749
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/22749)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=33572015, to=33582959, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/5946
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/5946)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=37435083, to=37445725, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/1123
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/1123)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=44017295, to=44031054, include.unknown = TRUE)
...
divsites4_EUR
D <- divsites4_EUR/12695
D

#Mutation rate
Clusters4_EUR <- neutrality.stats(Clusters4_EUR, FAST = TRUE)
Mu <- (Clusters4_EUR@theta_Watterson/12695)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR<- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=67290040, to=67306943, include.unknown = TRUE)
...
divsites5_EUR
D <- divsites5_EUR/8311
D

#Mutation rate
Clusters5_EUR <- neutrality.stats(Clusters5_EUR, FAST = TRUE)
Mu <- (Clusters5_EUR@theta_Watterson/8311)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EUR<- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=69446439, to=69483196, include.unknown = TRUE)
...
divsites6_EUR
D <- divsites6_EUR/34511
D

#Mutation rate
Clusters6_EUR <- neutrality.stats(Clusters6_EUR, FAST = TRUE)
Mu <- (Clusters6_EUR@theta_Watterson/34511)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EUR <- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=82495927, to=82518848, include.unknown = TRUE)
...
divsites7_EUR
D <- divsites7_EUR/14249
D

#Mutation rate
Clusters7_EUR <- neutrality.stats(Clusters7_EUR, FAST = TRUE)
Mu <- (Clusters7_EUR@theta_Watterson/14249)/(4*10000)
Mu
...
#Cluster_8
Clusters8_EUR <- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=82522045, to=82532928, include.unknown = TRUE)
...
#Cluster_9
Clusters9_EUR <- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=84523917, to=84548943, include.unknown = TRUE)
...
#Cluster_10
Clusters10_EUR <- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=84587919, to=84596471, include.unknown = TRUE)
...
divsites10_EUR
D <- divsites10_EUR/525
D

#Mutation rate
Clusters10_EUR <- neutrality.stats(Clusters10_EUR, FAST = TRUE)
Mu <- (Clusters10_EUR@theta_Watterson/525)/(4*10000)
Mu
...
#Cluster_11
Clusters11_EUR <- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=90528916, to=90548943, include.unknown = TRUE)
...
divsites11_EUR
D <- divsites11_EUR/11015
D

#Mutation rate
Clusters11_EUR <- neutrality.stats(Clusters11_EUR, FAST = TRUE)
Mu <- (Clusters11_EUR@theta_Watterson/11015)/(4*10000)
Mu
...
#Cluster_12
Clusters12_EUR <- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=90732964, to=90753918, include.unknown = TRUE)
...
divsites12_EUR
D <- divsites12_EUR/11966
D

#Mutation rate
Clusters12_EUR <- neutrality.stats(Clusters12_EUR, FAST = TRUE)
Mu <- (Clusters12_EUR@theta_Watterson/11966)/(4*10000)
Mu
...
#Cluster_13
Clusters13_EUR<- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=93340401, to=93351022, include.unknown = TRUE)
...
divsites13_EUR
D <- divsites13_EUR/5996
D

#Mutation rate
Clusters13_EUR <- neutrality.stats(Clusters13_EUR, FAST = TRUE)
Mu <- (Clusters13_EUR@theta_Watterson/5996)/(4*10000)
Mu
...
#Cluster_14
Clusters14_EUR<- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=125869371, to=125883279, include.unknown = TRUE)
...
divsites14_EUR
D <- divsites14_EUR/2402
D

#Mutation rate
Clusters14_EUR <- neutrality.stats(Clusters14_EUR, FAST = TRUE)
Mu <- (Clusters14_EUR@theta_Watterson/2402)/(4*10000)
Mu
...
#Cluster_15
Clusters15_EUR <- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=135562094, to=135572057, include.unknown = TRUE)
...
divsites15_EUR
D <- divsites15_EUR/1715
D

#Mutation rate
Clusters15_EUR <- neutrality.stats(Clusters15_EUR, FAST = TRUE)
Mu <- (Clusters15_EUR@theta_Watterson/1715)/(4*10000)
Mu
...
#Cluster_16
Clusters16_EUR <- readVCF("new_chr9_4.vcf.gz", numcols=10000, tid="9", from=136888679, to=136901094, include.unknown = TRUE)
...
divsites16_EUR
D <- divsites16_EUR/1882
D

#Mutation rate
Clusters16_EUR <- neutrality.stats(Clusters16_EUR, FAST = TRUE)
Mu <- (Clusters16_EUR@theta_Watterson/1882)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=26620003, to=136901094, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(26620003:26644650), c(33572015:33582959), c(37435083:37445725), c(38539024:38572019), c(44017295:44031054), c(67290040:67306943), c(69446439:69483196), c(82495927:82518848), c(82522045:82532928), c(84523917:84548943), c(84587919:84596471), c(90528916:90548943), c(90732964:90753918), c(93340401:93351022), c(125869371:125883279), c(135562094:135572057), c(136888679:136901094)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=26620003, to=26644650, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/22749
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/22749)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=33572015, to=33582959, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/5946
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/5946)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=37435083, to=37445725, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/1123
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/1123)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=44017295, to=44031054, include.unknown = TRUE)
...
divsites4_SAS
D <- divsites4_SAS/12695
D

#Mutation rate
Clusters4_SAS <- neutrality.stats(Clusters4_SAS, FAST = TRUE)
Mu <- (Clusters4_SAS@theta_Watterson/12695)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS<- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=67290040, to=67306943, include.unknown = TRUE)
...
divsites5_SAS
D <- divsites5_SAS/8311
D

#Mutation rate
Clusters5_SAS <- neutrality.stats(Clusters5_SAS, FAST = TRUE)
Mu <- (Clusters5_SAS@theta_Watterson/8311)/(4*10000)
Mu
...
#Cluster_6
Clusters6_SAS<- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=69446439, to=69483196, include.unknown = TRUE)
...
divsites6_SAS
D <- divsites6_SAS/34511
D

#Mutation rate
Clusters6_SAS <- neutrality.stats(Clusters6_SAS, FAST = TRUE)
Mu <- (Clusters6_SAS@theta_Watterson/34511)/(4*10000)
Mu
...
#Cluster_7
Clusters7_SAS <- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=82495927, to=82518848, include.unknown = TRUE)
...
divsites7_SAS
D <- divsites7_SAS/14249
D

#Mutation rate
Clusters7_SAS <- neutrality.stats(Clusters7_SAS, FAST = TRUE)
Mu <- (Clusters7_SAS@theta_Watterson/14249)/(4*10000)
Mu
...
#Cluster_8
Clusters8_SAS <- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=82522045, to=82532928, include.unknown = TRUE)
...
#Cluster_9
Clusters9_SAS <- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=84523917, to=84548943, include.unknown = TRUE)
...
#Cluster_10
Clusters10_SAS <- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=84587919, to=84596471, include.unknown = TRUE)
...
divsites10_SAS
D <- divsites10_SAS/525
D

#Mutation rate
Clusters10_SAS <- neutrality.stats(Clusters10_SAS, FAST = TRUE)
Mu <- (Clusters10_SAS@theta_Watterson/525)/(4*10000)
Mu
...
#Cluster_11
Clusters11_SAS <- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=90528916, to=90548943, include.unknown = TRUE)
...
divsites11_SAS
D <- divsites11_SAS/11015
D

#Mutation rate
Clusters11_SAS <- neutrality.stats(Clusters11_SAS, FAST = TRUE)
Mu <- (Clusters11_SAS@theta_Watterson/11015)/(4*10000)
Mu
...
#Cluster_12
Clusters12_SAS <- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=90732964, to=90753918, include.unknown = TRUE)
...
divsites12_SAS
D <- divsites12_SAS/11966
D

#Mutation rate
Clusters12_SAS <- neutrality.stats(Clusters12_SAS, FAST = TRUE)
Mu <- (Clusters12_SAS@theta_Watterson/11966)/(4*10000)
Mu
...
#Cluster_13
Clusters13_SAS<- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=93340401, to=93351022, include.unknown = TRUE)
...
divsites13_SAS
D <- divsites13_SAS/5996
D

#Mutation rate
Clusters13_SAS <- neutrality.stats(Clusters13_SAS, FAST = TRUE)
Mu <- (Clusters13_SAS@theta_Watterson/5996)/(4*10000)
Mu
...
#Cluster_14
Clusters14_SAS<- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=125869371, to=125883279, include.unknown = TRUE)
...
divsites14_SAS
D <- divsites14_SAS/2402
D

#Mutation rate
Clusters14_SAS <- neutrality.stats(Clusters14_SAS, FAST = TRUE)
Mu <- (Clusters14_SAS@theta_Watterson/2402)/(4*10000)
Mu
...
#Cluster_15
Clusters15_SAS <- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=135562094, to=135572057, include.unknown = TRUE)
...
divsites15_SAS
D <- divsites15_SAS/1715
D

#Mutation rate
Clusters15_SAS <- neutrality.stats(Clusters15_SAS, FAST = TRUE)
Mu <- (Clusters15_SAS@theta_Watterson/1715)/(4*10000)
Mu
...
#Cluster_16
Clusters16_SAS <- readVCF("new_chr9_5.vcf.gz", numcols=10000, tid="9", from=136888679, to=136901094, include.unknown = TRUE)
...
divsites16_SAS
D <- divsites16_SAS/1882
D

#Mutation rate
Clusters16_SAS <- neutrality.stats(Clusters16_SAS, FAST = TRUE)
Mu <- (Clusters16_SAS@theta_Watterson/1882)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=26614123, to=135600965, include.unknown = TRUE)
...
polysites <- sum(!is.na(match(polyal, 26614123:135600965))) # N polyallelic sites in that region
m <- 274441-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=26614123, to=26620002, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/5879
D

#Region 2
Intergenic2 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=33573007, to=33574359, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/1351
D

#Region 3
Intergenic3 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=37384431, to=37422663, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/38232
D

#Region 4
Intergenic4 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=42474239, to=42477991, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/3752
D

#Region 5
Intergenic5 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=44011839, to=44017295, include.unknown = TRUE)
...
divsites_inter5
D <- divsites_inter5/5456
D

#Region 6
Intergenic6 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=67306943, to=67327775, include.unknown = TRUE)
...
divsites_inter6
D <- divsites_inter6/20832
D

#Region 7
Intergenic7 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=82506922, to=82522044, include.unknown = TRUE)
...
divsites_inter7
D <- divsites_inter7/15122
D

#Region 8
Intergenic8 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=82518848, to=82528184, include.unknown = TRUE)
...
divsites_inter8
D <- divsites_inter8/9336
D

#Region 9
Intergenic9 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=84503900, to=84523916, include.unknown = TRUE)
...
divsites_inter9
D <- divsites_inter9/20016
D

#Region 10
Intergenic10 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=84534841, to=84542936, include.unknown = TRUE)
...
divsites_inter10
D <- divsites_inter10/8095
D

#Region 11
Intergenic11 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=90503814, to=90528915, include.unknown = TRUE)
...
divsites_inter11
D <- divsites_inter11/25101
D

#Region 12
Intergenic12 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=90682952, to=90732963, include.unknown = TRUE)
...
divsites_inter12
D <- divsites_inter12/50011
D

#Region 13
Intergenic13 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=93351023, to=93372114, include.unknown = TRUE)
...
divsites_inter13
D <- divsites_inter13/21091
D

#Region 14
Intergenic14 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=125867145, to=125869370, include.unknown = TRUE)
...
divsites_inter14
D <- divsites_inter14/2225
D

#Region 15
Intergenic15 <- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=135572057, to=135600965, include.unknown = TRUE)
...
divsites_inter15
D <- divsites_inter15/16998
D

#Region 16
Intergenic16<- readVCF("new_chr9_intergenic.vcf.gz", numcols=10000, tid="9", from=136857726, to=136888678, include.unknown = TRUE)
...
divsites_inter16
D <- divsites_inter16/30944
D

###################POPULATIONS####################################################
#AFR
Intergenic.all_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=26614123, to=136888678, include.unknown = TRUE)
...
polysites <- sum(!is.na(match(polyal, 26614123:136888678))) # N polyallelic sites in that region
m <- 274441-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=26614123, to=26620002, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/5879
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=33573007, to=33574359, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/1351
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=37384431, to=37422663, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/38232
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=42474239, to=42477991, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/3752
D

#Region 5
Intergenic5_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=44011839, to=44017295, include.unknown = TRUE)
...
divsites_inter5_AFR
D <- divsites_inter5_AFR/5456
D

#Region 6
Intergenic6_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=67306943, to=67327775, include.unknown = TRUE)
...
divsites_inter6_AFR
D <- divsites_inter6_AFR/20832
D

#Region 7
Intergenic7_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=82506922, to=82522044, include.unknown = TRUE)
...
divsites_inter7_AFR
D <- divsites_inter7_AFR/15122
D

#Region 8 
Intergenic8_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=82518848, to=82528184, include.unknown = TRUE)
...
divsites_inter8_AFR
D <- divsites_inter8_AFR/9336
D

#Region 9
Intergenic9_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=84503900, to=84523916, include.unknown = TRUE)
...
divsites_inter9_AFR
D <- divsites_inter9_AFR/20016
D

#Region 10
Intergenic10_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=84534841, to=84542936, include.unknown = TRUE)
...
D <- divsites_inter10_AFR/8095
D

#Region 11
Intergenic11_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=90503814, to=90528915, include.unknown = TRUE)
...
D <- divsites_inter11_AFR/25101
D

#Region 12
Intergenic12_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=9068295, to=90732963, include.unknown = TRUE)
...
D <- divsites_inter12_AFR/50011
D

#Region 13
Intergenic13_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=93351023, to=93372114, include.unknown = TRUE)
...
D <- divsites_inter13_AFR/21091
D

#Region 14
Intergenic14_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=125867145, to=125869370, include.unknown = TRUE)
...
D <- divsites_inter14_AFR/2225
D

#Region 15
Intergenic15_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=135572057, to=135600965, include.unknown = TRUE)
...
D <- divsites_inter15_AFR/16998
D

#Region 16
Intergenic16_AFR <- readVCF("new_chr9_1_intergenic.vcf.gz", numcols=10000, tid="9", from=136857726, to=136888678, include.unknown = TRUE)
...
D <- divsites_inter16_AFR/30944
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=26614123, to=136888678, include.unknown = TRUE)
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=26614123, to=26620002, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/5879
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=33573007, to=33574359, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/1351
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=37384431, to=37422663, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/38232
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=42474239, to=42477991, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/3752
D

#Region 5
Intergenic5_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=44011839, to=44017295, include.unknown = TRUE)
...
divsites_inter5_AMR
D <- divsites_inter5_AMR/5456
D

#Region 6
Intergenic6_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=67306943, to=67327775, include.unknown = TRUE)
...
divsites_inter6_AMR
D <- divsites_inter6_AMR/20832
D

#Region 7
Intergenic7_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=82506922, to=82522044, include.unknown = TRUE)
...
divsites_inter7_AMR
D <- divsites_inter7_AMR/15122
D

#Region 8 
Intergenic8_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=82518848, to=82528184, include.unknown = TRUE)
...
divsites_inter8_AMR
D <- divsites_inter8_AMR/9336
D

#Region 9
Intergenic9_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=84503900, to=84523916, include.unknown = TRUE)
...
divsites_inter9_AMR
D <- divsites_inter9_AMR/20016
D

#Region 10
Intergenic10_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=84534841, to=84542936, include.unknown = TRUE)
...
D <- divsites_inter10_AMR/8095
D

#Region 11
Intergenic11_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=90503814, to=90528915, include.unknown = TRUE)
...
D <- divsites_inter11_AMR/25101
D

#Region 12
Intergenic12_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=9068295, to=90732963, include.unknown = TRUE)
...
D <- divsites_inter12_AMR/50011
D

#Region 13
Intergenic13_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=93351023, to=93372114, include.unknown = TRUE)
...
D <- divsites_inter13_AMR/21091
D

#Region 14
Intergenic14_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=125867145, to=125869370, include.unknown = TRUE)
...
D <- divsites_inter14_AMR/2225
D

#Region 15
Intergenic15_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=135572057, to=135600965, include.unknown = TRUE)
...
D <- divsites_inter15_AMR/16998
D

#Region 16
Intergenic16_AMR <- readVCF("new_chr9_2_intergenic.vcf.gz", numcols=10000, tid="9", from=136857726, to=136888678, include.unknown = TRUE)
...
D <- divsites_inter16_AMR/30944
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=26614123, to=136888678, include.unknown = TRUE)
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=26614123, to=26620002, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/5879
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=33573007, to=33574359, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/1351
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=37384431, to=37422663, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/38232
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=42474239, to=42477991, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/3752
D

#Region 5
Intergenic5_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=44011839, to=44017295, include.unknown = TRUE)
...
divsites_inter5_EAS
D <- divsites_inter5_EAS/5456
D

#Region 6
Intergenic6_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=67306943, to=67327775, include.unknown = TRUE)
...
divsites_inter6_EAS
D <- divsites_inter6_EAS/20832
D

#Region 7
Intergenic7_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=82506922, to=82522044, include.unknown = TRUE)
...
divsites_inter7_EAS
D <- divsites_inter7_EAS/15122
D

#Region 8 
Intergenic8_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=82518848, to=82528184, include.unknown = TRUE)
...
divsites_inter8_EAS
D <- divsites_inter8_EAS/9336
D

#Region 9
Intergenic9_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=84503900, to=84523916, include.unknown = TRUE)
...
divsites_inter9_EAS
D <- divsites_inter9_EAS/20016
D

#Region 10
Intergenic10_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=84534841, to=84542936, include.unknown = TRUE)
...
D <- divsites_inter10_EAS/8095
D

#Region 11
Intergenic11_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=90503814, to=90528915, include.unknown = TRUE)
...
D <- divsites_inter11_EAS/25101
D

#Region 12
Intergenic12_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=9068295, to=90732963, include.unknown = TRUE)
...
D <- divsites_inter12_EAS/50011
D

#Region 13
Intergenic13_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=93351023, to=93372114, include.unknown = TRUE)
...
D <- divsites_inter13_EAS/21091
D

#Region 14
Intergenic14_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=125867145, to=125869370, include.unknown = TRUE)
...
D <- divsites_inter14_EAS/2225
D

#Region 15
Intergenic15_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=135572057, to=135600965, include.unknown = TRUE)
...
D <- divsites_inter15_EAS/16998
D

#Region 16
Intergenic16_EAS <- readVCF("new_chr9_3_intergenic.vcf.gz", numcols=10000, tid="9", from=136857726, to=136888678, include.unknown = TRUE)
...
D <- divsites_inter16_EAS/30944
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=26614123, to=136888678, include.unknown = TRUE)
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=26614123, to=26620002, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/5879
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=33573007, to=33574359, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/1351
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=37384431, to=37422663, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/38232
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=42474239, to=42477991, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/3752
D

#Region 5
Intergenic5_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=44011839, to=44017295, include.unknown = TRUE)
...
divsites_inter5_EUR
D <- divsites_inter5_EUR/5456
D

#Region 6
Intergenic6_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=67306943, to=67327775, include.unknown = TRUE)
...
divsites_inter6_EUR
D <- divsites_inter6_EUR/20832
D

#Region 7
Intergenic7_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=82506922, to=82522044, include.unknown = TRUE)
...
divsites_inter7_EUR
D <- divsites_inter7_EUR/15122
D

#Region 8 
Intergenic8_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=82518848, to=82528184, include.unknown = TRUE)
...
divsites_inter8_EUR
D <- divsites_inter8_EUR/9336
D

#Region 9
Intergenic9_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=84503900, to=84523916, include.unknown = TRUE)
...
divsites_inter9_EUR
D <- divsites_inter9_EUR/20016
D

#Region 10
Intergenic10_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=84534841, to=84542936, include.unknown = TRUE)
...
D <- divsites_inter10_EUR/8095
D

#Region 11
Intergenic11_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=90503814, to=90528915, include.unknown = TRUE)
...
D <- divsites_inter11_EUR/25101
D

#Region 12
Intergenic12_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=9068295, to=90732963, include.unknown = TRUE)
...
D <- divsites_inter12_EUR/50011
D

#Region 13
Intergenic13_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=93351023, to=93372114, include.unknown = TRUE)
...
D <- divsites_inter13_EUR/21091
D

#Region 14
Intergenic14_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=125867145, to=125869370, include.unknown = TRUE)
...
D <- divsites_inter14_EUR/2225
D

#Region 15
Intergenic15_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=135572057, to=135600965, include.unknown = TRUE)
...
D <- divsites_inter15_EUR/16998
D

#Region 16
Intergenic16_EUR <- readVCF("new_chr9_4_intergenic.vcf.gz", numcols=10000, tid="9", from=136857726, to=136888678, include.unknown = TRUE)
...
D <- divsites_inter16_EUR/30944
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=26614123, to=136888678, include.unknown = TRUE)
...
#Pi
individuals <- get.individuals(Intergenic.all_SAS)[[1]]humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=26614123, to=26620002, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/5879
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=33573007, to=33574359, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/1351
D

#Region 3
Intergenic3_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=37384431, to=37422663, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/38232
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=42474239, to=42477991, include.unknown = TRUE)
...
divsites_inter4_SAS
D <- divsites_inter4_SAS/3752
D

#Region 5
Intergenic5_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=44011839, to=44017295, include.unknown = TRUE)
...
divsites_inter5_SAS
D <- divsites_inter5_SAS/5456
D

#Region 6
Intergenic6_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=67306943, to=67327775, include.unknown = TRUE)
...
divsites_inter6_SAS
D <- divsites_inter6_SAS/20832
D

#Region 7
Intergenic7_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=82506922, to=82522044, include.unknown = TRUE)
...
divsites_inter7_SAS
D <- divsites_inter7_SAS/15122
D

#Region 8 
Intergenic8_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=82518848, to=82528184, include.unknown = TRUE)
...
divsites_inter8_SAS
D <- divsites_inter8_SAS/9336
D

#Region 9
Intergenic9_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=84503900, to=84523916, include.unknown = TRUE)
...
divsites_inter9_SAS
D <- divsites_inter9_SAS/20016
D

#Region 10
Intergenic10_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=84534841, to=84542936, include.unknown = TRUE)
...
D <- divsites_inter10_SAS/8095
D

#Region 11
Intergenic11_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=90503814, to=90528915, include.unknown = TRUE)
...
D <- divsites_inter11_SAS/25101
D

#Region 12
Intergenic12_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=9068295, to=90732963, include.unknown = TRUE)
...
D <- divsites_inter12_SAS/50011
D

#Region 13
Intergenic13_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=93351023, to=93372114, include.unknown = TRUE)
...
D <- divsites_inter13_SAS/21091
D

#Region 14
Intergenic14_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=125867145, to=125869370, include.unknown = TRUE)
...
D <- divsites_inter14_SAS/2225
D

#Region 15
Intergenic15_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=135572057, to=135600965, include.unknown = TRUE)
...
D <- divsites_inter15_SAS/16998
D

#Region 16
Intergenic16_SAS <- readVCF("new_chr9_5_intergenic.vcf.gz", numcols=10000, tid="9", from=136857726, to=136888678, include.unknown = TRUE)
