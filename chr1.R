...
Clusters.all <- readVCF("new_chr1.vcf.gz", numcols=10000, tid="1", from=6675490, to=229805740, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/33232)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 6675490:229805740))) # N polyallelic sites in that region
m <- 33232-sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(6675490:6687718), c(10434145:10443830), c(20230789:20241453), c(27647875:27656513), c(27728548:27736940), c(28293521:28302527), c(110036254:110044254), c(179551149:179562980), c(222640351:222655359), c(229796748:229805740)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr1.vcf.gz", numcols=10000, tid="1", from=6675490, to=6687718, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/833)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 6675490:6687718))) # N polyallelic sites in that region
m <- 833 -sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr1.vcf.gz", numcols=10000, tid="1", from=10434145, to=10443830, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/2157)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 10434145:10443830))) # N polyallelic sites in that region
m <- 2157-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr1.vcf.gz", numcols=10000, tid="1", from=20230789, to=20241453, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/2015)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 20230789:20241453))) # N polyallelic sites in that region
m <- 2015-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr1.vcf.gz", numcols=10000, tid="1", from=27647875, to=27656513, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/761)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 27647875:27656513))) # N polyallelic sites in that region
m <- 761-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr1.vcf.gz", numcols=10000, tid="1", from=27728548, to=27736940, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/2182)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 27728548:27736940))) # N polyallelic sites in that region
m <- 2182 -sum(misshuman,na.rm=T)-polysites
...
#Cluster_6
Clusters_6 <- readVCF("new_chr1.vcf.gz", numcols=10000, tid="1", from=28293521, to=28302527, include.unknown = TRUE)
...
Mu <- (Clusters_6@theta_Watterson/2248)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 28293521:28302527))) # N polyallelic sites in that region
m <- 2248-sum(misshuman,na.rm=T)-polysites
...
#Cluster_7
Clusters_7 <- readVCF("new_chr1.vcf.gz", numcols=10000, tid="1", from=110036254, to=110044254, include.unknown = TRUE)
...
Mu <- (Clusters_7@theta_Watterson/420)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 110036254:110044254))) # N polyallelic sites in that region
m <- 420-sum(misshuman,na.rm=T)-polysites
...
#Cluster_8
Clusters_8 <- readVCF("new_chr1.vcf.gz", numcols=10000, tid="1", from=179551149, to=179562980, include.unknown = TRUE)
...
Mu <- (Clusters_8@theta_Watterson/6190)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 179551149:179562980))) # N polyallelic sites in that region
m <- 6190-sum(misshuman,na.rm=T)-polysites
...
#Cluster_9
Clusters_9 <- readVCF("new_chr1.vcf.gz", numcols=10000, tid="1", from=222640351, to=222655359, include.unknown = TRUE)
...
Mu <- (Clusters_9@theta_Watterson/7434)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 222640351:222655359))) # N polyallelic sites in that region
m <- 7434-sum(misshuman,na.rm=T)-polysites
...
#Cluster_10
Clusters_10 <- readVCF("new_chr1.vcf.gz", numcols=10000, tid="1", from=229796748, to=229805740, include.unknown = TRUE)
...
Mu <- (Clusters_10@theta_Watterson/8992)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 229796748:229805740))) # N polyallelic sites in that region
m <- 8992-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr1_1.vcf.gz", numcols=10000, tid="1", from=6675490, to=229805740, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(6675490:6687718), c(10434145:10443830), c(20230789:20241453), c(27647875:27656513), c(27728548:27736940), c(28293521:28302527), c(110036254:110044254), c(179551149:179562980), c(222640351:222655359), c(229796748:229805740)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr1_1.vcf.gz", numcols=10000, tid="1", from=6675490, to=6687718, include.unknown = TRUE)
...
Mu <- (Clusters1_AFR@theta_Watterson/833)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr1_1.vcf.gz", numcols=10000, tid="1", from=10434145, to=10443830, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/2157
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/2157)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr1_1.vcf.gz", numcols=10000, tid="1", from=20230789, to=20241453, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/2015
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/2015)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr1_1.vcf.gz", numcols=10000, tid="1", from=27647875, to=27656513, include.unknown = TRUE)
...
Mu <- (Clusters4_AFR@theta_Watterson/761)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr1_1.vcf.gz", numcols=10000, tid="1", from=27728548, to=27736940, include.unknown = TRUE)
...
divsites5_AFR
D <- divsites5_AFR/2182
D

#Mutation rate
Clusters5_AFR <- neutrality.stats(Clusters5_AFR, FAST = TRUE)
Mu <- (Clusters5_AFR@theta_Watterson/2182)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AFR<- readVCF("new_chr1_1.vcf.gz", numcols=10000, tid="1", from=28293521, to=28302527, include.unknown = TRUE)
...
divsites6_AFR
D <- divsites6_AFR/2248
D

#Mutation rate
Clusters6_AFR <- neutrality.stats(Clusters6_AFR, FAST = TRUE)
Mu <- (Clusters6_AFR@theta_Watterson/2248)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AFR <- readVCF("new_chr1_1.vcf.gz", numcols=10000, tid="1", from=110036254, to=110044254, include.unknown = TRUE)
...
Mu <- (Clusters7_AFR@theta_Watterson/420)/(4*10000)
Mu
...
#Cluster_8
Clusters8_AFR <- readVCF("new_chr1_1.vcf.gz", numcols=10000, tid="1", from=179551149, to=179562980, include.unknown = TRUE)
...
divsites8_AFR
D <- divsites8_AFR/6190
D

#Mutation rate
Clusters8_AFR <- neutrality.stats(Clusters8_AFR, FAST = TRUE)
Mu <- (Clusters8_AFR@theta_Watterson/6190)/(4*10000)
Mu
...
#Cluster_9
Clusters9_AFR <- readVCF("new_chr1_1.vcf.gz", numcols=10000, tid="1", from=222640351, to=222655359, include.unknown = TRUE)
...
divsites9_AFR
D <- divsites9_AFR/7434
D

#Mutation rate
Clusters9_AFR <- neutrality.stats(Clusters9_AFR, FAST = TRUE)
Mu <- (Clusters9_AFR@theta_Watterson/7434)/(4*10000)
Mu
...
#Cluster_10
Clusters10_AFR <- readVCF("new_chr1_1.vcf.gz", numcols=10000, tid="1", from=229796748, to=229805740, include.unknown = TRUE)
...
divsites10_AFR
D <- divsites10_AFR/8992
D

#Mutation rate
Clusters10_AFR <- neutrality.stats(Clusters10_AFR, FAST = TRUE)
Mu <- (Clusters10_AFR@theta_Watterson/8992)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr1_2.vcf.gz", numcols=10000, tid="1", from=6675490, to=229805740, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(6675490:6687718), c(10434145:10443830), c(20230789:20241453), c(27647875:27656513), c(27728548:27736940), c(28293521:28302527), c(110036254:110044254), c(179551149:179562980), c(222640351:222655359), c(229796748:229805740)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr1_2.vcf.gz", numcols=10000, tid="1", from=6675490, to=6687718, include.unknown = TRUE)
...
Mu <- (Clusters1_AMR@theta_Watterson/833)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr1_2.vcf.gz", numcols=10000, tid="1", from=10434145, to=10443830, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/2157
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/2157)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr1_2.vcf.gz", numcols=10000, tid="1", from=20230789, to=20241453, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/2015
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/2015)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr1_2.vcf.gz", numcols=10000, tid="1", from=27647875, to=27656513, include.unknown = TRUE)
...
Mu <- (Clusters4_AMR@theta_Watterson/761)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr1_2.vcf.gz", numcols=10000, tid="1", from=27728548, to=27736940, include.unknown = TRUE)
...
divsites5_AMR
D <- divsites5_AMR/2182
D

#Mutation rate
Clusters5_AMR <- neutrality.stats(Clusters5_AMR, FAST = TRUE)
Mu <- (Clusters5_AMR@theta_Watterson/2182)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AMR<- readVCF("new_chr1_2.vcf.gz", numcols=10000, tid="1", from=28293521, to=28302527, include.unknown = TRUE)
...
divsites6_AMR
D <- divsites6_AMR/2248
D

#Mutation rate
Clusters6_AMR <- neutrality.stats(Clusters6_AMR, FAST = TRUE)
Mu <- (Clusters6_AMR@theta_Watterson/2248)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AMR <- readVCF("new_chr1_2.vcf.gz", numcols=10000, tid="1", from=110036254, to=110044254, include.unknown = TRUE)
...
Mu <- (Clusters7_AMR@theta_Watterson/420)/(4*10000)
Mu
...
#Cluster_8
Clusters8_AMR <- readVCF("new_chr1_2.vcf.gz", numcols=10000, tid="1", from=179551149, to=179562980, include.unknown = TRUE)
...
divsites8_AMR
D <- divsites8_AMR/6190
D

#Mutation rate
Clusters8_AMR <- neutrality.stats(Clusters8_AMR, FAST = TRUE)
Mu <- (Clusters8_AMR@theta_Watterson/6190)/(4*10000)
Mu
...
#Cluster_9
Clusters9_AMR <- readVCF("new_chr1_2.vcf.gz", numcols=10000, tid="1", from=222640351, to=222655359, include.unknown = TRUE)
...
divsites9_AMR
D <- divsites9_AMR/7434
D

#Mutation rate
Clusters9_AMR <- neutrality.stats(Clusters9_AMR, FAST = TRUE)
Mu <- (Clusters9_AMR@theta_Watterson/7434)/(4*10000)
Mu
...
#Cluster_10
Clusters10_AMR <- readVCF("new_chr1_2.vcf.gz", numcols=10000, tid="1", from=229796748, to=229805740, include.unknown = TRUE)
...
divsites10_AMR
D <- divsites10_AMR/8992
D

#Mutation rate
Clusters10_AMR <- neutrality.stats(Clusters10_AMR, FAST = TRUE)
Mu <- (Clusters10_AMR@theta_Watterson/8992)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr1_3.vcf.gz", numcols=10000, tid="1", from=6675490, to=229805740, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(6675490:6687718), c(10434145:10443830), c(20230789:20241453), c(27647875:27656513), c(27728548:27736940), c(28293521:28302527), c(110036254:110044254), c(179551149:179562980), c(222640351:222655359), c(229796748:229805740)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr1_3.vcf.gz", numcols=10000, tid="1", from=6675490, to=6687718, include.unknown = TRUE)
...
Mu <- (Clusters1_EAS@theta_Watterson/833)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS <- readVCF("new_chr1_3.vcf.gz", numcols=10000, tid="1", from=10434145, to=10443830, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/2157
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/2157)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr1_3.vcf.gz", numcols=10000, tid="1", from=20230789, to=20241453, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/2015
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/2015)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr1_3.vcf.gz", numcols=10000, tid="1", from=27647875, to=27656513, include.unknown = TRUE)
...
Mu <- (Clusters4_EAS@theta_Watterson/761)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS<- readVCF("new_chr1_3.vcf.gz", numcols=10000, tid="1", from=27728548, to=27736940, include.unknown = TRUE)
...
divsites5_EAS
D <- divsites5_EAS/2182
D

#Mutation rate
Clusters5_EAS <- neutrality.stats(Clusters5_EAS, FAST = TRUE)
Mu <- (Clusters5_EAS@theta_Watterson/2182)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EAS<- readVCF("new_chr1_3.vcf.gz", numcols=10000, tid="1", from=28293521, to=28302527, include.unknown = TRUE)
...
divsites6_EAS
D <- divsites6_EAS/2248
D

#Mutation rate
Clusters6_EAS <- neutrality.stats(Clusters6_EAS, FAST = TRUE)
Mu <- (Clusters6_EAS@theta_Watterson/2248)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EAS <- readVCF("new_chr1_3.vcf.gz", numcols=10000, tid="1", from=110036254, to=110044254, include.unknown = TRUE)
...
Mu <- (Clusters7_EAS@theta_Watterson/420)/(4*10000)
Mu
...
#Cluster_8
Clusters8_EAS <- readVCF("new_chr1_3.vcf.gz", numcols=10000, tid="1", from=179551149, to=179562980, include.unknown = TRUE)
...
divsites8_EAS
D <- divsites8_EAS/6190
D

#Mutation rate
Clusters8_EAS <- neutrality.stats(Clusters8_EAS, FAST = TRUE)
Mu <- (Clusters8_EAS@theta_Watterson/6190)/(4*10000)
Mu
...
#Cluster_9
Clusters9_EAS <- readVCF("new_chr1_3.vcf.gz", numcols=10000, tid="1", from=222640351, to=222655359, include.unknown = TRUE)
...
divsites9_EAS
D <- divsites9_EAS/7434
D

#Mutation rate
Clusters9_EAS <- neutrality.stats(Clusters9_EAS, FAST = TRUE)
Mu <- (Clusters9_EAS@theta_Watterson/7434)/(4*10000)
Mu
...
#Cluster_10
Clusters10_EAS <- readVCF("new_chr1_3.vcf.gz", numcols=10000, tid="1", from=229796748, to=229805740, include.unknown = TRUE)
...
divsites10_EAS
D <- divsites10_EAS/8992
D

#Mutation rate
Clusters10_EAS <- neutrality.stats(Clusters10_EAS, FAST = TRUE)
Mu <- (Clusters10_EAS@theta_Watterson/8992)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr1_4.vcf.gz", numcols=10000, tid="1", from=6675490, to=229805740, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(6675490:6687718), c(10434145:10443830), c(20230789:20241453), c(27647875:27656513), c(27728548:27736940), c(28293521:28302527), c(110036254:110044254), c(179551149:179562980), c(222640351:222655359), c(229796748:229805740)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr1_4.vcf.gz", numcols=10000, tid="1", from=6675490, to=6687718, include.unknown = TRUE)
...
Mu <- (Clusters1_EUR@theta_Watterson/833)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR <- readVCF("new_chr1_4.vcf.gz", numcols=10000, tid="1", from=10434145, to=10443830, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/2157
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/2157)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr1_4.vcf.gz", numcols=10000, tid="1", from=20230789, to=20241453, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/2015
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/2015)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr1_4.vcf.gz", numcols=10000, tid="1", from=27647875, to=27656513, include.unknown = TRUE)
...
Mu <- (Clusters4_EUR@theta_Watterson/761)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR<- readVCF("new_chr1_4.vcf.gz", numcols=10000, tid="1", from=27728548, to=27736940, include.unknown = TRUE)
...
divsites5_EUR
D <- divsites5_EUR/2182
D

#Mutation rate
Clusters5_EUR <- neutrality.stats(Clusters5_EUR, FAST = TRUE)
Mu <- (Clusters5_EUR@theta_Watterson/2182)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EUR<- readVCF("new_chr1_4.vcf.gz", numcols=10000, tid="1", from=28293521, to=28302527, include.unknown = TRUE)
...
divsites6_EUR
D <- divsites6_EUR/2248
D

#Mutation rate
Clusters6_EUR <- neutrality.stats(Clusters6_EUR, FAST = TRUE)
Mu <- (Clusters6_EUR@theta_Watterson/2248)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EUR <- readVCF("new_chr1_4.vcf.gz", numcols=10000, tid="1", from=110036254, to=110044254, include.unknown = TRUE)
...
Mu <- (Clusters7_EUR@theta_Watterson/420)/(4*10000)
Mu
...
#Cluster_8
Clusters8_EUR <- readVCF("new_chr1_4.vcf.gz", numcols=10000, tid="1", from=179551149, to=179562980, include.unknown = TRUE)
...
divsites8_EUR
D <- divsites8_EUR/6190
D

#Mutation rate
Clusters8_EUR <- neutrality.stats(Clusters8_EUR, FAST = TRUE)
Mu <- (Clusters8_EUR@theta_Watterson/6190)/(4*10000)
Mu
...
#Cluster_9
Clusters9_EUR <- readVCF("new_chr1_4.vcf.gz", numcols=10000, tid="1", from=222640351, to=222655359, include.unknown = TRUE)
...
divsites9_EUR
D <- divsites9_EUR/7434
D

#Mutation rate
Clusters9_EUR <- neutrality.stats(Clusters9_EUR, FAST = TRUE)
Mu <- (Clusters9_EUR@theta_Watterson/7434)/(4*10000)
Mu
...
#Cluster_10
Clusters10_EUR <- readVCF("new_chr1_4.vcf.gz", numcols=10000, tid="1", from=229796748, to=229805740, include.unknown = TRUE)
...
divsites10_EUR
D <- divsites10_EUR/8992
D

#Mutation rate
Clusters10_EUR <- neutrality.stats(Clusters10_EUR, FAST = TRUE)
Mu <- (Clusters10_EUR@theta_Watterson/8992)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr1_5.vcf.gz", numcols=10000, tid="1", from=6675490, to=229805740, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(6675490:6687718), c(10434145:10443830), c(20230789:20241453), c(27647875:27656513), c(27728548:27736940), c(28293521:28302527), c(110036254:110044254), c(179551149:179562980), c(222640351:222655359), c(229796748:229805740)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr1_5.vcf.gz", numcols=10000, tid="1", from=6675490, to=6687718, include.unknown = TRUE)
...
Mu <- (Clusters1_SAS@theta_Watterson/833)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS <- readVCF("new_chr1_5.vcf.gz", numcols=10000, tid="1", from=10434145, to=10443830, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/2157
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/2157)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr1_5.vcf.gz", numcols=10000, tid="1", from=20230789, to=20241453, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/2015
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/2015)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr1_5.vcf.gz", numcols=10000, tid="1", from=27647875, to=27656513, include.unknown = TRUE)
...
Mu <- (Clusters4_SAS@theta_Watterson/761)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS<- readVCF("new_chr1_5.vcf.gz", numcols=10000, tid="1", from=27728548, to=27736940, include.unknown = TRUE)
...
divsites5_SAS
D <- divsites5_SAS/2182
D

#Mutation rate
Clusters5_SAS <- neutrality.stats(Clusters5_SAS, FAST = TRUE)
Mu <- (Clusters5_SAS@theta_Watterson/2182)/(4*10000)
Mu
...
#Cluster_6
Clusters6_SAS<- readVCF("new_chr1_5.vcf.gz", numcols=10000, tid="1", from=28293521, to=28302527, include.unknown = TRUE)
...
divsites6_SAS
D <- divsites6_SAS/2248
D

#Mutation rate
Clusters6_SAS <- neutrality.stats(Clusters6_SAS, FAST = TRUE)
Mu <- (Clusters6_SAS@theta_Watterson/2248)/(4*10000)
Mu
...
#Cluster_7
Clusters7_SAS <- readVCF("new_chr1_5.vcf.gz", numcols=10000, tid="1", from=110036254, to=110044254, include.unknown = TRUE)
...
Mu <- (Clusters7_SAS@theta_Watterson/420)/(4*10000)
Mu
...
#Cluster_8
Clusters8_SAS <- readVCF("new_chr1_5.vcf.gz", numcols=10000, tid="1", from=179551149, to=179562980, include.unknown = TRUE)
...
divsites8_SAS
D <- divsites8_SAS/6190
D

#Mutation rate
Clusters8_SAS <- neutrality.stats(Clusters8_SAS, FAST = TRUE)
Mu <- (Clusters8_SAS@theta_Watterson/6190)/(4*10000)
Mu
...
#Cluster_9
Clusters9_SAS <- readVCF("new_chr1_5.vcf.gz", numcols=10000, tid="1", from=222640351, to=222655359, include.unknown = TRUE)
...
divsites9_SAS
D <- divsites9_SAS/7434
D

#Mutation rate
Clusters9_SAS <- neutrality.stats(Clusters9_SAS, FAST = TRUE)
Mu <- (Clusters9_SAS@theta_Watterson/7434)/(4*10000)
Mu
...
#Cluster_10
Clusters10_SAS <- readVCF("new_chr1_5.vcf.gz", numcols=10000, tid="1", from=229796748, to=229805740, include.unknown = TRUE)
...
divsites10_SAS
D <- divsites10_SAS/8992
D

#Mutation rate
Clusters10_SAS <- neutrality.stats(Clusters10_SAS, FAST = TRUE)
Mu <- (Clusters10_SAS@theta_Watterson/8992)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr1_intergenic.vcf.gz", numcols=10000, tid="1", from=6649340, to=229824746, include.unknown = TRUE)
...
polysites <- sum(!is.na(match(polyal, 6649340:229824746))) # N polyallelic sites in that region
m <- 144870-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr1_intergenic.vcf.gz", numcols=10000, tid="1", from=6649340, to=6650784, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/1444
D

#Region 2
Intergenic2 <- readVCF("new_chr1_intergenic.vcf.gz", numcols=10000, tid="1", from=10443831, to=10450059, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/6228
D

#Region 3
Intergenic3 <- readVCF("new_chr1_intergenic.vcf.gz", numcols=10000, tid="1", from=20145995, to=20209006, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/62986
D

#Region 4
Intergenic4 <- readVCF("new_chr1_intergenic.vcf.gz", numcols=10000, tid="1", from=27638329, to=27647874, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/9545
D

#Region 5
Intergenic5 <- readVCF("new_chr1_intergenic.vcf.gz", numcols=10000, tid="1", from=27722318, to=27728547, include.unknown = TRUE)
...
divsites_inter5
D <- divsites_inter5/6229
D

#Region 6
Intergenic6 <- readVCF("new_chr1_intergenic.vcf.gz", numcols=10000, tid="1", from=28241257, to=28261504, include.unknown = TRUE)
...
divsites_inter6
D <- divsites_inter6/20235
D

#Region 7
Intergenic7 <- readVCF("new_chr1_intergenic.vcf.gz", numcols=10000, tid="1", from=110045554, to=110046797, include.unknown = TRUE)
...
divsites_inter7
D <- divsites_inter7/1243
D

#Region 8
Intergenic8 <- readVCF("new_chr1_intergenic.vcf.gz", numcols=10000, tid="1", from=179545484, to=179551148, include.unknown = TRUE)
...
divsites_inter8
D <- divsites_inter8/5652
D

#Region 9
Intergenic9 <- readVCF("new_chr1_intergenic.vcf.gz", numcols=10000, tid="1", from=222628047, to=222640350, include.unknown = TRUE)
...
divsites_inter9
D <- divsites_inter9/12303
D

#Region 10
Intergenic10 <- readVCF("new_chr1_intergenic.vcf.gz", numcols=10000, tid="1", from=229805741, to=229824746, include.unknown = TRUE)
...
divsites_inter10
D <- divsites_inter10/19005
D

###################POPULATIONS####################################################

#AFR
Intergenic.all_AFR <- readVCF("new_chr1_1_intergenic.vcf.gz", numcols=10000, tid="1", from=6649340, to=229824746, include.unknown = TRUE)
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr1_1_intergenic.vcf.gz", numcols=10000, tid="1", from=6649340, to=6650784, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/1444
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr1_1_intergenic.vcf.gz", numcols=10000, tid="1", from=10443831, to=10450059, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/6228
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr1_1_intergenic.vcf.gz", numcols=10000, tid="1", from=20145995, to=20209006, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/62986
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr1_1_intergenic.vcf.gz", numcols=10000, tid="1", from=27638329, to=27647874, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/9545
D

#Region 5
Intergenic5_AFR <- readVCF("new_chr1_1_intergenic.vcf.gz", numcols=10000, tid="1", from=27722318, to=27728547, include.unknown = TRUE)
...
divsites_inter5_AFR
D <- divsites_inter5_AFR/6229
D

#Region 6
Intergenic6_AFR <- readVCF("new_chr1_1_intergenic.vcf.gz", numcols=10000, tid="1", from=28241257, to=28261504, include.unknown = TRUE)
...
divsites_inter6_AFR
D <- divsites_inter6_AFR/20235
D

#Region 7
Intergenic7_AFR <- readVCF("new_chr1_1_intergenic.vcf.gz", numcols=10000, tid="1", from=110045554, to=110046797, include.unknown = TRUE)
...
divsites_inter7_AFR
D <- divsites_inter7_AFR/1243
D

#Region 8
Intergenic8_AFR <- readVCF("new_chr1_1_intergenic.vcf.gz", numcols=10000, tid="1", from=179545484, to=179551148, include.unknown = TRUE)
...
divsites_inter8_AFR
D <- divsites_inter8_AFR/5652
D

#Region 9
Intergenic9_AFR <- readVCF("new_chr1_1_intergenic.vcf.gz", numcols=10000, tid="1", from=222628047, to=222640350, include.unknown = TRUE)
...
divsites_inter9_AFR
D <- divsites_inter9_AFR/12303
D

#Region 10
Intergenic10_AFR <- readVCF("new_chr1_1_intergenic.vcf.gz", numcols=10000, tid="1", from=229805741, to=229824746, include.unknown = TRUE)
...
D <- divsites_inter10_AFR/19005
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr1_2_intergenic.vcf.gz", numcols=10000, tid="1", from=6649340, to=229824746, include.unknown = TRUE)
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr1_2_intergenic.vcf.gz", numcols=10000, tid="1", from=6649340, to=6650784, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/1444
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr1_2_intergenic.vcf.gz", numcols=10000, tid="1", from=10443831, to=10450059, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/6228
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr1_2_intergenic.vcf.gz", numcols=10000, tid="1", from=20145995, to=20209006, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/62986
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr1_2_intergenic.vcf.gz", numcols=10000, tid="1", from=27638329, to=27647874, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/9545
D

#Region 5
Intergenic5_AMR <- readVCF("new_chr1_2_intergenic.vcf.gz", numcols=10000, tid="1", from=27722318, to=27728547, include.unknown = TRUE)
...
divsites_inter5_AMR
D <- divsites_inter5_AMR/6229
D

#Region 6
Intergenic6_AMR <- readVCF("new_chr1_2_intergenic.vcf.gz", numcols=10000, tid="1", from=28241257, to=28261504, include.unknown = TRUE)
...
divsites_inter6_AMR
D <- divsites_inter6_AMR/20235
D

#Region 7
Intergenic7_AMR <- readVCF("new_chr1_2_intergenic.vcf.gz", numcols=10000, tid="1", from=110045554, to=110046797, include.unknown = TRUE)
...
divsites_inter7_AMR
D <- divsites_inter7_AMR/1243
D

#Region 8
Intergenic8_AMR <- readVCF("new_chr1_2_intergenic.vcf.gz", numcols=10000, tid="1", from=179545484, to=179551148, include.unknown = TRUE)
...
divsites_inter8_AMR
D <- divsites_inter8_AMR/5652
D

#Region 9
Intergenic9_AMR <- readVCF("new_chr1_2_intergenic.vcf.gz", numcols=10000, tid="1", from=222628047, to=222640350, include.unknown = TRUE)
...
divsites_inter9_AMR
D <- divsites_inter9_AMR/12303
D

#Region 10
Intergenic10_AMR <- readVCF("new_chr1_2_intergenic.vcf.gz", numcols=10000, tid="1", from=229805741, to=229824746, include.unknown = TRUE)
...
D <- divsites_inter10_AMR/19005
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr1_3_intergenic.vcf.gz", numcols=10000, tid="1", from=6649340, to=229824746, include.unknown = TRUE)
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr1_3_intergenic.vcf.gz", numcols=10000, tid="1", from=6649340, to=6650784, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/1444
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr1_3_intergenic.vcf.gz", numcols=10000, tid="1", from=10443831, to=10450059, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/6228
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr1_3_intergenic.vcf.gz", numcols=10000, tid="1", from=20145995, to=20209006, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/62986
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr1_3_intergenic.vcf.gz", numcols=10000, tid="1", from=27638329, to=27647874, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/9545
D

#Region 5
Intergenic5_EAS <- readVCF("new_chr1_3_intergenic.vcf.gz", numcols=10000, tid="1", from=27722318, to=27728547, include.unknown = TRUE)
...
divsites_inter5_EAS
D <- divsites_inter5_EAS/6229
D

#Region 6
Intergenic6_EAS <- readVCF("new_chr1_3_intergenic.vcf.gz", numcols=10000, tid="1", from=28241257, to=28261504, include.unknown = TRUE)
...
divsites_inter6_EAS
D <- divsites_inter6_EAS/20235
D

#Region 7
Intergenic7_EAS <- readVCF("new_chr1_3_intergenic.vcf.gz", numcols=10000, tid="1", from=110045554, to=110046797, include.unknown = TRUE)
...
divsites_inter7_EAS
D <- divsites_inter7_EAS/1243
D

#Region 8
Intergenic8_EAS <- readVCF("new_chr1_3_intergenic.vcf.gz", numcols=10000, tid="1", from=179545484, to=179551148, include.unknown = TRUE)
...
divsites_inter8_EAS
D <- divsites_inter8_EAS/5652
D

#Region 9
Intergenic9_EAS <- readVCF("new_chr1_3_intergenic.vcf.gz", numcols=10000, tid="1", from=222628047, to=222640350, include.unknown = TRUE)
...
divsites_inter9_EAS
D <- divsites_inter9_EAS/12303
D

#Region 10
Intergenic10_EAS <- readVCF("new_chr1_3_intergenic.vcf.gz", numcols=10000, tid="1", from=229805741, to=229824746, include.unknown = TRUE)
...
D <- divsites_inter10_EAS/19005
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr1_4_intergenic.vcf.gz", numcols=10000, tid="1", from=6649340, to=229824746, include.unknown = TRUE)
...
divsites_inter_EUR
D <- divsites_inter_EUR/144870
D

Intergenic.all_EUR <- neutrality.stats(Intergenic.all_EUR, do.R2 = TRUE)
get.neutrality(Intergenic.all_EAS, theta=TRUE) [[1]]
Mu <- (Intergenic.all_EUR@theta_Watterson/144870)/(4*10000)
Mu
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr1_4_intergenic.vcf.gz", numcols=10000, tid="1", from=6649340, to=6650784, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/1444
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr1_4_intergenic.vcf.gz", numcols=10000, tid="1", from=10443831, to=10450059, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/6228
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr1_4_intergenic.vcf.gz", numcols=10000, tid="1", from=20145995, to=20209006, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/62986
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr1_4_intergenic.vcf.gz", numcols=10000, tid="1", from=27638329, to=27647874, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/9545
D

#Region 5
Intergenic5_EUR <- readVCF("new_chr1_4_intergenic.vcf.gz", numcols=10000, tid="1", from=27722318, to=27728547, include.unknown = TRUE)
...
divsites_inter5_EUR
D <- divsites_inter5_EUR/6229
D

#Region 6
Intergenic6_EUR <- readVCF("new_chr1_4_intergenic.vcf.gz", numcols=10000, tid="1", from=28241257, to=28261504, include.unknown = TRUE)
...
divsites_inter6_EUR
D <- divsites_inter6_EUR/20235
D

#Region 7
Intergenic7_EUR <- readVCF("new_chr1_4_intergenic.vcf.gz", numcols=10000, tid="1", from=110045554, to=110046797, include.unknown = TRUE)
...
divsites_inter7_EUR
D <- divsites_inter7_EUR/1243
D

#Region 8
Intergenic8_EUR <- readVCF("new_chr1_4_intergenic.vcf.gz", numcols=10000, tid="1", from=179545484, to=179551148, include.unknown = TRUE)
...
divsites_inter8_EUR
D <- divsites_inter8_EUR/5652
D

#Region 9
Intergenic9_EUR <- readVCF("new_chr1_4_intergenic.vcf.gz", numcols=10000, tid="1", from=222628047, to=222640350, include.unknown = TRUE)
...
divsites_inter9_EUR
D <- divsites_inter9_EUR/12303
D

#Region 10
Intergenic10_EUR <- readVCF("new_chr1_4_intergenic.vcf.gz", numcols=10000, tid="1", from=229805741, to=229824746, include.unknown = TRUE)
...
D <- divsites_inter10_EUR/19005
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr1_5_intergenic.vcf.gz", numcols=10000, tid="1", from=6649340, to=229824746, include.unknown = TRUE)
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr1_5_intergenic.vcf.gz", numcols=10000, tid="1", from=6649340, to=6650784, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/1444
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr1_5_intergenic.vcf.gz", numcols=10000, tid="1", from=10443831, to=10450059, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/6228
D

#Region 3
Intergenic3_SAS <- readVCF("new_chr1_5_intergenic.vcf.gz", numcols=10000, tid="1", from=20145995, to=20209006, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/62986
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr1_5_intergenic.vcf.gz", numcols=10000, tid="1", from=27638329, to=27647874, include.unknown = TRUE)
...
divsites_inter4_SAS
D <- divsites_inter4_SAS/9545
D

#Region 5
Intergenic5_SAS <- readVCF("new_chr1_5_intergenic.vcf.gz", numcols=10000, tid="1", from=27722318, to=27728547, include.unknown = TRUE)
...
divsites_inter5_SAS
D <- divsites_inter5_SAS/6229
D

#Region 6
Intergenic6_SAS <- readVCF("new_chr1_5_intergenic.vcf.gz", numcols=10000, tid="1", from=28241257, to=28261504, include.unknown = TRUE)
...
divsites_inter6_SAS
D <- divsites_inter6_SAS/20235
D

#Region 7
Intergenic7_SAS <- readVCF("new_chr1_5_intergenic.vcf.gz", numcols=10000, tid="1", from=110045554, to=110046797, include.unknown = TRUE)
...
divsites_inter7_SAS
D <- divsites_inter7_SAS/1243
D

#Region 8
Intergenic8_SAS <- readVCF("new_chr1_5_intergenic.vcf.gz", numcols=10000, tid="1", from=179545484, to=179551148, include.unknown = TRUE)
...
divsites_inter8_SAS
D <- divsites_inter8_SAS/5652
D

#Region 9
Intergenic9_SAS <- readVCF("new_chr1_5_intergenic.vcf.gz", numcols=10000, tid="1", from=222628047, to=222640350, include.unknown = TRUE)
...
divsites_inter9_SAS
D <- divsites_inter9_SAS/12303
D

#Region 10
Intergenic10_SAS <- readVCF("new_chr1_5_intergenic.vcf.gz", numcols=10000, tid="1", from=229805741, to=229824746, include.unknown = TRUE)
