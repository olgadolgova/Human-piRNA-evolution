...
Clusters.all <- readVCF("new_chr8.vcf.gz", numcols=10000, tid="8", from=156150, to=143749404, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/15159)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 156150:143749404))) # N polyallelic sites in that region
m <- 15159 -sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(156150:165015), c(28605622:28614366), c(28904563:28924544), c(142215114:142224752), c(143736415:143749404)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr8.vcf.gz", numcols=10000, tid="8", from=156150, to=165015, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/7036)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 156150:165015))) # N polyallelic sites in that region
m <- 7036-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr8.vcf.gz", numcols=10000, tid="8", from=28605622, to=28614366, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/1250)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 28605622:28614366))) # N polyallelic sites in that region
m <- 1250-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr8.vcf.gz", numcols=10000, tid="8", from=28904563, to=28924544, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/2263)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 28904563:28924544))) # N polyallelic sites in that region
m <- 2263-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr8.vcf.gz", numcols=10000, tid="8", from=142215114, to=142224752, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/2151)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 142215114:142224752))) # N polyallelic sites in that region
m <- 2151-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr8.vcf.gz", numcols=10000, tid="8", from=143736415, to=143749404, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/2459)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 143736415:143749404))) # N polyallelic sites in that region
m <- 2459-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr8_1.vcf.gz", numcols=10000, tid="8", from=156150, to=143749404, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(156150:165015), c(28605622:28614366), c(28904563:28924544), c(142215114:142224752), c(143736415:143749404)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr8_1.vcf.gz", numcols=10000, tid="8", from=156150, to=165015, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/7036
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/7036)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr8_1.vcf.gz", numcols=10000, tid="8", from=28605622, to=28614366, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/1250
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/1250)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr8_1.vcf.gz", numcols=10000, tid="8", from=28904563, to=28924544, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/2263
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/2263)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr8_1.vcf.gz", numcols=10000, tid="8", from=142215114, to=142224752, include.unknown = TRUE)
...
divsites4_AFR
D <- divsites4_AFR/2151
D

#Mutation rate
Clusters4_AFR <- neutrality.stats(Clusters4_AFR, FAST = TRUE)
Mu <- (Clusters4_AFR@theta_Watterson/2151)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr8_1.vcf.gz", numcols=10000, tid="8", from=143736415, to=143749404, include.unknown = TRUE)
...
divsites5_AFR
D <- divsites5_AFR/2459
D

#Mutation rate
Clusters5_AFR <- neutrality.stats(Clusters5_AFR, FAST = TRUE)
Mu <- (Clusters5_AFR@theta_Watterson/2459)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr8_2.vcf.gz", numcols=10000, tid="8", from=156150, to=143749404, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(156150:165015), c(28605622:28614366), c(28904563:28924544), c(142215114:142224752), c(143736415:143749404)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr8_2.vcf.gz", numcols=10000, tid="8", from=156150, to=165015, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/7036
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/7036)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr8_2.vcf.gz", numcols=10000, tid="8", from=28605622, to=28614366, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/1250
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/1250)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr8_2.vcf.gz", numcols=10000, tid="8", from=28904563, to=28924544, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/2263
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/2263)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr8_2.vcf.gz", numcols=10000, tid="8", from=142215114, to=142224752, include.unknown = TRUE)
...
divsites4_AMR
D <- divsites4_AMR/2151
D

#Mutation rate
Clusters4_AMR <- neutrality.stats(Clusters4_AMR, FAST = TRUE)
Mu <- (Clusters4_AMR@theta_Watterson/2151)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr8_2.vcf.gz", numcols=10000, tid="8", from=143736415, to=143749404, include.unknown = TRUE)
...
divsites5_AMR
D <- divsites5_AMR/2459
D

#Mutation rate
Clusters5_AMR <- neutrality.stats(Clusters5_AMR, FAST = TRUE)
Mu <- (Clusters5_AMR@theta_Watterson/2459)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr8_3.vcf.gz", numcols=10000, tid="8", from=156150, to=143749404, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(156150:165015), c(28605622:28614366), c(28904563:28924544), c(142215114:142224752), c(143736415:143749404)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr8_3.vcf.gz", numcols=10000, tid="8", from=156150, to=165015, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/7036
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/7036)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr8_3.vcf.gz", numcols=10000, tid="8", from=28605622, to=28614366, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/1250
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/1250)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr8_3.vcf.gz", numcols=10000, tid="8", from=28904563, to=28924544, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/2263
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/2263)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr8_3.vcf.gz", numcols=10000, tid="8", from=142215114, to=142224752, include.unknown = TRUE)
...
divsites4_EAS
D <- divsites4_EAS/2151
D

#Mutation rate
Clusters4_EAS <- neutrality.stats(Clusters4_EAS, FAST = TRUE)
Mu <- (Clusters4_EAS@theta_Watterson/2151)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS<- readVCF("new_chr8_3.vcf.gz", numcols=10000, tid="8", from=143736415, to=143749404, include.unknown = TRUE)
...
divsites5_EAS
D <- divsites5_EAS/2459
D

#Mutation rate
Clusters5_EAS <- neutrality.stats(Clusters5_EAS, FAST = TRUE)
Mu <- (Clusters5_EAS@theta_Watterson/2459)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr8_4.vcf.gz", numcols=10000, tid="8", from=156150, to=143749404, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(156150:165015), c(28605622:28614366), c(28904563:28924544), c(142215114:142224752), c(143736415:143749404)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr8_4.vcf.gz", numcols=10000, tid="8", from=156150, to=165015, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/7036
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/7036)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr8_4.vcf.gz", numcols=10000, tid="8", from=28605622, to=28614366, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/1250
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/1250)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr8_4.vcf.gz", numcols=10000, tid="8", from=28904563, to=28924544, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/2263
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/2263)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr8_4.vcf.gz", numcols=10000, tid="8", from=142215114, to=142224752, include.unknown = TRUE)
...
divsites4_EUR
D <- divsites4_EUR/2151
D

#Mutation rate
Clusters4_EUR <- neutrality.stats(Clusters4_EUR, FAST = TRUE)
Mu <- (Clusters4_EUR@theta_Watterson/2151)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR<- readVCF("new_chr8_4.vcf.gz", numcols=10000, tid="8", from=143736415, to=143749404, include.unknown = TRUE)
...
divsites5_EUR
D <- divsites5_EUR/2459
D

#Mutation rate
Clusters5_EUR <- neutrality.stats(Clusters5_EUR, FAST = TRUE)
Mu <- (Clusters5_EUR@theta_Watterson/2459)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr8_5.vcf.gz", numcols=10000, tid="8", from=156150, to=143749404, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(156150:165015), c(28605622:28614366), c(28904563:28924544), c(142215114:142224752), c(143736415:143749404)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr8_5.vcf.gz", numcols=10000, tid="8", from=156150, to=165015, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/7036
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/7036)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr8_5.vcf.gz", numcols=10000, tid="8", from=28605622, to=28614366, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/1250
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/1250)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr8_5.vcf.gz", numcols=10000, tid="8", from=28904563, to=28924544, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/2263
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/2263)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr8_5.vcf.gz", numcols=10000, tid="8", from=142215114, to=142224752, include.unknown = TRUE)
...
divsites4_SAS
D <- divsites4_SAS/2151
D

#Mutation rate
Clusters4_SAS <- neutrality.stats(Clusters4_SAS, FAST = TRUE)
Mu <- (Clusters4_SAS@theta_Watterson/2151)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS<- readVCF("new_chr8_5.vcf.gz", numcols=10000, tid="8", from=143736415, to=143749404, include.unknown = TRUE)
...
divsites5_SAS
D <- divsites5_SAS/2459
D

#Mutation rate
Clusters5_SAS <- neutrality.stats(Clusters5_SAS, FAST = TRUE)
Mu <- (Clusters5_SAS@theta_Watterson/2459)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr8_intergenic.vcf.gz", numcols=10000, tid="8", from=152897, to=143736414, include.unknown = TRUE)
...
polysites <- sum(!is.na(match(polyal, 152897:143736414))) # N polyallelic sites in that region
m <- 44086-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr8_intergenic.vcf.gz", numcols=10000, tid="8", from=152897, to=156149, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/2856
D

#Region 2
Intergenic2 <- readVCF("new_chr8_intergenic.vcf.gz", numcols=10000, tid="8", from=28614367, to=28625178, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/10811
D

#Region 3
Intergenic3 <- readVCF("new_chr8_intergenic.vcf.gz", numcols=10000, tid="8", from=29120641, to=29127491, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/6850
D

#Region 4
Intergenic4 <- readVCF("new_chr8_intergenic.vcf.gz", numcols=10000, tid="8", from=142205907, to=142215113, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/9194
D

#Region 5
Intergenic5 <- readVCF("new_chr8_intergenic.vcf.gz", numcols=10000, tid="8", from=143722027, to=143736414, include.unknown = TRUE)
...
divsites_inter5
D <- divsites_inter5/14375
D

###################POPULATIONS####################################################

#AFR
Intergenic.all_AFR <- readVCF("new_chr8_1_intergenic.vcf.gz", numcols=10000, tid="8", from=152897, to=143736414, include.unknown = TRUE)
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr8_1_intergenic.vcf.gz", numcols=10000, tid="8", from=152897, to=156149, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/2856
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr8_1_intergenic.vcf.gz", numcols=10000, tid="8", from=28614367, to=28625178, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/10811
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr8_1_intergenic.vcf.gz", numcols=10000, tid="8", from=29120641, to=29127491, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/6850
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr8_1_intergenic.vcf.gz", numcols=10000, tid="8", from=142205907, to=142215113, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/9194
D

#Region 5
Intergenic5_AFR <- readVCF("new_chr8_1_intergenic.vcf.gz", numcols=10000, tid="8", from=143722027, to=143736414, include.unknown = TRUE)
...
divsites_inter5_AFR
D <- divsites_inter5_AFR/14375
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr8_2_intergenic.vcf.gz", numcols=10000, tid="8", from=152897, to=143736414, include.unknown = TRUE)
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr8_2_intergenic.vcf.gz", numcols=10000, tid="8", from=152897, to=156149, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/2856
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr8_2_intergenic.vcf.gz", numcols=10000, tid="8", from=28614367, to=28625178, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/10811
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr8_2_intergenic.vcf.gz", numcols=10000, tid="8", from=29120641, to=29127491, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/6850
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr8_2_intergenic.vcf.gz", numcols=10000, tid="8", from=142205907, to=142215113, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/9194
D

#Region 5
Intergenic5_AMR <- readVCF("new_chr8_2_intergenic.vcf.gz", numcols=10000, tid="8", from=143722027, to=143736414, include.unknown = TRUE)
...
divsites_inter5_AMR
D <- divsites_inter5_AMR/14375
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr8_3_intergenic.vcf.gz", numcols=10000, tid="8", from=152897, to=143736414, include.unknown = TRUE)
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr8_3_intergenic.vcf.gz", numcols=10000, tid="8", from=152897, to=156149, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/2856
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr8_3_intergenic.vcf.gz", numcols=10000, tid="8", from=28614367, to=28625178, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/10811
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr8_3_intergenic.vcf.gz", numcols=10000, tid="8", from=29120641, to=29127491, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/6850
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr8_3_intergenic.vcf.gz", numcols=10000, tid="8", from=142205907, to=142215113, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/9194
D

#Region 5
Intergenic5_EAS <- readVCF("new_chr8_3_intergenic.vcf.gz", numcols=10000, tid="8", from=143722027, to=143736414, include.unknown = TRUE)
...
divsites_inter5_EAS
D <- divsites_inter5_EAS/14375
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr8_4_intergenic.vcf.gz", numcols=10000, tid="8", from=152897, to=143736414, include.unknown = TRUE)
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr8_4_intergenic.vcf.gz", numcols=10000, tid="8", from=152897, to=156149, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/2856
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr8_4_intergenic.vcf.gz", numcols=10000, tid="8", from=28614367, to=28625178, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/10811
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr8_4_intergenic.vcf.gz", numcols=10000, tid="8", from=29120641, to=29127491, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/6850
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr8_4_intergenic.vcf.gz", numcols=10000, tid="8", from=142205907, to=142215113, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/9194
D

#Region 5
Intergenic5_EUR <- readVCF("new_chr8_4_intergenic.vcf.gz", numcols=10000, tid="8", from=143722027, to=143736414, include.unknown = TRUE)
...
divsites_inter5_EUR
D <- divsites_inter5_EUR/14375
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr8_5_intergenic.vcf.gz", numcols=10000, tid="8", from=152897, to=143736414, include.unknown = TRUE)
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr8_5_intergenic.vcf.gz", numcols=10000, tid="8", from=152897, to=156149, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/2856
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr8_5_intergenic.vcf.gz", numcols=10000, tid="8", from=28614367, to=28625178, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/10811
D

#Region 3
Intergenic3_SAS <- readVCF("new_chr8_5_intergenic.vcf.gz", numcols=10000, tid="8", from=29120641, to=29127491, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/6850
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr8_5_intergenic.vcf.gz", numcols=10000, tid="8", from=142205907, to=142215113, include.unknown = TRUE)
...
divsites_inter4_SAS
D <- divsites_inter4_SAS/9194
D

#Region 5
Intergenic5_SAS <- readVCF("new_chr8_5_intergenic.vcf.gz", numcols=10000, tid="8", from=143722027, to=143736414, include.unknown = TRUE)
