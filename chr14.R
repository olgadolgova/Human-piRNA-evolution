...
Clusters.all <- readVCF("new_chr14.vcf.gz", numcols=10000, tid="14", from=19581332, to=88638180, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/46559)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 19581332:886381806))) # N polyallelic sites in that region
m <- 46559 -sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(19581332:19605056), c(61578302:61587727), c(71187038:71198306), c(88594365:88638180)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr14.vcf.gz", numcols=10000, tid="14", from=19581332, to=19605056, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/14978)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 19581332:19605056))) # N polyallelic sites in that region
m <- 14978-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr14.vcf.gz", numcols=10000, tid="14", from=61578302, to=61587727, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/9425)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 61578302:61587727))) # N polyallelic sites in that region
m <- 9425-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr14.vcf.gz", numcols=10000, tid="14", from=71187038, to=71198306, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/2205)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 71187038:71198306))) # N polyallelic sites in that region
m <- 2205-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr14.vcf.gz", numcols=10000, tid="14", from=88594365, to=88638180, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/19951)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 88594365:88638180))) # N polyallelic sites in that region
m <- 19951-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr14_1.vcf.gz", numcols=10000, tid="14", from=19581332, to=88638180, include.unknown = TRUE)
...
polysites <- sum(!is.na(match(polyal, 19581332:88638180))) # N polyallelic sites in that region
m <- 46559-sum(misshuman,na.rm=T)-polysites
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(19581332:19605056), c(61578302:61587727), c(71187038:71198306), c(88594365:88638180)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr14_1.vcf.gz", numcols=10000, tid="14", from=19581332, to=19605056, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/14978
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/14978)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr14_1.vcf.gz", numcols=10000, tid="14", from=61578302, to=61587727, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/9425	
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/9425)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr14_1.vcf.gz", numcols=10000, tid="14", from=71187038, to=71198306, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/2205
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/2205)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr14_1.vcf.gz", numcols=10000, tid="14", from=88594365, to=88638180, include.unknown = TRUE)
...
divsites4_AFR
D <- divsites4_AFR/19951
D

#Mutation rate
Clusters4_AFR <- neutrality.stats(Clusters4_AFR, FAST = TRUE)
Mu <- (Clusters4_AFR@theta_Watterson/19951)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr14_2.vcf.gz", numcols=10000, tid="14", from=19581332, to=88638180, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(19581332:19605056), c(61578302:61587727), c(71187038:71198306), c(88594365:88638180)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr14_1.vcf.gz", numcols=10000, tid="14", from=19581332, to=19605056, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/14978
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/14978)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr14_2.vcf.gz", numcols=10000, tid="14", from=61578302, to=61587727, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/9425	
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/9425)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr14_2.vcf.gz", numcols=10000, tid="14", from=71187038, to=71198306, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/2205
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/2205)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr14_2.vcf.gz", numcols=10000, tid="14", from=88594365, to=88638180, include.unknown = TRUE)
...
divsites4_AMR
D <- divsites4_AMR/19951
D

#Mutation rate
Clusters4_AMR <- neutrality.stats(Clusters4_AMR, FAST = TRUE)
Mu <- (Clusters4_AMR@theta_Watterson/19951)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr14_3.vcf.gz", numcols=10000, tid="14", from=19581332, to=88638180, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(19581332:19605056), c(61578302:61587727), c(71187038:71198306), c(88594365:88638180)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr14_3.vcf.gz", numcols=10000, tid="14", from=19581332, to=19605056, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/14978
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/14978)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr14_3.vcf.gz", numcols=10000, tid="14", from=61578302, to=61587727, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/9425	
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/9425)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr14_3.vcf.gz", numcols=10000, tid="14", from=71187038, to=71198306, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/2205
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/2205)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr14_3.vcf.gz", numcols=10000, tid="14", from=88594365, to=88638180, include.unknown = TRUE)
...
divsites4_EAS
D <- divsites4_EAS/19951
D

#Mutation rate
Clusters4_EAS <- neutrality.stats(Clusters4_EAS, FAST = TRUE)
Mu <- (Clusters4_EAS@theta_Watterson/19951)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr14_4.vcf.gz", numcols=10000, tid="14", from=19581332, to=88638180, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(19581332:19605056), c(61578302:61587727), c(71187038:71198306), c(88594365:88638180)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr14_4.vcf.gz", numcols=10000, tid="14", from=19581332, to=19605056, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/14978
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/14978)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr14_4.vcf.gz", numcols=10000, tid="14", from=61578302, to=61587727, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/9425	
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/9425)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr14_4.vcf.gz", numcols=10000, tid="14", from=71187038, to=71198306, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/2205
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/2205)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr14_4.vcf.gz", numcols=10000, tid="14", from=88594365, to=88638180, include.unknown = TRUE)
...
divsites4_EUR
D <- divsites4_EUR/19951
D

#Mutation rate
Clusters4_EUR <- neutrality.stats(Clusters4_EUR, FAST = TRUE)
Mu <- (Clusters4_EUR@theta_Watterson/19951)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr14_5.vcf.gz", numcols=10000, tid="14", from=19581332, to=88638180, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(19581332:19605056), c(61578302:61587727), c(71187038:71198306), c(88594365:88638180)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr14_5.vcf.gz", numcols=10000, tid="14", from=19581332, to=19605056, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/14978
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/14978)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr14_5.vcf.gz", numcols=10000, tid="14", from=61578302, to=61587727, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/9425	
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/9425)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr14_5.vcf.gz", numcols=10000, tid="14", from=71187038, to=71198306, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/2205
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/2205)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr14_5.vcf.gz", numcols=10000, tid="14", from=88594365, to=88638180, include.unknown = TRUE)
...
divsites4_SAS
D <- divsites4_SAS/19951
D

#Mutation rate
Clusters4_SAS <- neutrality.stats(Clusters4_SAS, FAST = TRUE)
Mu <- (Clusters4_SAS@theta_Watterson/19951)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr14_intergenic.vcf.gz", numcols=10000, tid="14", from=19605057, to=88594364, include.unknown = TRUE)
...
polysites <- sum(!is.na(match(polyal, 19605057:88594364))) # N polyallelic sites in that region
m <- 73092-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr14_intergenic.vcf.gz", numcols=10000, tid="14", from=19605057, to=19611768, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/6711
D

#Region 2
Intergenic2 <- readVCF("new_chr14_intergenic.vcf.gz", numcols=10000, tid="14", from=61550451, to=61578301, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/27838
D

#Region 3
Intergenic3 <- readVCF("new_chr14_intergenic.vcf.gz", numcols=10000, tid="14", from=71178870, to=71187037, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/8154
D

#Region 4
Intergenic4 <- readVCF("new_chr14_intergenic.vcf.gz", numcols=10000, tid="14", from=88563963, to=88594364, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/30389
D

###################POPULATIONS####################################################
#AFR
Intergenic.all_AFR <- readVCF("new_chr14_1_intergenic.vcf.gz", numcols=10000, tid="14", from=19605057, to=88594364, include.unknown = TRUE)
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr14_1_intergenic.vcf.gz", numcols=10000, tid="14", from=19605057, to=19611768, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/6711
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr14_1_intergenic.vcf.gz", numcols=10000, tid="14", from=61550451, to=61578301, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/27838
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr14_1_intergenic.vcf.gz", numcols=10000, tid="14", from=71178870, to=71187037, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/8154
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr14_1_intergenic.vcf.gz", numcols=10000, tid="14", from=88563963, to=88594364, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/30389
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr14_2_intergenic.vcf.gz", numcols=10000, tid="14", from=19605057, to=88594364, include.unknown = TRUE)
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr14_2_intergenic.vcf.gz", numcols=10000, tid="14", from=19605057, to=19611768, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/6711
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr14_2_intergenic.vcf.gz", numcols=10000, tid="14", from=61550451, to=61578301, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/27838
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr14_2_intergenic.vcf.gz", numcols=10000, tid="14", from=71178870, to=71187037, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/8154
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr14_2_intergenic.vcf.gz", numcols=10000, tid="14", from=88563963, to=88594364, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/30389
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr14_3_intergenic.vcf.gz", numcols=10000, tid="14", from=19605057, to=88594364, include.unknown = TRUE)
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr14_3_intergenic.vcf.gz", numcols=10000, tid="14", from=19605057, to=19611768, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/6711
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr14_3_intergenic.vcf.gz", numcols=10000, tid="14", from=61550451, to=61578301, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/27838
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr14_3_intergenic.vcf.gz", numcols=10000, tid="14", from=71178870, to=71187037, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/8154
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr14_3_intergenic.vcf.gz", numcols=10000, tid="14", from=88563963, to=88594364, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/30389
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr14_4_intergenic.vcf.gz", numcols=10000, tid="14", from=19605057, to=88594364, include.unknown = TRUE)
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr14_4_intergenic.vcf.gz", numcols=10000, tid="14", from=19605057, to=19611768, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/6711
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr14_4_intergenic.vcf.gz", numcols=10000, tid="14", from=61550451, to=61578301, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/27838
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr14_4_intergenic.vcf.gz", numcols=10000, tid="14", from=71178870, to=71187037, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/8154
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr14_4_intergenic.vcf.gz", numcols=10000, tid="14", from=88563963, to=88594364, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/30389
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr14_5_intergenic.vcf.gz", numcols=10000, tid="14", from=19605057, to=88594364, include.unknown = TRUE)
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr14_5_intergenic.vcf.gz", numcols=10000, tid="14", from=19605057, to=19611768, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/6711
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr14_5_intergenic.vcf.gz", numcols=10000, tid="14", from=61550451, to=61578301, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/27838
D

#Region 3
Intergenic3_SAS <- readVCF("new_chr14_5_intergenic.vcf.gz", numcols=10000, tid="14", from=71178870, to=71187037, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/8154
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr14_5_intergenic.vcf.gz", numcols=10000, tid="14", from=88563963, to=88594364, include.unknown = TRUE)
