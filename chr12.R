...
Clusters.all <- readVCF("new_chr12.vcf.gz", numcols=10000, tid="12", from=9462671, to=121140830, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/68776)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 9462671:121140830))) # N polyallelic sites in that region
m <- 68776-sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(9462671:9525135), c(9544701:9557062), c(54621785:54637501), c(58210790:58222803), c(58320819:58333655), c(100545969:100570873), c(121132912:121140830)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr12.vcf.gz", numcols=10000, tid="12", from=9462671, to=9525135, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/50358)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 9462671:9525135))) # N polyallelic sites in that region
m <- 50358-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr12.vcf.gz", numcols=10000, tid="12", from=9544701, to=9557062, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/738)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 9544701:9557062))) # N polyallelic sites in that region
m <- 738-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr12.vcf.gz", numcols=10000, tid="12", from=54621785, to=54637501, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/2939)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 54621785:54637501))) # N polyallelic sites in that region
m <- 2939-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr12.vcf.gz", numcols=10000, tid="12", from=58210790, to=58222803, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/1223)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 58210790:58222803))) # N polyallelic sites in that region
m <- 1223-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr12.vcf.gz", numcols=10000, tid="12", from=58320819, to=58333655, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/8189)/40000
Mu
...
#Cluster_6
Clusters_6 <- readVCF("new_chr12.vcf.gz", numcols=10000, tid="12", from=100545969, to=100570873, include.unknown = TRUE)
...
Mu <- (Clusters_6@theta_Watterson/4166)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 100545969:100570873))) # N polyallelic sites in that region
m <- 4166-sum(misshuman,na.rm=T)-polysites
...
#Cluster_7
Clusters_7 <- readVCF("new_chr12.vcf.gz", numcols=10000, tid="12", from=121132912, to=121140830, include.unknown = TRUE)
...
Mu <- (Clusters_7@theta_Watterson/1163)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 121132912:121140830))) # N polyallelic sites in that region
m <- 1163-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr12_1.vcf.gz", numcols=10000, tid="12", from=9462671, to=121140830, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(9462671:9525135), c(9544701:9557062), c(54621785:54637501), c(58210790:58222803), c(58320819:58333655), c(100545969:100570873), c(121132912:121140830)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr12_1.vcf.gz", numcols=10000, tid="12", from=9462671, to=9525135, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/50358
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/50358)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr12_1.vcf.gz", numcols=10000, tid="12", from=9544701, to=9557062, include.unknown = TRUE)
...
Mu <- (Clusters2_AFR@theta_Watterson/738)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr12_1.vcf.gz", numcols=10000, tid="12", from=54621785, to=54637501, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/2939
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/2939)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr12_1.vcf.gz", numcols=10000, tid="12", from=58210790, to=58222803, include.unknown = TRUE)
...
divsites4_AFR
D <- divsites4_AFR/1223
D

#Mutation rate
Clusters4_AFR <- neutrality.stats(Clusters4_AFR, FAST = TRUE)
Mu <- (Clusters4_AFR@theta_Watterson/1223)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr12_1.vcf.gz", numcols=10000, tid="12", from=58320819, to=58333655, include.unknown = TRUE)
...
divsites5_AFR
D <- divsites5_AFR/8189
D

#Mutation rate
Clusters5_AFR <- neutrality.stats(Clusters5_AFR, FAST = TRUE)
Mu <- (Clusters5_AFR@theta_Watterson/8189)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 58320819:58333655))) # N polyallelic sites in that region
m <- 8189-sum(misshuman,na.rm=T)-polysites
...
#Cluster_6
Clusters6_AFR<- readVCF("new_chr12_1.vcf.gz", numcols=10000, tid="12", from=100545969, to=100570873, include.unknown = TRUE)
...
divsites6_AFR
D <- divsites6_AFR/4166
D

#Mutation rate
Clusters6_AFR <- neutrality.stats(Clusters6_AFR, FAST = TRUE)
Mu <- (Clusters6_AFR@theta_Watterson/4166)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AFR <- readVCF("new_chr12_1.vcf.gz", numcols=10000, tid="12", from=121132912, to=121140830, include.unknown = TRUE)
...
divsites7_AFR
D <- divsites7_AFR/1163
D

#Mutation rate
Clusters7_AFR <- neutrality.stats(Clusters7_AFR, FAST = TRUE)
Mu <- (Clusters7_AFR@theta_Watterson/1163)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr12_2.vcf.gz", numcols=10000, tid="12", from=9462671, to=121140830, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(9462671:9525135), c(9544701:9557062), c(54621785:54637501), c(58210790:58222803), c(58320819:58333655), c(100545969:100570873), c(121132912:121140830)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr12_2.vcf.gz", numcols=10000, tid="12", from=9462671, to=9525135, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/50358
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/50358)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr12_2.vcf.gz", numcols=10000, tid="12", from=9544701, to=9557062, include.unknown = TRUE)
...
Mu <- (Clusters2_AMR@theta_Watterson/738)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr12_2.vcf.gz", numcols=10000, tid="12", from=54621785, to=54637501, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/2939
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/2939)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr12_2.vcf.gz", numcols=10000, tid="12", from=58210790, to=58222803, include.unknown = TRUE)
...
divsites4_AMR
D <- divsites4_AMR/1223
D

#Mutation rate
Clusters4_AMR <- neutrality.stats(Clusters4_AMR, FAST = TRUE)
Mu <- (Clusters4_AMR@theta_Watterson/1223)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr12_2.vcf.gz", numcols=10000, tid="12", from=58320819, to=58333655, include.unknown = TRUE)
...
divsites5_AMR
D <- divsites5_AMR/8189
D

#Mutation rate
Clusters5_AMR <- neutrality.stats(Clusters5_AMR, FAST = TRUE)
Mu <- (Clusters5_AMR@theta_Watterson/8189)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AMR<- readVCF("new_chr12_2.vcf.gz", numcols=10000, tid="12", from=100545969, to=100570873, include.unknown = TRUE)
...
divsites6_AMR
D <- divsites6_AMR/4166
D

#Mutation rate
Clusters6_AMR <- neutrality.stats(Clusters6_AMR, FAST = TRUE)
Mu <- (Clusters6_AMR@theta_Watterson/4166)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AMR <- readVCF("new_chr12_2.vcf.gz", numcols=10000, tid="12", from=121132912, to=121140830, include.unknown = TRUE)
...
divsites7_AMR
D <- divsites7_AMR/1163
D

#Mutation rate
Clusters7_AMR <- neutrality.stats(Clusters7_AMR, FAST = TRUE)
Mu <- (Clusters7_AMR@theta_Watterson/1163)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr12_3.vcf.gz", numcols=10000, tid="12", from=9462671, to=121140830, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(9462671:9525135), c(9544701:9557062), c(54621785:54637501), c(58210790:58222803), c(58320819:58333655), c(100545969:100570873), c(121132912:121140830)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr12_3.vcf.gz", numcols=10000, tid="12", from=9462671, to=9525135, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/50358
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/50358)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr12_3.vcf.gz", numcols=10000, tid="12", from=9544701, to=9557062, include.unknown = TRUE)
...
Mu <- (Clusters2_EAS@theta_Watterson/738)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr12_3.vcf.gz", numcols=10000, tid="12", from=54621785, to=54637501, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/2939
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/2939)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr12_3.vcf.gz", numcols=10000, tid="12", from=58210790, to=58222803, include.unknown = TRUE)
...
divsites4_EAS
D <- divsites4_EAS/1223
D

#Mutation rate
Clusters4_EAS <- neutrality.stats(Clusters4_EAS, FAST = TRUE)
Mu <- (Clusters4_EAS@theta_Watterson/1223)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS<- readVCF("new_chr12_3.vcf.gz", numcols=10000, tid="12", from=58320819, to=58333655, include.unknown = TRUE)
...
divsites5_EAS
D <- divsites5_EAS/8189
D

#Mutation rate
Clusters5_EAS <- neutrality.stats(Clusters5_EAS, FAST = TRUE)
Mu <- (Clusters5_EAS@theta_Watterson/8189)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EAS<- readVCF("new_chr12_3.vcf.gz", numcols=10000, tid="12", from=100545969, to=100570873, include.unknown = TRUE)
...
divsites6_EAS
D <- divsites6_EAS/4166
D

#Mutation rate
Clusters6_EAS <- neutrality.stats(Clusters6_EAS, FAST = TRUE)
Mu <- (Clusters6_EAS@theta_Watterson/4166)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EAS <- readVCF("new_chr12_3.vcf.gz", numcols=10000, tid="12", from=121132912, to=121140830, include.unknown = TRUE)
...
divsites7_EAS
D <- divsites7_EAS/1163
D

#Mutation rate
Clusters7_EAS <- neutrality.stats(Clusters7_EAS, FAST = TRUE)
Mu <- (Clusters7_EAS@theta_Watterson/1163)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr12_4.vcf.gz", numcols=10000, tid="12", from=9462671, to=121140830, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(9462671:9525135), c(9544701:9557062), c(54621785:54637501), c(58210790:58222803), c(58320819:58333655), c(100545969:100570873), c(121132912:121140830)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr12_4.vcf.gz", numcols=10000, tid="12", from=9462671, to=9525135, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/50358
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/50358)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr12_4.vcf.gz", numcols=10000, tid="12", from=9544701, to=9557062, include.unknown = TRUE)
...
Mu <- (Clusters2_EUR@theta_Watterson/738)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr12_4 .vcf.gz", numcols=10000, tid="12", from=54621785, to=54637501, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/2939
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/2939)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr12_4.vcf.gz", numcols=10000, tid="12", from=58210790, to=58222803, include.unknown = TRUE)
...
divsites4_EUR
D <- divsites4_EUR/1223
D

#Mutation rate
Clusters4_EUR <- neutrality.stats(Clusters4_EUR, FAST = TRUE)
Mu <- (Clusters4_EUR@theta_Watterson/1223)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR<- readVCF("new_chr12_4.vcf.gz", numcols=10000, tid="12", from=58320819, to=58333655, include.unknown = TRUE)
...
divsites5_EUR
D <- divsites5_EUR/8189
D

#Mutation rate
Clusters5_EUR <- neutrality.stats(Clusters5_EUR, FAST = TRUE)
Mu <- (Clusters5_EUR@theta_Watterson/8189)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EUR<- readVCF("new_chr12_4.vcf.gz", numcols=10000, tid="12", from=100545969, to=100570873, include.unknown = TRUE)
...
divsites6_EUR
D <- divsites6_EUR/4166
D

#Mutation rate
Clusters6_EUR <- neutrality.stats(Clusters6_EUR, FAST = TRUE)
Mu <- (Clusters6_EUR@theta_Watterson/4166)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EUR <- readVCF("new_chr12_4.vcf.gz", numcols=10000, tid="12", from=121132912, to=121140830, include.unknown = TRUE)
...
divsites7_EUR
D <- divsites7_EUR/1163
D

#Mutation rate
Clusters7_EUR <- neutrality.stats(Clusters7_EUR, FAST = TRUE)
Mu <- (Clusters7_EUR@theta_Watterson/1163)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr12_5.vcf.gz", numcols=10000, tid="12", from=9462671, to=121140830, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(9462671:9525135), c(9544701:9557062), c(54621785:54637501), c(58210790:58222803), c(58320819:58333655), c(100545969:100570873), c(121132912:121140830)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr12_5.vcf.gz", numcols=10000, tid="12", from=9462671, to=9525135, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/50358
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/50358)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr12_5.vcf.gz", numcols=10000, tid="12", from=9544701, to=9557062, include.unknown = TRUE)
...
Mu <- (Clusters2_SAS@theta_Watterson/738)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr12_5.vcf.gz", numcols=10000, tid="12", from=54621785, to=54637501, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/2939
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/2939)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr12_5.vcf.gz", numcols=10000, tid="12", from=58210790, to=58222803, include.unknown = TRUE)
...
divsites4_SAS
D <- divsites4_SAS/1223
D

#Mutation rate
Clusters4_SAS <- neutrality.stats(Clusters4_SAS, FAST = TRUE)
Mu <- (Clusters4_SAS@theta_Watterson/1223)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS<- readVCF("new_chr12_5.vcf.gz", numcols=10000, tid="12", from=58320819, to=58333655, include.unknown = TRUE)
...
divsites5_SAS
D <- divsites5_SAS/8189
D

#Mutation rate
Clusters5_SAS <- neutrality.stats(Clusters5_SAS, FAST = TRUE)
Mu <- (Clusters5_SAS@theta_Watterson/8189)/(4*10000)
Mu
...
#Cluster_6
Clusters6_SAS<- readVCF("new_chr12_5.vcf.gz", numcols=10000, tid="12", from=100545969, to=100570873, include.unknown = TRUE)
...
divsites6_SAS
D <- divsites6_SAS/4166
D

#Mutation rate
Clusters6_SAS <- neutrality.stats(Clusters6_SAS, FAST = TRUE)
Mu <- (Clusters6_SAS@theta_Watterson/4166)/(4*10000)
Mu
...
#Cluster_7
Clusters7_SAS <- readVCF("new_chr12_5.vcf.gz", numcols=10000, tid="12", from=121132912, to=121140830, include.unknown = TRUE)
...
divsites7_SAS
D <- divsites7_SAS/1163
D

#Mutation rate
Clusters7_SAS <- neutrality.stats(Clusters7_SAS, FAST = TRUE)
Mu <- (Clusters7_SAS@theta_Watterson/1163)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr12_intergenic.vcf.gz", numcols=10000, tid="12", from=9428413, to=121132911, include.unknown = TRUE)
...
Mu <- (Intergenic.all@theta_Watterson/130462)/(4*10000)
Mu
...
#Region 1
Intergenic1 <- readVCF("new_chr12_intergenic.vcf.gz", numcols=10000, tid="12", from=9428413, to=9429831, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/1418
D

#Region 2
Intergenic2 <- readVCF("new_chr12_intergenic.vcf.gz", numcols=10000, tid="12", from=9569314, to=9571269, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/1955
D

#Region 3
Intergenic3 <- readVCF("new_chr12_intergenic.vcf.gz", numcols=10000, tid="12", from=54582792, to=54621784, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/38992
D

#Region 4
Intergenic4 <- readVCF("new_chr12_intergenic.vcf.gz", numcols=10000, tid="12", from=58240522, to=58263618, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/22610
D

#Region 5
Intergenic5 <- readVCF("new_chr12_intergenic.vcf.gz", numcols=10000, tid="12", from=58290629, to=58320818, include.unknown = TRUE)
...
divsites_inter5
D <- divsites_inter5/30189
D

#Region 6
Intergenic6 <- readVCF("new_chr12_intergenic.vcf.gz", numcols=10000, tid="12", from=100538449, to=100545968, include.unknown = TRUE)
...
divsites_inter6
D <- divsites_inter6/7519
D

#Region 7
Intergenic7 <- readVCF("new_chr12_intergenic.vcf.gz", numcols=10000, tid="12", from=121105127, to=121132911, include.unknown = TRUE)
...
divsites_inter7
D <- divsites_inter7/27779
D

###################POPULATIONS####################################################

#AFR
Intergenic.all_AFR <- readVCF("new_chr12_1_intergenic.vcf.gz", numcols=10000, tid="12", from=9428413, to=121132911, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AFR@theta_Watterson/130462)/(4*10000)
Mu
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr12_1_intergenic.vcf.gz", numcols=10000, tid="12", from=9428413, to=9429831, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/1418
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr12_1_intergenic.vcf.gz", numcols=10000, tid="12", from=9569314, to=9571269, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/1955
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr12_1_intergenic.vcf.gz", numcols=10000, tid="12", from=54582792, to=54621784, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/38992
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr12_1_intergenic.vcf.gz", numcols=10000, tid="12", from=58240522, to=58263618, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/22610
D

#Region 5
Intergenic5_AFR <- readVCF("new_chr12_1_intergenic.vcf.gz", numcols=10000, tid="12", from=58290629, to=58320818, include.unknown = TRUE)
...
divsites_inter5_AFR
D <- divsites_inter5_AFR/30189
D

#Region 6
Intergenic6_AFR <- readVCF("new_chr12_1_intergenic.vcf.gz", numcols=10000, tid="12", from=100538449, to=100545968, include.unknown = TRUE)
...
divsites_inter6_AFR
D <- divsites_inter6_AFR/7519
D

#Region 7
Intergenic7_AFR <- readVCF("new_chr12_1_intergenic.vcf.gz", numcols=10000, tid="12", from=121105127, to=121132911, include.unknown = TRUE)
...
divsites_inter7_AFR
D <- divsites_inter7_AFR/27779
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr12_2_intergenic.vcf.gz", numcols=10000, tid="12", from=9428413, to=121132911, include.unknown = TRUE)
...
Mu <- (Intergenic.all_AMR@theta_Watterson/130462)/(4*10000)
Mu
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr12_2_intergenic.vcf.gz", numcols=10000, tid="12", from=9428413, to=9429831, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/1418
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr12_2_intergenic.vcf.gz", numcols=10000, tid="12", from=9569314, to=9571269, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/1955
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr12_2_intergenic.vcf.gz", numcols=10000, tid="12", from=54582792, to=54621784, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/38992
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr12_2_intergenic.vcf.gz", numcols=10000, tid="12", from=58240522, to=58263618, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/22610
D

#Region 5
Intergenic5_AMR <- readVCF("new_chr12_2_intergenic.vcf.gz", numcols=10000, tid="12", from=58290629, to=58320818, include.unknown = TRUE)
...
divsites_inter5_AMR
D <- divsites_inter5_AMR/30189
D

#Region 6
Intergenic6_AMR <- readVCF("new_chr12_2_intergenic.vcf.gz", numcols=10000, tid="12", from=100538449, to=100545968, include.unknown = TRUE)
...
divsites_inter6_AMR
D <- divsites_inter6_AMR/7519
D

#Region 7
Intergenic7_AMR <- readVCF("new_chr12_2_intergenic.vcf.gz", numcols=10000, tid="12", from=121105127, to=121132911, include.unknown = TRUE)
...
divsites_inter7_AMR
D <- divsites_inter7_AMR/27779
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr12_3_intergenic.vcf.gz", numcols=10000, tid="12", from=9428413, to=121132911, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EAS@theta_Watterson/130462)/(4*10000)
Mu
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr12_3_intergenic.vcf.gz", numcols=10000, tid="12", from=9428413, to=9429831, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/1418
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr12_3_intergenic.vcf.gz", numcols=10000, tid="12", from=9569314, to=9571269, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/1955
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr12_3_intergenic.vcf.gz", numcols=10000, tid="12", from=54582792, to=54621784, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/38992
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr12_3_intergenic.vcf.gz", numcols=10000, tid="12", from=58240522, to=58263618, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/22610
D

#Region 5
Intergenic5_EAS <- readVCF("new_chr12_3_intergenic.vcf.gz", numcols=10000, tid="12", from=58290629, to=58320818, include.unknown = TRUE)
...
divsites_inter5_EAS
D <- divsites_inter5_EAS/30189
D

#Region 6
Intergenic6_EAS <- readVCF("new_chr12_3_intergenic.vcf.gz", numcols=10000, tid="12", from=100538449, to=100545968, include.unknown = TRUE)
...
divsites_inter6_EAS
D <- divsites_inter6_EAS/7519
D

#Region 7
Intergenic7_EAS <- readVCF("new_chr12_3_intergenic.vcf.gz", numcols=10000, tid="12", from=121105127, to=121132911, include.unknown = TRUE)
...
divsites_inter7_EAS
D <- divsites_inter7_EAS/27779
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr12_4_intergenic.vcf.gz", numcols=10000, tid="12", from=9428413, to=121132911, include.unknown = TRUE)
...
Mu <- (Intergenic.all_EUR@theta_Watterson/130462)/(4*10000)
Mu
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr12_4_intergenic.vcf.gz", numcols=10000, tid="12", from=9428413, to=9429831, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/1418
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr12_4_intergenic.vcf.gz", numcols=10000, tid="12", from=9569314, to=9571269, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/1955
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr12_4_intergenic.vcf.gz", numcols=10000, tid="12", from=54582792, to=54621784, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/38992
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr12_1_intergenic.vcf.gz", numcols=10000, tid="12", from=58240522, to=58263618, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/22610
D

#Region 5
Intergenic5_EUR <- readVCF("new_chr12_4_intergenic.vcf.gz", numcols=10000, tid="12", from=58290629, to=58320818, include.unknown = TRUE)
...
divsites_inter5_EUR
D <- divsites_inter5_EUR/30189
D

#Region 6
Intergenic6_EUR <- readVCF("new_chr12_4_intergenic.vcf.gz", numcols=10000, tid="12", from=100538449, to=100545968, include.unknown = TRUE)
...
divsites_inter6_EUR
D <- divsites_inter6_EUR/7519
D

#Region 7
Intergenic7_EUR <- readVCF("new_chr12_4_intergenic.vcf.gz", numcols=10000, tid="12", from=121105127, to=121132911, include.unknown = TRUE)
...
divsites_inter7_EUR
D <- divsites_inter7_EUR/27779
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr12_5_intergenic.vcf.gz", numcols=10000, tid="12", from=9428413, to=121132911, include.unknown = TRUE)
...
Mu <- (Intergenic.all_SAS@theta_Watterson/130462)/(4*10000)
Mu
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr12_5_intergenic.vcf.gz", numcols=10000, tid="12", from=9428413, to=9429831, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/1418
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr12_5_intergenic.vcf.gz", numcols=10000, tid="12", from=9569314, to=9571269, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/1955
D

#Region 3
Intergenic3_SAS <- readVCF("new_chr12_5_intergenic.vcf.gz", numcols=10000, tid="12", from=54582792, to=54621784, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/38992
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr12_5_intergenic.vcf.gz", numcols=10000, tid="12", from=58240522, to=58263618, include.unknown = TRUE)
...
divsites_inter4_SAS
D <- divsites_inter4_SAS/22610
D

#Region 5
Intergenic5_SAS <- readVCF("new_chr12_5_intergenic.vcf.gz", numcols=10000, tid="12", from=58290629, to=58320818, include.unknown = TRUE)
...
divsites_inter5_SAS
D <- divsites_inter5_SAS/30189
D

#Region 6
Intergenic6_SAS <- readVCF("new_chr12_5_intergenic.vcf.gz", numcols=10000, tid="12", from=100538449, to=100545968, include.unknown = TRUE)
...
divsites_inter6_SAS
D <- divsites_inter6_SAS/7519
D

#Region 7
Intergenic7_SAS <- readVCF("new_chr12_5_intergenic.vcf.gz", numcols=10000, tid="12", from=121105127, to=121132911, include.unknown = TRUE)
