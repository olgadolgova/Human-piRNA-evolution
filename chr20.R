ssetwd("~/Dropbox (CRG)/Bioinformatics/PiRNA/populations/new_clusters")
library (PopGenome)

Clusters.all <- readVCF("new_chr20.vcf.gz", numcols=10000, tid="20", from=5171677, to=47162369, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/15795)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 5171677:47162369))) # N polyallelic sites in that region
m <- 15795 -sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(5171677:5179628), c(5473972:5486585), c(31436063:31444827), c(47154559:47162369)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr20.vcf.gz", numcols=10000, tid="20", from=5171677, to=5179628, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/1095)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 5171677:5179628))) # N polyallelic sites in that region
m <- 1095-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr20.vcf.gz", numcols=10000, tid="20", from=5473972, to=5486585, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/5154)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 5473972:5486585))) # N polyallelic sites in that region
m <- 5154-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr20.vcf.gz", numcols=10000, tid="20", from=31436063, to=31444827, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/2364)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 31436063:31444827))) # N polyallelic sites in that region
m <- 2364-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr20.vcf.gz", numcols=10000, tid="20", from=47154559, to=47162369, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/7182)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 47154559:47162369))) # N polyallelic sites in that region
m <- 7182-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr20_1.vcf.gz", numcols=10000, tid="20", from=5171677, to=47162369, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(5171677:5179628), c(5473972:5486585), c(31436063:31444827), c(47154559:47162369)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr20_1.vcf.gz", numcols=10000, tid="20", from=5171677, to=5179628, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/1095
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/1095)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr20_1.vcf.gz", numcols=10000, tid="20", from=5473972, to=5486585, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/5154	
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/5154)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr20_1.vcf.gz", numcols=10000, tid="20", from=31436063, to=31444827, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/2364
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/2364)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr20_1.vcf.gz", numcols=10000, tid="20", from=47154559, to=47162369, include.unknown = TRUE)
...
divsites4_AFR
D <- divsites4_AFR/7182
D

#Mutation rate
Clusters4_AFR <- neutrality.stats(Clusters4_AFR, FAST = TRUE)
Mu <- (Clusters4_AFR@theta_Watterson/7182)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr20_2.vcf.gz", numcols=10000, tid="20", from=5171677, to=47162369, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(5171677:5179628), c(5473972:5486585), c(31436063:31444827), c(47154559:47162369)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr20_2.vcf.gz", numcols=10000, tid="20", from=5171677, to=5179628, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/1095
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/1095)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr20_2.vcf.gz", numcols=10000, tid="20", from=5473972, to=5486585, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/5154	
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/5154)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr20_2.vcf.gz", numcols=10000, tid="20", from=31436063, to=31444827, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/2364
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/2364)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr20_2.vcf.gz", numcols=10000, tid="20", from=47154559, to=47162369, include.unknown = TRUE)
...
divsites4_AMR
D <- divsites4_AMR/7182
D

#Mutation rate
Clusters4_AMR <- neutrality.stats(Clusters4_AMR, FAST = TRUE)
Mu <- (Clusters4_AMR@theta_Watterson/7182)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr20_3.vcf.gz", numcols=10000, tid="20", from=5171677, to=47162369, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(5171677:5179628), c(5473972:5486585), c(31436063:31444827), c(47154559:47162369)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr20_3.vcf.gz", numcols=10000, tid="20", from=5171677, to=5179628, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/1095
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/1095)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr20_3.vcf.gz", numcols=10000, tid="20", from=5473972, to=5486585, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/5154	
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/5154)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr20_3.vcf.gz", numcols=10000, tid="20", from=31436063, to=31444827, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/2364
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/2364)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr20_3.vcf.gz", numcols=10000, tid="20", from=47154559, to=47162369, include.unknown = TRUE)
...
divsites4_EAS
D <- divsites4_EAS/7182
D

#Mutation rate
Clusters4_EAS <- neutrality.stats(Clusters4_EAS, FAST = TRUE)
Mu <- (Clusters4_EAS@theta_Watterson/7182)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr20_4.vcf.gz", numcols=10000, tid="20", from=5171677, to=47162369, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(5171677:5179628), c(5473972:5486585), c(31436063:31444827), c(47154559:47162369)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr20_4.vcf.gz", numcols=10000, tid="20", from=5171677, to=5179628, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/1095
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/1095)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr20_4.vcf.gz", numcols=10000, tid="20", from=5473972, to=5486585, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/5154	
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/5154)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr20_4.vcf.gz", numcols=10000, tid="20", from=31436063, to=31444827, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/2364
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/2364)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr20_4.vcf.gz", numcols=10000, tid="20", from=47154559, to=47162369, include.unknown = TRUE)
...
divsites4_EUR
D <- divsites4_EUR/7182
D

#Mutation rate
Clusters4_EUR <- neutrality.stats(Clusters4_EUR, FAST = TRUE)
Mu <- (Clusters4_EUR@theta_Watterson/7182)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr20_5.vcf.gz", numcols=10000, tid="20", from=5171677, to=47162369, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(5171677:5179628), c(5473972:5486585), c(31436063:31444827), c(47154559:47162369)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr20_5.vcf.gz", numcols=10000, tid="20", from=5171677, to=5179628, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/1095
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/1095)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr20_5.vcf.gz", numcols=10000, tid="20", from=5473972, to=5486585, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/5154	
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/5154)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr20_5.vcf.gz", numcols=10000, tid="20", from=31436063, to=31444827, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/2364
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/2364)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr20_5.vcf.gz", numcols=10000, tid="20", from=47154559, to=47162369, include.unknown = TRUE)
...
divsites4_SAS
D <- divsites4_SAS/7182
D

#Mutation rate
Clusters4_SAS <- neutrality.stats(Clusters4_SAS, FAST = TRUE)
Mu <- (Clusters4_SAS@theta_Watterson/7182)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr20_intergenic.vcf.gz", numcols=10000, tid="20", from=5179629, to=47154558, include.unknown = TRUE)
...
polysites <- sum(!is.na(match(polyal, 5179629:47154558))) # N polyallelic sites in that region
m <- 156794-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr20_intergenic.vcf.gz", numcols=10000, tid="20", from=5179629, to=5273034, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/93388
D

#Region 2
Intergenic2 <- readVCF("new_chr20_intergenic.vcf.gz", numcols=10000, tid="20", from=5455828, to=5476713, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/20872
D

#Region 3
Intergenic3 <- readVCF("new_chr20_intergenic.vcf.gz", numcols=10000, tid="20", from=31397162, to=31407699, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/10531
D

#Region 4
Intergenic4 <- readVCF("new_chr20_intergenic.vcf.gz", numcols=10000, tid="20", from=47122555, to=47154558, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/32003
D

###################POPULATIONS####################################################
#AFR
Intergenic.all_AFR <- readVCF("new_chr20_1_intergenic.vcf.gz", numcols=10000, tid="20", from=5179629, to=47154558, include.unknown = TRUE)
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr20_1_intergenic.vcf.gz", numcols=10000, tid="20", from=5179629, to=5273034, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/93388
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr20_1_intergenic.vcf.gz", numcols=10000, tid="20", from=5455828, to=5476713, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/20872
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr20_1_intergenic.vcf.gz", numcols=10000, tid="20", from=31397162, to=31407699, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/10531
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr20_1_intergenic.vcf.gz", numcols=10000, tid="20", from=47122555, to=47154558, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/32003
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr20_2_intergenic.vcf.gz", numcols=10000, tid="20", from=5179629, to=47154558, include.unknown = TRUE)
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr20_2_intergenic.vcf.gz", numcols=10000, tid="20", from=5179629, to=5273034, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/93388
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr20_2_intergenic.vcf.gz", numcols=10000, tid="20", from=5455828, to=5476713, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/20872
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr20_2_intergenic.vcf.gz", numcols=10000, tid="20", from=31397162, to=31407699, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/10531
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr20_2_intergenic.vcf.gz", numcols=10000, tid="20", from=47122555, to=47154558, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/32003
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr20_3_intergenic.vcf.gz", numcols=10000, tid="20", from=5179629, to=47154558, include.unknown = TRUE)
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr20_3_intergenic.vcf.gz", numcols=10000, tid="20", from=5179629, to=5273034, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/93388
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr20_3_intergenic.vcf.gz", numcols=10000, tid="20", from=5455828, to=5476713, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/20872
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr20_3_intergenic.vcf.gz", numcols=10000, tid="20", from=31397162, to=31407699, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/10531
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr20_3_intergenic.vcf.gz", numcols=10000, tid="20", from=47122555, to=47154558, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/32003
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr20_4_intergenic.vcf.gz", numcols=10000, tid="20", from=5179629, to=47154558, include.unknown = TRUE)
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr20_4_intergenic.vcf.gz", numcols=10000, tid="20", from=5179629, to=5273034, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/93388
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr20_4_intergenic.vcf.gz", numcols=10000, tid="20", from=5455828, to=5476713, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/20872
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr20_4_intergenic.vcf.gz", numcols=10000, tid="20", from=31397162, to=31407699, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/10531
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr20_4_intergenic.vcf.gz", numcols=10000, tid="20", from=47122555, to=47154558, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/32003
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr20_5_intergenic.vcf.gz", numcols=10000, tid="20", from=5179629, to=47154558, include.unknown = TRUE)
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr20_5_intergenic.vcf.gz", numcols=10000, tid="20", from=5179629, to=5273034, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/93388
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr20_5_intergenic.vcf.gz", numcols=10000, tid="20", from=5455828, to=5476713, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/20872
D

#Region 3
Intergenic3_SAS <- readVCF("new_chr20_5_intergenic.vcf.gz", numcols=10000, tid="20", from=31397162, to=31407699, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/10531
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr20_5_intergenic.vcf.gz", numcols=10000, tid="20", from=47122555, to=47154558, include.unknown = TRUE)
