...
Clusters.all <- readVCF("new_chr4.vcf.gz", numcols=10000, tid="4", from=41981218, to=165938097, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/30258)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 41981218:165938097))) # N polyallelic sites in that region
m <- 30258-sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(41981218:41989614), c(119547188:119563146), c(120323190:120336158), c(152584172:152591018), c(165928222:165938097)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr4.vcf.gz", numcols=10000, tid="4", from=41981218, to=41989614, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/8396)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 41981218:41989614))) # N polyallelic sites in that region
m <- 8396-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr4.vcf.gz", numcols=10000, tid="4", from=119547188, to=119563146, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/5265)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 119547188:119563146))) # N polyallelic sites in that region
m <- 5265-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr4.vcf.gz", numcols=10000, tid="4", from=120323190, to=120336158, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/5932)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 120323190:120336158))) # N polyallelic sites in that region
m <- 5932-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr4.vcf.gz", numcols=10000, tid="4", from=152584172, to=152591018, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/3592)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 152584172:152591018))) # N polyallelic sites in that region
m <- 3592-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr4.vcf.gz", numcols=10000, tid="4", from=165928222, to=165938097, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/7073)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 165928222:165938097))) # N polyallelic sites in that region
m <- 7073-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr4_1.vcf.gz", numcols=10000, tid="4", from=41981218, to=165938097, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(41981218:41989614), c(119547188:119563146), c(120323190:120336158), c(152584172:152591018), c(165928222:165938097)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr4_1.vcf.gz", numcols=10000, tid="4", from=41981218, to=41989614, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/8396
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/8396)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr4_1.vcf.gz", numcols=10000, tid="4", from=119547188, to=119563146, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/5265
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/5265)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr4_1.vcf.gz", numcols=10000, tid="4", from=120323190, to=120336158, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/5932
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/5932)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr4_1.vcf.gz", numcols=10000, tid="4", from=152584172, to=152591018, include.unknown = TRUE)
...
divsites4_AFR
D <- divsites4_AFR/3592
D

#Mutation rate
Clusters4_AFR <- neutrality.stats(Clusters4_AFR, FAST = TRUE)
Mu <- (Clusters4_AFR@theta_Watterson/3592)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr4_1.vcf.gz", numcols=10000, tid="4", from=165928222, to=165938097, include.unknown = TRUE)
...
divsites5_AFR
D <- divsites5_AFR/7073
D

#Mutation rate
Clusters5_AFR <- neutrality.stats(Clusters5_AFR, FAST = TRUE)
Mu <- (Clusters5_AFR@theta_Watterson/7073)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr4_2.vcf.gz", numcols=10000, tid="4", from=41981218, to=165938097, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(41981218:41989614), c(119547188:119563146), c(120323190:120336158), c(152584172:152591018), c(165928222:165938097)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr4_2.vcf.gz", numcols=10000, tid="4", from=41981218, to=41989614, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/8396
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/8396)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr4_2.vcf.gz", numcols=10000, tid="4", from=119547188, to=119563146, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/5265
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/5265)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr4_2.vcf.gz", numcols=10000, tid="4", from=120323190, to=120336158, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/5932
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/5932)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr4_2.vcf.gz", numcols=10000, tid="4", from=152584172, to=152591018, include.unknown = TRUE)
...
divsites4_AMR
D <- divsites4_AMR/3592
D

#Mutation rate
Clusters4_AMR <- neutrality.stats(Clusters4_AMR, FAST = TRUE)
Mu <- (Clusters4_AMR@theta_Watterson/3592)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr4_2.vcf.gz", numcols=10000, tid="4", from=165928222, to=165938097, include.unknown = TRUE)
...
divsites5_AMR
D <- divsites5_AMR/7073
D

#Mutation rate
Clusters5_AMR <- neutrality.stats(Clusters5_AMR, FAST = TRUE)
Mu <- (Clusters5_AMR@theta_Watterson/7073)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr4_3.vcf.gz", numcols=10000, tid="4", from=41981218, to=165938097, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(41981218:41989614), c(119547188:119563146), c(120323190:120336158), c(152584172:152591018), c(165928222:165938097)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr4_3.vcf.gz", numcols=10000, tid="4", from=41981218, to=41989614, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/8396
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/8396)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr4_3.vcf.gz", numcols=10000, tid="4", from=119547188, to=119563146, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/5265
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/5265)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr4_3.vcf.gz", numcols=10000, tid="4", from=120323190, to=120336158, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/5932
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/5932)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr4_3.vcf.gz", numcols=10000, tid="4", from=152584172, to=152591018, include.unknown = TRUE)
...
divsites4_EAS
D <- divsites4_EAS/3592
D

#Mutation rate
Clusters4_EAS <- neutrality.stats(Clusters4_EAS, FAST = TRUE)
Mu <- (Clusters4_EAS@theta_Watterson/3592)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS<- readVCF("new_chr4_3.vcf.gz", numcols=10000, tid="4", from=165928222, to=165938097, include.unknown = TRUE)
...
divsites5_EAS
D <- divsites5_EAS/7073
D

#Mutation rate
Clusters5_EAS <- neutrality.stats(Clusters5_EAS, FAST = TRUE)
Mu <- (Clusters5_EAS@theta_Watterson/7073)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr4_4.vcf.gz", numcols=10000, tid="4", from=41981218, to=165938097, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(41981218:41989614), c(119547188:119563146), c(120323190:120336158), c(152584172:152591018), c(165928222:165938097)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr4_2.vcf.gz", numcols=10000, tid="4", from=41981218, to=41989614, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/8396
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/8396)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr4_4.vcf.gz", numcols=10000, tid="4", from=119547188, to=119563146, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/5265
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/5265)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr4_4.vcf.gz", numcols=10000, tid="4", from=120323190, to=120336158, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/5932
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/5932)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr4_4.vcf.gz", numcols=10000, tid="4", from=152584172, to=152591018, include.unknown = TRUE)
...
divsites4_EUR
D <- divsites4_EUR/3592
D

#Mutation rate
Clusters4_EUR <- neutrality.stats(Clusters4_EUR, FAST = TRUE)
Mu <- (Clusters4_EUR@theta_Watterson/3592)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR<- readVCF("new_chr4_4.vcf.gz", numcols=10000, tid="4", from=165928222, to=165938097, include.unknown = TRUE)
...
divsites5_EUR
D <- divsites5_EUR/7073
D

#Mutation rate
Clusters5_EUR <- neutrality.stats(Clusters5_EUR, FAST = TRUE)
Mu <- (Clusters5_EUR@theta_Watterson/7073)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr4_5.vcf.gz", numcols=10000, tid="4", from=41981218, to=165938097, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(41981218:41989614), c(119547188:119563146), c(120323190:120336158), c(152584172:152591018), c(165928222:165938097)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr4_5.vcf.gz", numcols=10000, tid="4", from=41981218, to=41989614, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/8396
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/8396)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr4_5.vcf.gz", numcols=10000, tid="4", from=119547188, to=119563146, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/5265
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/5265)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr4_5.vcf.gz", numcols=10000, tid="4", from=120323190, to=120336158, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/5932
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/5932)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr4_5.vcf.gz", numcols=10000, tid="4", from=152584172, to=152591018, include.unknown = TRUE)
...
divsites4_SAS
D <- divsites4_SAS/3592
D

#Mutation rate
Clusters4_SAS <- neutrality.stats(Clusters4_SAS, FAST = TRUE)
Mu <- (Clusters4_SAS@theta_Watterson/3592)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS<- readVCF("new_chr4_5.vcf.gz", numcols=10000, tid="4", from=165928222, to=165938097, include.unknown = TRUE)
...
divsites5_SAS
D <- divsites5_SAS/7073
D

#Mutation rate
Clusters5_SAS <- neutrality.stats(Clusters5_SAS, FAST = TRUE)
Mu <- (Clusters5_SAS@theta_Watterson/7073)/(4*10000)
Mu
...
Intergenic4.all <- readVCF("new_chr4_intergenic.vcf.gz", numcols=10000, tid="4", from=41989615, to=165928221, include.unknown = TRUE)
Intergenic4.all <- set.outgroup(Intergenic4.all,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic4.all) 

Intergenic4.all <- neutrality.stats(Intergenic4.all, do.R2 = TRUE)
get.neutrality(Intergenic4.all, theta=TRUE) [[1]]
Intergenic4.all <- diversity.stats(Intergenic4.all, pi=TRUE)
get.diversity(Intergenic4.all) [[1]]
Mu <- (Intergenic4.all@theta_Watterson/87696)/(4*10000)
Mu

#Divergence calculation
bial <- get.biallelic.matrix(Intergenic4.all,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
...
humans <- individuals[which(individuals != c("Chimp","Chimp.2"))]
n <- length(humans) 
bial <- get.biallelic.matrix(Intergenic4.all,1) # Biallelic matrix
bialhuman <- bial[1:n,,drop=F] # Remove outgroup (drop = F to keep 1 dimension)
polym <- apply(bialhuman,2,sum)>0 # Sites polymorphic in humans: non REF (0) alleles
bialhuman <- bialhuman[,polym,drop=F] # Remove sites monomorphic in humans
misshuman <- colSums(is.na(bialhuman))>0 # Sites missing in humans (e.g. structural variants)
bialhuman <- bialhuman[,!misshuman,drop=FALSE] # Remove missing
polyal <- Intergenic4.all@region.data@polyallelic.sites[[1]] # Positions of all polyalleles
polysites <- sum(!is.na(match(polyal, 41989615:165928221))) # N polyallelic sites in that region
m <- 87696-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic4.1 <- readVCF("new_:chr4_intergenic.vcf.gz", numcols=10000, tid="4", from=41989615, to=41990758, include.unknown = TRUE)
Intergenic4.1 <- set.outgroup(Intergenic4.1,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic4.1) 

#Divergence
bial <- get.biallelic.matrix(Intergenic4.1,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter1 <- sum (div & !polym,na.rm=T)
divsites_inter1
D <- divsites_inter1/1143
D

#Region 2
Intergenic4.2 <- readVCF("new_chr4_intergenic.vcf.gz", numcols=10000, tid="4", from=119563147, to=119585242, include.unknown = TRUE)
Intergenic4.2 <- set.outgroup(Intergenic4.2,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic4.2) 

#Divergence
bial <- get.biallelic.matrix(Intergenic4.2,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter2 <- sum (div & !polym,na.rm=T)
divsites_inter2
D <- divsites_inter2/22095
D

#Region 3
Intergenic4.3 <- readVCF("new_chr4_intergenic.vcf.gz", numcols=10000, tid="4", from=120316490, to=120323189, include.unknown = TRUE)
Intergenic4.3 <- set.outgroup(Intergenic4.3,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic4.3) 

#Divergence
bial <- get.biallelic.matrix(Intergenic4.3,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter3 <- sum (div & !polym,na.rm=T)
divsites_inter3
D <- divsites_inter3/6699
D

#Region 4
Intergenic4.4 <- readVCF("new_chr4_intergenic.vcf.gz", numcols=10000, tid="4", from=152682175, to=152720652, include.unknown = TRUE)
Intergenic4.4 <- set.outgroup(Intergenic4.4,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic4.4) 

#Divergence
bial <- get.biallelic.matrix(Intergenic4.4,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter4 <- sum (div & !polym,na.rm=T)
divsites_inter4
D <- divsites_inter4/38477
D

#Region 5
Intergenic4.5 <- readVCF("new_chr4_intergenic.vcf.gz", numcols=10000, tid="4", from=165908939, to=165928221, include.unknown = TRUE)
Intergenic4.5 <- set.outgroup(Intergenic4.5,c("Chimp"), diploid=TRUE)
get.sum.data(Intergenic4.5) 

bial <- get.biallelic.matrix(Intergenic4.5,1)
n <- nrow(bial)-2
polym <- apply(bial[1:n,,drop=F],2,sum)>0 
div <- bial[n+1,] == 1
divsites_inter5 <- sum (div & !polym,na.rm=T)
divsites_inter5
D <- divsites_inter5/19282
D

#MKT
#chi-square
MKT =rbind(c(Intergenic5.all@n.biallelic.sites, divsites_inter), c(Clusters5.all@n.biallelic.sites, divsites))
MKT
chisq.test(MKT, simulate.p.value=TRUE)

MKT_1=rbind(c(Intergenic5.1@n.biallelic.sites, divsites_inter1), c(Clusters5.1@n.biallelic.sites, divsites1))
MKT_1
chisq.test(MKT_1, simulate.p.value=TRUE)

MKT_2=rbind(c(Intergenic5.2@n.biallelic.sites, divsites_inter2), c(Clusters5.2@n.biallelic.sites, divsites2))
MKT_2
chisq.test(MKT_2, simulate.p.value=TRUE)

MKT_3=rbind(c(Intergenic5.3@n.biallelic.sites, divsites_inter3), c(Clusters5.3@n.biallelic.sites, divsites3))
MKT_3
chisq.test(MKT_3, simulate.p.value=TRUE)

MKT_4=rbind(c(Intergenic5.4@n.biallelic.sites, divsites_inter4), c(Clusters5.4@n.biallelic.sites, divsites4))
MKT_4
chisq.test(MKT_4, simulate.p.value=TRUE)

MKT_5=rbind(c(Intergenic5.5@n.biallelic.sites, divsites_inter5), c(Clusters5.5@n.biallelic.sites, divsites5))
MKT_5
...
MKT_AFR_5=rbind(c(Intergenic5.5_AFR@n.biallelic.sites, divsites_inter5_AFR), c(Clusters5.5_AFR@n.biallelic.sites, divsites5_AFR))
MKT_AFR_5
...
MKT_AMR_5=rbind(c(Intergenic5.5_AMR@n.biallelic.sites, divsites_inter5_AMR), c(Clusters5.5_AMR@n.biallelic.sites, divsites5_AMR))
MKT_AMR_5
...
MKT_EAS_5=rbind(c(Intergenic5.5_EAS@n.biallelic.sites, divsites_inter5_EAS), c(Clusters5.5_EAS@n.biallelic.sites, divsites5_EAS))
MKT_EAS_5
...
MKT_EUR_5=rbind(c(Intergenic5.5_EUR@n.biallelic.sites, divsites_inter5_EUR), c(Clusters5.5_EUR@n.biallelic.sites, divsites5_EUR))
MKT_EUR_5
...
MKT_SAS_5=rbind(c(Intergenic5.5_SAS@n.biallelic.sites, divsites_inter5_SAS), c(Clusters5.5_SAS@n.biallelic.sites, divsites5_SAS))
MKT_SAS_5
