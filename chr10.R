...
Clusters.all <- readVCF("new_chr10.vcf.gz", numcols=10000, tid="10", from=29074929, to=94184786, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/35929)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 29074929:94184786))) # N polyallelic sites in that region
m <- 35929 -sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(29074929:29088891), c(45489591:45499469), c(51765930:51773243), c(59862000:59868949), c(72179774:72190667), c(85319031:85327160), c(91564793:91580773), c(94174861:94184786)), type=2)
...
#Cluster_1
Clusters_1 <- readVCF("new_chr10.vcf.gz", numcols=10000, tid="10", from=29074929, to=29088891, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/3188)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 29074929:29088891))) # N polyallelic sites in that region
m <- 3188-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr10.vcf.gz", numcols=10000, tid="10", from=45489591, to=45499469, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/1807)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 45489591:45499469))) # N polyallelic sites in that region
m <- 1807-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr10.vcf.gz", numcols=10000, tid="10", from=51765930, to=51773243, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/2984)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 51765930:51773243))) # N polyallelic sites in that region
m <- 2984-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr10.vcf.gz", numcols=10000, tid="10", from=59862000, to=59868949, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/6493)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 59862000:9868949))) # N polyallelic sites in that region
m <- 6493-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr10.vcf.gz", numcols=10000, tid="10", from=72179774, to=72190667, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/1662)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 72179774:72190667))) # N polyallelic sites in that region
m <- 1662-sum(misshuman,na.rm=T)-polysites
...
#Cluster_6
Clusters_6 <- readVCF("new_chr10.vcf.gz", numcols=10000, tid="10", from=85319031, to=85327160, include.unknown = TRUE)
...
Mu <- (Clusters_6@theta_Watterson/8129)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 85319031:85327160))) # N polyallelic sites in that region
m <- 8129-sum(misshuman,na.rm=T)-polysites
...
#Cluster_7
Clusters_7 <- readVCF("new_chr10.vcf.gz", numcols=10000, tid="10", from=91564793, to=91580773, include.unknown = TRUE)
...
Mu <- (Clusters_7@theta_Watterson/3949)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 91564793:91580773))) # N polyallelic sites in that region
m <- 3949-sum(misshuman,na.rm=T)-polysites
...
#Cluster_8
Clusters_8 <- readVCF("new_chr10.vcf.gz", numcols=10000, tid="10", from=94174861, to=94184786, include.unknown = TRUE)
...
Mu <- (Clusters_8@theta_Watterson/7717)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 94174861:94184786))) # N polyallelic sites in that region
m <- 7717-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr10_1.vcf.gz", numcols=10000, tid="10", from=29074929, to=94184786, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(29074929:29088891), c(45489591:45499469), c(51765930:51773243), c(59862000:59868949), c(72179774:72190667), c(85319031:85327160), c(91564793:91580773), c(94174861:94184786)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr10_1.vcf.gz", numcols=10000, tid="10", from=29074929, to=29088891, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/3188
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/3188)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr10_1.vcf.gz", numcols=10000, tid="10", from=45489591, to=45499469, include.unknown = TRUE)
...
divsites2_AFR
D <- divsites2_AFR/1807	
D

#Mutation rate
Clusters2_AFR <- neutrality.stats(Clusters2_AFR, FAST = TRUE)
Mu <- (Clusters2_AFR@theta_Watterson/1807)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr10_1.vcf.gz", numcols=10000, tid="10", from=51765930, to=51773243, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/2984
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/2984)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr10_1.vcf.gz", numcols=10000, tid="10", from=59862000, to=59868949, include.unknown = TRUE)
...
divsites4_AFR
D <- divsites4_AFR/6493
D

#Mutation rate
Clusters4_AFR <- neutrality.stats(Clusters4_AFR, FAST = TRUE)
Mu <- (Clusters4_AFR@theta_Watterson/6493)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 59862000:59862000))) # N polyallelic sites in that region
m <- 6493-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr10_1.vcf.gz", numcols=10000, tid="10", from=72179774, to=72190667, include.unknown = TRUE)
...
divsites5_AFR
D <- divsites5_AFR/1662
D

#Mutation rate
Clusters5_AFR <- neutrality.stats(Clusters5_AFR, FAST = TRUE)
Mu <- (Clusters5_AFR@theta_Watterson/1662)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AFR<- readVCF("new_chr10_1.vcf.gz", numcols=10000, tid="10", from=85319031, to=85327160, include.unknown = TRUE)
...
divsites6_AFR
D <- divsites6_AFR/8129
D

#Mutation rate
Clusters6_AFR <- neutrality.stats(Clusters6_AFR, FAST = TRUE)
Mu <- (Clusters6_AFR@theta_Watterson/8129)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AFR <- readVCF("new_chr10_1.vcf.gz", numcols=10000, tid="10", from=91564793, to=91580773, include.unknown = TRUE)
...
divsites7_AFR
D <- divsites7_AFR/3949
D

#Mutation rate
Clusters7_AFR <- neutrality.stats(Clusters7_AFR, FAST = TRUE)
Mu <- (Clusters7_AFR@theta_Watterson/3949)/(4*10000)
Mu
...
#Cluster_8
Clusters8_AFR <- readVCF("new_chr10_1.vcf.gz", numcols=10000, tid="10", from=94174861, to=94184786, include.unknown = TRUE)
...
divsites8_AFR
D <- divsites8_AFR/7717
D

#Mutation rate
Clusters8_AFR <- neutrality.stats(Clusters8_AFR, FAST = TRUE)
Mu <- (Clusters8_AFR@theta_Watterson/7717)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr10_2.vcf.gz", numcols=10000, tid="10", from=29074929, to=94184786, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(29074929:29088891), c(45489591:45499469), c(51765930:51773243), c(59862000:59868949), c(72179774:72190667), c(85319031:85327160), c(91564793:91580773), c(94174861:94184786)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr10_2.vcf.gz", numcols=10000, tid="10", from=29074929, to=29088891, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/3188
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/3188)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr10_2.vcf.gz", numcols=10000, tid="10", from=45489591, to=45499469, include.unknown = TRUE)
...
divsites2_AMR
D <- divsites2_AMR/1807	
D

#Mutation rate
Clusters2_AMR <- neutrality.stats(Clusters2_AMR, FAST = TRUE)
Mu <- (Clusters2_AMR@theta_Watterson/1807)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr10_2.vcf.gz", numcols=10000, tid="10", from=51765930, to=51773243, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/2984
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/2984)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr10_2.vcf.gz", numcols=10000, tid="10", from=59862000, to=59868949, include.unknown = TRUE)
...
divsites4_AMR
D <- divsites4_AMR/6493
D

#Mutation rate
Clusters4_AMR <- neutrality.stats(Clusters4_AMR, FAST = TRUE)
Mu <- (Clusters4_AMR@theta_Watterson/6493)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr10_2.vcf.gz", numcols=10000, tid="10", from=72179774, to=72190667, include.unknown = TRUE)
...
divsites5_AMR
D <- divsites5_AMR/1662
D

#Mutation rate
Clusters5_AMR <- neutrality.stats(Clusters5_AMR, FAST = TRUE)
Mu <- (Clusters5_AMR@theta_Watterson/1662)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AMR<- readVCF("new_chr10_2.vcf.gz", numcols=10000, tid="10", from=85319031, to=85327160, include.unknown = TRUE)
...
divsites6_AMR
D <- divsites6_AMR/8129
D

#Mutation rate
Clusters6_AMR <- neutrality.stats(Clusters6_AMR, FAST = TRUE)
Mu <- (Clusters6_AMR@theta_Watterson/8129)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AMR <- readVCF("new_chr10_2.vcf.gz", numcols=10000, tid="10", from=91564793, to=91580773, include.unknown = TRUE)
...
divsites7_AMR
D <- divsites7_AMR/3949
D

#Mutation rate
Clusters7_AMR <- neutrality.stats(Clusters7_AMR, FAST = TRUE)
Mu <- (Clusters7_AMR@theta_Watterson/3949)/(4*10000)
Mu
...
#Cluster_8
Clusters8_AMR <- readVCF("new_chr10_2.vcf.gz", numcols=10000, tid="10", from=94174861, to=94184786, include.unknown = TRUE)
...
divsites8_AMR
D <- divsites8_AMR/7717
D

#Mutation rate
Clusters8_AMR <- neutrality.stats(Clusters8_AMR, FAST = TRUE)
Mu <- (Clusters8_AMR@theta_Watterson/7717)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr10_3.vcf.gz", numcols=10000, tid="10", from=29074929, to=94184786, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(29074929:29088891), c(45489591:45499469), c(51765930:51773243), c(59862000:59868949), c(72179774:72190667), c(85319031:85327160), c(91564793:91580773), c(94174861:94184786)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr10_3.vcf.gz", numcols=10000, tid="10", from=29074929, to=29088891, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/3188
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/3188)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr10_3.vcf.gz", numcols=10000, tid="10", from=45489591, to=45499469, include.unknown = TRUE)
...
divsites2_EAS
D <- divsites2_EAS/1807	
D

#Mutation rate
Clusters2_EAS <- neutrality.stats(Clusters2_EAS, FAST = TRUE)
Mu <- (Clusters2_EAS@theta_Watterson/1807)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr10_3.vcf.gz", numcols=10000, tid="10", from=51765930, to=51773243, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/2984
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/2984)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr10_3.vcf.gz", numcols=10000, tid="10", from=59862000, to=59868949, include.unknown = TRUE)
...
divsites4_EAS
D <- divsites4_EAS/6493
D

#Mutation rate
Clusters4_EAS <- neutrality.stats(Clusters4_EAS, FAST = TRUE)
Mu <- (Clusters4_EAS@theta_Watterson/6493)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS<- readVCF("new_chr10_3.vcf.gz", numcols=10000, tid="10", from=72179774, to=72190667, include.unknown = TRUE)
...
divsites5_EAS
D <- divsites5_EAS/1662
D

#Mutation rate
Clusters5_EAS <- neutrality.stats(Clusters5_EAS, FAST = TRUE)
Mu <- (Clusters5_EAS@theta_Watterson/1662)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EAS<- readVCF("new_chr10_3.vcf.gz", numcols=10000, tid="10", from=85319031, to=85327160, include.unknown = TRUE)
...
divsites6_EAS
D <- divsites6_EAS/8129
D

#Mutation rate
Clusters6_EAS <- neutrality.stats(Clusters6_EAS, FAST = TRUE)
Mu <- (Clusters6_EAS@theta_Watterson/8129)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EAS <- readVCF("new_chr10_3.vcf.gz", numcols=10000, tid="10", from=91564793, to=91580773, include.unknown = TRUE)
...
divsites7_EAS
D <- divsites7_EAS/3949
D

#Mutation rate
Clusters7_EAS <- neutrality.stats(Clusters7_EAS, FAST = TRUE)
Mu <- (Clusters7_EAS@theta_Watterson/3949)/(4*10000)
Mu
...
#Cluster_8
Clusters8_EAS <- readVCF("new_chr10_3.vcf.gz", numcols=10000, tid="10", from=94174861, to=94184786, include.unknown = TRUE)
...
divsites8_EAS
D <- divsites8_EAS/7717
D

#Mutation rate
Clusters8_EAS <- neutrality.stats(Clusters8_EAS, FAST = TRUE)
Mu <- (Clusters8_EAS@theta_Watterson/7717)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr10_4.vcf.gz", numcols=10000, tid="10", from=29074929, to=94184786, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(29074929:29088891), c(45489591:45499469), c(51765930:51773243), c(59862000:59868949), c(72179774:72190667), c(85319031:85327160), c(91564793:91580773), c(94174861:94184786)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr10_4.vcf.gz", numcols=10000, tid="10", from=29074929, to=29088891, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/3188
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/3188)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr10_4.vcf.gz", numcols=10000, tid="10", from=45489591, to=45499469, include.unknown = TRUE)
...
divsites2_EUR
D <- divsites2_EUR/1807	
D

#Mutation rate
Clusters2_EUR <- neutrality.stats(Clusters2_EUR, FAST = TRUE)
Mu <- (Clusters2_EUR@theta_Watterson/1807)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr10_4.vcf.gz", numcols=10000, tid="10", from=51765930, to=51773243, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/2984
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/2984)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr10_4.vcf.gz", numcols=10000, tid="10", from=59862000, to=59868949, include.unknown = TRUE)
...
divsites4_EUR
D <- divsites4_EUR/6493
D

#Mutation rate
Clusters4_EUR <- neutrality.stats(Clusters4_EUR, FAST = TRUE)
Mu <- (Clusters4_EUR@theta_Watterson/6493)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR<- readVCF("new_chr10_4.vcf.gz", numcols=10000, tid="10", from=72179774, to=72190667, include.unknown = TRUE)
...
divsites5_EUR
D <- divsites5_EUR/1662
D

#Mutation rate
Clusters5_EUR <- neutrality.stats(Clusters5_EUR, FAST = TRUE)
Mu <- (Clusters5_EUR@theta_Watterson/1662)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EUR<- readVCF("new_chr10_4.vcf.gz", numcols=10000, tid="10", from=85319031, to=85327160, include.unknown = TRUE)
...
divsites6_EUR
D <- divsites6_EUR/8129
D

#Mutation rate
Clusters6_EUR <- neutrality.stats(Clusters6_EUR, FAST = TRUE)
Mu <- (Clusters6_EUR@theta_Watterson/8129)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EUR <- readVCF("new_chr10_4.vcf.gz", numcols=10000, tid="10", from=91564793, to=91580773, include.unknown = TRUE)
...
divsites7_EUR
D <- divsites7_EUR/3949
D

#Mutation rate
Clusters7_EUR <- neutrality.stats(Clusters7_EUR, FAST = TRUE)
Mu <- (Clusters7_EUR@theta_Watterson/3949)/(4*10000)
Mu
...
#Cluster_8
Clusters8_EUR <- readVCF("new_chr10_4.vcf.gz", numcols=10000, tid="10", from=94174861, to=94184786, include.unknown = TRUE)
...
divsites8_EUR
D <- divsites8_EUR/7717
D

#Mutation rate
Clusters8_EUR <- neutrality.stats(Clusters8_EUR, FAST = TRUE)
Mu <- (Clusters8_EUR@theta_Watterson/7717)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr10_5.vcf.gz", numcols=10000, tid="10", from=29074929, to=94184786, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(29074929:29088891), c(45489591:45499469), c(51765930:51773243), c(59862000:59868949), c(72179774:72190667), c(85319031:85327160), c(91564793:91580773), c(94174861:94184786)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr10_5.vcf.gz", numcols=10000, tid="10", from=29074929, to=29088891, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/3188
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/3188)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr10_5.vcf.gz", numcols=10000, tid="10", from=45489591, to=45499469, include.unknown = TRUE)
...
divsites2_SAS
D <- divsites2_SAS/1807	
D

#Mutation rate
Clusters2_SAS <- neutrality.stats(Clusters2_SAS, FAST = TRUE)
Mu <- (Clusters2_SAS@theta_Watterson/1807)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr10_5.vcf.gz", numcols=10000, tid="10", from=51765930, to=51773243, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/2984
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/2984)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr10_5.vcf.gz", numcols=10000, tid="10", from=59862000, to=59868949, include.unknown = TRUE)
...
divsites4_SAS
D <- divsites4_SAS/6493
D

#Mutation rate
Clusters4_SAS <- neutrality.stats(Clusters4_SAS, FAST = TRUE)
Mu <- (Clusters4_SAS@theta_Watterson/6493)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS<- readVCF("new_chr10_5.vcf.gz", numcols=10000, tid="10", from=72179774, to=72190667, include.unknown = TRUE)
...
divsites5_SAS
D <- divsites5_SAS/1662
D

#Mutation rate
Clusters5_SAS <- neutrality.stats(Clusters5_SAS, FAST = TRUE)
Mu <- (Clusters5_SAS@theta_Watterson/1662)/(4*10000)
Mu
...
#Cluster_6
Clusters6_SAS<- readVCF("new_chr10_5.vcf.gz", numcols=10000, tid="10", from=85319031, to=85327160, include.unknown = TRUE)
...
divsites6_SAS
D <- divsites6_SAS/8129
D

#Mutation rate
Clusters6_SAS <- neutrality.stats(Clusters6_SAS, FAST = TRUE)
Mu <- (Clusters6_SAS@theta_Watterson/8129)/(4*10000)
Mu
...
#Cluster_7
Clusters7_SAS <- readVCF("new_chr10_5.vcf.gz", numcols=10000, tid="10", from=91564793, to=91580773, include.unknown = TRUE)
...
divsites7_SAS
D <- divsites7_SAS/3949
D

#Mutation rate
Clusters7_SAS <- neutrality.stats(Clusters7_SAS, FAST = TRUE)
Mu <- (Clusters7_SAS@theta_Watterson/3949)/(4*10000)
Mu
...
#Cluster_8
Clusters8_SAS <- readVCF("new_chr10_5.vcf.gz", numcols=10000, tid="10", from=94174861, to=94184786, include.unknown = TRUE)
...
divsites8_SAS
D <- divsites8_SAS/7717
D

#Mutation rate
Clusters8_SAS <- neutrality.stats(Clusters8_SAS, FAST = TRUE)
Mu <- (Clusters8_SAS@theta_Watterson/7717)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr10_intergenic.vcf.gz", numcols=10000, tid="10", from=29049732, to=94200968, include.unknown = TRUE)
...
m <- 392743-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr10_intergenic.vcf.gz", numcols=10000, tid="10", from=29049732, to=29074928, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/25196
D

#Region 2
Intergenic2 <- readVCF("new_chr10_intergenic.vcf.gz", numcols=10000, tid="10", from=51773244, to=51780942, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/4906
D

#Region 3
Intergenic3 <- readVCF("new_chr10_intergenic.vcf.gz", numcols=10000, tid="10", from=51773244, to=51780942, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/4906
D

#Region 4
Intergenic4 <- readVCF("new_chr10_intergenic.vcf.gz", numcols=10000, tid="10", from=59868949, to=59951278, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/82329
D

#Region 5
Intergenic5 <- readVCF("new_chr10_intergenic.vcf.gz", numcols=10000, tid="10", from=72190668, to=72192071, include.unknown = TRUE)
...
divsites_inter5
D <- divsites_inter5/1403
D

#Region 6
Intergenic6 <- readVCF("new_chr10_intergenic.vcf.gz", numcols=10000, tid="10", from=85074231, to=85319031, include.unknown = TRUE)
...
divsites_inter6
D <- divsites_inter6/244800
D

#Region 7
Intergenic7 <- readVCF("new_chr10_intergenic.vcf.gz", numcols=10000, tid="10", from=91546864, to=91564792, include.unknown = TRUE)
...
divsites_inter7
D <- divsites_inter7/17928
D

#Region 8
Intergenic8 <- readVCF("new_chr10_intergenic.vcf.gz", numcols=10000, tid="10", from=94184787, to=94200968, include.unknown = TRUE)
...
divsites_inter8
D <- divsites_inter8/16181
D

###################POPULATIONS####################################################
#AFR
Intergenic.all_AFR <- readVCF("new_chr10_1_intergenic.vcf.gz", numcols=10000, tid="10", from=29049732, to=94200968, include.unknown = TRUE)
...
polysites <- sum(!is.na(match(polyal, 29049732:94200968))) # N polyallelic sites in that region
m <- 392743-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr10_1_intergenic.vcf.gz", numcols=10000, tid="10", from=29049732, to=29074928, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/25196
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr10_1_intergenic.vcf.gz", numcols=10000, tid="10", from=51773244, to=51780942, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/4906
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr10_1_intergenic.vcf.gz", numcols=10000, tid="10", from=51773244, to=51780942, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/4906
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr10_1_intergenic.vcf.gz", numcols=10000, tid="10", from=59868949, to=59951278, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/82329
D

#Region 5
Intergenic5_AFR <- readVCF("new_chr10_1_intergenic.vcf.gz", numcols=10000, tid="10", from=72190668, to=72192071, include.unknown = TRUE)
...
divsites_inter5_AFR
D <- divsites_inter5_AFR/1403
D

#Region 6
Intergenic6_AFR <- readVCF("new_chr10_1_intergenic.vcf.gz", numcols=10000, tid="10", from=85074231, to=85319031, include.unknown = TRUE)
...
divsites_inter6_AFR
D <- divsites_inter6_AFR/244800
D

#Region 7
Intergenic7_AFR <- readVCF("new_chr10_1_intergenic.vcf.gz", numcols=10000, tid="10", from=91546864, to=91564792, include.unknown = TRUE)
...
divsites_inter7_AFR
D <- divsites_inter7_AFR/17928
D

#Region 8 
Intergenic8_AFR <- readVCF("new_chr10_1_intergenic.vcf.gz", numcols=10000, tid="10", from=94184787, to=94200968, include.unknown = TRUE)
...
divsites_inter8_AFR
D <- divsites_inter8_AFR/16181
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr10_2_intergenic.vcf.gz", numcols=10000, tid="10", from=29049732, to=94200968, include.unknown = TRUE)
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr10_2_intergenic.vcf.gz", numcols=10000, tid="10", from=29049732, to=29074928, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/25196
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr10_2_intergenic.vcf.gz", numcols=10000, tid="10", from=51773244, to=51780942, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/4906
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr10_2_intergenic.vcf.gz", numcols=10000, tid="10", from=51773244, to=51780942, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/4906
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr10_2_intergenic.vcf.gz", numcols=10000, tid="10", from=59868949, to=59951278, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/82329
D

#Region 5
Intergenic5_AMR <- readVCF("new_chr10_2_intergenic.vcf.gz", numcols=10000, tid="10", from=72190668, to=72192071, include.unknown = TRUE)
...
divsites_inter5_AMR
D <- divsites_inter5_AMR/1403
D

#Region 6
Intergenic6_AMR <- readVCF("new_chr10_2_intergenic.vcf.gz", numcols=10000, tid="10", from=85074231, to=85319031, include.unknown = TRUE)
...
divsites_inter6_AMR
D <- divsites_inter6_AMR/244800
D

#Region 7
Intergenic7_AMR <- readVCF("new_chr10_2_intergenic.vcf.gz", numcols=10000, tid="10", from=91546864, to=91564792, include.unknown = TRUE)
...
divsites_inter7_AMR
D <- divsites_inter7_AMR/17928
D

#Region 8 
Intergenic8_AMR <- readVCF("new_chr10_2_intergenic.vcf.gz", numcols=10000, tid="10", from=94184787, to=94200968, include.unknown = TRUE)
...
divsites_inter8_AMR
D <- divsites_inter8_AMR/16181
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr10_3_intergenic.vcf.gz", numcols=10000, tid="10", from=29049732, to=94200968, include.unknown = TRUE)
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr10_3_intergenic.vcf.gz", numcols=10000, tid="10", from=29049732, to=29074928, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/25196
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr10_3_intergenic.vcf.gz", numcols=10000, tid="10", from=51773244, to=51780942, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/4906
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr10_3_intergenic.vcf.gz", numcols=10000, tid="10", from=51773244, to=51780942, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/4906
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr10_3_intergenic.vcf.gz", numcols=10000, tid="10", from=59868949, to=59951278, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/82329
D

#Region 5
Intergenic5_EAS <- readVCF("new_chr10_3_intergenic.vcf.gz", numcols=10000, tid="10", from=72190668, to=72192071, include.unknown = TRUE)
...
divsites_inter5_EAS
D <- divsites_inter5_EAS/1403
D

#Region 6
Intergenic6_EAS <- readVCF("new_chr10_3_intergenic.vcf.gz", numcols=10000, tid="10", from=85074231, to=85319031, include.unknown = TRUE)
...
divsites_inter6_EAS
D <- divsites_inter6_EAS/244800
D

#Region 7
Intergenic7_EAS <- readVCF("new_chr10_3_intergenic.vcf.gz", numcols=10000, tid="10", from=91546864, to=91564792, include.unknown = TRUE)
...
divsites_inter7_EAS
D <- divsites_inter7_EAS/17928
D

#Region 8 
Intergenic8_EAS <- readVCF("new_chr10_3_intergenic.vcf.gz", numcols=10000, tid="10", from=94184787, to=94200968, include.unknown = TRUE)
...
divsites_inter8_EAS
D <- divsites_inter8_EAS/16181
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr10_4_intergenic.vcf.gz", numcols=10000, tid="10", from=29049732, to=94200968, include.unknown = TRUE)
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr10_4_intergenic.vcf.gz", numcols=10000, tid="10", from=29049732, to=29074928, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/25196
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr10_4_intergenic.vcf.gz", numcols=10000, tid="10", from=51773244, to=51780942, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/4906
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr10_4_intergenic.vcf.gz", numcols=10000, tid="10", from=51773244, to=51780942, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/4906
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr10_4_intergenic.vcf.gz", numcols=10000, tid="10", from=59868949, to=59951278, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/82329
D

#Region 5
Intergenic5_EUR <- readVCF("new_chr10_4_intergenic.vcf.gz", numcols=10000, tid="10", from=72190668, to=72192071, include.unknown = TRUE)
...
divsites_inter5_EUR
D <- divsites_inter5_EUR/1403
D

#Region 6
Intergenic6_EUR <- readVCF("new_chr10_4_intergenic.vcf.gz", numcols=10000, tid="10", from=85074231, to=85319031, include.unknown = TRUE)
...
divsites_inter6_EUR
D <- divsites_inter6_EUR/244800
D

#Region 7
Intergenic7_EUR <- readVCF("new_chr10_4_intergenic.vcf.gz", numcols=10000, tid="10", from=91546864, to=91564792, include.unknown = TRUE)
...
divsites_inter7_EUR
D <- divsites_inter7_EUR/17928
D

#Region 8 
Intergenic8_EUR <- readVCF("new_chr10_4_intergenic.vcf.gz", numcols=10000, tid="10", from=94184787, to=94200968, include.unknown = TRUE)
...
divsites_inter8_EUR
D <- divsites_inter8_EUR/16181
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr10_5_intergenic.vcf.gz", numcols=10000, tid="10", from=29049732, to=94200968, include.unknown = TRUE)
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr10_5_intergenic.vcf.gz", numcols=10000, tid="10", from=29049732, to=29074928, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/25196
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr10_5_intergenic.vcf.gz", numcols=10000, tid="10", from=51773244, to=51780942, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/4906
D

#Region 3
Intergenic3_SAS <- readVCF("new_chr10_5_intergenic.vcf.gz", numcols=10000, tid="10", from=51773244, to=51780942, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/4906
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr10_5_intergenic.vcf.gz", numcols=10000, tid="10", from=59868949, to=59951278, include.unknown = TRUE)
...
divsites_inter4_SAS
D <- divsites_inter4_SAS/82329
D

#Region 5
Intergenic5_SAS <- readVCF("new_chr10_5_intergenic.vcf.gz", numcols=10000, tid="10", from=72190668, to=72192071, include.unknown = TRUE)
...
divsites_inter5_SAS
D <- divsites_inter5_SAS/1403
D

#Region 6
Intergenic6_SAS <- readVCF("new_chr10_5_intergenic.vcf.gz", numcols=10000, tid="10", from=85074231, to=85319031, include.unknown = TRUE)
...
divsites_inter6_SAS
D <- divsites_inter6_SAS/244800
D

#Region 7
Intergenic7_SAS <- readVCF("new_chr10_5_intergenic.vcf.gz", numcols=10000, tid="10", from=91546864, to=91564792, include.unknown = TRUE)
...
divsites_inter7_SAS
D <- divsites_inter7_SAS/17928
D

#Region 8 
Intergenic8_SAS <- readVCF("new_chr10_5_intergenic.vcf.gz", numcols=10000, tid="10", from=94184787, to=94200968, include.unknown = TRUE)
