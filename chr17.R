...
Clusters.all <- readVCF("new_chr17.vcf.gz", numcols=10000, tid="17", from=7231762, to=79483935, include.unknown = TRUE)
...
Mu <- (Clusters.all@theta_Watterson/23613)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 7231762:79483935))) # N polyallelic sites in that region
m <- 23613-sum(misshuman,na.rm=T)-polysites
...
Clusters.all.split <- splitting.data (Clusters.all, positions = list(c(7231762:7239463), c(18216209:18232206), c(26586053:26605774), c(34229674:34248832), c(36552280:36562782), c(66117204:66135103), c(73056106:73063992), c(74553469:74562102), c(76985085:76993110), c(79473027:79483935)), type=2)
...
Clusters.all.split@nuc.F_ST.vs.all [[1]]
Clusters.all.split@nuc.F_ST.vs.all [[2]]
Clusters.all.split@nuc.F_ST.vs.all [[3]]
Clusters.all.split@nuc.F_ST.vs.all [[4]]
Clusters.all.split@nuc.F_ST.vs.all [[5]]

###########################Analysis per cluster##################################

#Cluster_1
Clusters_1 <- readVCF("new_chr17.vcf.gz", numcols=10000, tid="17", from=7231762, to=7239463, include.unknown = TRUE)
...
Mu <- (Clusters_1@theta_Watterson/1790)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 7231762:7239463))) # N polyallelic sites in that region
m <- 1790-sum(misshuman,na.rm=T)-polysites
...
#Cluster_2
Clusters_2 <- readVCF("new_chr17.vcf.gz", numcols=10000, tid="17", from=18216209, to=18232206, include.unknown = TRUE)
...
Mu <- (Clusters_2@theta_Watterson/303)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 18216209:18232206))) # N polyallelic sites in that region
m <- 303-sum(misshuman,na.rm=T)-polysites
...
#Cluster_3
Clusters_3 <- readVCF("new_chr17.vcf.gz", numcols=10000, tid="17", from=26586053, to=26605774, include.unknown = TRUE)
...
Mu <- (Clusters_3@theta_Watterson/5396)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 26586053:26605774))) # N polyallelic sites in that region
m <- 5396-sum(misshuman,na.rm=T)-polysites
...
#Cluster_4
Clusters_4 <- readVCF("new_chr17.vcf.gz", numcols=10000, tid="17", from=34229674, to=34248832, include.unknown = TRUE)
...
Mu <- (Clusters_4@theta_Watterson/1668)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 34229674:34248832))) # N polyallelic sites in that region
m <- 1668-sum(misshuman,na.rm=T)-polysites
...
#Cluster_5
Clusters_5 <- readVCF("new_chr17.vcf.gz", numcols=10000, tid="17", from=36552280, to=36562782, include.unknown = TRUE)
...
Mu <- (Clusters_5@theta_Watterson/936)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 36552280:36562782))) # N polyallelic sites in that region
m <- 936 -sum(misshuman,na.rm=T)-polysites
...
#Cluster_6
Clusters_6 <- readVCF("new_chr17.vcf.gz", numcols=10000, tid="17", from=66117204, to=66135103, include.unknown = TRUE)
...
Mu <- (Clusters_6@theta_Watterson/4714)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 66117204:66135103))) # N polyallelic sites in that region
m <- 4714-sum(misshuman,na.rm=T)-polysites
...
#Cluster_7
Clusters_7 <- readVCF("new_chr17.vcf.gz", numcols=10000, tid="17", from=73056106, to=73063992, include.unknown = TRUE)
...
Mu <- (Clusters_7@theta_Watterson/2008)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 73056106:73063992))) # N polyallelic sites in that region
m <- 2008-sum(misshuman,na.rm=T)-polysites
...
#Cluster_8
Clusters_8 <- readVCF("new_chr17.vcf.gz", numcols=10000, tid="17", from=74553469, to=74562102, include.unknown = TRUE)
...
Mu <- (Clusters_8@theta_Watterson/114)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 74553469:74562102))) # N polyallelic sites in that region
m <- 114-sum(misshuman,na.rm=T)-polysites
...
#Cluster_9
Clusters_9 <- readVCF("new_chr17.vcf.gz", numcols=10000, tid="17", from=76985085, to=79483935, include.unknown = TRUE)
...
Mu <- (Clusters_9@theta_Watterson/2714)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 76985085:79483935))) # N polyallelic sites in that region
m <- 2714-sum(misshuman,na.rm=T)-polysites
...
#Cluster_10
Clusters_10 <- readVCF("new_chr17.vcf.gz", numcols=10000, tid="17", from=79473027, to=79483935, include.unknown = TRUE)
...
Mu <- (Clusters_10@theta_Watterson/3970)/40000
Mu
...
polysites <- sum(!is.na(match(polyal, 79473027:79483935))) # N polyallelic sites in that region
m <- 3970-sum(misshuman,na.rm=T)-polysites
...
#AFR
Clusters.all_AFR <- readVCF("new_chr17_1.vcf.gz", numcols=10000, tid="17", from=7231762, to=79483935, include.unknown = TRUE)
...
Clusters.all_AFR.split <- splitting.data (Clusters.all_AFR, positions = list(c(7231762:7239463), c(18216209:18232206), c(26586053:26605774), c(34229674:34248832), c(36552280:36562782), c(66117204:66135103), c(73056106:73063992), c(74553469:74562102), c(76985085:76993110), c(79473027:79483935)), type=2)
...
#Cluster_1
Clusters1_AFR<- readVCF("new_chr17_1.vcf.gz", numcols=10000, tid="17", from=7231762, to=7239463, include.unknown = TRUE)
...
divsites1_AFR
D <- divsites1_AFR/1790
D

#Mutation rate
Clusters1_AFR <- neutrality.stats(Clusters1_AFR, FAST = TRUE)
Mu <- (Clusters1_AFR@theta_Watterson/1790)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AFR<- readVCF("new_chr17_1.vcf.gz", numcols=10000, tid="17", from=18216209, to=18232206, include.unknown = TRUE)
...
Mu <- (Clusters2_AFR@theta_Watterson/303)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AFR <- readVCF("new_chr17_1.vcf.gz", numcols=10000, tid="17", from=26586053, to=26605774, include.unknown = TRUE)
...
divsites3_AFR
D <- divsites3_AFR/5396
D

#Mutation rate
Clusters3_AFR <- neutrality.stats(Clusters3_AFR, FAST = TRUE)
Mu <- (Clusters3_AFR@theta_Watterson/5396)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AFR <- readVCF("new_chr17_1.vcf.gz", numcols=10000, tid="17", from=34229674, to=34248832, include.unknown = TRUE)
...
divsites4_AFR
D <- divsites4_AFR/1668
D

#Mutation rate
Clusters4_AFR <- neutrality.stats(Clusters4_AFR, FAST = TRUE)
Mu <- (Clusters4_AFR@theta_Watterson/1668)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AFR<- readVCF("new_chr17_1.vcf.gz", numcols=10000, tid="17", from=36552280, to=36562782, include.unknown = TRUE)
...
Mu <- (Clusters5_AFR@theta_Watterson/936)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AFR<- readVCF("new_chr17_1.vcf.gz", numcols=10000, tid="17", from=66117204, to=66135103, include.unknown = TRUE)
...
divsites6_AFR
D <- divsites6_AFR/4714
D

#Mutation rate
Clusters6_AFR <- neutrality.stats(Clusters6_AFR, FAST = TRUE)
Mu <- (Clusters6_AFR@theta_Watterson/4714)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AFR <- readVCF("new_chr17_1.vcf.gz", numcols=10000, tid="17", from=73056106, to=73063992, include.unknown = TRUE)
...
divsites7_AFR
D <- divsites7_AFR/2008
D

#Mutation rate
Clusters7_AFR <- neutrality.stats(Clusters7_AFR, FAST = TRUE)
Mu <- (Clusters7_AFR@theta_Watterson/2008)/(4*10000)
Mu
...
#Cluster_8
Clusters8_AFR <- readVCF("new_chr17_1.vcf.gz", numcols=10000, tid="17", from=74553469, to=74562102, include.unknown = TRUE)
...
Mu <- (Clusters8_AFR@theta_Watterson/114)/(4*10000)
Mu
...
#Cluster_9
Clusters9_AFR <- readVCF("new_chr17_1.vcf.gz", numcols=10000, tid="17", from=76985085, to=76993110, include.unknown = TRUE)
...
divsites9_AFR
D <- divsites9_AFR/2714
D

#Mutation rate
Clusters9_AFR <- neutrality.stats(Clusters9_AFR, FAST = TRUE)
Mu <- (Clusters9_AFR@theta_Watterson/2714)/(4*10000)
Mu
...
polysites <- sum(!is.na(match(polyal, 76985085:76993110))) # N polyallelic sites in that region
m <- 2714-sum(misshuman,na.rm=T)-polysites
...
#Cluster_10
Clusters10_AFR <- readVCF("new_chr17_1.vcf.gz", numcols=10000, tid="17", from=79473027, to=79483935, include.unknown = TRUE)
...
divsites10_AFR
D <- divsites10_AFR/3970
D

#Mutation rate
Clusters10_AFR <- neutrality.stats(Clusters10_AFR, FAST = TRUE)
Mu <- (Clusters10_AFR@theta_Watterson/3970)/(4*10000)
Mu
...
#AMR
Clusters.all_AMR <- readVCF("new_chr17_2.vcf.gz", numcols=10000, tid="17", from=7231762, to=79483935, include.unknown = TRUE)
...
Clusters.all_AMR.split <- splitting.data (Clusters.all_AMR, positions = list(c(7231762:7239463), c(18216209:18232206), c(26586053:26605774), c(34229674:34248832), c(36552280:36562782), c(66117204:66135103), c(73056106:73063992), c(74553469:74562102), c(76985085:76993110), c(79473027:79483935)), type=2)
...
#Cluster_1
Clusters1_AMR<- readVCF("new_chr17_2.vcf.gz", numcols=10000, tid="17", from=7231762, to=7239463, include.unknown = TRUE)
...
divsites1_AMR
D <- divsites1_AMR/1790
D

#Mutation rate
Clusters1_AMR <- neutrality.stats(Clusters1_AMR, FAST = TRUE)
Mu <- (Clusters1_AMR@theta_Watterson/1790)/(4*10000)
Mu
...
#Cluster_2
Clusters2_AMR<- readVCF("new_chr17_2.vcf.gz", numcols=10000, tid="17", from=18216209, to=18232206, include.unknown = TRUE)
...
Mu <- (Clusters2_AMR@theta_Watterson/303)/(4*10000)
Mu
...
#Cluster_3
Clusters3_AMR <- readVCF("new_chr17_2.vcf.gz", numcols=10000, tid="17", from=26586053, to=26605774, include.unknown = TRUE)
...
divsites3_AMR
D <- divsites3_AMR/5396
D

#Mutation rate
Clusters3_AMR <- neutrality.stats(Clusters3_AMR, FAST = TRUE)
Mu <- (Clusters3_AMR@theta_Watterson/5396)/(4*10000)
Mu
...
#Cluster_4
Clusters4_AMR <- readVCF("new_chr17_2.vcf.gz", numcols=10000, tid="17", from=34229674, to=34248832, include.unknown = TRUE)
...
divsites4_AMR
D <- divsites4_AMR/1668
D

#Mutation rate
Clusters4_AMR <- neutrality.stats(Clusters4_AMR, FAST = TRUE)
Mu <- (Clusters4_AMR@theta_Watterson/1668)/(4*10000)
Mu
...
#Cluster_5
Clusters5_AMR<- readVCF("new_chr17_2.vcf.gz", numcols=10000, tid="17", from=36552280, to=36562782, include.unknown = TRUE)
...
Mu <- (Clusters5_AMR@theta_Watterson/936)/(4*10000)
Mu
...
#Cluster_6
Clusters6_AMR<- readVCF("new_chr17_2.vcf.gz", numcols=10000, tid="17", from=66117204, to=66135103, include.unknown = TRUE)
...
divsites6_AMR
D <- divsites6_AMR/4714
D

#Mutation rate
Clusters6_AMR <- neutrality.stats(Clusters6_AMR, FAST = TRUE)
Mu <- (Clusters6_AMR@theta_Watterson/4714)/(4*10000)
Mu
...
#Cluster_7
Clusters7_AMR <- readVCF("new_chr17_2.vcf.gz", numcols=10000, tid="17", from=73056106, to=73063992, include.unknown = TRUE)
...
divsites7_AMR
D <- divsites7_AMR/2008
D

#Mutation rate
Clusters7_AMR <- neutrality.stats(Clusters7_AMR, FAST = TRUE)
Mu <- (Clusters7_AMR@theta_Watterson/2008)/(4*10000)
Mu
...
#Cluster_8
Clusters8_AMR <- readVCF("new_chr17_2.vcf.gz", numcols=10000, tid="17", from=74553469, to=74562102, include.unknown = TRUE)
...
Mu <- (Clusters8_AMR@theta_Watterson/114)/(4*10000)
Mu
...
#Cluster_9
Clusters9_AMR <- readVCF("new_chr17_2.vcf.gz", numcols=10000, tid="17", from=76985085, to=76993110, include.unknown = TRUE)
...
divsites9_AMR
D <- divsites9_AMR/2714
D

#Mutation rate
Clusters9_AMR <- neutrality.stats(Clusters9_AMR, FAST = TRUE)
Mu <- (Clusters9_AMR@theta_Watterson/2714)/(4*10000)
Mu
...
#Cluster_10
Clusters10_AMR <- readVCF("new_chr17_2.vcf.gz", numcols=10000, tid="17", from=79473027, to=79483935, include.unknown = TRUE)
...
divsites10_AMR
D <- divsites10_AMR/3970
D

#Mutation rate
Clusters10_AMR <- neutrality.stats(Clusters10_AMR, FAST = TRUE)
Mu <- (Clusters10_AMR@theta_Watterson/3970)/(4*10000)
Mu
...
#EAS
Clusters.all_EAS <- readVCF("new_chr17_3.vcf.gz", numcols=10000, tid="17", from=7231762, to=79483935, include.unknown = TRUE)
...
Clusters.all_EAS.split <- splitting.data (Clusters.all_EAS, positions = list(c(7231762:7239463), c(18216209:18232206), c(26586053:26605774), c(34229674:34248832), c(36552280:36562782), c(66117204:66135103), c(73056106:73063992), c(74553469:74562102), c(76985085:76993110), c(79473027:79483935)), type=2)
...
#Cluster_1
Clusters1_EAS<- readVCF("new_chr17_3.vcf.gz", numcols=10000, tid="17", from=7231762, to=7239463, include.unknown = TRUE)
...
divsites1_EAS
D <- divsites1_EAS/1790
D

#Mutation rate
Clusters1_EAS <- neutrality.stats(Clusters1_EAS, FAST = TRUE)
Mu <- (Clusters1_EAS@theta_Watterson/1790)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EAS<- readVCF("new_chr17_3.vcf.gz", numcols=10000, tid="17", from=18216209, to=18232206, include.unknown = TRUE)
...
Mu <- (Clusters2_EAS@theta_Watterson/303)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EAS <- readVCF("new_chr17_3.vcf.gz", numcols=10000, tid="17", from=26586053, to=26605774, include.unknown = TRUE)
...
divsites3_EAS
D <- divsites3_EAS/5396
D

#Mutation rate
Clusters3_EAS <- neutrality.stats(Clusters3_EAS, FAST = TRUE)
Mu <- (Clusters3_EAS@theta_Watterson/5396)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EAS <- readVCF("new_chr17_3.vcf.gz", numcols=10000, tid="17", from=34229674, to=34248832, include.unknown = TRUE)
...
divsites4_EAS
D <- divsites4_EAS/1668
D

#Mutation rate
Clusters4_EAS <- neutrality.stats(Clusters4_EAS, FAST = TRUE)
Mu <- (Clusters4_EAS@theta_Watterson/1668)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EAS<- readVCF("new_chr17_3.vcf.gz", numcols=10000, tid="17", from=36552280, to=36562782, include.unknown = TRUE)
...
Mu <- (Clusters5_EAS@theta_Watterson/936)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EAS<- readVCF("new_chr17_3.vcf.gz", numcols=10000, tid="17", from=66117204, to=66135103, include.unknown = TRUE)
...
divsites6_EAS
D <- divsites6_EAS/4714
D

#Mutation rate
Clusters6_EAS <- neutrality.stats(Clusters6_EAS, FAST = TRUE)
Mu <- (Clusters6_EAS@theta_Watterson/4714)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EAS <- readVCF("new_chr17_3.vcf.gz", numcols=10000, tid="17", from=73056106, to=73063992, include.unknown = TRUE)
...
divsites7_EAS
D <- divsites7_EAS/2008
D

#Mutation rate
Clusters7_EAS <- neutrality.stats(Clusters7_EAS, FAST = TRUE)
Mu <- (Clusters7_EAS@theta_Watterson/2008)/(4*10000)
Mu
...
#Cluster_8
Clusters8_EAS <- readVCF("new_chr17_3.vcf.gz", numcols=10000, tid="17", from=74553469, to=74562102, include.unknown = TRUE)
...
Mu <- (Clusters8_EAS@theta_Watterson/114)/(4*10000)
Mu
...
#Cluster_9
Clusters9_EAS <- readVCF("new_chr17_3.vcf.gz", numcols=10000, tid="17", from=76985085, to=76993110, include.unknown = TRUE)
...
divsites9_EAS
D <- divsites9_EAS/2714
D

#Mutation rate
Clusters9_EAS <- neutrality.stats(Clusters9_EAS, FAST = TRUE)
Mu <- (Clusters9_EAS@theta_Watterson/2714)/(4*10000)
Mu
...
#Cluster_10
Clusters10_EAS <- readVCF("new_chr17_3.vcf.gz", numcols=10000, tid="17", from=79473027, to=79483935, include.unknown = TRUE)
...
divsites10_EAS
D <- divsites10_EAS/3970
D

#Mutation rate
Clusters10_EAS <- neutrality.stats(Clusters10_EAS, FAST = TRUE)
Mu <- (Clusters10_EAS@theta_Watterson/3970)/(4*10000)
Mu
...
#EUR
Clusters.all_EUR <- readVCF("new_chr17_4.vcf.gz", numcols=10000, tid="17", from=7231762, to=79483935, include.unknown = TRUE)
...
Clusters.all_EUR.split <- splitting.data (Clusters.all_EUR, positions = list(c(7231762:7239463), c(18216209:18232206), c(26586053:26605774), c(34229674:34248832), c(36552280:36562782), c(66117204:66135103), c(73056106:73063992), c(74553469:74562102), c(76985085:76993110), c(79473027:79483935)), type=2)
...
#Cluster_1
Clusters1_EUR<- readVCF("new_chr17_4.vcf.gz", numcols=10000, tid="17", from=7231762, to=7239463, include.unknown = TRUE)
...
divsites1_EUR
D <- divsites1_EUR/1790
D

#Mutation rate
Clusters1_EUR <- neutrality.stats(Clusters1_EUR, FAST = TRUE)
Mu <- (Clusters1_EUR@theta_Watterson/1790)/(4*10000)
Mu
...
#Cluster_2
Clusters2_EUR<- readVCF("new_chr17_4.vcf.gz", numcols=10000, tid="17", from=18216209, to=18232206, include.unknown = TRUE)
...
Mu <- (Clusters2_EUR@theta_Watterson/303)/(4*10000)
Mu
...
#Cluster_3
Clusters3_EUR <- readVCF("new_chr17_4.vcf.gz", numcols=10000, tid="17", from=26586053, to=26605774, include.unknown = TRUE)
...
divsites3_EUR
D <- divsites3_EUR/5396
D

#Mutation rate
Clusters3_EUR <- neutrality.stats(Clusters3_EUR, FAST = TRUE)
Mu <- (Clusters3_EUR@theta_Watterson/5396)/(4*10000)
Mu
...
#Cluster_4
Clusters4_EUR <- readVCF("new_chr17_4.vcf.gz", numcols=10000, tid="17", from=34229674, to=34248832, include.unknown = TRUE)
...
divsites4_EUR
D <- divsites4_EUR/1668
D

#Mutation rate
Clusters4_EUR <- neutrality.stats(Clusters4_EUR, FAST = TRUE)
Mu <- (Clusters4_EUR@theta_Watterson/1668)/(4*10000)
Mu
...
#Cluster_5
Clusters5_EUR<- readVCF("new_chr17_4.vcf.gz", numcols=10000, tid="17", from=36552280, to=36562782, include.unknown = TRUE)
...
Mu <- (Clusters5_EUR@theta_Watterson/936)/(4*10000)
Mu
...
#Cluster_6
Clusters6_EUR<- readVCF("new_chr17_4.vcf.gz", numcols=10000, tid="17", from=66117204, to=66135103, include.unknown = TRUE)
...
divsites6_EUR
D <- divsites6_EUR/4714
D

#Mutation rate
Clusters6_EUR <- neutrality.stats(Clusters6_EUR, FAST = TRUE)
Mu <- (Clusters6_EUR@theta_Watterson/4714)/(4*10000)
Mu
...
#Cluster_7
Clusters7_EUR <- readVCF("new_chr17_4.vcf.gz", numcols=10000, tid="17", from=73056106, to=73063992, include.unknown = TRUE)
...
divsites7_EUR
D <- divsites7_EUR/2008
D

#Mutation rate
Clusters7_EUR <- neutrality.stats(Clusters7_EUR, FAST = TRUE)
Mu <- (Clusters7_EUR@theta_Watterson/2008)/(4*10000)
Mu
...
#Cluster_8
Clusters8_EUR <- readVCF("new_chr17_4.vcf.gz", numcols=10000, tid="17", from=74553469, to=74562102, include.unknown = TRUE)
...
Mu <- (Clusters8_EUR@theta_Watterson/114)/(4*10000)
Mu
...
#Cluster_9
Clusters9_EUR <- readVCF("new_chr17_4.vcf.gz", numcols=10000, tid="17", from=76985085, to=76993110, include.unknown = TRUE)
...
divsites9_EUR
D <- divsites9_EUR/2714
D

#Mutation rate
Clusters9_EUR <- neutrality.stats(Clusters9_EUR, FAST = TRUE)
Mu <- (Clusters9_EUR@theta_Watterson/2714)/(4*10000)
Mu
...
#Cluster_10
Clusters10_EUR <- readVCF("new_chr17_4.vcf.gz", numcols=10000, tid="17", from=79473027, to=79483935, include.unknown = TRUE)
...
divsites10_EUR
D <- divsites10_EUR/3970
D

#Mutation rate
Clusters10_EUR <- neutrality.stats(Clusters10_EUR, FAST = TRUE)
Mu <- (Clusters10_EUR@theta_Watterson/3970)/(4*10000)
Mu
...
#SAS
Clusters.all_SAS <- readVCF("new_chr17_5.vcf.gz", numcols=10000, tid="17", from=7231762, to=79483935, include.unknown = TRUE)
...
Clusters.all_SAS.split <- splitting.data (Clusters.all_SAS, positions = list(c(7231762:7239463), c(18216209:18232206), c(26586053:26605774), c(34229674:34248832), c(36552280:36562782), c(66117204:66135103), c(73056106:73063992), c(74553469:74562102), c(76985085:76993110), c(79473027:79483935)), type=2)
...
#Cluster_1
Clusters1_SAS<- readVCF("new_chr17_5.vcf.gz", numcols=10000, tid="17", from=7231762, to=7239463, include.unknown = TRUE)
...
divsites1_SAS
D <- divsites1_SAS/1790
D

#Mutation rate
Clusters1_SAS <- neutrality.stats(Clusters1_SAS, FAST = TRUE)
Mu <- (Clusters1_SAS@theta_Watterson/1790)/(4*10000)
Mu
...
#Cluster_2
Clusters2_SAS<- readVCF("new_chr17_5.vcf.gz", numcols=10000, tid="17", from=18216209, to=18232206, include.unknown = TRUE)
...
Mu <- (Clusters2_SAS@theta_Watterson/303)/(4*10000)
Mu
...
#Cluster_3
Clusters3_SAS <- readVCF("new_chr17_5.vcf.gz", numcols=10000, tid="17", from=26586053, to=26605774, include.unknown = TRUE)
...
divsites3_SAS
D <- divsites3_SAS/5396
D

#Mutation rate
Clusters3_SAS <- neutrality.stats(Clusters3_SAS, FAST = TRUE)
Mu <- (Clusters3_SAS@theta_Watterson/5396)/(4*10000)
Mu
...
#Cluster_4
Clusters4_SAS <- readVCF("new_chr17_5.vcf.gz", numcols=10000, tid="17", from=34229674, to=34248832, include.unknown = TRUE)
...
divsites4_SAS
D <- divsites4_SAS/1668
D

#Mutation rate
Clusters4_SAS <- neutrality.stats(Clusters4_SAS, FAST = TRUE)
Mu <- (Clusters4_SAS@theta_Watterson/1668)/(4*10000)
Mu
...
#Cluster_5
Clusters5_SAS<- readVCF("new_chr17_5.vcf.gz", numcols=10000, tid="17", from=36552280, to=36562782, include.unknown = TRUE)
...
Mu <- (Clusters5_SAS@theta_Watterson/936)/(4*10000)
Mu
...
#Cluster_6
Clusters6_SAS<- readVCF("new_chr17_5.vcf.gz", numcols=10000, tid="17", from=66117204, to=66135103, include.unknown = TRUE)
...
divsites6_SAS
D <- divsites6_SAS/4714
D

#Mutation rate
Clusters6_SAS <- neutrality.stats(Clusters6_SAS, FAST = TRUE)
Mu <- (Clusters6_SAS@theta_Watterson/4714)/(4*10000)
Mu
...
#Cluster_7
Clusters7_SAS <- readVCF("new_chr17_5.vcf.gz", numcols=10000, tid="17", from=73056106, to=73063992, include.unknown = TRUE)
...
divsites7_SAS
D <- divsites7_SAS/2008
D

#Mutation rate
Clusters7_SAS <- neutrality.stats(Clusters7_SAS, FAST = TRUE)
Mu <- (Clusters7_SAS@theta_Watterson/2008)/(4*10000)
Mu
...
#Cluster_8
Clusters8_SAS <- readVCF("new_chr17_5.vcf.gz", numcols=10000, tid="17", from=74553469, to=74562102, include.unknown = TRUE)
...
Mu <- (Clusters8_SAS@theta_Watterson/114)/(4*10000)
Mu
...
#Cluster_9
Clusters9_SAS <- readVCF("new_chr17_5.vcf.gz", numcols=10000, tid="17", from=76985085, to=76993110, include.unknown = TRUE)
...
divsites9_SAS
D <- divsites9_SAS/2714
D

#Mutation rate
Clusters9_SAS <- neutrality.stats(Clusters9_SAS, FAST = TRUE)
Mu <- (Clusters9_SAS@theta_Watterson/2714)/(4*10000)
Mu
...
#Cluster_10
Clusters10_SAS <- readVCF("new_chr17_5.vcf.gz", numcols=10000, tid="17", from=79473027, to=79483935, include.unknown = TRUE)
...
divsites10_SAS
D <- divsites10_SAS/3970
D

#Mutation rate
Clusters10_SAS <- neutrality.stats(Clusters10_SAS, FAST = TRUE)
Mu <- (Clusters10_SAS@theta_Watterson/3970)/(4*10000)
Mu
...
Intergenic.all <- readVCF("new_chr17_intergenic.vcf.gz", numcols=10000, tid="17", from=7197934, to=79473026, include.unknown = TRUE)
...
polysites <- sum(!is.na(match(polyal, 7197934:79473026))) # N polyallelic sites in that region
m <- 88849-sum(misshuman,na.rm=T)-polysites
...
#Region 1
Intergenic1 <- readVCF("new_chr17_intergenic.vcf.gz", numcols=10000, tid="17", from=7197934, to=7210318, include.unknown = TRUE)
...
divsites_inter1
D <- divsites_inter1/12378
D

#Region 2
Intergenic2 <- readVCF("new_chr17_intergenic.vcf.gz", numcols=10000, tid="17", from=18266877, to=18280976, include.unknown = TRUE)
...
divsites_inter2
D <- divsites_inter2/14079
D

#Region 3
Intergenic3 <- readVCF("new_chr17_intergenic.vcf.gz", numcols=10000, tid="17", from=26581655, to=26583401, include.unknown = TRUE)
...
divsites_inter3
D <- divsites_inter3/1746
D

#Region 4
Intergenic4 <- readVCF("new_chr17_intergenic.vcf.gz", numcols=10000, tid="17", from=34216808, to=34220711, include.unknown = TRUE)
...
divsites_inter4
D <- divsites_inter4/3903
D

#Region 5
Intergenic5 <- readVCF("new_chr17_intergenic.vcf.gz", numcols=10000, tid="17", from=36562783, to=36566042, include.unknown = TRUE)
...
divsites_inter5
D <- divsites_inter5/3259
D

#Region 6
Intergenic6 <- readVCF("new_chr17_intergenic.vcf.gz", numcols=10000, tid="17", from=66111659, to=66117203, include.unknown = TRUE)
...
divsites_inter6
D <- divsites_inter6/5544
D

#Region 7
Intergenic7 <- readVCF("new_chr17_intergenic.vcf.gz", numcols=10000, tid="17", from=73063993, to=73070401, include.unknown = TRUE)
...
divsites_inter7
D <- divsites_inter7/5989
D

#Region 8
Intergenic8 <- readVCF("new_chr17_intergenic.vcf.gz", numcols=10000, tid="17", from=74583038, to=74591666, include.unknown = TRUE)
...
divsites_inter8
D <- divsites_inter8/8628
D

#Region 9
Intergenic9 <- readVCF("new_chr17_intergenic.vcf.gz", numcols=10000, tid="17", from=76976191, to=76985084, include.unknown = TRUE)
...
divsites_inter9
D <- divsites_inter9/8893
D

#Region 10
Intergenic10 <- readVCF("new_chr17_intergenic.vcf.gz", numcols=10000, tid="17", from=79448596, to=79473026, include.unknown = TRUE)
...
divsites_inter10
D <- divsites_inter10/24430
D

###################POPULATIONS####################################################

#AFR
Intergenic.all_AFR <- readVCF("new_chr17_1_intergenic.vcf.gz", numcols=10000, tid="17", from=7197934, to=79473026, include.unknown = TRUE)
...
#Region 1
Intergenic1_AFR <- readVCF("new_chr17_1_intergenic.vcf.gz", numcols=10000, tid="17", from=7197934, to=7210318, include.unknown = TRUE)
...
divsites_inter1_AFR
D <- divsites_inter1_AFR/12378
D

#Region 2
Intergenic2_AFR <- readVCF("new_chr17_1_intergenic.vcf.gz", numcols=10000, tid="17", from=18266877, to=18280976, include.unknown = TRUE)
...
divsites_inter2_AFR
D <- divsites_inter2_AFR/14079
D

#Region 3
Intergenic3_AFR <- readVCF("new_chr17_1_intergenic.vcf.gz", numcols=10000, tid="17", from=26581655, to=26583401, include.unknown = TRUE)
...
divsites_inter3_AFR
D <- divsites_inter3_AFR/1746
D

#Region 4
Intergenic4_AFR <- readVCF("new_chr17_1_intergenic.vcf.gz", numcols=10000, tid="17", from=34216808, to=34220711, include.unknown = TRUE)
...
divsites_inter4_AFR
D <- divsites_inter4_AFR/3903
D

#Region 5
Intergenic5_AFR <- readVCF("new_chr17_1_intergenic.vcf.gz", numcols=10000, tid="17", from=36562783, to=36566042, include.unknown = TRUE)
...
divsites_inter5_AFR
D <- divsites_inter5_AFR/3259
D

#Region 6
Intergenic6_AFR <- readVCF("new_chr17_1_intergenic.vcf.gz", numcols=10000, tid="17", from=66111659, to=66117203, include.unknown = TRUE)
...
divsites_inter6_AFR
D <- divsites_inter6_AFR/5544
D

#Region 7
Intergenic7_AFR <- readVCF("new_chr17_1_intergenic.vcf.gz", numcols=10000, tid="17", from=73063993, to=73070401, include.unknown = TRUE)
...
divsites_inter7_AFR
D <- divsites_inter7_AFR/5989
D

#Region 8
Intergenic8_AFR <- readVCF("new_chr17_1_intergenic.vcf.gz", numcols=10000, tid="17", from=74583038, to=74591666, include.unknown = TRUE)
...
divsites_inter8_AFR
D <- divsites_inter8_AFR/8628
D

#Region 9
Intergenic9_AFR <- readVCF("new_chr17_1_intergenic.vcf.gz", numcols=10000, tid="17", from=76976191, to=76985084, include.unknown = TRUE)
...
divsites_inter9_AFR
D <- divsites_inter9_AFR/8893
D

#Region 10
Intergenic10_AFR <- readVCF("new_chr17_1_intergenic.vcf.gz", numcols=10000, tid="17", from=79448596, to=79473026, include.unknown = TRUE)
...
D <- divsites_inter10_AFR/24430
D

#AMR
Intergenic.all_AMR <- readVCF("new_chr17_2_intergenic.vcf.gz", numcols=10000, tid="17", from=7197934, to=79473026, include.unknown = TRUE)
...
#Region 1
Intergenic1_AMR <- readVCF("new_chr17_2_intergenic.vcf.gz", numcols=10000, tid="17", from=7197934, to=7210318, include.unknown = TRUE)
...
divsites_inter1_AMR
D <- divsites_inter1_AMR/12378
D

#Region 2
Intergenic2_AMR <- readVCF("new_chr17_2_intergenic.vcf.gz", numcols=10000, tid="17", from=18266877, to=18280976, include.unknown = TRUE)
...
divsites_inter2_AMR
D <- divsites_inter2_AMR/14079
D

#Region 3
Intergenic3_AMR <- readVCF("new_chr17_2_intergenic.vcf.gz", numcols=10000, tid="17", from=26581655, to=26583401, include.unknown = TRUE)
...
divsites_inter3_AMR
D <- divsites_inter3_AMR/1746
D

#Region 4
Intergenic4_AMR <- readVCF("new_chr17_2_intergenic.vcf.gz", numcols=10000, tid="17", from=34216808, to=34220711, include.unknown = TRUE)
...
divsites_inter4_AMR
D <- divsites_inter4_AMR/3903
D

#Region 5
Intergenic5_AMR <- readVCF("new_chr17_2_intergenic.vcf.gz", numcols=10000, tid="17", from=36562783, to=36566042, include.unknown = TRUE)
...
divsites_inter5_AMR
D <- divsites_inter5_AMR/3259
D

#Region 6
Intergenic6_AMR <- readVCF("new_chr17_2_intergenic.vcf.gz", numcols=10000, tid="17", from=66111659, to=66117203, include.unknown = TRUE)
...
divsites_inter6_AMR
D <- divsites_inter6_AMR/5544
D

#Region 7
Intergenic7_AMR <- readVCF("new_chr17_2_intergenic.vcf.gz", numcols=10000, tid="17", from=73063993, to=73070401, include.unknown = TRUE)
...
divsites_inter7_AMR
D <- divsites_inter7_AMR/5989
D

#Region 8
Intergenic8_AMR <- readVCF("new_chr17_2_intergenic.vcf.gz", numcols=10000, tid="17", from=74583038, to=74591666, include.unknown = TRUE)
...
divsites_inter8_AMR
D <- divsites_inter8_AMR/8628
D

#Region 9
Intergenic9_AMR <- readVCF("new_chr17_2_intergenic.vcf.gz", numcols=10000, tid="17", from=76976191, to=76985084, include.unknown = TRUE)
...
divsites_inter9_AMR
D <- divsites_inter9_AMR/8893
D

#Region 10
Intergenic10_AMR <- readVCF("new_chr17_2_intergenic.vcf.gz", numcols=10000, tid="17", from=79448596, to=79473026, include.unknown = TRUE)
...
D <- divsites_inter10_AMR/24430
D

#EAS
Intergenic.all_EAS <- readVCF("new_chr17_3_intergenic.vcf.gz", numcols=10000, tid="17", from=7197934, to=79473026, include.unknown = TRUE)
...
#Region 1
Intergenic1_EAS <- readVCF("new_chr17_3_intergenic.vcf.gz", numcols=10000, tid="17", from=7197934, to=7210318, include.unknown = TRUE)
...
divsites_inter1_EAS
D <- divsites_inter1_EAS/12378
D

#Region 2
Intergenic2_EAS <- readVCF("new_chr17_3_intergenic.vcf.gz", numcols=10000, tid="17", from=18266877, to=18280976, include.unknown = TRUE)
...
divsites_inter2_EAS
D <- divsites_inter2_EAS/14079
D

#Region 3
Intergenic3_EAS <- readVCF("new_chr17_3_intergenic.vcf.gz", numcols=10000, tid="17", from=26581655, to=26583401, include.unknown = TRUE)
...
divsites_inter3_EAS
D <- divsites_inter3_EAS/1746
D

#Region 4
Intergenic4_EAS <- readVCF("new_chr17_3_intergenic.vcf.gz", numcols=10000, tid="17", from=34216808, to=34220711, include.unknown = TRUE)
...
divsites_inter4_EAS
D <- divsites_inter4_EAS/3903
D

#Region 5
Intergenic5_EAS <- readVCF("new_chr17_3_intergenic.vcf.gz", numcols=10000, tid="17", from=36562783, to=36566042, include.unknown = TRUE)
...
divsites_inter5_EAS
D <- divsites_inter5_EAS/3259
D

#Region 6
Intergenic6_EAS <- readVCF("new_chr17_3_intergenic.vcf.gz", numcols=10000, tid="17", from=66111659, to=66117203, include.unknown = TRUE)
...
divsites_inter6_EAS
D <- divsites_inter6_EAS/5544
D

#Region 7
Intergenic7_EAS <- readVCF("new_chr17_3_intergenic.vcf.gz", numcols=10000, tid="17", from=73063993, to=73070401, include.unknown = TRUE)
...
divsites_inter7_EAS
D <- divsites_inter7_EAS/5989
D

#Region 8
Intergenic8_EAS <- readVCF("new_chr17_3_intergenic.vcf.gz", numcols=10000, tid="17", from=74583038, to=74591666, include.unknown = TRUE)
...
divsites_inter8_EAS
D <- divsites_inter8_EAS/8628
D

#Region 9
Intergenic9_EAS <- readVCF("new_chr17_3_intergenic.vcf.gz", numcols=10000, tid="17", from=76976191, to=76985084, include.unknown = TRUE)
...
divsites_inter9_EAS
D <- divsites_inter9_EAS/8893
D

#Region 10
Intergenic10_EAS <- readVCF("new_chr17_3_intergenic.vcf.gz", numcols=10000, tid="17", from=79448596, to=79473026, include.unknown = TRUE)
...
D <- divsites_inter10_EAS/24430
D

#EUR
Intergenic.all_EUR <- readVCF("new_chr17_4_intergenic.vcf.gz", numcols=10000, tid="17", from=7197934, to=79473026, include.unknown = TRUE)
...
#Region 1
Intergenic1_EUR <- readVCF("new_chr17_4_intergenic.vcf.gz", numcols=10000, tid="17", from=7197934, to=7210318, include.unknown = TRUE)
...
divsites_inter1_EUR
D <- divsites_inter1_EUR/12378
D

#Region 2
Intergenic2_EUR <- readVCF("new_chr17_4_intergenic.vcf.gz", numcols=10000, tid="17", from=18266877, to=18280976, include.unknown = TRUE)
...
divsites_inter2_EUR
D <- divsites_inter2_EUR/14079
D

#Region 3
Intergenic3_EUR <- readVCF("new_chr17_4_intergenic.vcf.gz", numcols=10000, tid="17", from=26581655, to=26583401, include.unknown = TRUE)
...
divsites_inter3_EUR
D <- divsites_inter3_EUR/1746
D

#Region 4
Intergenic4_EUR <- readVCF("new_chr17_4_intergenic.vcf.gz", numcols=10000, tid="17", from=34216808, to=34220711, include.unknown = TRUE)
...
divsites_inter4_EUR
D <- divsites_inter4_EUR/3903
D

#Region 5
Intergenic5_EUR <- readVCF("new_chr17_4_intergenic.vcf.gz", numcols=10000, tid="17", from=36562783, to=36566042, include.unknown = TRUE)
...
divsites_inter5_EUR
D <- divsites_inter5_EUR/3259
D

#Region 6
Intergenic6_EUR <- readVCF("new_chr17_4_intergenic.vcf.gz", numcols=10000, tid="17", from=66111659, to=66117203, include.unknown = TRUE)
...
divsites_inter6_EUR
D <- divsites_inter6_EUR/5544
D

#Region 7
Intergenic7_EUR <- readVCF("new_chr17_4_intergenic.vcf.gz", numcols=10000, tid="17", from=73063993, to=73070401, include.unknown = TRUE)
...
divsites_inter7_EUR
D <- divsites_inter7_EUR/5989
D

#Region 8
Intergenic8_EUR <- readVCF("new_chr17_4_intergenic.vcf.gz", numcols=10000, tid="17", from=74583038, to=74591666, include.unknown = TRUE)
...
divsites_inter8_EUR
D <- divsites_inter8_EUR/8628
D

#Region 9
Intergenic9_EUR <- readVCF("new_chr17_4_intergenic.vcf.gz", numcols=10000, tid="17", from=76976191, to=76985084, include.unknown = TRUE)
...
divsites_inter9_EUR
D <- divsites_inter9_EUR/8893
D

#Region 10
Intergenic10_EUR <- readVCF("new_chr17_4_intergenic.vcf.gz", numcols=10000, tid="17", from=79448596, to=79473026, include.unknown = TRUE)
...
D <- divsites_inter10_EUR/24430
D

#SAS
Intergenic.all_SAS <- readVCF("new_chr17_5_intergenic.vcf.gz", numcols=10000, tid="17", from=7197934, to=79473026, include.unknown = TRUE)
...
#Region 1
Intergenic1_SAS <- readVCF("new_chr17_5_intergenic.vcf.gz", numcols=10000, tid="17", from=7197934, to=7210318, include.unknown = TRUE)
...
divsites_inter1_SAS
D <- divsites_inter1_SAS/12378
D

#Region 2
Intergenic2_SAS <- readVCF("new_chr17_5_intergenic.vcf.gz", numcols=10000, tid="17", from=18266877, to=18280976, include.unknown = TRUE)
...
divsites_inter2_SAS
D <- divsites_inter2_SAS/14079
D

#Region 3
Intergenic3_SAS <- readVCF("new_chr17_5_intergenic.vcf.gz", numcols=10000, tid="17", from=26581655, to=26583401, include.unknown = TRUE)
...
divsites_inter3_SAS
D <- divsites_inter3_SAS/1746
D

#Region 4
Intergenic4_SAS <- readVCF("new_chr17_5_intergenic.vcf.gz", numcols=10000, tid="17", from=34216808, to=34220711, include.unknown = TRUE)
...
divsites_inter4_SAS
D <- divsites_inter4_SAS/3903
D

#Region 5
Intergenic5_SAS <- readVCF("new_chr17_5_intergenic.vcf.gz", numcols=10000, tid="17", from=36562783, to=36566042, include.unknown = TRUE)
...
divsites_inter5_SAS
D <- divsites_inter5_SAS/3259
D

#Region 6
Intergenic6_SAS <- readVCF("new_chr17_5_intergenic.vcf.gz", numcols=10000, tid="17", from=66111659, to=66117203, include.unknown = TRUE)
...
divsites_inter6_SAS
D <- divsites_inter6_SAS/5544
D

#Region 7
Intergenic7_SAS <- readVCF("new_chr17_5_intergenic.vcf.gz", numcols=10000, tid="17", from=73063993, to=73070401, include.unknown = TRUE)
...
divsites_inter7_SAS
D <- divsites_inter7_SAS/5989
D

#Region 8
Intergenic8_SAS <- readVCF("new_chr17_5_intergenic.vcf.gz", numcols=10000, tid="17", from=74583038, to=74591666, include.unknown = TRUE)
...
divsites_inter8_SAS
D <- divsites_inter8_SAS/8628
D

#Region 9
Intergenic9_SAS <- readVCF("new_chr17_5_intergenic.vcf.gz", numcols=10000, tid="17", from=76976191, to=76985084, include.unknown = TRUE)
...
divsites_inter9_SAS
D <- divsites_inter9_SAS/8893
D

#Region 10
Intergenic10_SAS <- readVCF("new_chr17_5_intergenic.vcf.gz", numcols=10000, tid="17", from=79448596, to=79473026, include.unknown = TRUE)
